...
<body>
    <div class="card-container">
        <a href="https://staging.docs.user.clevertap.net/docs/events-changelog" class="card" target="_blank">
            <div class="card-icon">
        ...
        <a href="https://staging.docs.dev.clevertap.net/docs/changelog" class="card" target="_blank">
            <div class="card-icon">
