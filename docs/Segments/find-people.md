...
1. [Find Users by Identity](doc:find-people-copy#find-users-by-identity)
2. [Find Users by Segmentation](doc:find-people-copy#find-users-by-segmentation)
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5924323-Find_Users_by_Identity.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ca4f53c-small-User_Profile_Find_People.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ceca1f6-Find_People_by_Segmentation.png",
        null,
        "Find People"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d590ce5-small-Save_Segment_Find_People.png",
        null,
        "Save Segment"
      ],
      "align": "center",
...
The _Find People_ section allows you to export the users in the CSV format from any segment that you have created. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b87f458-small-Download_Icon.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/84c2e27-small-Profile_Find_People.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0b0a537-small-Activity_Find_People.png",
        null,
        "View Activity Details"
      ],
      "align": "center",
      "border": true,
      "caption": "View Activity Details"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e56e713-small-Engagement_Find_People.png",
        null,
        "View Engagement Details"
      ],
      "align": "center",
      "border": true,
      "caption": "View Engagement Details"
    }
  ]
}
[/block]