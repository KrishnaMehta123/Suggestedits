  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <li>Past Behavior Segment</li><li>Live User Segment</li><li>Custom List Segment</li><li>Partner Segment (where Partner Name can be Amplitude, Mixpanel and so on)</li>
      </td>
    </tr>
...
7. Click **Save segment** and name the segment.
