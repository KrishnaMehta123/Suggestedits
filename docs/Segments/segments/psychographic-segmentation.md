...
Psychographic Segment is a CleverTap capability that enables you to segment your users based on event properties, including their relative frequencies, date, and time.
