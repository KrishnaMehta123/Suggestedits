...
<Image alt="Global Device Filter" align="center" border={true} src="https://files.readme.io/102aca6cfb0cfbe212d29c65f1345f82b43ed61b930c6e76965357496fa0c56c-image.png">
...
**Rule:** *Did Purchase in last 30 days* → All devices of that user receive the campaign.
...
**Rule:** *Did App Launch in the last 30 days*\
**Global Device Filter:** *OS = 13*
...
**Rule:** *Did Notification Clicked*\
**Global Device Filter:** *Browser = Chrome* → Only Chrome devices are included.
...
**Rule:** *Did Not App Launch in last 30 days + OS in\[13,14,15,16]*\
**Global Device Filter:** *OS = 13* → Only dormant OS 13 devices are targeted.
