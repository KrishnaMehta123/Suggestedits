...
next:
  description: ''
---
(@Meenal: As discussed, let's move this to under the FAQ section of [https://docs.clevertap.com/docs/troubleshooting-faqs-push-notifications](https://docs.clevertap.com/docs/troubleshooting-faqs-push-notifications) document.)
...
Previously, filters in the *Who* section were evaluated during campaign user qualification. With the enhanced Segment Builder, this evaluation now happens during campaign dispatch. Here is how it works:
