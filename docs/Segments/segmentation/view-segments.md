...
<Image alt="View Segment Trend" align="center" border={true} src="https://files.readme.io/eeb00ea-Segment_Trend.png">
  View Segment Trend
</Image>

* **Insights**: Displays the number of users reachable via different messaging channels and sample user profiles who qualify for the segment.

<Image alt="View Segment Insights" align="center" border={true} src="https://files.readme.io/1759d4a-Segment_Insights.png">
...
<Image alt="View Segment Insights" align="center" border={true} src="https://files.readme.io/dc297a5488daa78627ae612e673309de9654066bb724ca6903fe23e4d1c9f491-image.png">
  View Segment Insights
</Image>

# Export User Profiles

The *Insights* section allows you to export the users in the CSV format from any segment that you have created. 

To export the users in CSV format:

1. Click the![](https://files.readme.io/758da8c-Export_User_Profiles.png) icon under the *Insights*  section. 
2. Select the fields that you may want to export and click **Export**.

<Image alt="Export User Profiles" align="center" border={true} src="https://files.readme.io/1f2f69a-Export_User_Profiles.png">
  Export User Profiles
</Image>
