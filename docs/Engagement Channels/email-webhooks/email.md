...
<Image title="ec1.png" alt={1234} className="border" border={true} src="https://files.readme.io/ddb734f-ec1.png" />

Click Select under the Email channel.

<Image title="ec2.png" alt={1237} className="border" border={true} src="https://files.readme.io/f41e986-ec2.png" />

## Step 2: Define the When

<Image title="ec3.png" alt={1238} className="border" border={true} src="https://files.readme.io/fe7beeb-ec3.png" />
...
<Image title="ec4.png" alt={1242} className="border" border={true} src="https://files.readme.io/52f3055-ec4.png" />
...
<Image title="Screen Shot 2018-07-17 at 12.57.00 AM.png" alt={1242} className="border" border={true} src="https://files.readme.io/8e027cb-Screen_Shot_2018-07-17_at_12.57.00_AM.png" />
...
<Image title="ec5.png" alt={1240} className="border" border={true} src="https://files.readme.io/24eae55-ec5.png" />
...
<Image title="Screen Shot 2019-08-23 at 3.27.36 PM.png" alt={1391} className="border" border={true} src="https://files.readme.io/1e8ce94-Screen_Shot_2019-08-23_at_3.27.36_PM.png" />
...
<Image title="ec6.png" alt={1242} className="border" border={true} src="https://files.readme.io/fb18b00-ec6.png" />
...
<Image title="ec7.png" alt={1247} className="border" border={true} src="https://files.readme.io/cb7a048-ec7.png" />
...
![802](https://files.readme.io/06232a9-ec11.png "ec11.png")
...
When including links in your email, please tag them each with distinct UTM parameters (source = wizrocket (say), medium = email (say), campaign = campaign1\_link1 (say), and so on). 

Then, you can go into "Events" or "Find People", select the "UTM Visited" event, and filter by UTM campaign = campaign1\_link1, or campaign1\_link2, and so on.
...
<Image title="ab1.png" alt={1323} className="border" border={true} src="https://files.readme.io/8cbbeec-ab1.png" />
...
<Image title="ab4.png" alt={1332} className="border" border={true} src="https://files.readme.io/e949ea8-ab4.png" />
