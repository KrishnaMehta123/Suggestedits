...
<Image title="WA Templates-1.png" alt={1440} className="border" border={true} src="https://files.readme.io/0101bbf-WA_Templates-1.png" />

Click on **+Add Template** button and a **Add new whatsapp message template** appears. Add the template. 

<Image title="Campaign_Whatsapp_Settings_Template_Add.png" alt={1440} className="border" border={true} src="https://files.readme.io/74fc448-Campaign_Whatsapp_Settings_Template_Add.png" />
...
<Image title="Campaign Listing - 2.png" alt={1436} className="border" border={true} src="https://files.readme.io/732956d-Campaign_Listing_-_2.png" />

Select WhatsApp from the channel selection page.

![1437](https://files.readme.io/4be04bc-Campaign_Whatsapp_Channel_Select.png "Campaign_Whatsapp_Channel_Select.png")
...
![1436](https://files.readme.io/4012566-Campaign_Whatsapp_Template_Types_copy.png "Campaign_Whatsapp_Template_Types copy.png")
