...
3. Check the Monthly Active Users (MAU). This metric helps track whether users are opening the mobile application at least once a month. This field is not editable and the value is already set during the sign up procedure. 
