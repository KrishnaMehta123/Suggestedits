...
These are example instruction sets you (or customers) can pre-fill in the Instructions field under _Content Guidelines_ and _Image Guidelines_ in the Brand Kit. They tell the AI how to represent the brand’s style and tone.
