...
2. From the list of available system predictions, select the prediction you want to start.
3. Click on the dropdown under the default status labeled _Available_.
4. Select _Activate_ from the dropdown to start the prediction. 

The following example shows how to start the _Uninstalls_ system prediction:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/53a73295f56903a5f4217558799ccb4658d70d5a98a5e4f2a969446c7cb3d4c2-Setup_System_Prediction_Uninstalls.gif",
        "",
        "Activating the Uninstalls System Prediction"
      ],
      "align": "center",
      "border": true,
      "caption": "Activating the Uninstalls System Prediction"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8f69bf0d381625550ac60df82f58156197487957f9e00052b462dced6aeae086-Add_Basic_Details.png",
        "",
        "Add Basic Details"
      ],
      "align": "center",
      "border": true,
      "caption": "Add Basic Details"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c151e575d4cfd6c55ccb2c2d32e76c304320ac02121ddd1346a853bc8a9410d7-Set_a_Goal.png",
        "",
        "Set a Goal"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c895b90308b46a8013067790eb3a79e3a1e3f5e4c7585ae0dd8619b58e4b63c9-Define_a_Target.png",
        null,
        "Define a Target"
      ],
      "align": "center",
      "border": true,
      "caption": "Define a Target"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/770f5b08f426c1886187550f8ed86cb4da1ecf203a8e277f8eed5759bf677472-Search_Predictions.png",
        "",
        "Search Predictions"
      ],
      "align": "center",
      "border": true,
      "caption": "Search Predictions"
    }
  ]
}
[/block]
...
- **Prediction Type**: Indicates the type of prediction i.e. _System_ or _Custom_.
- **Created By**: Indicates the name of the user who created the prediction.
- **Prediction Status**: Indicates the status of the predictions i.e. _Available, Processing, Active, Stopped_. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6a705bb038fdb0db305c08e89b7bf937c5a44e0190184a459216f46fc7e5a8b9-Filters.png",
        "",
        "Filter Predictions"
      ],
      "align": "center",
      "border": true,
      "caption": "Filter Predictions"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/526c3930df22b2efd0bfdca0f5c9771a4f2d5ad33ce6d1cf5c2d60a13fa956e5-2024-08-21_23-42-41_1.gif",
        null,
        "Edit/Clone Custom Predictions"
      ],
      "align": "center",
      "border": true,
      "caption": "Edit/Clone Custom Predictions"
    }
  ]
}
[/block]
