...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/18953ed26a32fa2e10518a4587c1a85a939bbc34e6b2d307a95c11b34f6cf276-Preferred_Channel_Functionality.png",
        "",
        "How Preferred Channel is Calculated"
      ],
      "align": "center",
      "sizing": "85% ",
      "border": true,
      "caption": "Preferred Channel Calculation"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    "h-0": "Product Area",
    "h-1": "How Preferred Channel Helps",
    "0-0": "Segmentation",
    "0-1": "Filter users by their most engaged channel to create precise, channel-specific segments.  \nFor example: Users whose Preferred Channel = WhatsApp.",
    "1-0": "Campaigns",
    "1-1": "Use the Preferred Channel property in the _Who_ section to refine targeting and ensure messages are delivered through the channel where users are most responsive.",
    "2-0": "Journeys",
    "2-1": "Branch users dynamically in a Conditional Split node based on their Preferred Channel. The property is read-only and can only be used for segmentation or branching logic.",
    "3-0": "Analytics",
    "3-1": "Track and analyze engagement performance by comparing metrics across different Preferred Channels.",
    "4-0": "Profile Exports",
    "4-1": "Export the Preferred Channel property for analysis to external analytics or CRM systems."
  },
  "cols": 2,
  "rows": 5,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4cdf28aadc0e6bfcf384afd4d776111c4f0b146f00fdac4713df2fb90fe099dc-Preferred_Channel_vs._Est._Reach.png",
        "",
        "Preferred Channel vs. Estimate Reach"
      ],
      "align": "center",
      "sizing": "80% ",
      "border": true,
      "caption": "Preferred Channel and Estimate Reach"
    }
  ]
}
[/block]
...
When creating a Campaign, use the _Preferred Channel _ property in the Who section to target users who are most likely to engage on that channel.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c3eaeda6af0240ec4d598a99327f796f8409a895aa36ace4fe8878729ceb8835-Define_Who_Using_Preferred_Channel.png",
        null,
        "Preferred Channel in Campaigns"
      ],
      "align": "center",
      "border": true,
      "caption": "Using Preferred Channel in Campaigns"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ce090f631fe289914a4480207ccc614024ba6f484a7999ab02f129b5f745a6ce-image.png",
        null,
        "Preferred Channel Setup in Conditional Split Journeys"
      ],
      "align": "center",
      "border": true,
      "caption": "Preferred Channel Setup in Conditional Split Journeys"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3c15b597dc0d65a91adb55bf09915590e48ca8dc2fd695749a3b406277430a5c-image.png",
        null,
        "Personalize Journey Basis Preferred Channel"
      ],
      "align": "center",
      "border": true,
      "caption": "Personalize Journey Basis Preferred Channel"
    }
  ]
}
[/block]
