...
To create a WhatsApp campaign using Gupshup as the provider, refer to [https://docs.clevertap.com/docs/whatsapp#section-creating-a-whatsapp-campaign](https://docs.clevertap.com/docs/whatsapp#section-creating-a-whatsapp-campaign) for detailed instructions.
