...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a26d185-2020-06-25_10-25-38_Name_and_save_template.png",
        "2020-06-25_10-25-38_Name and save template.png",
        972,
        601,
        "#b3b4b6"
      ]
...
[block:callout]
{
  ...
  "body": "Namespace is combination of your Account name in capital and template name on Gupshup dashboard. for example if you account is ABC and the template name for a verified template on Gupshup is welcome_message, then namespace would be **ABC:welcome_message**"
}
[/block]
5. Click **Save**.
