...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e3455eb-Whatsapp_Nexmo_Setup.png",
        "Whatsapp_Nexmo_Setup.png",
        596,
        1042,
        "#f7f8fa"
      ],
...
[block:callout]
{
  ...
  "body": "Select the checkbox if you want to set auto-replies for users who are not tracked in CleverTap."
}
[/block]
4. Click **Save**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/55f6bda-Whatsapp_Nexmo_Template_main.png",
        "Whatsapp_Nexmo_Template_main.png",
        883,
        583,
        "#afb0b2"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/622f441-Whatsapp_Nexmo_Template.png",
        "Whatsapp_Nexmo_Template.png",
        386,
        644,
        "#f3f4f7"
      ],
...
4. Select an *Image, Video, Document, *or *Location* from the *Attachment type* list.  
5. Click Save. 
...
4. Perform WhatsApp warm up. Tiers have to be crossed, and it is called Initial Warm-Up by the Facebook team. <<Need to clarify this sentence>>
5. For any concerns specific to Nexmo that need redressal, contact Nexmo support at support@nexmo.com.