...
<Image title="Bucket page.png" alt={2876} className="border" border={true} src="https://files.readme.io/9df246a-Bucket_page.png" />
...
5. Click **Create bucket**. On successful bucket creation, the following message displays at the top:

<Image title="Successful bucket creation.png" alt={2768} className="border" border={true} src="https://files.readme.io/d503e56-Successful_bucket_creation.png" />
...
<Image title="Add user.png" alt={2878} className="border" border={true} src="https://files.readme.io/cc6631b-Add_user.png" />
...
<Image title="Create policy.png" alt={2648} className="border" border={true} src="https://files.readme.io/efd246c-Create_policy.png" />

On successful policy creation, the following message displays at the top:
...
12. Go back to the *Create group* page, search for the policy you just created and assign it to the new group by selecting the checkbox next to it.
...
<Image title="Exports page.png" alt={2270} className="border" border={true} src="https://files.readme.io/d67d37f-Exports_page.png" />
...
<Image title="Create an export popup.png" alt={1098} className="border" width="80%" border={true} src="https://files.readme.io/370dd04-Create_an_export_popup.png" />
...
<Image title="S3 Bucket Details 3.png" alt={1209} className="border" border={true} src="https://files.readme.io/8ea72b5-S3_Bucket_Details_3.png" />
...
<Image title="Search for export files.png" alt={2842} className="border" border={true} src="https://files.readme.io/62b08d0-Search_for_export_files.png" />
