...
{
  "type": "info",
  "body": "This capability is a part of the CleverTap for Enterprises plan. Contact your sales account manager to have it activated for you.",
  "title": "Feature Part of the CleverTap for Enterprises Plan"
}
[/block]
# Initiate an Export
...
{
  "type": "success",
  "body": "If your CleverTap account uses AWS EU (Ireland), then you will have to create an S3 bucket in the AWS EU (Ireland) region.",
  "title": "Region Example"
}
[/block]
...
{
  "type": "info",
  "body": "*IP Whitelisting* is not supported with S3 exports. For more information about AWS API access policies, please review [this post](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_examples_s3_rw-bucket-console.html) from the AWS blog.",
