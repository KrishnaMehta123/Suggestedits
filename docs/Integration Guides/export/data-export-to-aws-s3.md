...
![2874](https://files.readme.io/bc21bb7-Replace_JSON_code.png "Replace JSON code.png")
...
<Image title="Exports page.png" alt={2270} className="border" border={true} src="https://files.readme.io/5e37549-Exports_page.png" />
...
![1209](https://files.readme.io/dfbc693-Create_Export_page.png "Create Export page.png")
...
* **Export details**: Select the following appropriate export-related options: the type of export (user profile or events), export frequency, and export format. For more information, refer to [Export Details](doc:data-export-to-aws-s3#export-details).
