...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Enter API Key(Username) obtained in [Step II](https://docs.clevertap.com/docs/exotel_wip#ii-find-exotel-details).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Enter API Token(Password) obtained in [Step II](https://docs.clevertap.com/docs/exotel_wip#ii-find-exotel-details).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * Select the *Region* of your Exotel account from the dropdown list. 
        * For any queries, contact [Exotel Support Team](https://support.exotel.com/a/solutions/articles/3000114660).
        * The following are the available options:
          * Singapore: [api.exotel.com](api.exotel.com). This is the default value.
          * Mumbai: [api.in.exotel.com](api.in.exotel.com)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * The following are the options available:
          ...
          * **transactional\_opt\_in**: Indicates that the SMS consists of Service Explicit content.
