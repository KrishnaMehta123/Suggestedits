...
1. Go to *Settings* > *Partners* > *Attribution*.
2. Click the **Edit** icon to view the toggle options.

<Image title="Attribution Partner.png" alt={4448} className="border" border={true} src="https://files.readme.io/b4bb04a-Attribution_Partner.png" />
...
<Image title="Click Save.png" alt={490} className="border" width="80%" border={true} src="https://files.readme.io/148c653-Click_Save.png" />
...
<Image title="Duplication of events.png" alt={1960} className="border" border={true} src="https://files.readme.io/8760f66-Duplication_of_events.png" />
