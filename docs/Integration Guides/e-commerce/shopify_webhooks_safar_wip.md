...
6. Enter the CleverTap endpoint URL. For example, *[https://api.clevertap.com/shopify/m/](https://api.clevertap.com/shopify/m/)&lt;Account ID&gt;* 
7. Click Save.
...
>
> The Checkout Created, Checkout Updated, Checkout Deleted and Charged events are available automatically via webhooks for all Shopify plugin installs/reinstalls after 27th September 2021. There is no need to subscribe to these events manually.
