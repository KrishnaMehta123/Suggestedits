...
[block:callout]
{
  ...
  "body": "If the user clicks **Connect** without entering a link, the following error message is displayed: \"Please enter a store name\"."
}
[/block]
...
{
  "type": "warning",
  "body": "If the user enters an invalid store name, the following message is displayed: \"Store name invalid or does not exist\".",
  "title": "Invalid Shopify Store Name"
}
[/block]
