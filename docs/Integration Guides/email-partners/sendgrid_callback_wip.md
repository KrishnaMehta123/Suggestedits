...
[block:callout]
{
  "type": "warning",
  "title": "Note",
  "body": "SendGrid will discontinue the username and password on 9th December 2020. The only identifier available will be the API key.\n\nPlease reach out to your SendGrid Account Executive or SendGrid Support for any clarifications."
}
[/block]
...
{
  "type": "warning",
  "body": "If you are using SendGrid credentials with SMTP integration, then enter **apikey** as username and <API_KEY_VALUE> as password.",
  "title": "Note"
}
[/block]
