...
To enable support for bounce processing, follow the below mentioned steps:

* Go to Your Server → Settings → Outbound.
...
<Image title="webhooks1.png" alt={1808} className="border" border={true} src="https://files.readme.io/2ea0382-webhooks1.png" />
