...
# Step 2: CleverTap Dashboard Steps
  * Login to the [CleverTap Dashboard](https://dashboard.clevertap.com/
) and go to the Settings page. 
  * Click on the Integrate ad network campaigns button. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/db716f5-ads1.png",
        "ads1.png",
        1050,
        655,
        "#f7f7fb"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/09a66be-ads2.png",
        "ads2.png",
        875,
        373,
        "#f4f1f5"
...
{
  "type": "warning",
  "body": "If you have multiple CleverTap accounts, make sure that you are using the correct one. Similarly, if you have multiple AdWords accounts, please verify it is the correct one.",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6d4ced6-campaign1.png",
        "campaign1.png",
        1251,
        525,
        "#dadbe0"
