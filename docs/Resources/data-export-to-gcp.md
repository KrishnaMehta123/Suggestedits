...
<Image title="Screenshot 2020-04-06 at 8.19.51 PM.png" alt={2862} className="border" border={true} src="https://files.readme.io/f364c54-Screenshot_2020-04-06_at_8.19.51_PM.png" />
...
<Image title="Screenshot 2020-04-06 at 8.20.31 PM.png" alt={2862} className="border" border={true} src="https://files.readme.io/ac2e5d8-Screenshot_2020-04-06_at_8.20.31_PM.png" />
...
1. Login to your CleverTap account, and go to [this page](https://eu1.dashboard.clevertap.com/AAA-BBB-CCC/my-exports.html). Click on the Settings -> Partner-> Exports->Google 

<Image title="Screenshot 2020-04-06 at 4.22.11 PM.png" alt={2754} className="border" border={true} src="https://files.readme.io/59a5b14-Screenshot_2020-04-06_at_4.22.11_PM.png" />
...
<Image title="Screenshot 2020-04-06 at 4.51.32 PM.png" alt={2044} className="border" border={true} src="https://files.readme.io/e4bca7d-Screenshot_2020-04-06_at_4.51.32_PM.png" />

## Step 4 - Create a New Data Export

Click on the Partner Data -> Exports -> Activity Log -> Create Export 

<Image title="Screenshot 2020-04-06 at 8.19.51 PM.png" alt={2862} className="border" border={true} src="https://files.readme.io/0ebf390-Screenshot_2020-04-06_at_8.19.51_PM.png" />
...
<Image title="Data_Export_AWS_settings.gif" alt={1280} className="border" border={true} src="https://files.readme.io/448d753-Data_Export_AWS_settings.gif" />
...
<Image title="Screenshot 2020-04-06 at 8.22.31 PM.png" alt={2862} className="border" border={true} src="https://files.readme.io/6991174-Screenshot_2020-04-06_at_8.22.31_PM.png" />
