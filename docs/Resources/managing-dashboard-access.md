...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/900a2e6-dash1.gif",
        "dash1.gif",
        960,
        540,
        "#c2c0be"
...
{
  "type": "warning",
  "title": "Not Enabled by Default",
  "body": "The Approver role is not enabled by default. Please contact your CleverTap sales representative, or email CleverTap support (support@clevertap.com) to enable it in your account."
}
[/block]
