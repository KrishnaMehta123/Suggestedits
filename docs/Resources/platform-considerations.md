...
excerpt: Understand the crucial platform considerations of CleverTap.
deprecated: false
hidden: false
metadata:
  title: ''
...
- Concurrent requests to this API are limited to 15 per account. Requests that exceed the limit will return a 429 HTTP response code.
...
- The _Charged_ event supports up to 256 Items values.
