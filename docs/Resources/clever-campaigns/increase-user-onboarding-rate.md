...
<Image title="clever-campaigns-2.png" alt={1399} className="border" border={true} src="https://files.readme.io/3021cda-clever-campaigns-2.png" />
...
<Image title="ua1.png" alt={877} className="border" border={true} src="https://files.readme.io/eca8c74-ua1.png" />
...
<Image title="ua2.png" alt={881} className="border" border={true} src="https://files.readme.io/5dd9b5b-ua2.png" />
...
![1401](https://files.readme.io/586420d-clever-campaign-3.png "clever-campaign-3.png")

First, click “Edit Campaign”, then personalize by adding text and custom user attributes.

<Image title="ua3.png" alt={879} className="border" border={true} src="https://files.readme.io/85b26f6-ua3.png" />
...
<Image title="ua4.png" alt={881} className="border" border={true} src="https://files.readme.io/d650ee8-ua4.png" />
...
<Image title="ua5.png" alt={1294} className="border" border={true} src="https://files.readme.io/8173ce9-ua5.png" />
