...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ec8ee47-1_Journeys.png",
        "1 Journeys.png",
        1648,
        428,
        "#f0f2f4"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7f60601-2_Journeys.png",
        "2 Journeys.png",
        1610,
        442,
        "#f1f2f4"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/568e1bf-3_Use_case.png",
        "3 Use case.png",
        900,
        1999,
        "#7b8674"
...
## Target different segments such as Custom list segment and Past Behaviour segments in the in-app notification campaigns <<Sunil to Add this to backlog. Needs more input. and review>>
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/51c87c3-in-app_journey_past_behavior.png",
        "in-app_journey_past_behavior.png",
        733,
        224,
        "#e6efe8"
      ],
      "caption": "Past Behavior Entry Node"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/538bb69-in-app_journey_inaction_entry.png",
        "in-app_journey_inaction_entry.png",
        853,
        250,
        "#ecf3ed"
      ],
      "caption": "Inaction Entry Node"
    }
  ]
}
[/block]
## Use Case <<Sunil to Add this to backlog. Needs more input. and review>>
Send in-app notification when the user launches the app stating there are new arrivals. The navigation button can consist of a deep link to the page of the new arrivals.
...
## Q. My partial user base is on an old SDK, and the rest are on new. How do I send them the same campaign? <<Sunil to Add this to backlog. Needs more input. and review>>
...
## Q. Can multiple in-app campaigns run on the same triggering event?  <<Sunil to Add this to backlog. Needs more input. and review>>
...
## Q. What are the text and image specifications for in-app campaigns in each template? <<Sunil to add this. to Create message section>>
Text limit:
...
For image specifications, refer to [template aspect ratio and image size guide]  (https://docs.clevertap.com/docs/inapp-campaigns#section-template-aspect-ratio-and-image-size-guide).

## Q. I need to send crisp template campaigns. Do I need to update my SDK? <<Sunil to Add this to backlog. Needs more input. and review>>
