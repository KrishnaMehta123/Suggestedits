...
1. BEFORE PUBLISHING THIS DOC, ENSURE THAT THE EXISTING PAGE IS UNPUBLISHED (OR DELETED) AND THAT ALL ITEMS FROM THE EXISTING PAGE ARE COVERED IN THE NEW (HACKATHON) SUBPAGES: [https://docs.clevertap.com/docs/push](https://docs.clevertap.com/docs/push)
2. PM DK IS STILL REVIEWING THE CAMPAIGN REDESIGN WIP USER DOC [https://docs.clevertap.com/docs/push-notifications\_campaign\_redesign\_wip](https://docs.clevertap.com/docs/push-notifications_campaign_redesign_wip) WHICH WILL BECOME THE SOURCE OF TRUTH
