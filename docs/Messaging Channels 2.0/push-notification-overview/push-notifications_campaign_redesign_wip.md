---
title: Push Notifications_campaign_redesign_WIP
excerpt: ''
deprecated: false
hidden: true
metadata:
...
<Image title="campaign_setup_main.png" alt={1378} className="border" border={true} src="https://files.readme.io/6bc44d8-campaign_setup_main.png" />
...
* Setup:  Displays the information for platforms such as FCM, Xiaomi, or iOS. Check that the required platforms are integrated and ready for campaigns. 
* Delivery Type: Deliver the notification by time, [events](https://docs.clevertap.com/docs/push-notifications_campaign_redesign_wip#section-deliver-action-based-push-notifications-instantly), or API. 
...
Click the *Filter* link to create more focussed conversions using event properties.  For more information on event properties, see [Events](doc:events) ]. 

Define the conversion period by selecting the *Funnel Conversion Time*.  (@vishal somani please check now)

![1338](https://files.readme.io/4c59d9b-campaign_push_setup.png "campaign_push_setup.png")

## Define the Who

You must indicate the target audience for your push campaign. You can target your push campaign to a new user segment by clicking on the **Target segment** section. Here you can create a new segment or use a previously saved user segment from the *Segments* list. \<\<@vishal please confirm>>
...
<Image title="Campaign_Who_User_properties.png" alt={821} className="border" border={true} src="https://files.readme.io/9d51f1a-Campaign_Who_User_properties.png" />

### Constant event property

You can also hold a property constant across the selected event.  For more information, see [Constant Event Property](doc:constant-property) .
...
The campaign limits can also be configured as follows \<\<@vishal these options are not visible on the UI>>: 
...
![1222](https://files.readme.io/ecd5f8d-campaign_push_What.png "campaign_push_What.png")
...
<Image title="campaign_push_multi_message.png" alt={1326} className="border" border={true} src="https://files.readme.io/309985d-campaign_push_multi_message.png" />

### Advanced Settings

Click *Go To Editor* to create your message. This section displays the editor to create your push message. 
...
<Image title="campaign_iOS.png" alt={1251} className="border" border={true} src="https://files.readme.io/3d711b6-campaign_iOS.png" />
...
<Image title="campaign_iOS.png" alt={1251} className="border" border={true} src="https://files.readme.io/2bd5135-campaign_iOS.png" />
...
<Image title="campaign_Android_button.png" alt={687} className="border" border={true} src="https://files.readme.io/f4f1a42-campaign_Android_button.png" />
...
@vishal somani it is already mentioned under the Who section
...
Once you are all done setting up the content of your campaign in *What*, you have the option to send a test push notification to any CleverTap user profile you have marked as a *Test profile* \<\<@vishal, where do we see this testing option?>>.
