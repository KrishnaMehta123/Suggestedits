...
<Image title="Select_all_channel.png" alt={1360} width="80%" border={true} src="https://files.readme.io/ec0c217-Select_all_channel.png">
...
<Image title="push_main.png" alt={971} className="border" border={true} src="https://files.readme.io/46013be-push_main.png" />
...
<Image title="Push_notification_image_URL_Android.png" alt={1274} className="border" border={true} src="https://files.readme.io/eeec895-Push_notification_image_URL_Android.png" />
...
You can further increase the delivery of push notifications by sending a copy of the same message to App Inbox. For more information, see [Optimize Delivery](https://docs.clevertap.com/docs/optimize-delivery) 
...
![1080](https://files.readme.io/a91ddec-Push_notification_example.jpg "Push_notification_example.jpg")
...
<Image title="AB_Test_all.png" alt={881} className="border" border={true} src="https://files.readme.io/4d99162-AB_Test_all.png" />
