...
[block:callout]
{
  ...
  "body": "All the push campaigns that are created *after* turning on the push amplification toggle are amplified. Similarly, no new campaigns are amplified after the push amplification is turned off."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1c984d8-push_amplification_optimize_delivery.png",
        "push_amplification_optimize_delivery.png",
        2672,
        812,
        "#f9fafa"
      ],
...
{
  "type": "info",
  "body": "*App Inbox* also exists as a stand-alone channel. For more information, refer to [App Inbox](https://docs.clevertap.com/docs/app-inbox-overview).",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2a58958-push_amplification_stats.png",
        "push_amplification_stats.png",
        5344,
        1624,
        "#f9fafa"
      ],
