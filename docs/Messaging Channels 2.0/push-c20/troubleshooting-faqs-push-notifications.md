...
<Image title="Analyze_CTA_1.png" alt={1232} className="border" border={true} src="https://files.readme.io/a1eeb55-Analyze_CTA_1.png" />

On the result, go to *Trend & Properties*, then scroll down to the *Event property* table and filter in the dropdown by *wzrk\_c2a* to see a distribution of clicks across the various buttons on that respective campaign.

\<\<@dk, need a good screen here>>

<Image title="Analyze_CTA_2.png" alt={1046} className="border" border={true} src="https://files.readme.io/9d5e8c1-Analyze_CTA_2.png" />
...
* Max size: 40Kb\
  We would recommend maintaining an Aspect ratio of 16:9. Adjust the dimensions accordingly. You can calculate the aspect ratio from websites such as [https://calculateaspectratio.com](https://calculateaspectratio.com).
