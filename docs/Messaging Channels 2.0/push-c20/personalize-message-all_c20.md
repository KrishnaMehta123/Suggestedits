---
title: Personalize Message_clone_standard_template
excerpt: ''
deprecated: false
hidden: true
metadata:
...
<Image title="Constant_property_sample.png" alt={1374} className="border" border={true} src="https://files.readme.io/790bd5c-Constant_property_sample.png" />
