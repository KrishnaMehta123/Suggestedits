...
excerpt: Understand how to personalize your Segment campaign
deprecated: false
hidden: true
metadata:
  title: ''
...
<Image title="Personalize Campaign.png" alt={2878} className="border" border={true} src="https://files.readme.io/7ceb4cf-Personalize_Campaign.png" />
