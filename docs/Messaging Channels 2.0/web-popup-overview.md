...
These segments can be created on the basis of a user performing an action on one of your webpages, a user visiting one of your specific webpages, a user visiting your website via an external ad referral, or even based on the number of your webpages a user has visited so far. 
