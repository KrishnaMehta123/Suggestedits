...
next:
  description: ''
---
DOCS NOTE: COMPARE/REVIEW WITH THE EXISTING PAGE: [https://docs.clevertap.com/docs/handling-unsubscribes](https://docs.clevertap.com/docs/handling-unsubscribes)
