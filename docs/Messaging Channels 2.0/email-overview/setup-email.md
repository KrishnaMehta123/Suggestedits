...
[https://docs.clevertap.com/docs/enabling-previews](https://docs.clevertap.com/docs/enabling-previews)
...
![1162](https://files.readme.io/9206de0-Plus_provider.png "Plus provider.png")
...
> 📘 Recommended List of Contacts
>
> We recommend that you have a list of contacts of more than 10,000 emails.
...
> 📘 SendGrid Support
>
> \<\< @PM/TEAM: CAN SOMEONE CONFIRM THIS NOTE AND ADD MORE INSIGHTS/DETAILS? >> 
>
...
> 🚧 CSV Requirements
>
> The emails must be under the *identity* column where:
>
> * The letter "i" has to be lowercase.
> * *identity* always has to be the first column irrespective of their user properties.

![512](https://files.readme.io/8219ca0-Historical_data.png "Historical data.png")
...
![512](https://files.readme.io/724be4c-Display_common_properties.png "Display common properties.png")

The following is a sample format on how to upload the suppression list of users.

![512](https://files.readme.io/c2dde94-Sample_format.png "Sample format.png")
...
![1172](https://files.readme.io/49e8f2d-Enable_an_inbox_preview.png "Enable an inbox preview.png")
