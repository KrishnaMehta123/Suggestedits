...
<Image title="Campaign Listing - 2.png" alt={1436} className="border" border={true} src="https://files.readme.io/458cdc9-Campaign_Listing_-_2.png" />
...
<Image title="Campaign_Saved_Segment_PBS_Who.png" alt={1147} className="border" border={true} src="https://files.readme.io/5b79062-Campaign_Saved_Segment_PBS_Who.png" />
...
![1816](https://files.readme.io/8f211e1-2020-06-17_12-41-37_Convert_to_HTML_Select_option.png "2020-06-17_12-41-37_Convert to HTML_Select option.png")

After your template loads, select **More**.

![1172](https://files.readme.io/2817e52-2020-06-17_12-41-37_Convert_to_HTML_Click_more.png "2020-06-17_12-41-37_Convert to HTML_Click more.png")

Select **Convert to HTML** from the dropdown menu.

![351](https://files.readme.io/b3695d3-2020-06-17_12-41-37_Convert_to_HTML_option.png "2020-06-17_12-41-37_Convert to HTML option.png")
...
![454](https://files.readme.io/e17a37f-2020-06-17_13-13-46_Save_template.png "2020-06-17_13-13-46_Save template.png")

Type your edits into the HTML editor.

![1160](https://files.readme.io/5cd74e4-2020-06-17_13-15-35_HTML_mode.png "2020-06-17_13-15-35_HTML mode.png")

Select **Previews** and save your template when you are satisfied with the changes.

![1156](https://files.readme.io/e421ee0-2020-06-17_13-18-06_Preview.png "2020-06-17_13-18-06_Preview.png")
...
<Image title="Campaigns_Email_Preheader_Output.png" alt={1439} className="border" border={true} src="https://files.readme.io/4b49cf1-Campaigns_Email_Preheader_Output.png" />

After you have completed creating the message, click Continue. To display *Preheader* in your message, enter the *Preheader* text in the Preheader box. You can preview the text at this stage. 
...
Confirm the settings on the next page. Click **Continue**.
...
* **Do Not Disturb:** This option allows you to stop the delivery of the campaign during a specified time. 
* **Campaign Cut-off:** This option allows you to stop the delivery of the campaign after a specified time. 
* **Global Throttle Limits:** These are limits you can apply to determine how many emails each app user receives per day. If you would like to override these settings for an important campaign, you can click the *Settle Throttle Limits* link. 
* **Global Campaign Limits:** These are limits you can apply to control the maximum number of emails sent in a campaign. If you would like to override these settings for an important campaign, you can click the edit icon to change the limit. \<\<@vishal somani please verify>>
...
\<\<@vishal somani where how do we send test email in the UI?>>

![1028](https://files.readme.io/94979e6-Campaigns_Email_Preview_Test.gif "Campaigns_Email_Preview_Test.gif")

You will see a summary of your email campaign. When you are ready to send the campaign, click the *Publish Campaign* button.
