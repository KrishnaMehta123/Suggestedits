...
You can use the Campaign filter to [Filters](doc:filters) to find your campaigns.  Once the campaign is live, you can view its stats by selecting a *Native Display* campaign from the *Campaigns* page on the CleverTap dashboard. Click to view its deliveries, clicks, and conversions. 
