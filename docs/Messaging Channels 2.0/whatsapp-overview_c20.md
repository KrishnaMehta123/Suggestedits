...
metadata:
  ...
  robots: noindex
next:
  description: 'Refer to the pages listed below to learn more about each WhatsApp sections:'
  pages:
    - type: link
      title: Setup
      url: https://docs.clevertap.com/docs/setup-whatsapp_c20
    - type: link
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1139844-Whatsapp_.png",
        "Whatsapp .png",
        605,
        764,
        "#9ba29c"
