...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/edea828-Webhook_editor_main.png",
        "Webhook_editor_main.png",
        1084,
        1455,
        "#faf9fb"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dbf1c37-campaigns_user_properties.png",
...
You can either use *Profile Variables* or *Custom* body.  You can also add personalization with the @ symbol. You have the option to send/receive an email, identity, objectId (CleverTap ID), profileData (custom profile variables), and push_token for each user.  <<@vishal, dk, need a sample screen here>>
[block:image]
{
  "images": [
    {
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d8ce9a1-Webhook_delivery_preference.png",
        "Webhook_delivery_preference.png",
        801,
        699,
        "#fbfcfd"
      ],
