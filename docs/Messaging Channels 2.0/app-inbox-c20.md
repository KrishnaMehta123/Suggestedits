...
next:
  ...
  pages:
    - type: link
      title: App Inbox Setup
      url: https://docs.clevertap.com/docs/setup-app-inbox
    - type: link
      title: App Inbox Create Message
      url: https://docs.clevertap.com/docs/create-message-app-inbox
    - type: link
...
<Image title="iPhoneXs Max - black.png" alt={890} width="smart" src="https://files.readme.io/effe757-iPhoneXs_Max_-_black.png" />
...
<Image title="app_inbox_simple_message_sample.png" alt={484} className="border" width="smart" border={true} src="https://files.readme.io/99159fa-app_inbox_simple_message_sample.png" />
...
<Image title="2a Carousel message with Content.png" alt={1080} className="border" width="smart" border={true} src="https://files.readme.io/017189e-2a_Carousel_message_with_Content.png" />

<Image title="2b Carousel message with Content.png.png" alt={1080} className="border" width="smart" border={true} src="https://files.readme.io/a586da4-2b_Carousel_message_with_Content.png.png" />
...
<Image title="Message with Icon.png" alt={246} className="border" border={true} src="https://files.readme.io/5f9780b-Message_with_Icon.png" />
