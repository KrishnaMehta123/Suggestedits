...
To invoke the personalization menu, type the @ symbol in the title or the text fields while creating the SMS message.

You can also add dynamic replacements in the SMS title and body. 
