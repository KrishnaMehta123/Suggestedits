...
<Image title="Select Amamzon EventBridge.png" alt={2858} className="border" border={true} src="https://files.readme.io/3d6fb90-Select_Amamzon_EventBridge.png" />

The *Campaigns* page displays.

<Image title="New Amamzon Eventbridge campaign.png" alt={2748} className="border" width="80%" border={true} src="https://files.readme.io/97597d8-New_Amamzon_Eventbridge_campaign.png" />
...
<Image title="Push_notification_set_goal_track_conversion.png" alt={919} className="border" border={true} src="https://files.readme.io/32d63db-Push_notification_set_goal_track_conversion.png" />
...
<Image title="Target Segment_Live Behavior.png" alt={2282} className="border" border={true} src="https://files.readme.io/e6bdd94-Target_Segment_Live_Behavior.png" />
...
<Image title="Filter By User Properties.png" alt={486} className="border" border={true} src="https://files.readme.io/7989d1a-Filter_By_User_Properties.png" />
...
<Image title="Set a cap for targeting.png" alt={1454} className="border" border={true} src="https://files.readme.io/a51ee27-Set_a_cap_for_targeting.png" />
...
<Image title="Targeting Cap_Live Behavior.png" alt={1290} className="border" border={true} src="https://files.readme.io/94d8049-Targeting_Cap_Live_Behavior.png" />
...
<Image title="campaign_what_single_message.png" alt={1165} className="border" border={true} src="https://files.readme.io/2f8d628-campaign_what_single_message.png" />
...
<Image title="amazon_eventbridge_editor_create_messge.png" alt={989} className="border" border={true} src="https://files.readme.io/d199531-amazon_eventbridge_editor_create_messge.png" />
...
<Image title="Delivery Preferences_Live Behavior.png" alt={2274} className="border" border={true} src="https://files.readme.io/2884f9b-Delivery_Preferences_Live_Behavior.png" />
