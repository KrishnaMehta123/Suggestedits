---
title: Web Pop-up_WIP hackathon
excerpt: ''
deprecated: false
hidden: true
metadata:
...
3. Select *Web Pop-up* under the *Messaging Channels* list. 
...
If it is a limited-time incentive, you might want to end the web pop-up at a particular end date and time. On the other hand, if it is always relevant, you can specify that the campaign to never end; however, if you change your mind later, you can always stop the campaign by clicking on the *Stop campaign* icon next to the campaign on the main web pop-up *Campaigns* page. 
...
<Image title="New Define the When.png" alt={615} className="border" border={true} src="https://files.readme.io/388cdda-New_Define_the_When.png" />
...
<Image title="New Define the Who Overview.png" alt={1371} className="border" border={true} src="https://files.readme.io/2608a16-New_Define_the_Who_Overview.png" />
...
For instance, you can choose to create a live *Single action* campaign that will target users as soon as they apply a payment offer on your desktop or mobile website.
...
![476](https://files.readme.io/712cb1f-New_Define_the_When_Filter.png "New Define the When Filter.png")

## Define the What

Now, set up the web pop-up campaign content in the *What* section.
...
<Image title="Define the What exit web intent.png" alt={698} className="border" border={true} src="https://files.readme.io/58514cc-Define_the_What_exit_web_intent.png" />
...
<Image title="Define the What - Preview notification.png" alt={679} className="border" border={true} src="https://files.readme.io/e67c8e9-Define_the_What_-_Preview_notification.png" />

3. Click **Schedule notification**.

<Image title="Define the What - Schedule.png" alt={626} className="border" border={true} src="https://files.readme.io/fa9c9f2-Define_the_What_-_Schedule.png" />
...
FAQ\
What is the image dimension of sending notifications via Web Pop Up?\
The Dimensions and format, which can be used along with the image are mentioned below:\
URL must begin with "https\://"\
The image ratio should be 4:3.\
The maximum frame size is defined for the interstitial pop-up banner and will be 1500 \* 900.\
Formats supported are JPG, JPEG, and PNG.
