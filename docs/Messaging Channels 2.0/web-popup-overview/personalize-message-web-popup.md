...
# Emojis and @ Personalization

To invoke the personalization menu, type the @ symbol in the title or the text fields while creating the Web Popup message.

You can include emojis in your Web Popup message as you would in a regular text. You can use the CleverTap emoji picker or copy-paste emojis from an emoji keyboard online.
...
![1180](https://files.readme.io/1457f2e-Web_push__personalization.png "Web_push_@_personalization.png")
...
You can create a campaign for each product added to the cart or use a *constant event property* to personalize the campaign to each user who did not purchase the item. 
