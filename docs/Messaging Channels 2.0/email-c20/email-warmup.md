...
> 📘 SendGrid Support
>
> If you have set up your email service provider with SendGrid, their support team can help you with IP warming and monitor your domain as well as your IP quality.
...
<Image title="Historical data.png" alt={512} className="border" width="smart" border={true} src="https://files.readme.io/8219ca0-Historical_data.png" />
