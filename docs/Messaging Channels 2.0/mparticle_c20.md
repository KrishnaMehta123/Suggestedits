...
metadata:
  ...
  robots: noindex
next:
  description: 'Refer to the pages listed below to learn more about each mParticle section:'
  pages:
    - type: link
      title: Setup
      url: https://docs.clevertap.com/docs/setup-for-data-export_c20
    - type: link
      title: Create Message
      url: https://docs.clevertap.com/docs/create-message_mparticle_c20
    - type: link
