...
Create a campaign to deliver your Web Push message. To create a new campaign, perform the following:
...
You can trigger a Web Push message based on an action. Users receive Web Push notifications when they perform an action in the app instead of waiting for the next app launch. This makes notifications more contextual and increases conversion. 

### Deliver Web Push Notifications based on Past Behavior (PBS)

You can also target users their past user behavior. For past behavior campaigns, you also have an option to calculate estimated reach to view how many users qualify for the campaign criteria and how many are reachable via Web Push as of now.

### Filter by User Properties

Using the *With user properties* filter in the *Who* section, you can segment your campaign to only reach users who meet specific criteria. 

For example, you can send a Web Push notification to English-speaking female users who live in the United States. 
...
![933](https://files.readme.io/30a6b31-Control_Group_Editor.png "Control_Group_Editor.png")
...
<Image title="Web_push_Editor_create_message.png" alt={1185} className="border" width="80%" border={true} src="https://files.readme.io/0a2263c-Web_push_Editor_create_message.png" />
...
<Image title="campaigns_user_properties.png" alt={516} className="border" border={true} src="https://files.readme.io/db35130-campaigns_user_properties.png" />
...
![978](https://files.readme.io/4974c50-Push_notification_editor_when.png "Push_notification_editor_when.png")

### Delivery preferences

Global campaign limits are limits you can apply to determine how many Web Popup notifications each app user receives per day. If you want to override these settings for an important campaign, you can click on the *Don’t apply global campaign limits to this campaign* checkbox.

You can also specify *Do Not Disturb* (DND) hours during which notifications from this Web Popup campaign are prevented from going out, either by discarding them or delaying delivery to after DND hours complete, such as 9 PM to 9 AM.
