...
You can include emojis in your push notifications as you would in a regular text. You can use the CleverTap emoji picker or copy-paste emojis from an emoji keyboard online. \<\<@dk we do not have emojis anymore in the new UI ?>>
...
You can add emojis using CleverTap’s built-in emoji picker by clicking on the smiley face icon. \<\<@dk we do not have emojis anymore in the new UI ?>>
...
![748](https://files.readme.io/ae0ec11-Personalization_.png "Personalization_@.png")
