...
<Image title="Filtering Campaigns by Channel.png" alt={2752} className="border" border={true} src="https://files.readme.io/7f323f7-Filtering_Campaigns_by_Channel.png" />
...
<Image title="FB Audiences Stats.png" alt={2607} className="border" border={true} src="https://files.readme.io/35f38c1-FB_Audiences_Stats.png" />

## Message Trend

<Image title="Facebook Audiences Message Trend.png" alt={2605} className="border" border={true} src="https://files.readme.io/1008553-Facebook_Audiences_Message_Trend.png" />
