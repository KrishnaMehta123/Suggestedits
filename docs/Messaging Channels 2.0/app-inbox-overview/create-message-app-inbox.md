...
<Image title="Campaigns_list_first.png" alt={1152} className="border" border={true} src="https://files.readme.io/4fc4993-Campaigns_list_first.png" />

The campaign page displays. 

<Image title="App_Inbox_editor_main.png" alt={1180} className="border" width="80%" border={true} src="https://files.readme.io/1de9fd3-App_Inbox_editor_main.png" />
...
![516](https://files.readme.io/3ef0749-campaigns_user_properties.png "campaigns_user_properties.png")
...
![1188](https://files.readme.io/2a258a9-Editor_What.png "Editor_What.png")
...
![678](https://files.readme.io/19799ac-App_Inbox_editor_message_tags.png "App_Inbox_editor_message_tags.png")
...
<Image title="app_inbox_split_delivery.png" alt={582} className="border" border={true} src="https://files.readme.io/198a9fd-app_inbox_split_delivery.png" />
...
<Image title="campaigns_user_properties.png" alt={516} className="border" border={true} src="https://files.readme.io/af26a47-campaigns_user_properties.png" />
