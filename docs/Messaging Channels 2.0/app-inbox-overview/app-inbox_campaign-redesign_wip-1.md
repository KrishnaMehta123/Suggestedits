---
title: App Inbox_Campaign redesign_WIP
excerpt: ''
deprecated: false
hidden: true
metadata:
...
[/block]
4. Select the message type and target segment. You can also create an ad-hoc segment. 
...
2. As a final step, click on **Publish Campaign**.
[block:callout]
{
  "type": "info",
