...
excerpt: Understand how to engage with users outside the app via Google AdWords
deprecated: false
hidden: true
metadata:
  title: ''
...
next:
  description: >-
    Refer to the pages listed below to learn more about each Google AdWords
    section:
  pages:
    - type: link
      title: Setup
      url: https://docs.clevertap.com/docs/setup-google-adwords_c20
    - type: link
