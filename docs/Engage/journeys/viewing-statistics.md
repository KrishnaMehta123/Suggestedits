...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The total number of users that qualified for the Journey. This stat is available only on the Entry Node.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The users who have entered a Journey via node connectors, such as Yes or No.
      </td>
    </tr>
...
A. The number of users moving forward from a node will always match the number of users that are entering the following nodes.
