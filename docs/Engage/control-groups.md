...
CleverTap allows you to measure and track the performance of your engagement efforts comparing it to the Control Group
...
* Custom Control Groups are generally created for short duration strategies\
  For example, Determining Engagement impact for the Christmas campaigns
...
<Image title="Screenshot 2020-06-09 at 4.35.14 PM.png" alt={1001} className="border" border={true} src="https://files.readme.io/cdfc1f4-Screenshot_2020-06-09_at_4.35.14_PM.png" />
...
> 🚧 Important Note
>
> Once you make this selection, you cannot change it

<Image title="Screenshot 2020-06-09 at 4.36.00 PM.png" alt={703} className="border" border={true} src="https://files.readme.io/1af5b41-Screenshot_2020-06-09_at_4.36.00_PM.png" />

**Step 3**\
Now, you will be able to see the details of the system control group you created

<Image title="Screenshot 2018-12-28 at 4.01.09 PM.png" alt={763} className="border" border={true} src="https://files.readme.io/7fc7693-Screenshot_2018-12-28_at_4.01.09_PM.png" />

## Creating a Custom Control Group

> 📘 Custom Control Group can be created only after you have a created System Control Group

**Step 1**\
When you move to 'Custom Control Group' and create a new custom control group, a new group will be created for you

<Image title="Screenshot 2020-06-09 at 4.39.47 PM.png" alt={985} className="border" border={true} src="https://files.readme.io/e15bc24-Screenshot_2020-06-09_at_4.39.47_PM.png" />

**Step 2**\
Once you click on + Create New, you asked to provide a name, purpose and control group size

<Image title="Screenshot 2018-12-28 at 4.13.51 PM.png" alt={458} className="border" border={true} src="https://files.readme.io/3243bbf-Screenshot_2018-12-28_at_4.13.51_PM.png" />
...
<Image title="Screenshot 2018-12-28 at 4.10.44 PM.png" alt={1247} className="border" border={true} src="https://files.readme.io/d18233f-Screenshot_2018-12-28_at_4.10.44_PM.png" />
...
<Image title="Screenshot 2020-06-09 at 4.47.17 PM.png" alt={1122} className="border" border={true} src="https://files.readme.io/78b2456-Screenshot_2020-06-09_at_4.47.17_PM.png" />
...
* The system control group is applied by default for every campaign.
* You can choose to add a Custom control group to the campaign
* Optionally you can also add a Journey control group. This control group will be applicable only to the said Journey

<Image title="Screenshot 2020-06-09 at 4.50.20 PM.png" alt={1066} className="border" border={true} src="https://files.readme.io/dc3a90d-Screenshot_2020-06-09_at_4.50.20_PM.png" />
...
* In Journeys, it is all users who have qualified on the 'who' section picked by you in the entry node.
...
Once a campaign or a journey is created with a Control Group, the stats for the same can be viewed on the stats page\
Here you can see -
...
Control group users can be exported to AWS S3. The option is available via Settings > Partners > Exports > Activity log tab > Create Export. 

<Image title="Control_Group_Export_Activity.png" alt={1437} className="border" border={true} src="https://files.readme.io/f0a224a-Control_Group_Export_Activity.png" />

Click the ‘+ Create Export’ button. The Create an export window appears.\
...
<Image title="Control_group_export_create.png" alt={620} className="border" border={true} src="https://files.readme.io/8290224-Control_group_export_create.png" />
