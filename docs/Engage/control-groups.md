...
<Image title="Screenshot 2018-12-28 at 3.54.17 PM.png" alt={1440} className="border" border={true} src="https://files.readme.io/c22b4d9-Screenshot_2018-12-28_at_3.54.17_PM.png" />
...
<Image title="Screenshot 2018-12-28 at 3.57.08 PM.png" alt={567} className="border" border={true} src="https://files.readme.io/8338049-Screenshot_2018-12-28_at_3.57.08_PM.png" />
...
<Image title="Screenshot 2018-12-28 at 4.06.58 PM.png" alt={1440} className="border" border={true} src="https://files.readme.io/250f7ef-Screenshot_2018-12-28_at_4.06.58_PM.png" />
...
>
> Although CleverTap provides the option to remove the System Control Group, we recommend to only use this option for transactional messages. Removing the System Control Group will impact the campaign reports
...
<Image title="Screenshot 2018-12-31 at 11.20.29 AM.png" alt={1371} className="border" border={true} src="https://files.readme.io/bb533d2-Screenshot_2018-12-31_at_11.20.29_AM.png" />
...
<Image title="Screenshot 2018-12-31 at 11.26.46 AM.png" alt={1440} className="border" border={true} src="https://files.readme.io/72b3281-Screenshot_2018-12-31_at_11.26.46_AM.png" />
...
>
> If a Control Group is deleted when campaigns are running with a Control Group, the campaign report will be impacted
