...
[block:callout]
{
  ...
  "body": "Although CleverTap provides the option to remove the System Control Group, we recommend to only use this option for transactional messages. Removing the System Control Group will impact the campaign and journey reports"
}
[/block]
## Campaign Creation
...
[block:callout]
{
  ...
  "body": "If a Control Group is deleted when campaigns and journeys are running with the Control Group, the corresponding campaign and journey report will be impacted"
}
[/block]
...
[block:code]
{
  "codes": [
    {
      "code": "{\"ts\":20200317193200,\"eventName\":\"Journey Control Group\",\"profile\":{\"all_identities\":[\"jamessmithi19020907-0@testwiz.com\"],\"platform\":\"iOS\",\"name\":\"JamesSmith\",\"email\":\"jamessmithi19020907-0@testwiz.com\",\"push_token\":\"ios-19020907-0\",\"phone\":119021007089},\"deviceInfo\":{\"make\":\"Apple\",\"model\":\"iPhone8,1\",\"appVersion\":\"App Version 4\",\"sdkVersion\":\"0\",\"osVersion\":\"9.1\"},\"controlGroupName\":\"System Control Group\",\"eventProps\":{\"Journey id\":\"171\",\"Journey name\":\"PBS_All_users\"}}\n\n",
      "language": "json"
    }
  ]
}
