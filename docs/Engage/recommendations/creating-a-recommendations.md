...
To create new recommendations, go to Settings > Engage > Recommendations on the dashboard.
...
**My e-commerce App**
In the case of an e-commerce application, you may wish to trigger a recommendation as soon as a user adds a Nike shoe to the cart. 
...
**My OTT App**
In the case of a video streaming application, you may wish to trigger a recommendation once a user completes watching a trailer of a fantasy TV series. 
