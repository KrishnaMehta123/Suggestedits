...
<Image title="Journeys_Main_List_Create.png" alt={1437} className="border" border={true} src="https://files.readme.io/598f235-Journeys_Main_List_Create.png" />
...
<Image title="Journeys_Entry_Segment_Drag.png" alt={1213} className="border" border={true} src="https://files.readme.io/0118ba3-Journeys_Entry_Segment_Drag.png" />

You can drag and drop any of the segment nodes. 

> 📘 The entry criteria is always a segment node.
...
<Image title="Journeys_Entry_Node.png" alt={438} className="border" border={true} src="https://files.readme.io/1af7794-Journeys_Entry_Node.png" />

<Image title="Journey_Entry_When.png" alt={1440} className="border" border={true} src="https://files.readme.io/39e425c-Journey_Entry_When.png" />
...
<Image title="Journeys_Re-enter_Users.png" alt={376} className="border" border={true} src="https://files.readme.io/34a9ebe-Journeys_Re-enter_Users.png" />
...
![683](https://files.readme.io/2bcad63-Journeys_Reenter_Users.png "Journeys_Reenter_Users.png")
...
{user["Need info"]} {user["Need to add GIF"]}
...
{user["Need info"]} change the connection from one node to another so that the old node can be reused somewhere else. 

{user["Need to add GIF"]}

### Edit Connectors

{user["Need info"]} change the timeout
...
<Image title="Journeys_Node_Connect_Engagment_Segment.png" alt={1042} className="border" border={true} src="https://files.readme.io/1e2f341-Journeys_Node_Connect_Engagment_Segment.png" />
...
<Image title="Journeys_Node_Connect_Segment_Engagment.png" alt={626} className="border" border={true} src="https://files.readme.io/9d619ef-Journeys_Node_Connect_Segment_Engagment.png" />
...
<Image title="Journeys_Node_Connect_Engagment_Engagement.png" alt={963} className="border" border={true} src="https://files.readme.io/be8a505-Journeys_Node_Connect_Engagment_Engagement.png" />
...
<Image title="Journeys_Node_Connect_Segment_Segment.png" alt={1062} className="border" border={true} src="https://files.readme.io/a5054fa-Journeys_Node_Connect_Segment_Segment.png" />
...
![1235](https://files.readme.io/a39d24d-Journeys_Goal.png "Journeys_Goal.png")
...
{user["TBD - add qualifying window"]}
...
> 📘 Note
>
> The yellow blinking circle on your segment node is a reminder that you may need to plan for waiting users in the Journey.
...
<Image title="Journey_Example_All_cases.png" alt={1381} className="border" border={true} src="https://files.readme.io/2547701-Journey_Example_All_cases.png" />
