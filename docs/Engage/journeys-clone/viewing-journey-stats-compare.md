...
<Image title="Journeys_tab_build.png" alt={1376} border={true} src="https://files.readme.io/054d5be-Journeys_tab_build.png">
  Enhanced Build Journey
</Image>
...
<Image title="Journeys_Tab_Journey_Stats1.png" alt={1379} border={true} src="https://files.readme.io/60f7b80-Journeys_Tab_Journey_Stats1.png">
  New Journey Stats
</Image>
...
![774](https://files.readme.io/c4d4ac9-Journeys_Entry_Node_Old_New.png "Journeys_Entry_Node_Old_New.png")
...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The total number of users that entered the Journey. This stat is available only on the Entry Node.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The users who have moved forward via node connectors, such as Yes, No, Node Timeout.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The number of users who were marked for the control group. 
...
![711](https://files.readme.io/b1d80f5-Journeys_Segment_Node_Old_New_copy.png "Journeys_Segment_Node_Old_New copy.png")
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The users who have moved forward via node connectors, such as Yes, No, or Node Timeout.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The users waiting at a node to qualify. The users may wait for either of the 2 reasons: 
...
![864](https://files.readme.io/07642f3-Journeys_Engage_Node_Old_New.png "Journeys_Engage_Node_Old_New.png")
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The users who have moved forward via node connectors, such as Sent, Viewed, Clicked, Failed, and Unreachable.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        These users may wait for either of the 2 reasons: 
...
<Image title="Journey_Goal_Hero_stats.png" alt={1345} className="border" border={true} src="https://files.readme.io/b68d6bb-Journey_Goal_Hero_stats.png" />
...
<Image title="Journeys_Stats_Goal.png" alt={1880} className="border" border={true} src="https://files.readme.io/8f1e196-Journeys_Stats_Goal.png" />
...
<Image title="Journeys_Stats_Trends.png" alt={1348} className="border" border={true} src="https://files.readme.io/74da704-Journeys_Stats_Trends.png" />
