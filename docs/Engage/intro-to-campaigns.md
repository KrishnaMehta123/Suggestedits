...
next:
  description: ''
---
CleverTap offers you the flexibility to engage your users through different messaging channels and deliver personalized messages at the right time. 

Learn about the different message channels here to build campaigns and influence users. 
...
**[Push](doc:push)**\
Communicate with your users through Push notifications even if they are not using your app. You can configure Push messages to appear on a user's lock screen or in a top/bottom banner. 

![666](https://files.readme.io/1803dac-Campaigns_Push_example.png "Campaigns_Push_example.png")

**[In-App](doc:in-app)**\
In-app notifications are pop-up messages that users see while they are using your app. While push notifications are viewed by the user outside the app, in-app notifications are viewed strictly inside the app. In-app notifications are great to show contextual messages, such as discount offers while the user is within the app, or to communicate with users who have turned off push notifications.

![1430](https://files.readme.io/61b1c76-Campaigns_Inapp_example.png "Campaigns_Inapp_example.png")
...
![900](https://files.readme.io/fb82652-App_Inbox_Example.png "App_Inbox_Example.png")
...
![660](https://files.readme.io/d272d2c-Campaign_SMS_Example.png "Campaign_SMS_Example.png")
...
![900](https://files.readme.io/a80b18c-Campaign_WebPopup_Example.png "Campaign_WebPopup_Example.png")
...
![1100](https://files.readme.io/e040630-Web_Push_Notification_example.png "Web_Push_Notification_example.png")
...
![936](https://files.readme.io/3d65c92-campaign_web_exit_intent_example.png "campaign_web_exit_intent_example.png")
...
![1380](https://files.readme.io/ff96c09-Campaign_Email_example.png "Campaign_Email_example.png")
...
![1430](https://files.readme.io/05b3119-Campaign_Webhooks_example.png "Campaign_Webhooks_example.png")
...
![646](https://files.readme.io/26acaff-Facebook_remarketing_example.png "Facebook_remarketing_example.png")
...
<Image title="Campaign_main_list.png" alt={1436} className="border" border={true} src="https://files.readme.io/726e0ed-Campaign_main_list.png" />
...
<Image title="image85.png" alt={1999} className="border" border={true} src="https://files.readme.io/8e05636-image85.png" />
...
<Image title="image101.png" alt={1999} className="border" border={true} src="https://files.readme.io/cdeb472-image101.png" />
