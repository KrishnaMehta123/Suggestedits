...
<Image title="image2.png" alt={1189} className="border" border={true} src="https://files.readme.io/3c46ca9-image2.png" />
...
<Image title="image3.png" alt={836} className="border" border={true} src="https://files.readme.io/653ede1-image3.png" />

## Step 3: Select the Best Time Option

<Image title="image1.png" alt={717} className="border" border={true} src="https://files.readme.io/a0ca65c-image1.png" />
