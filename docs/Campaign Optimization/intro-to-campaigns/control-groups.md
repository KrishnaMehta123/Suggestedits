...
**Step 2**\
You can choose to apply the Control Group to existing running campaigns and journeys by checking the box to *Apply to all current campaigns and journeys*.
...
Click the **+ Create Export** button. The *Create an export* window displays.\
