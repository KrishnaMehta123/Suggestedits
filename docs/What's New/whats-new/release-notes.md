...
<Image alt="Footer Standardization with Content Blocks" align="center" border={true} src="https://files.readme.io/686373549b6ac569fd3abb3ab7bafddabdd0b37236d60ce08b551e2a559309e1-image.png">
...
### Store Outgoing Messages Using Message Archiving ![BETA](https://files.readme.io/7776b09-Beta.svg)
...
### Email Add-on for CleverTap Essentials Plan ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
<Image alt="Email Add-on for CleverTap Essentials Plan" align="center" border={true} src="https://files.readme.io/fdf055c4de60720e01da16e73a883ac275845e8884b53a8f46ac757370e3da03-image.png">
...
You can now use Journey labels in the *Analytics* section to analyze the *Notifications Sent* event. You can now easily track and derive insights from notifications sent through Journeys tagged with specific labels.

<Image alt="Analyze Journey Performance Using Journey Labels" align="center" width="100% " border={true} src="https://files.readme.io/7f26df255f646c42fcdfbb0a6760afa7be9495d671c751f7d2d28431e2000008-Analyze_Journey_Performance_Using_Journey_Label.png">
...
CleverTap has redesigned *Journey Entry Timelines* to remove redundancies and improve usability. Also, the error handling has been improved to manage scenarios such as incorrect date or day of recurrence inputs.
...
Campaign ID Personalization is now available in both the *Email HTML (Rich Media) Editor* and *Drag & Drop Editor*, giving you more flexibility when personalizing email campaigns. You can create unique links and track engagements more accurately.
...
You can now apply Event Personalization to *Live Action* and *Date Time* campaigns with a delay of more than 24 hours. Create highly personalized Email campaigns based on event properties broadening the window for event-triggered communications to create custom-tailored notifications, driving better targeting and relevance.
...
* **Flexible Grant Types:** Support for *Password Credentials* and *Client Credentials.*
...
### Support for Azure Blob in Message Archiving ![BETA](https://files.readme.io/7776b09-Beta.svg)
...
<Image alt="TikTok Remarketing" align="center" width="80% " border={true} src="https://files.readme.io/98b03ed9bf4d8d0fa38a02edccf927c58913835c1333ec18f9cf0f16a9a2619d-Tik_Tok_Remarketing-_Option_2.png">
  TikTok Remarketing
</Image>
...
### Introducing Event Personalization Beyond 24 Hours for Live Behavior Campaigns ![](https://files.readme.io/bbc3552-PrivateBeta.svg)
...
Announcing a significant enhancement to our Email Analytics: the *Notification Failed* event that gives you more deeper insights into campaign errors. With this update, CleverTap captures a *Notification Failed* event, along with the reason for failure, enabling better targeting and resolution.
...
<Image alt="Caption: Manage Content Folders in Files" align="center" border={true} src="https://files.readme.io/03a1110c2de7b3575d14e09ae17df33348f6ead9fac4854bbb44a40486e95ec7-image-20241003-153613.png">
  Manage Content Folders in Files
</Image>
...
For more information, refer to [Organize Files Using Folders](doc:content-manager-files#organize-files-using-folders) documentation.
...
<Image alt="Emoji Support Within Push Editor" align="center" border={true} src="https://files.readme.io/62c28fee13c67880b112d93ff1062defd40c27cf4f9fc0b9d751cbc1acddd269-image-20241008-155442.png">
  Emoji Support Within Push Editor
</Image>

For more information, refer to the [Create Push Campaign](doc:create-message-push#push-editor) documentation.
...
For more information, refer the [Auto Append Link Parameters](doc:auto-append-link-parameters) documentation.

### Introducing Real-time Message Archiving ![BETA](https://files.readme.io/7776b09-Beta.svg)
...
For more information, refer to the [Message Archiving](doc:message-archiving) documentation.

### Uncover True Growth Drivers with CleverTap and AppTrove Integration ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
For more information, refer to the [AppTrove](doc:clevertap.com/docs/apptrove) documentation.

### Transform Your Email Template Creation with CleverTap and Taxi for Email Integration ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
For more information, refer to the [Taxi for Email](doc:taxi-for-email) documentation.

### Link Events to User Properties ![BETA](https://files.readme.io/7776b09-Beta.svg)
...
For more details, refer to [Create Linked Event for User Property](doc:schema-create-linked-events#create-linked-event-for-user-property) documentation.
...
<Image alt="vNext Trends" align="center" border={true} src="https://files.readme.io/c0c5526d697e0b45b74c968ff830f17802a2ace2153488965ca9603fece1cc99-vNext_Trends.png">
  Trend Analysis
</Image>

For more information, refer to [Trends](doc:trends-v2) documentation.

## August

### File Variables in Product Experiences NextGen ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
File Variables are linked to CleverTap CMS, which helps manage and re-use customer assets across the CleverTap platform. For more information, refer to the [Product Experiences](doc:product-experiences-nextgen) documentation.
...
<Image alt="WhatsApp Carousel Templates" align="center" width="80% " border={true} src="https://files.readme.io/25ac047-WhatsApp_carousel_graphic_2x.png">
...
This feature is available to all customers using CleverTap BSP, and those utilizing Generic Integrations. For more information, refer to the [carousel](doc:whatsapp-message-templates#carousel-template) documentation.
...
For more information, refer to the [Gmail Promotional Annotations](doc:gmail-promotional-annotations) documentation.

### New Journey Paths in WhatsApp and SMS Journey Nodes ![](https://files.readme.io/7f99f23-Tags-1.svg)

We are thrilled to announce that customers can now utilize *Viewed* and *Clicked* paths with WhatsApp node in Journeys. The enhancement also introduces a new *Delivered* path for SMS node in Journeys. 
...
The feature is available to customers only on the **Cutting Edge Plan**. For more information, refer to the following documents:
...
The Webhook currently supports the Do Not Disturb (DND) feature only in Campaigns, not in Journeys. For more information, refer to the [Delivery Preferences in Webhook](doc:create-message-webhook#delivery-preferences) documentation.

### Elevate User Experience with Linked Content URL Personalization ![](https://files.readme.io/7f99f23-Tags-1.svg)

The Linked Content URL Personalization Enhancement, previously in Private Beta, is now available to all customers. This feature allows you to personalize URLs within your campaigns, enhancing user experience with more relevant and engaging content. For more information, refer to the [Linked Content](doc:linked-content#personalize-linked-content-url) documentation.

### Seamless Personalization with the All-New Visual Editor ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
<Image alt="Visual Editor" align="center" width="80% " border={true} src="https://files.readme.io/bac5f5a-point_and_click_template_1.jpg">
  Visual Editor
</Image>
...
For more information, refer to the [Visual Editor documentation](doc:web-native-display-editor#visual-editor).

### Custom Font Support For Enhanced Email Design ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
The feature is available to customers on the Advanced and Cutting Edge plans. For more information, refer to the [Font Manager](doc:setup-email#font-manager) documentation.

### Control Web Pop-up Display with Enhanced Campaign Priority ![](https://files.readme.io/7f99f23-Tags-1.svg)

We are excited to announce our enhanced web pop-ups, which allow customers to define granular-level priority on a scale from 1 to 100 for their campaigns. This offers complete control over the sequence in which your campaigns are displayed, leading to a more engaging customer experience. For more information, refer to the [Web Pop-up Campaign Priority](doc:create-message-web-popup#campaign-priority) documentation.
...
<Image alt="In-App Delivery Preferences" align="center" width="80% " border={true} src="https://files.readme.io/2df482a-image.png">
  In-App Delivery Preferences
</Image>

For more details, refer to the [Delivery Preferences (In-App)](doc:create-message-inapp#delivery-preferences) documentation.
...
<Image alt="CleverTap Hostem Email preference Center" align="center" border={true} src="https://files.readme.io/e457f73-2024-07-31_11-13-50_1.gif">
  CleverTap Hostem Email preference Center
</Image>

This feature is currently in Private Beta. For more details, refer to the [Manage Custom Email Preference Center](https://docs.clevertap.com/docs/manage-custom-email-preference-center) documentation.

## July

### Multi-Button Templates and Limited Time Offer Templates Now Supported with Gupshup ![Update](https://files.readme.io/0c15d9f-Tags.svg)
...
<Image alt="WhatsApp" align="center" width="100% " border={true} src="https://files.readme.io/1fd2637-WhatsApp.webp">
  Multi Button / Limited Time Offer
</Image>

This enhancement allows for more dynamic and engaging messaging, providing customers with versatile options to enhance their campaigns and drive better engagement. For template details and detailed use cases, refer to this [blog](https://clevertap.com/blog/lead-the-way-in-conversational-messaging-with-whatsapps-new-cutting-edge-templates/). For steps on how to use these templates in campaigns, refer to the [WhatsApp Templates](doc:whatsapp-message-templates#whatsapp-template-types)  documentation.

## June

### CleverTap-Hosted Email Preference Center for Enhanced User Experience ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
* **Focused "Group Unsubscribe"**: Direct users to a dedicated page displaying only the subscription groups associated with the campaign upon clicking on the *Unsubscribe* link. They can easily opt-out or unsubscribe from all groups if needed.
...
For more information, refer to the [Manage Email Preferences](doc:manage-email-preferences) document.

### Unveiling External Trigger: Elevate User Engagement with Personalized Non-Promotional Alerts ![BETA](https://files.readme.io/7776b09-Beta.svg)
...
<Image alt="External Trigger Campaigns" align="center" border={true} src="https://files.readme.io/cb5bbce-image-20240613-102654.png">
  External Trigger Campaigns
</Image>

For more information, refer to the [External Trigger](doc:external-trigger) document.
...
For more information, refer to the [Messaging Frequency Caps](doc:messaging-frequency-caps#throttle) document.
...
For more information, refer to the [One-Click Unsubscribe](doc:one-click-unsubscribe) document.
...
<Image alt="Engagement Stats" align="center" border={true} src="https://files.readme.io/af6a4ed-Engagement_Stats-20240618-095619.gif">
  Engagement Stats
</Image>
...
For more information, refer to the [Engagement Stats](doc:engagement-stats) document.

### WhatsApp Carousel Templates Support For CleverTap BSP ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
This feature is available to all CleverTap BSP customers. For more information, refer to the complete [carousel documentation](doc:whatsapp-message-templates#carousel-template).
...
### One-Click Unsubscribe for Enhanced Deliverability & User Experience ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
For more information, refer to the [Send Test Personalization](doc:send-test-personalization-for-email) document.
...
With this enhancement, you can now accurately measure the performance of each variant by considering the conversion metrics and target group revenue. 
 ...
 For more information, refer to the [Conversion Performance](doc:push-campaign-stats#conversion-performance) section.
...
<Image alt="One-Click Unsubscribe from Inbox" align="center" border={true} src="https://files.readme.io/f012ff2-image-20240412-053706.png">
  One-Click Unsubscribe from Inbox
</Image>

<Image alt="One-Click Unsubscribe from Email Body" align="center" border={true} src="https://files.readme.io/0fa115b-image-20240412-053756.png">
  One-Click Unsubscribe from Email Body
</Image>
...
For more information, refer to the[ One-Click Unsubscribe](https://docs.clevertap.com/docs/one-click-unsubscribe) document.

### Hyper-personalized Experiences With Support For Personalization In Test Messages![Enhancement](https://files.readme.io/7f99f23-Tags-1.svg)
...
<Image alt="Send Personalized Campaigns to Test Profiles" align="center" border={true} src="https://files.readme.io/68feacf-send-test-personalization-push-20240412-045513.gif">
  Send Personalized Campaigns to Test Profiles
</Image>

Currently available on the Push Notification channel in Campaigns & Journeys and will be made available on other channels soon. For more information, refer to the  [Send Test Personalization](https://docs.clevertap.com/docs/send-test-personalization-for-push) document.

### Introducing the New Image Interstitial Editor for In-App Messages ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
<Image alt="Image Interstitial Template" align="center" border={true} src="https://files.readme.io/f5ccae3-animation-updated_1_1.gif">
  Image Interstitial Template
</Image>
...
For more information, refer to the [Image Interstitial Template](https://docs.clevertap.com/docs/in-app-editor#image-interstitial) document.

### Multi-button CTA and Limited Time Offer Templates for Urgency and User Interactivity ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
<Image alt="Multi Button CTAs and Limited Time Offer Templates" align="center" width="70% " border={true} src="https://files.readme.io/8a92907-LTO_sample.png">
  Multi Button CTAs and Limited Time Offer Templates
</Image>
...
### Gmail Carousel Annotations for Improved Email Discoverability and Engagement ![New Feature](https://files.readme.io/c30bf56-NewFeature.svg)
...
### Enhanced Quick Reply Autoresponder For Streamlined Automated Conversations ![Enhancement](https://files.readme.io/7f99f23-Tags-1.svg)
...
### Discontinuation of Xiaomi Push Service ![Update](https://files.readme.io/0c15d9f-Tags.svg)
...
* Utilize our proprietary technology, [RenderMax™](https://docs.clevertap.com/docs/rendermax), to enhance your push notification campaigns on Xiaomi devices.
 ...
 For more information, refer to the [Discontinuation of Xiaomi Push Service](https://developer.clevertap.com/docs/discontinuation-of-xiaomi-push-service) document.
...
<Image alt="Product Experiences NextGen" align="center" width="85% " border={true} src="https://files.readme.io/f4f17b8-Product-Experiences-P-B_1.gif">
...
For more details,  refer to the [documentation](https://docs.clevertap.com/docs/product-experiences-nextgen).
...
<Image alt="In-App Message Delivery Enhancements" align="center" width="80% " border={true} src="https://files.readme.io/6d21640-campaign_frequency_limits.png">
  In-App Message Delivery Enhancements
</Image>

These features are currently in Private Beta, exclusively available to a select group of customers. For more details, refer to the [Delivery preferences (In-App)](https://docs.clevertap.com/docs/create-message-inapp#delivery-preferences) documentation.

### Identity Personalization for Creating More Contextual User Experiences ![Enhancement](https://files.readme.io/7f99f23-Tags-1.svg)
...
For more information, refer to the[ Identity Personalization](https://docs.clevertap.com/docs/personalize-message-all#identity-personalization) document.

### Elevate User Experience with Linked Content URL Personalization ![Enhancement](https://files.readme.io/7f99f23-Tags-1.svg)
...
For more information, refer to the [Linked Content](https://docs.clevertap.com/docs/linked-content-url-personalization) document.
