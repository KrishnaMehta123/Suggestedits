...
* [Journey Entry](https://docs.clevertap.com/docs/setup-journey_c20#define-the-journey-entry-criteria)
* [Journey Entry Timelines](https://docs.clevertap.com/docs/setup-journey_c20#define-the-journey-entry-timelines)
* [DND and Timezone](https://docs.clevertap.com/docs/setup-journey_c20#dnd-and-timezone)
* [Control Group](https://docs.clevertap.com/docs/setup-journey_c20#define-the-control-group)
* [Journey Timeout](https://docs.clevertap.com/docs/setup-journey_c20#select-a-journey-timeout)
...
<Image title="Journeys_setup_begin.png" alt={1348} className="border" border={true} src="https://files.readme.io/4f63f9a-Journeys_setup_begin.png" />
...
<Image title="Journeys_setup_entry_criteria.png" alt={766} className="border" border={true} src="https://files.readme.io/ada99a2-Journeys_setup_entry_criteria.png" />
...
<Image title="Journeys_setup_entry_timelines.png" alt={726} className="border" border={true} src="https://files.readme.io/de68ca2-Journeys_setup_entry_timelines.png" />
...
<Image title="Journeys_setup_reenter_user.png" alt={698} className="border" border={true} src="https://files.readme.io/3b04e68-Journeys_setup_reenter_user.png" />
...
<Image title="Journeys_setup_DND_timezone.png" alt={697} className="border" width="80%" border={true} src="https://files.readme.io/a226d97-Journeys_setup_DND_timezone.png" />
...
<Image title="2020-08-17_16-14-20_DND hours Conflict.png" alt={1206} className="border" border={true} src="https://files.readme.io/7ff47d7-2020-08-17_16-14-20_DND_hours_Conflict.png" />

## Define the Control Group

Define the required control groups. For more information on control groups, see [Control Groups](doc:control-groups). 

<Image title="Journeys_setup_control_group.png" alt={725} className="border" border={true} src="https://files.readme.io/7092b2a-Journeys_setup_control_group.png" />
...
<Image title="Journeys_setup_timeout.png" alt={724} className="border" border={true} src="https://files.readme.io/e182621-Journeys_setup_timeout.png" />
