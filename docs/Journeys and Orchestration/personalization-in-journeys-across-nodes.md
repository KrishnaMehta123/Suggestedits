  ...
  "images": [
    {
      "image": [
        ...
        "Journeys_campaign_personalization.png",
        780
      ],
      "align": "center",
      "sizing": "smart",
...
| Inaction Segment Node  | Engagement Node | Applicable only for a _Yes_ path in the Journey. |
  ...
  "images": [
    {
      "image": [
        ...
        "277a7fc-Action_engage1_engage2.png",
        2356
      ],
      "align": "center",
      "border": true
  ...
  "images": [
    {
      "image": [
        ...
        "614275c-Action_delay_case2.png",
        2384
      ],
      "align": "center",
      "border": true
...
Now, all the engagement nodes after _Enagemement Node 3_ will only get trigger events from _Segment 2_ for event personalization.  
