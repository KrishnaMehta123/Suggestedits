---
title: Personalization in Journeys Across Nodes
...
* [Personalize Messages in Journeys](https://docs.clevertap.com/docs/individualization-in-journeys-across-nodes#personalize-messages-in-journeys)
* [Personalize Events across Nodes](https://docs.clevertap.com/docs/individualization-in-journeys-across-nodes#personalize-events-across-nodes)

# Personalize Messages in Journeys

You can personalize messages in journeys after you finish [constructing a journey](https://docs.clevertap.com/docs/construct-a-journey). To personalize the messages in Journeys from the engagement nodes:

1. Click an engagement node and create a campaign. 
2. Select *What*  and then select the *Message Type*.

<Image title="Journeys_campaign_personalization.png" alt={780} align="center" className="border" width="smart" border={true} src="https://files.readme.io/02868b8-Journeys_campaign_personalization.png" />
...
<Image title="CNP_Personalization.png" alt={1988} align="center" className="border" width="smart" border={true} src="https://files.readme.io/055e687-CNP_Personalization.png" />
...
| Inaction Segment Node  | Engagement Node | Applicable only for a *Yes* path in the Journey. |
...
* Event personalization is available for the Action, Inaction(through a yes path), and Date Time segment nodes.
...
<Image title="277a7fc-Action_engage1_engage2.png" alt={2356} align="center" className="border" border={true} src="https://files.readme.io/737d23f-277a7fc-Action_engage1_engage2.png" />

### Personalize Engagement Node with Delay

You can set up a maximum delay of up to 24 hours per node in a journey. The following journey shows a 15-hour delay for each node.  Send a push message after 15 hours and send another email message after 15 hours of delay.

Following is a sample Journey flow:\
*Action Node  > (delay of 15 hrs) > Engagement Node 1 > (delay of 15 hrs) > Engagement node 2*

<Image title="614275c-Action_delay_case2.png" alt={2384} align="center" className="border" border={true} src="https://files.readme.io/2e33188-614275c-Action_delay_case2.png" />
...
<Image title="6accfcc-Action_controller.png" alt={3510} align="center" className="border" border={true} src="https://files.readme.io/9d3099e-6accfcc-Action_controller.png" />
...
Now, all the engagement nodes after *Enagemement Node 3* will only get trigger events from *Segment 2* for event personalization.  

<Image title="fb01df9-two_action_nodes.png" alt={5478} align="center" className="border" border={true} src="https://files.readme.io/ea42acf-fb01df9-two_action_nodes.png" />
