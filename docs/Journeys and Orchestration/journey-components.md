...
<Image title="Various engagement nodes in Journeys" alt={406} align="center" width="smart" border={true} src="https://files.readme.io/a08182196524e08a8a30a68131269c412acf70369e3fdc47eb68f6d645be4f26-Journey_Engagement_Nodes.png">
  Engagement Nodes
</Image>
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Webhooks serve many purposes. It includes receiving push notifications on the app server and tracking events in a system. Chatbots and virtual assistants use it to connect with external services. It enables them to exchange data when responding to user inquiries.
      </td>
    ...
    <tr>
      ...
      <td>
        Send WhatsApp messages to your app or website users even outside of the app. To know more, refer to 
    ...
    <tr>
      ...
      <td>
        Send messages to users outside your app or website via ads on Google apps.
      </td>
...
<Image alt="Journey Controllers" align="center" width="40% " border={true} src="https://files.readme.io/f72c5b9cad2e508628cae0f6e07bc1e73860e3ddb90e31449c2f46fca14fe026-Journey_Controllers.png">
  Journey Controllers
</Image>
