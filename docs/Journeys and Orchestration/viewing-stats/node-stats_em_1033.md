...
To view detailed stats of a Node, click any Node, and the Stats screen displays.

![](https://files.readme.io/38858c7-Stats.png "Stats.png")

- **Sent**: These are the total number of messages sent.
- **Delivered**: These are the total number of messages delivered.
- **Clicked**: These are the total number of messages clicked.
- **CTR**: These are the rate of clicks on the total number of messages sent.
- **Converted users**: These are the total number of users converted.

The detailed Node Stats also provides:

- _Conversion Performance_ based on the _Target Group Conversions_ and _Control Group Conversions_ on a daily, weekly, and monthly basis. 

![](https://files.readme.io/0f576a3-Conversion_Funnel.png "Conversion Funnel.png")

- _Revenue Performance_ based on the _Target Group Conversions_ and _Control Group Conversions_ on a daily, weekly, and monthly basis. 

![](https://files.readme.io/61b4bae-Revenue_Performance.png "Revenue Performance.png")

- _Influenced Conversion Funnel_ showing _Sent Conversion rate_ of the users.

![](https://files.readme.io/c3fa941-Influenced_Conversion_Funnel.png "Influenced Conversion Funnel.png")