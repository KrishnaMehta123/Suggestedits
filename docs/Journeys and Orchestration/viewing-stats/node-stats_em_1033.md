...
* *Conversion Performance* based on the *Target Group Conversions* and *Control Group Conversions* on a daily, weekly, and monthly basis. 

![](https://files.readme.io/0f576a3-Conversion_Funnel.png "Conversion Funnel.png")

* *Revenue Performance* based on the *Target Group Conversions* and *Control Group Conversions* on a daily, weekly, and monthly basis. 

![](https://files.readme.io/61b4bae-Revenue_Performance.png "Revenue Performance.png")

* *Influenced Conversion Funnel* showing *Sent Conversion rate* of the users.
