...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e009683-Select_Engagement_Type.gif",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/759cded-Set_Qualification_Window.gif",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e64f531-User_Waiting_at_Engage_Node.gif",
...
Consider an example where you publish a weekly recurring PBS Journey. You schedule the user's entry into the Journey for _Now_ and _every Tuesday_. You also publish it at 5 p.m. on a Tuesday, and the push notification must be sent at 8 p.m. Let us now understand how a PBS Journey works, how users qualify, and when the users receive the messages.
