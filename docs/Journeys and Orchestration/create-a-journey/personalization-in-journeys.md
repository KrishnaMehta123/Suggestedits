...
- [Personalize Mesages in Journeys](https://docs.clevertap.com/docs/individualization-in-journeys-across-nodes#personalize-messages-in-journeys)
...
> 📘 Event Property Personalization
> 
> In any campaign or journey, if _Inaction_ is an entry criteria, the Event Property Personalization is available based on the following scenarios:  
> **Scenario 1**
> 
> - User did action **A**
> - User did not do** B **within 24 hours.
> - Event Property Personalization is available for action **A** in the message
> 
> **Scenario 2:**
> 
> - User did action **A**
> - User did not do **B **beyond 24 hours.
> - Event Property Personalization is not available.
