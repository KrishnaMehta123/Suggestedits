...
<Image title="Drag and drop a segment to define a goal for Journey" alt={1208} align="center" border={true} src="https://files.readme.io/d824ddb-Define_a_Journey_Goal.gif">
