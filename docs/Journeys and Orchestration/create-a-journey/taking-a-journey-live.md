...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/161841bb4dd9bf998a790e3378a54c80a9d3d6234f81e970831073fd25ed3d83-View_Journey_Description.png",
        "",
...
Once you publish a journey, the status of the journey on the _Journey List_ page changes to _Running_ or _Scheduled_. Also, you cannot change a journey except the _What_ section in an engagement node once you publish it. You can perform different actions such as Archive, Stop, and so on.
