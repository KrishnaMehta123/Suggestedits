...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      <td>
        [**Setting Up a Journey**](https://staging.docs.user.clevertap.net/docs/setup-journey)
      </td>
    ...
    <tr>
      <td>
        [**Define Goals**](https://staging.docs.user.clevertap.net/docs/define-goals)
      </td>

      <td>
        Define the goal of the Journey. A goal is the desired action you want a selection of users to achieve on your app as they move along a Journey. For example, perform a purchase, subscribe,  launch, or register on the app, and so on.
      </td>
    </tr>

    <tr>
      <td>
        [**Define Entry Segment**](https://staging.docs.user.clevertap.net/docs/define-entry-segment)
      </td>
    ...
    <tr>
      <td>
        [**Define Journey Path**](https://staging.docs.user.clevertap.net/docs/construct-a-journey)
      </td>
    ...
    <tr>
      <td>
        [**Personalize the Journey Content**](https://staging.docs.user.clevertap.net/docs/personalization-in-journeys)
      </td>
    ...
    <tr>
      <td>
        [**Publish a Journey**](https://staging.docs.user.clevertap.net/docs/taking-a-journey-live)
      </td>
    ...
    <tr>
      <td>
        [**Monitor the Journey**](https://staging.docs.user.clevertap.net/docs/viewing-statistics)
      </td>
