---
title: Journeys (COPY)
excerpt: Understand how to engage users through Journeys.
deprecated: false
hidden: true
metadata:
  title: ''
...
Journey, a visual campaign builder, lets you create an automated omnichannel messaging experience for your users. It consists of a series of engagement channels, each engaging the user with the most relevant content at the right moment, resulting in the desired conversion. A CleverTap Journey can engage users at every stage throughout their lifecycle in the app. You can also personalize the Journey based on user and event data.

# [Placeholder: Journey Infographic]
...
[block:parameters]
{
  "data": {
    "h-0": "Steps",
    "h-1": "Description",
    "0-0": "[**Setting Up a Journey**](https://staging.docs.user.clevertap.net/docs/setup-journey)",
    ...
    "1-0": "[**Define Goals**](https://staging.docs.user.clevertap.net/docs/define-goals)",
    "1-1": "Define the goal of the Journey. A goal is the desired action you want a selection of users to achieve on your app as they move along a Journey. For example, perform a purchase, subscribe,  launch, or register on the app, and so on.",
    "2-0": "[**Define Entry Segment**](https://staging.docs.user.clevertap.net/docs/define-entry-segment)",
    ...
    "3-0": "[**Define Journey Path **](https://staging.docs.user.clevertap.net/docs/construct-a-journey)",
    ...
    "4-0": "[**Personalize the Journey Content**](https://staging.docs.user.clevertap.net/docs/personalization-in-journeys)",
    ...
    "5-0": "[**Publish a Journey**](https://staging.docs.user.clevertap.net/docs/taking-a-journey-live)",
    "5-1": "Save and publish the Journey.",
    "6-0": "[**Monitor the Journey**](https://staging.docs.user.clevertap.net/docs/viewing-statistics)",
...
Before building a Journey on the CleverTap Dashboard, ensure you understand the [Journey Components](https://staging.docs.user.clevertap.net/docs/journey-components).