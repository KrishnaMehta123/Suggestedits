...
The *Draft* state indicates that the journey is not published yet. You can still modify each and every section of the journey as per your use case before you publish the journey. 
...
<Image align="center" className="border" border={true} src="https://files.readme.io/8cc3248fc45e68678698e035a601ab2494bb746351b4c975f22e16c6938d1dbf-Running-state_wip-4.gif" />
...
* **User Entry**: User Entry does not happen.
* **User Movement**: User Movement happens.
* **Type of Modifications**: *What* section, change provider for Email, SMS, or WhatsApp engagement nodes, and user distribution for IntelliNODE journey split in manual mode.
