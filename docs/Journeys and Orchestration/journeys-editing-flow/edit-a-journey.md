...
You can now edit live journeys in CleverTap, helping you refine your user flows in real time, whether you want to fix your campaign message or an error, add new touchpoints, or optimize engagement. This document provides information about how you can edit journeys. There are two types of edits available:

- **Partial Editing**  
  Used when you want to make non-structural changes directly to the current version of a _Running_ journey. This includes modifying the following: _What_ section, User distribution in an IntelliNODE journey, and Service Provider. For more information, refer to [Edit What Section](doc:doc:edit-a-journey#option-1-edit-what-section). 
- **Full Editing**  
...
1. From the _Journeys_ section, select the journey you want to edit.
2. Click the ![](https://files.readme.io/83228df00854230893cae44b546618d79d0c2bf8bab434103b15fa2e4900a8cc-Edit_icon_-_Journeys.png) icon in the top-right of the canvas to edit a Journey. If the journey is not in _Draft_ state, the _Edit Journey_ popup opens with the following options:

   [block:image]{"images":[{"image":["https://files.readme.io/cf8a4772101e6c5bef7811b3a9f6ea2b331267c40caf21488c6e13d7509dd0ca-Edit_Journey_Popup.png","","Edit Journey Popup"],"align":"center","border":true,"caption":"Edit Journey Popup"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/67fa67ddb149a7e651a22463f0ef087bf833f5903826755ced814fd763279133-Current_Journey_-_Purchase_in_last_7_days.png",
        "",
        "Current Journey"
      ],
      "align": "center",
      "border": true,
      "caption": "Current Journey"
    }
  ]
}
[/block]
...
The journey is running, and users are progressing through the flow as shown in the above image. After publishing the journey, you want to make some edits. 

Based on the type of change, CleverTap offers the following options:

## Option 1: Edit _What_ section
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8103c7adbb4a6c74336aa7899550d4a9c6a33542fb16535742b04139fe3e74cb-image.png",
        null,
        "Stop Old Journey to Publish New Version"
      ],
      "align": "center",
      "sizing": "65% ",
      "border": true,
      "caption": "Options When Publishing New Version"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7254c0ade86a85c9e7e3b153991364cbc04e85ae1b2765a39a54809e6f98912d-Restricted_state_-_Static_New_Journey.png",
        "",
        "Restricted State - Journey Workflow "
      ],
      "align": "center",
      "border": true,
      "caption": "Restricted State - Journey Workflow "
    }
  ]
}
[/block]
...
This approach avoids disruption and allows a smooth switchover to the new version. This ensures a smooth switchover where live users are not force-exited, but all future activity happens in the updated version. You should use this to preserve the experience for users already in progress, while activating new logic for upcoming users.
...
- The users who exited the previous version would be able to qualify for the new version.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/98f98016b7614737330d4092365eda08609abbd6d986cf494a60b276a5b10cdd-Stopped_State_Edit_a_Journey.png",
        "",
        "Stopped State - Journey Workflow"
      ],
      "align": "center",
      "border": true,
      "caption": "Stopped State - Journey Workflow"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    "h-0": "**Journey State**",
    "h-1": "**Edit What Section**",
    "h-2": "**Create New Version**",
    "h-3": "**Notes**",
    "0-0": "**Draft**",
    "0-1": "Allowed",
    "0-2": "Not Required",
    "0-3": "Full editing allowed. All changes happen within the draft.",
    "1-0": "**Scheduled**",
    "1-1": "Allowed",
    "1-2": "Not Allowed",
    "1-3": "Limited edits are allowed to the _What_ section of engagement nodes, such as message content, providers, and manual distribution percentages.",
    "2-0": "**Running**",
    "2-1": "Allowed",
    "2-2": "Allowed",
    "2-3": "The older version can be stopped or moved to the Restricted state when creating a new version. The existing users continue to move ahead in the older journey. You choose what happens to the older version.",
    "3-0": "**Paused**",
    "3-1": "Allowed",
    "3-2": "Allowed",
    "3-3": "The older version can be stopped or moved to the Restricted state when creating a new version. The existing users continue to move ahead in the older journey. You choose what happens to the older version.",
    "4-0": "**Completed**",
    "4-1": "Not Allowed",
    "4-2": "Allowed",
    "4-3": "Once you publish a new version, you can:<li>**Force exit from version**, if you want all users to move to the new version immediately.</li><li>** Keep moving in the version** if you want to allow existing users to continue moving through it. The new users who meet the updated entry criteria are routed into the new version of the journey.</li>",
    "5-0": "**Stopped**",
    "5-1": "Not Allowed",
    "5-2": "Allowed",
    "5-3": "You can make changes to a stopped journey by creating a new draft version. This allows you to modify all aspects of the journey, including nodes, paths, goals, and qualification criteria.",
    "6-0": "**Restricted**",
    "6-1": "Allowed",
    "6-2": "Allowed",
    "6-3": "The existing users continue to move ahead in the older journey. You choose what happens to the older version."
  },
  "cols": 4,
  "rows": 7,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1c7b4727cbe265a07649fc0b10082bf87461a7cd10123865d512dcb66ee1516a-View_All_Journey_Versions.png",
        "",
        ""
      ],
      "align": "center",
...
For example, a marketing team wants to change a Running journey that sends a single push notification after 3 days of inactivity. In the new version, they add a reminder email on day 2. By comparing the metrics across versions, they can determine which approach yields higher reactivation.