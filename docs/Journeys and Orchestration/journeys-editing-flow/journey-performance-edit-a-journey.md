...
Before diving into Journey stats, it is important to understand a few core terms. These concepts define how user progress is tracked through the Journey and help you interpret the stats more accurately.

- **Goal Met**: If a goal is set in the Journey builder, these are all users who met the goal. 
- ** Journey Timeout**: If a Journey timeout is set in the Journey builder (entry criteria), all the users timed out.
