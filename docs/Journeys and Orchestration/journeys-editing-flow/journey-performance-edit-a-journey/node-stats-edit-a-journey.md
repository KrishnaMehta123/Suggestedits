...
| Entered Journey | The number of users who entered the journey flow after qualifying. These users move forward through node connectors such as Yes or No.                                                           |
...
(@Saby: Can I get a better image here?)
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The total number of users who entered the node. It includes all the users from Moved forward, Waiting users, Goal Met, and Journey timeout.
      </td>
    </tr>
...
The *Force Exit* node is used to manually remove users from the journey at a specific point. This node tracks only the number of users who were explicitly exited at that point in the journey flow.
