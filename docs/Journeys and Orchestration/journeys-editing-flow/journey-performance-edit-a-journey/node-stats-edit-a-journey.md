...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "Entered Node",
    "0-1": "The total number of users who entered the node. It includes all the users from Moved forward, Waiting users, Goal Met, and Journey timeout.",
    "1-0": "Moved forward",
...
The _Force Exit_ node is used to manually remove users from the journey at a specific point. This node tracks only the number of users who were explicitly exited at that point in the journey flow.
