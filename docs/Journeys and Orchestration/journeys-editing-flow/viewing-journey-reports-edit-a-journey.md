...
| **System Control Group Conversions**          | Conversions in system control group.          |
...
| **Connector from Previous\***            | Connector logic used to enter the node. Possibe values: Yes, No, and  Timeout. (@Saby: Are there any other values for this??) |
