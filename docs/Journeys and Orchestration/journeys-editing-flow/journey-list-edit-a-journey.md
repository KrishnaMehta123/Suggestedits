...
If a Journey has been edited after publishing, it may have multiple versions. The list shows details of the latest journey entity, which can either be published or in the _Draft_ state. For example, you have a journey called Cart Abandonment where:
...
[block:parameters]
{
  "data": {
    ...
    "2-0": "Status",
    "2-1": "Displays the current state of the Journey, such as Draft, Scheduled, Running, Paused, Completed, Restricted, and Stopped. For more information, refer to [Journey States](doc:journey-states-edit-a-journey).",
    "3-0": "Entry Type",
