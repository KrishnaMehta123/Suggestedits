...
If a Journey has been edited after publishing, it may have multiple versions. The list shows details of the latest journey entity, which can either be published or in the *Draft* state. For example, you have a journey called Cart Abandonment where:
