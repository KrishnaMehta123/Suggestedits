...
***Inaction Segment > Yes > Push Notification > 2 Hours Delay > SMS > 2 Hours Delay > Email***

<Image align="center" className="border" border={true} src="https://files.readme.io/d3ee3f1-image.png" />
...
* [Set up the Journey](https://staging.docs.user.clevertap.net/docs/use-case-2-recover-abandoned-cart-using-clevertap-journeys#set-up-the-journey)
* [Define goals](https://staging.docs.user.clevertap.net/docs/use-case-2-recover-abandoned-cart-using-clevertap-journeys#define-goals) 
* [Define entry segment](https://staging.docs.user.clevertap.net/docs/use-case-2-recover-abandoned-cart-using-clevertap-journeys#define-the-entry-segment)
* [Define the journey path](https://staging.docs.user.clevertap.net/docs/use-case-2-recover-abandoned-cart-using-clevertap-journeys#define-the-journey-path)
* [Personalize the journey ](https://staging.docs.user.clevertap.net/docs/use-case-2-recover-abandoned-cart-using-clevertap-journeys#personalize-the-messages)
* [Publish the journey](https://staging.docs.user.clevertap.net/docs/use-case-2-recover-abandoned-cart-using-clevertap-journeys#personalize-the-messages:~:text=and%20Email%20messages.-,Click%20Publish,-to%20make%20the) 
...
1. To set up your Journey, click the **Setup** widget and provide the following details as shown in the following image:
   ...
   * **Journey timeout duration**
   ...
   <Image align="left" className="border" width="80% " border={true} src="https://files.readme.io/8f50305-image.png" />
...
2. Click the **Goals** widget and set the following details: 
   ...
   1. Enter the name of the goal in the **Goal name** field. For example, *Completed the Purchase*. 
   2. Under **Who** > **Target Segment**, set the **Charged** event as the exit criteria. Click **Continue**.

      <Image align="left" className="border" width="80% " border={true} src="https://files.readme.io/8e561e9-image.png" />
3. Click **Save & Close**.
...
2. Click the **Action** segment node and enter the following details: 
   ...
   1. Enter the name of the segment in the **Segment name** field. For example, *Added to Cart but Did Not Do Charge*.
   2. Under **Who** > **Target Segment**, set the following events and click **Continue**:  

      1. **As soon as user does** = *Added to Cart* event
      2. **And does not do** = *Charged* event *within 2 minutes*

         <Image align="left" className="border" width="80% " border={true} src="https://files.readme.io/a0bdb4d-image.png" />
3. Click **Save & Close**.
...
<Image align="center" className="border" border={true} src="https://files.readme.io/4319962-image.png" />
...
Once you have outlined the journey path, compose the [Push](https://docs.clevertap.com/docs/push), [SMS](https://docs.clevertap.com/docs/sms), and [Email](https://docs.clevertap.com/docs/email) messages. 

For more information about composing your message, refer to our Push, SMS, and Email documents. 
...
3. Enter the message in the **Title** and **Message** field. You can use the **Scribe** ![Magic Wand](https://files.readme.io/bf3a4d6-2023-03-17_11-28-28.jpg) icon to generate personalized copies.
...
In the following graphic, **@** directly includes the customer's name in the message.

<Image align="center" className="border" border={true} src="https://files.readme.io/aa369bd-image.png" />

For more information on personalization, refer to the  [Personalization in Journeys](https://staging.docs.user.clevertap.net/docs/personalization-in-journeys) document. 
