...
<Image title="View IntelliNODE node stats for a Journey" alt={2212} align="center" width="90% " border={true} src="https://files.readme.io/9477aaa71df86d418e67dbd006f0fc514918418d2309ea03eb03ba9cd1ae1124-View_IntelliNODE_Node_Stats_for_a_Journey.png">
...
You can view the goal conversion results for all paths in absolute numbers or percentages.  The values are cumulative from the date the journey was first run till the date selected on the canvas. The following details are displayed on the *Stats* page:
...
* Total Conversions: Displays the summation of all the defined goals, that is, *Goal 1 + Goal 2 + Goal 3 = Total Conversions.*

<Image title="View IntelliNODE goal conversion results for all paths" alt={1532} align="center" width="90% " border={true} src="https://files.readme.io/e9b4c952d2f00b58f05278ae16317650d96896d8f6c7a3d567b336440efb4a6b-Goal_Conversions_Across_Paths.png">
  View IntelliNODE Goal Stats
</Image>
...
<Image title="Select a preferred path and declare winning IntelliNODE path" alt={1490} align="center" width="90% " border={true} src="https://files.readme.io/423aefc9a22fd9ed13a6b4f8cafc6962b8538366fa3acd524d458a8512ad8ba8-Declare_Winning_Path.png">
  Declare Winning IntelliNODE Path
</Image>
...
<Image title="View user distribution changelog for manual and automated journeys" alt={1568} align="center" width="75% " border={true} src="https://files.readme.io/4fe9225-Intellinode_user_distribution_edit_log.png">
  IntelliNODE Change Log
</Image>
...
<Image title="IntelliNODE goal conversion across path" alt={1532} align="center" width="90% " border={true} src="https://files.readme.io/30d8cef-IntelliNODE_goal_conversion_trend.png">
...
<Image title="IntelliNODE user distribution across paths" alt={1532} align="center" width="75% " border={true} src="https://files.readme.io/4f2f7ab-IntelliNODE_user_distribution_trend.png">
  User Distribution Across Paths
</Image>
