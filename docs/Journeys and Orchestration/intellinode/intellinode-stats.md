...
<Image title="View IntelliNODE node stats for a Journey" alt={2212} align="center" width="90% " border={true} src="https://files.readme.io/6613953-IntelliNODE_Node_stats.png">
...
<Image title="View IntelliNODE goal conversion results for all paths" alt={1532} align="center" width="90% " border={true} src="https://files.readme.io/9495658-IntelliNODE_goal_stats.png">
...
<Image title="Select a preferred path and declare winning IntelliNODE path" alt={1490} align="center" width="90% " border={true} src="https://files.readme.io/fe28acf-Declare_Winning_IntelliNODE_Path.png">
...
<Image title="View user distribution changelog for manual and automated journeys" alt={1568} align="center" width="90% " border={true} src="https://files.readme.io/4fe9225-Intellinode_user_distribution_edit_log.png">
...
<Image title="IntelliNODE user distribution across paths" alt={1532} align="center" width="90% " border={true} src="https://files.readme.io/4f2f7ab-IntelliNODE_user_distribution_trend.png">
  User Distribution Across Paths
</Image>
