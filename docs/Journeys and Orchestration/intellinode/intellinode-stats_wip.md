---
title: IntelliNODE Stats_WIP
excerpt: Understand how to view IntelliNODE Stats and measure performance.
deprecated: false
hidden: true
metadata:
  title: ''
...
<Image title="IntelliNODE Node stats.png" alt={2212} className="border" width="smart" border={true} src="https://files.readme.io/6613953-IntelliNODE_Node_stats.png" />
...
<Image title="IntelliNODE goal stats.png" alt={1532} className="border" width="80%" border={true} src="https://files.readme.io/9495658-IntelliNODE_goal_stats.png" />
...
<Image title="Declare Winning IntelliNODE Path.png" alt={1490} className="border" border={true} src="https://files.readme.io/fe28acf-Declare_Winning_IntelliNODE_Path.png" />
...
<Image title="Intellinode_user_distribution_edit_log.png" alt={1568} className="border" border={true} src="https://files.readme.io/4fe9225-Intellinode_user_distribution_edit_log.png" />
...
<Image title="IntelliNODE goal conversion trend.png" alt={1532} className="border" border={true} src="https://files.readme.io/30d8cef-IntelliNODE_goal_conversion_trend.png" />
...
<Image title="IntelliNODE user distribution trend.png" alt={1532} className="border" border={true} src="https://files.readme.io/4f2f7ab-IntelliNODE_user_distribution_trend.png" />
