...
<Image title="Drag and drop IntelliNODE controller to create a Journey" alt={1392} align="center" width="90% " border={true} src="https://files.readme.io/e4f294f-Create_an_IntelliNODE_Journey.gif">
  Create an IntelliNODE Journey
</Image>
