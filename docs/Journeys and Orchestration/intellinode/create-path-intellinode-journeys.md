...
<Image title="Setup user distribution for IntelliNODE Journeys" alt={1514} align="center" width="75% " border={true} src="https://files.readme.io/d3be1aa-InteliNODE_Set_Up.png">
  Setup IntelliNODE 
</Image>
