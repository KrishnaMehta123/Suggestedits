...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/50c75d8-rfm3.png",
        "rfm3.png",
        1340,
        652,
        "#d8d8de"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/42c0b7d-rfm3.png",
        "rfm3.png",
        1340,
        652,
        "#d8d8de"
...
[block:callout]
{
  "type": "info",
  "title": "Note",
  "body": "Currently, in RFM analysis, we sample your data to load it faster. We sample the results only when the query exceeds 50,000 events. The sample size is 10%\n\nYou may see a minor difference in counts when you compare these numbers with the numbers in your dashboard.  However, the numbers are directionally correct."
}
[/block]