...
{
  "type": "success",
  "title": "Feature Available in Beta to Customers on the Enterprise Plan",
  "body": "Intent Based Segments is currently available in beta to customers who are on the [Enterprise plan](https://clevertap.com/pricing/). This feature will be available to Enterprise customers until November 30, 2018 with no additional charge.\n\nStarting December 1, 2018, this will be offered as an add-on feature to customers who purchase our AI Pack. The AI Pack will include a set of new features that utilize the power of CleverTap artificial intelligence and machine learning to help you achieve your marketing goals.\n\nPlease contact us on sales@clevertap.com for more information regarding the AI pack"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/09ca8a9-Screen_Shot_2018-10-17_at_12.00.01_PM.png",
        "Screen Shot 2018-10-17 at 12.00.01 PM.png",
        1440,
        721,
        "#d9dce4"
      ],
...
[block:callout]
{
  ...
  "body": "Use maximize if you want to maximize your goal (e.g. Maximize video watched). This can be used for your conversion goals\n\nUse minimize if you want to minimize your goal (e.g. Minimize uninstalls). This can be used for your churn goals"
}
[/block]
...
[block:callout]
{
  "type": "info",
  "title": "Goal Limits",
  "body": "All customers can create up to 5 goals across the account. Goal creation is open for all customer types - Free, Business and Enterprise users"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ae9d4f0-Screen_Shot_2018-10-17_at_4.24.46_PM.png",
        "Screen Shot 2018-10-17 at 4.24.46 PM.png",
        1440,
        755,
        "#e2e4e9"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/375b9a3-Screen_Shot_2018-10-17_at_12.00.01_PM.png",
        "Screen Shot 2018-10-17 at 12.00.01 PM.png",
        1440,
        721,
        "#d9dce4"
