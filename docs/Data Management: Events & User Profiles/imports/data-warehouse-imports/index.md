...
<a href="https://staging.docs.user.clevertap.net/docs/map-data-for-import#perform-dry-run-recommended" class="integration-card">
    <div class="name">BigQuery</div>
  </a>
  <a href="https://staging.docs.user.clevertap.net/docs/schedule-import" class="integration-card">
...
<div class="grid">
  <a href="https://staging.docs.user.clevertap.net/docs/create-import" class="integration-card">
    <div class="name">Set Up Import</div>
  </a>
  <a href="https://staging.docs.user.clevertap.net/docs/map-data-for-import" class="integration-card">
    <div class="name">Map Data</div>
  </a>
<a href="https://staging.docs.user.clevertap.net/docs/map-data-for-import#perform-dry-run-recommended" class="integration-card">
    <div class="name">Perform Dry Run</div>
  </a>
  <a href="https://staging.docs.user.clevertap.net/docs/schedule-import" class="integration-card">
...
(@Krishna: add config page links for DWH partners.)