...
This option is ideal when you want hands-free, regular updates. It ensures your CleverTap data is periodically refreshed. A best practice is to align the interval with your data update frequency. For instance, if your data warehouse's (@parth accurate?) data is updated once a day, a daily import interval (or slightly after the update time) is sufficient and avoids unnecessary runs.
