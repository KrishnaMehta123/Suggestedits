...
[block:parameters]
{
  "data": {
    ...
    "h-1": "**Description**",
    "0-0": "Nickname",
    "0-1": "The unique name given to each import. This helps easily identify and differentiate between different database imports.",
    "1-0": "Partner",
...
[block:parameters]
{
  "data": {
    ...
    "1-0": "Imported On",
    "1-1": "The date when the import was successfully recorded in the data warehouse.",
    "2-0": "Health",
    ...
    "4-1": "The number of records that were successfully imported into the data warehouse without errors.",
    "5-0": "Failed Syncs",
