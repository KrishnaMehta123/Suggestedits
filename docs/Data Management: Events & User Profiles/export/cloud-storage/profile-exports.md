...
3. Select the _Partner_ to which you want to send the export and click **Start**. The export setup includes the following four main steps:
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/e09f980fca5805d1eca3447ff04724e0799336b580ea2af71f4cc1a58ced80e2-Create_Export.gif","","Create Export"],"align":"center","border":true,"caption":"Create Export"}]}[/block]
...
2. **Set Up Sub-folder Structure**  
   ...
   - **Custom**:  Build your own folder structure using dynamic variables. Click {{}} to insert variables and use `/` to create subfolders.  
     ...
     - `{{Date}}`: Export run date in `yyyymmdd`.  
       ...
       _Preview_: `/{bucket-name}/20251003/run-1761650178/file.csv.gz`  
       <br />
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a77ce23417eb8525f39e6d8cad5e0bb24e209b8b6b3e5e6ea4c0a6575606ac6e-Set_Up_Sub-Folder_Structure.png",
        "",
        "Set Up Sub-Folder Structure"
      ],
      "align": "center",
      "border": true,
      "caption": "Set Up Sub-Folder Structure"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/574aeb96345953e27aee4ff4e007b9362d967255ef41270d87e97b98a5e36ca5-Define_File_Name_Convention.png",
        null,
        "Select File Format and Define File Name"
      ],
      "align": "center",
      "border": true,
      "caption": "Select File Format and Define File Name"
    }
  ]
}
[/block]
...
1. **Select Identity & Define Order**  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/1a28ae6ee64add0430f7cbc2338843b9ff4dd7633e0bf6330e72fc70f9c97f40-Select_Identity.gif","","Select Identity"],"align":"center","border":true,"caption":"Select Identity"}]}[/block]
...
2. **Define Export Preference**  
   ...
   - **Single value with fallback**:  Exports one identifier value per profile following your priority order. If the first identifier is unavailable, CleverTap uses the next available identifier as per your defined sequence. Use the _Reorder_ option to set priority by dragging rows or entering position numbers. For example, if the priority order is `Identity → Email → Phone → CRM ID [Custom properties]`, CleverTap exports the first available identifier in that order for each user.
     ...
     [block:image]{"images":[{"image":["https://files.readme.io/4763bf86ff4c593bf96063be083efa00e9f86b24fd6e5940c7013dddd2a96a29-Choose_Export_Preference.gif","","Define Export Preference when Exporting Single Value for Identity"],"align":"center","border":true,"caption":"Define Export Preference when Exporting Single Value for Identity"}]}[/block]
...
```text Account-Defined User Identity
all_identities
[user_123,user_456,user@example.com]
```
...
5. **Preview Output**  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/5e0c6d84a15621ab608e199f8de65af4fd10e9948aedec8377d9877aa9337b37-Preview_Output.png","","Preview Output"],"align":"center","border":true,"caption":"Preview Output"}]}[/block]
...
1. **Include Device Attributes**  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/89080e6460bd1d6639605ff0ef7e5df35c8962418f704967ceeaa796c115892d-Include_Device_Attributes.png","","Include Device Attributes"],"align":"center","border":true,"caption":"Include Device Attributes"}]}[/block]
...
2. **Add Communication Preferences**.  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/c494bcc5ab5779790e9c9a66457dd15674f31428997d95de5ddcbebf1ae7380c-Export_Communication_Preferences.gif","","Export Communication Preferences"],"align":"center","border":true,"caption":"Export Communication Preferences"}]}[/block]
...
3. **Select User Properties**  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/86580e1c39e195008221ca0c636d54717b94ff958c0e31dbf96c245927e65742-Select_User_Properties_to_Export.gif","","Select User Properties to Export"],"align":"center","border":true,"caption":"Select User Properties to Export"}]}[/block]
...
4. **Rename & Reorder Properties**:  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/785878c2969967e4229143efedd2b4d61283bdfc8ddea7b09da7af3186c61043-Rename__Reorder_Properties.gif","","Rename and Reorder User Properties to Export"],"align":"center","border":true,"caption":"Rename and Reorder User Properties to Export"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e9dd4ed68144deefe6f7f3e9bdc3bd0ad7e28688f97466f55b662c6148f5ca0e-Manage_Schema_Updates.png",
        "",
        "Manage Schema Updates"
      ],
      "align": "center",
      "border": true,
      "caption": "Manage Schema Updates"
    }
  ]
}
[/block]
...
2. **Select Export Type**  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/0afbe823816d06a3c231d2392bf02f421b4d1f493264cae95b5c5afda68a6cd9-Recurring_Export.png","","Create Recurring Export"],"align":"center","border":true,"caption":"Create Recurring Export"}]}[/block]
...
[block:parameters]
{
  "data": {
    ...
    "0-1": "[ \"XXXXXXX\" ]",
    "0-2": "\\_\\_g1234567890",
    "0-3": "[__g1234567890,Ne22k5-xQ90sN1aebRkzjiV65JN6Cwdc]",
    "0-4": "{\"token\":\"XXXXXXX\"}",
    "0-5": "XXXXX",
    "0-6": "XXXXX",
    "0-7": "XXXXX",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/925d13fe3d81e2d20983b0beb6b1772daad788c46b3e74ee6b99ebda0e38da6e-Stop_Export.png",
        "",
        "Stop Export"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/10ce99261935856c41e06cbcf9153637975303b753ed7a45bee6aaae562daad3-Filter_Exports.png",
        "",
        "Filter Exports"
      ],
      "align": "center",
