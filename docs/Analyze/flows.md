...
> 📘
>
> **Flows** is a part of CleverTap's Discovery Platform and is available for Enterprise accounts
...
<Image title="Flows 1.png" alt={1440} className="border" border={true} src="https://files.readme.io/2325466-Flows_1.png" />
...
<Image title="screencapture-eu1-dashboard-staging-4-dashboard-clevertap-ZWW-WWW-WWRZ-flows-html-2018-12-26-23_36_09.png" alt={1480} className="border" border={true} src="https://files.readme.io/ac86285-screencapture-eu1-dashboard-staging-4-dashboard-clevertap-ZWW-WWW-WWRZ-flows-html-2018-12-26-23_36_09.png" />
...
<Image title="image2.png" alt={1928} className="border" border={true} src="https://files.readme.io/ac9c85d-image2.png" />
...
<Image title="flows2.png" alt={1236} className="border" border={true} src="https://files.readme.io/1beab10-flows2.png" />

# Set Up a Content Flow

To use Content Flows, go to the Analyze tab in the CleverTap Dashboard, select Flows -> Content Flows

<Image title="Flows 1.png" alt={1440} className="border" border={true} src="https://files.readme.io/b3154c2-Flows_1.png" />
...
<Image title="Screenshot 2018-12-26 at 11.25.14 PM.png" alt={1233} className="border" border={true} src="https://files.readme.io/3602328-Screenshot_2018-12-26_at_11.25.14_PM.png" />
