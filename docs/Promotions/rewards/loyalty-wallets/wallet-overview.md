...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4702391dd54c7c81f6de0c46ca93e2bc5189b7541327ed9f2ef7012ab29d5b27-Wallet_Overview.png",
        null,
        "Wallet Overview"
      ],
      "align": "center",
...
The _Summary_ section provides the current status of all the loyalty wallet points. Track the real-time status of the loyalty points available for users and those scheduled for future credit with the following key metrics:

- **Active Points:** Total points currently available for use.
- **Promised Points:** Points earned by customers but are yet to be credited to the Active bucket based on the points activation date.
...
- **Issued Points:** Total points awarded to users within the selected date range through various sources, such as:
  ...
  - **Promo Campaigns**: Points credited via marketing promotions. For example, a festival sale campaign credits 100 points to a user's wallet.
...
- **Removed Points:** Points deducted or revoked due to manual adjustments made through the CleverTap Wallet dashboard. For example, if a customer was mistakenly credited with extra points, an Admin can manually remove those excess points from the wallet via the dashboard. These deducted points will be recorded as _Removed Points_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1b39c2a0341e367aa00857137f05467ee93a0c95fc12516b0f1bc5b36ca5f746-Setup_Details.png",
        "",
        "Setup Details"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c4b6551f0a2665e0e3aec60ca9c181641b3cd105b12ac9c902fe174a2d876753-Calendar_Widget.png",
        "",
        "Calendar Widget"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7cfe24d02f41493079a13b689e05654d42fcb03c5de41e2802798260c77cec4f-Edit_Loyalty_Wallet.gif",
        null,
        "Edit Loyalty Wallet and Points Name"
      ],
      "align": "center",
      "border": true,
      "caption": "Edit Loyalty Wallet and Points Name"
    }
  ]
}
[/block]
...
2. Click the **Transactions** tab. The following parameters of the transactions appear to help you audit wallet activity and track how users are earning or redeeming points.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7ca194070e2bb934aca1e64c92678dfb76bb9734aa5697dc71acdff97d18f0fb-image.png",
        null,
        "View Wallet Transactions"
      ],
      "align": "center",
      "border": true,
      "caption": "View Wallet Transactions"
    }
  ]
}
[/block]
...
| Field       | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| :---------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Identity    | A unique identifier representing the user associated with the transaction. The identity value is clickable and redirects to the user details page in a new window, allowing quick access to user-specific information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Timestamp   | The date and time when the transaction was recorded.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Source      | <p>The origin of the transaction. The following are valid sources:</p><ul><li>API</li><li>Promo Campaigns</li><li>Manual</li><li>Cashback Coupon</li><li>System</li></ul>For more information, refer to [Source](doc:wallet-operations#source).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Txn ID      | A unique transaction identifier for the wallet transaction.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Description | <p>A brief note about the transaction. The transaction descriptions are determined based on the following transaction types:</p><ul><li>**API Transactions (Credit/Debit)**: The description is determined by user input in the API payload.</li><li>**Manual Adjustments (Dashboard)**: The description is set by the user while adjusting points.</li><li>**System-Generated Transactions**: The following standard descriptions are applied based on the following transaction types{@barjang, this sentence is confusing}:</li><ul><li>_Points earned from campaign_: for credit transactions from campaigns.</li><li>_Points earned for redeeming {Coupon Code} coupon_: for cashback coupon redemptions.</li><li>_Expired points_: for points that have expired.</li></ul> |
| Txn Type    | The transaction type, such as Credit, Debit, Scheduled, or Expired.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Points      | The value credited, debited, or expired in the transaction.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |