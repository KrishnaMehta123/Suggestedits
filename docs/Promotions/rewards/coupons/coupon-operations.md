  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <p> For more information, refer to [Select Coupon Type](doc:create-coupon#select-coupon-type).</p>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <li>**Percentage discount**: A percentage-based discount applied to the order total or specific products.</li>
        <li>**Flat cashback**: Fixed cashback points credited to the user.</li>
        <li>**Percentage cashback**: Cashback provided as a percentage of the order amount.</li>
      </td>
    </tr>
