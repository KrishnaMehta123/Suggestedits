...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Shows the number of times the coupon has been redeemed by users. For bulk unique code coupons, this is calculated as 

        *Number of codes redeemed / Number of codes generated in this series*
