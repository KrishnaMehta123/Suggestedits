...
| **Coupon Type**      | <p>Indicates how the coupon is distributed and redeemed based on the format and triggering method. The following are the available options:</p><ul><li>Single code for all users</li><li>Single code based on user actions</li><li>Downloadable bulk unique codes</li><li>Bulk unique codes based on user actions</li></ul>For more information, refer to [Select Coupon Type](doc:create-coupon#select-coupon-type). |
...
| **Redemption**       | Shows the number of times the coupon has been redeemed by users. For bulk unique code coupons, this is calculated as _Number of codes redeemed / Number of codes generated in this series_.                                                                                                                                                                                                                           |