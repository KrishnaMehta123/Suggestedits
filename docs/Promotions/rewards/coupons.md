...
title: Coupons
excerpt: >-
  Learn how to create and manage coupon rewards using the CleverTap dashboard to
  drive engagement, encourage repeat purchases, and support targeted promotional
  campaigns.
deprecated: false
hidden: false
metadata:
...
- **Expiration Settings**: Define when a coupon expires using one of the following options:
  ...
  - **Relative Expiry**: Valid for a defined period after activation. For example, 7 days from the date of activation.

- **Coupon Distribution**: Define how coupons are issued to users. For more information, refer to [Select Coupon Type](create-coupons#select-coupon-type).
...
- **Fintech**: UPI or wallet top-up incentives tied to specific payment methods.
...
- **Personalizing Coupon Distribution**: Target all users or segments through promo campaigns.
...
[block:html]
{
  "html": " <div class=\"two-col-container\">\n  <div class=\"link-content\">\n    <ul>\n      <li><a class=\"links\" href=\"https://staging.docs.user.clevertap.net/docs/view-coupons\" target=\"_blank\" rel=\"noopener noreferrer\">View Coupons</a></li>\n      <li><a class=\"links\" href=\"https://staging.docs.user.clevertap.net/docs/coupon-operations\" target=\"_blank\" rel=\"noopener noreferrer\">Coupon Operations</a></li>\n    </ul>\n  </div>\n  \n  <div class=\"link-content\">\n    <ul>\n      <li><a class=\"links\" href=\"https://staging.docs.user.clevertap.net/docs/create-coupons\" target=\"_blank\" rel=\"noopener noreferrer\">Create Coupons</a></li>\n      <li><a class=\"links\" href=\"https://staging.docs.user.clevertap.net/docs/coupon-stats\" target=\"_blank\" rel=\"noopener noreferrer\">Coupon Stats</a></li>\n    </ul>\n  </div>\n</div>"
}
[/block]