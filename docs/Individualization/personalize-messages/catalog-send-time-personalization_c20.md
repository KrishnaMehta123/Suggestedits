...
<Image title="Select Catalog.png" alt={2878} className="border" border={true} src="https://files.readme.io/d72233a-Select_Catalog.png" />

3. Click the **Catalog** tab and select the required catalog from the list. 

<Image title="Catalog Personalization.png" alt={1898} className="border" width="80%" border={true} src="https://files.readme.io/1266641-Catalog_Personalization.png" />

4. Select the event. You can personalize your message based on the property values of this event. 

<Image title="Select Catalog Send-Time Values.png" alt={1894} className="border" width="80%" border={true} src="https://files.readme.io/be98af1-Select_Catalog_Send-Time_Values.png" />
...
<Image title="Map Catalog Columns.png" alt={1896} className="border" width="80%" border={true} src="https://files.readme.io/fad7eeb-Map_Catalog_Columns.png" />
...
<Image title="catalog_personalization_liquid_message.png" alt={1173} className="border" border={true} src="https://files.readme.io/3069384-catalog_personalization_liquid_message.png" />
...
<Image title="Select Catalog.png" alt={2878} className="border" border={true} src="https://files.readme.io/98a92e5-Select_Catalog.png" />

3. Click the **Catalog** tab and select the required catalog from the list. 

<Image title="Catalog Personalization.png" alt={1898} className="border" width="80%" border={true} src="https://files.readme.io/18b28fa-Catalog_Personalization.png" />
...
<Image title="Map Catalog Columns_Event Property.png" alt={1900} className="border" width="80%" border={true} src="https://files.readme.io/3f75e23-Map_Catalog_Columns_Event_Property.png" />
...
<Image title="catalog_personalization_liquid_message_User_property.png" alt={1081} className="border" border={true} src="https://files.readme.io/cc955ed-catalog_personalization_liquid_message_User_property.png" />
