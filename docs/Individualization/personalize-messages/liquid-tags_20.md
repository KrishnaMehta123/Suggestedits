...
<Image title="Select Rich Media Template.png" alt={2878} border={true} src="https://files.readme.io/bc6d48d-Select_Rich_Media_Template.png">
...
<Image title="Add Liquid tags.png" alt={2876} className="border" border={true} src="https://files.readme.io/e7aa86c-Add_Liquid_tags.png" />
...
<Image title="Select Media Template.png" alt={2878} className="border" border={true} src="https://files.readme.io/0fc50d2-Select_Media_Template.png" />

2. Click the Row item in *Preview*.

<Image title="2020-07-28_19-19-33_Select row item.png" alt={1047} className="border" border={true} src="https://files.readme.io/b461f6b-2020-07-28_19-19-33_Select_row_item.png" />
...
<Image title="Select Customize with Liquid Tags.png" alt={2862} className="border" border={true} src="https://files.readme.io/6404ab8-Select_Customize_with_Liquid_Tags.png" />

4. Add the liquid script inside the popup.

<Image title="Add liquid script.png" alt={2856} className="border" border={true} src="https://files.readme.io/57f0cf4-Add_liquid_script.png" />
