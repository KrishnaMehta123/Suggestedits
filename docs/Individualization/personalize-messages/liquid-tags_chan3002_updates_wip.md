...
<Image title="Campaigns_Email_Liquid_Tags_Template.png" alt={1440} border={true} src="https://files.readme.io/75cd8d0-Campaigns_Email_Liquid_Tags_Template.png">
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        logical or. Choose between condition 1 or condition 2.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        logical and. Choose conditions 1 and condition 2
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        check for a string within a string
      </td>
    </tr>
  </tbody>
</Table>
...
<Image title="Campaign_Email_HTML_editor.png" alt={1437} className="border" border={true} src="https://files.readme.io/1cbbd27-Campaign_Email_HTML_editor.png" />
...
![1390](https://files.readme.io/695cc49-campaigns_email_liquid_editor_example.png "campaigns_email_liquid_editor_example.png")
...
![1098](https://files.readme.io/e404d9c-2020-07-28_18-55-48_Select_template.png "2020-07-28_18-55-48_Select template.png")

2. Click on a *Row* item in *Preview*.

![1047](https://files.readme.io/b461f6b-2020-07-28_19-19-33_Select_row_item.png "2020-07-28_19-19-33_Select row item.png")

3. Select **Add display content** in the right pane.

![1054](https://files.readme.io/e695382-2020-07-28_19-15-27_Content_editor.png "2020-07-28_19-15-27 Content editor.png")

4. Add the liquid script inside the personalized text box.

![1082](https://files.readme.io/7850f33-2020-07-28_19-25-41_add_personalized_message..png "2020-07-28_19-25-41_add personalized message..png")
