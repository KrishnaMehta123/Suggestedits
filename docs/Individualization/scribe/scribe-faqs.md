---
title: Scribe FAQs
excerpt: Discover the answers to frequently asked questions about Scribe.
deprecated: false
hidden: false
metadata:
  title: ''
...
This section describes the Frequently Asked Questions (FAQs) for [Scribe](https://docs.clevertap.com/docs/scribe).

### Q. How does Scribe work?

A. Scribe is created using our in-house emotion analyzer and OpenAI APIs. It is the first and only content generator coupled with an emotion analyzer for creating emotionally resonant and hyper-personalized content at scale.

### Q. Does Scribe give everyone the same suggestions for the same prompts?

Scribe uses OpenAI APIs to generate message copies. It does not provide the same suggestions to everyone. However, it may generate similar responses based on identical prompts. 
