...
[block:callout]
{
  ...
  "body": "You can only select events you mapped to the catalog on which the chosen recommendation is running."
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Enhanced recommendations with both catalogs.png",
        1956,
        1218,
        "#f7f7f9"
      ],
...
{
  "type": "info",
  "body": "In case of Web Popup campaign preview, CleverTap does not support recommendations.",
  "title": "Web Popup Campaign Preview"
}
[/block]
