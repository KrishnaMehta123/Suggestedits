...
* Jane has just watched *Game of Thrones*. Next, she receives an instant, in-app recommendation that suggests she watch similar English drama series and other titles that are often viewed by viewers who also watch *Game of Thrones*. These recommendations are also sensitive to recent trends and patterns.
