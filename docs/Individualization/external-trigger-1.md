...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5325bd51cbc1aa529216ed609981bebb62e9a144c94726eb217c76ab84311a8b-Select_a_Campaign.png",
        null,
...
Setting up an External Trigger campaign is simple. After selecting the messaging channel, select _External Trigger_ from the _Qualification Criteria_ section.
