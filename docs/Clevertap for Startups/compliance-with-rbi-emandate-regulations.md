...
---
# Overview
With the new regulations from RBI coming into effect, payment processing for India-issued cards will get affected. This section provides information about changes done to CleverTap Basic payment workflows to comply with the new regulations.
