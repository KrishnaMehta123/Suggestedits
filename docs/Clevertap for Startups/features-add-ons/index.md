...
<Table align={["left","left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Use the WhatsApp Direct Add-on to engage with customers on WhatsApp without bringing your own Business Solution Provider (BSP).
      </td>

      <td>
        20% of the base plan (excluding credits purchased)
      </td>
    </tr>

    <tr>
      <td>
        [CleverTap Email](doc:email)
      </td>
      ...
      <td>
        Seamlessly manage your email campaigns within CleverTap without integrating an external Email Service Provider.
      </td>

      <td>
        $50 + 10% of the base plan
      </td>
    </tr>
    ...
    <tr>
      <td>
        [Promotions](doc:promo-campaigns) 
      </td>
