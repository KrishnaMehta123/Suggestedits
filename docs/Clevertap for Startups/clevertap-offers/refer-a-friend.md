...
excerpt: >-
  Learn more about the Refer-a-Friend: Promotional Credit offer for new and
  existing Essentials plan customers.
deprecated: false
hidden: true
metadata:
  title: Refer-A-Friend
...
CleverTap for Startups is thrilled to unveil the **Refer-A-Friend** program, where our Essentials Plan customers can refer leads — such as friends, peers, fellow cohort founders, or anyone from your network — and earn credits when a referred startup lead converts into a C4S customer. Build our community while earning promotional credits for each successful referral—everyone, including you and your network, wins.

## Offer Name

**Refer-A-Friend: Earn Credits for Each Startup You Refer**

## Offer Eligibility

Available to all new and existing customers on the **CleverTap Essentials Plan**. The referrer and referred customer must fulfil the eligibility criteria specified in [How Referral Works](doc:refer-a-friend#how-referral-works).
...
### For Referrers (Existing Essentials Customers)
...
### How will I know when my referral is successful?

You will receive an email when your referral enrolls and another email when credits are posted to your account.

### Can I cash out my credits?

No, credits cannot be cashed out. Once added to your account, they are automatically applied to your future CleverTap invoices.

### What if my referral has already signed up for CleverTap or joined another program?

Only new customers who have not previously participated in any CleverTap program are eligible.