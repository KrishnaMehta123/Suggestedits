...
For additional information, refer to the [FAQ section](https://staging.docs.user.clevertap.net/docs/faqs-on-billing-and-overagescopy?utm_source=C4S\&utm_medium=doc\&utm_id=KB) for details on commonly encountered queries.
