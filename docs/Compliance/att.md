...
excerpt: >-
  Learn how CleverTap ensures compliance with Apple's App Tracking Transparency
  (ATT) policy and how it impacts user tracking, IDFA, and device information in
  your iOS app.
deprecated: false
hidden: false
metadata:
