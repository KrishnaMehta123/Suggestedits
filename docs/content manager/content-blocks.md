...
> 📘 Private Beta
>
> This feature is currently a Private Beta Release. If you want access to it, contact your Account Manager.
...
6. From the list of labels, select the appropriate labels to organize and identify your content block. 
7. Click **Done**. 
...
Before proceeding with the creation of content blocks, it is advisable to review the specifications and considerations carefully.

| Content Block Element | Specification                                                                                                                                                                                                                               |
| :-------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Name/Rename           | Names can include letters (A-Z, a-z), numbers (0-9), underscores (\_), periods (.), hyphens (-), parentheses (()), and spaces. However, names must not begin with a special character. Additionally, the content block name must be unique. |
...
Before using Content Blocks, refer to these important guidelines for supported personalization. These guidelines help ensure that your messaging campaigns are effective within the required specifications.

| Personalization Type | Supported? | Description                                                                                                                                            |
| :------------------- | :--------- | :----------------------------------------------------------------------------------------------------------------------------------------------------- |
| Profile              | Yes        | You can use profile attributes                                                                                                                         |
| Conditional Tags     | Yes        | You can create a 'write once use multiple times' message and add multiple variations to it. For more information, see [Liquid Tags](doc:liquid-tags) . |
| Event                | No         | -                                                                                                                                                      |
| Linked Content       | No         | -                                                                                                                                                      |
