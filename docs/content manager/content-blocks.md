...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/444e1b6e3fa2349d38e754650d5bedb0d0cab2645f0d5eaf92a6eabc05f12902-image.png",
        null,
        "Nest Multiple Content Blocks"
      ],
      "align": "center",
      "border": true,
      "caption": "Nest Multiple Content Blocks"
    }
  ]
}
[/block]
...
| Conditional Tags     | Yes        | You can create a _write once use multiple times_ message by adding conditional variations based on user attributes or behavior. For more information, see [Liquid Tags](doc:liquid-tags).        |
