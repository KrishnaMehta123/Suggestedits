...
excerpt: Learn how to use templates in CleverTap Content Manager.
deprecated: false
hidden: false
metadata:
  title: ''
...
The *Templates* section organizes your messaging templates. You can save and reuse templates from the *Templates* section. 

Navigate to *Content > Content Manager > Messaging Channel > Templates*.

<Image alt="Templates Editor" align="center" border={true} src="https://files.readme.io/339b33f-CMS_Templates_Main.jpg" /> Templates Editor

The Templates Editor offers multiple options:
...
* *Add label*: Select to add a label. Labeling templates help organize and search them easily. 
* *Delete*: Select to delete the template. A template deleted from the template gallery will not affect the templates in a running campaign. 
...
1. Navigate to *Content > Content Manager > Messaging Channel > Templates*.
...
* *Time Period*: Filter and search by the period when the template was created.
...
### Email Templates
 ...
 You add content to pre-built templates or customize and build your templates. To create a new template with drag-and-drop elements, refer to [drag and drop templates](doc:email-editor-templates#drag-and-drop-template). You can also create a template from the HTML editor with a Rich Media template. For more information, refer to [Source HTML Editor](doc:email-editor-templates#using-source-mode).