...
excerpt: Learn how to use CleverTap's Content Manager.
deprecated: false
hidden: false
metadata:
  title: ''
...
> 📘 Private Beta
> 
> Currently, this feature is a Private Beta Release. To access this feature, contact your Account Manager.
...
The Content Manager allows controlling template access via a [role-based access](https://docs.clevertap.com/docs/role-based-access-control).  It offers the following benefits:
