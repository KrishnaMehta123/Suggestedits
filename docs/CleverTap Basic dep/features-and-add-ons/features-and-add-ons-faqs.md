...
Consider the following FAQs on CleverTap for Startups features and add-ons:
...
CleverTap integrates with all attribution partners, such as Appsflyer, Branch etc., to track app installations, measure attribution with third-party sources, and view reports in the CleverTap Dashboard. Check out the complete list of attribution partners [here](https://docs.clevertap.com/docs/attribution).

## Does CleverTap have a feature to analyze the time spent per user daily?

CleverTap doesn’t have a usage time tracking mechanism. However, Session Analytics can track users' events within a session. A session is a period of continuous activity by the user. Analyzing session length is a great way to measure engagement for certain apps, such as video or music streaming, news, etc. For more details, refer [here](https://docs.clevertap.com/docs/session-analytics).
