...
For more information about how billing works for Monthly Active Users in CleverTap Basic, refer to [Billing for Monthly Active Users](https://docs.clevertap.com/docs/billing#billing-for-monthly-active-users).
