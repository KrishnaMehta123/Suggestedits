...
<Image title="Analytics_Session_Distribution.png" alt={947} className="border" width="100%" border={true} src="https://files.readme.io/c85d6ed-Analytics_Session_Distribution.png" />
