...
>
> To view *Real Impact* performance metrics, you need to enable a system control group for your account; this system control group is an account-level categorization of profiles that will never receive any of your campaigns. For more information, refer to [Control Groups](doc:control-groups).
>
...
<Image title="Click Revenue Per User and Select the Options" alt={1216} align="center" border={true} src="https://files.readme.io/af4e987-Screenshot_2019-03-13_at_9.23.03_PM.png">
  View Real Impact
</Image>
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Indicates how many users come back to your product to perform a set of actions based on your marketing efforts over a given period. For example, what percentage of users who made a purchase came back for a repeat purchase in the last 30 days?
      </td>
    ...
    <tr>
      ...
      <td>
        Measures the real impact of your campaigns on a target group for a conversion event. This metric tells you what percentage of target group users converted on your product as compared to the conversion rate of control group users.
      </td>

      <td>
        Similar to [Funnels](doc:funnels).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Select an event used to calculate the accumulated revenue for a particular day and its corresponding property used to identify active users (App Launched).  This metric helps compare the average revenue per user in the target group who received campaigns and the control group who did not receive campaigns for a particular period of time.  
      ...
      <td>
        Total revenue for the selected period / Active user for the same period
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        This *Real Impact* metric gives a boost in the health score of the target group based on recency, frequency, and monetary parameters.  

        For example, what is the RFM health score for all users who launched an app and made a purchase in the last 30 days?
      </td>

      <td>
        Refer to [RFM Score](https://docs.clevertap.com/docs/real_impact#section-rfm-score) below.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Increases/decreases the percentage of users in each of RFM sub-segments from two consecutive date ranges.
      </td>
    ...
    <tr>
      ...
      <td>
        Views user's movements from one sub-segment to another.
      </td>
    ...
    <tr>
      ...
      <td>
        Tracks how recently target users visited your product in the last 30 days as compared to the control group.
      </td>
...
For a deeper understanding of how to leverage customer segmentation effectively, check this [RFM Analysis blog](https://clevertap.com/blog/rfm-analysis/) that explores how RFM scoring can drive impactful engagement strategies and business outcomes.
...
To gain more insights into user behavior over time, our [Cohort Analysis blog](https://clevertap.com/blog/cohort-analysis/) offers strategies to track and enhance user engagement effectively.​
