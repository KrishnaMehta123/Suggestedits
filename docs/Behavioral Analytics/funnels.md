...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/505951f-Analytics_Funnels_Create.png",
        "Analytics_Funnels_Create.png",
        1187,
        914,
        "#f6f7f9"
      ],
...
{
  "type": "info",
  "body": "You can drag and drop to re-arrange the steps in a funnel.",
  "title": "Note"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d0dd43c-Analytics_Funnels_steps_rearrange.gif",
        "Analytics_Funnels_steps_rearrange.gif",
        920,
        569,
        "#f7f8f8"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/012fee4-Analytics_Funnels_Compare_Segments_Search.png",
        "Analytics_Funnels_Compare_Segments_Search.png",
        1163,
        1571,
        "#f9f9fb"
      ],
  ...
  "images": [
    {
      ...
      "border": true,
      "caption": "Breakdown by User Property",
      "sizing": "full"
    }
  ]
}
  ...
  "images": [
    {
      ...
      "caption": "Breakdown by Event Property",
      "border": true
    }
  ]
}
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cc17fa1-Analytics_Funnels_hold_property.png",
        "Analytics_Funnels_hold_property.png",
        1174,
        820,
        "#f0f0e3"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a850a6e-image3.png",
        "image3.png",
        1650,
        322,
        "#fafbf8"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/80345c6-Analytics_Funnels_Table_view.png",
        "Analytics_Funnels_Table_view.png",
        1186,
        1311,
        "#f2f2ea"
      ],
...
[block:callout]
{
  ...
  "title": "Frequency Chart Considerations"
}
[/block]
# Bookmarks
  ...
  "images": [
    {
      ...
      "border": true,
      "caption": "Create Segment/Campaign for dropoffs"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "border": true,
      "caption": "Create Segment/Campaign for converted users"
    }
  ]
}
[/block]