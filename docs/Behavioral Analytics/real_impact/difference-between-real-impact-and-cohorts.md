...
next:
  description: ''
---
@DOCS NOTES: REAL IMPACT SECTION CAME DIRECTLY FROM THE EXISTING USER DOC [https://docs.clevertap.com/docs/real\_impact#section-overview](https://docs.clevertap.com/docs/real_impact#section-overview) 
