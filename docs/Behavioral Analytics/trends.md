...
{
  "type": "info",
  "body": "The advanced filter is a general feature available for all analytics features and most campaigns. Read more in the [Segments](doc:segments) guide.",
  "title": "Feature Availabilities"
}
[/block]
#Add Trends
...
[block:callout]
{
  "type": "info",
  "title": "Note",
  "body": "You can add up to five events for analysis."
}
[/block]
4. Click **View trend**. 
[block:image]
  ...
  "images": [
    {
      "image": [
        ...
        "Trends_Split_by_Event_Property_Results_Edit.png",
        1185,
        645,
        "#f9f8f9"
      ]
...
[block:callout]
{
  "type": "info",
  "title": "Maximum Split",
  "body": "You can split by a maximum of three event properties per event."
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Clean-Trends_Split_By_User_Property.png",
        1186,
        713,
        "#f8f9fa"
      ]
...
[block:callout]
{
  "type": "info",
  "title": "Maximum Split",
  "body": "You can split by a maximum of two user properties."
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Clean-Trends_Formula_Select_Events.png",
        1164,
        1057,
        "#f8f8fa"
      ]
  ...
  "images": [
    {
      "image": [
        ...
        "Clean-Trends_Formula_Select_Events_Create_formula.png",
        1164,
        978,
        "#fafbfc"
      ]
...
{
  "type": "info",
  "body": "You can compare up to four formulas together on the same chart by adding a “;” between the formulas.",
  "title": "Compare up to Four Formulas"
}
[/block]
...
[block:callout]
{
  ...
  "body": "A function must always be uppercase such as *TOTALS* instead of *Totals*."
}
[/block]
...
[block:callout]
{
  "type": "warning",
  "title": "Always Uppercase",
  "body": "A function must always have uppercase such as *PROPSUM* instead of *PropSum*. An event must be summarized by event property for a property level function."
}
[/block]
##Operators
