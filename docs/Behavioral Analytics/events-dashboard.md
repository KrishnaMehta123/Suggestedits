---
title: Events Dashboard (Deprecated)
excerpt: ''
deprecated: false
hidden: true
metadata:
...
<Image title="events-1.png" alt={1255} className="border" border={true} src="https://files.readme.io/cb41835-events-1.png" />
...
<Image title="image3.png" alt={1999} className="border" border={true} src="https://files.readme.io/f215589-image3.png" />
...
<Image title="flows4.png" alt={1231} className="border" border={true} src="https://files.readme.io/ab28f10-flows4.png" />
