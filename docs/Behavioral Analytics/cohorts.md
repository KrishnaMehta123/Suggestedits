...
{
  "type": "info",
  "body": "This feature is available in the insights add-on.",
  "title": "Note"
}
[/block]
## Advanced Filtering
...
{
  "type": "info",
  "title": "Consideration in Cohorts",
  "body": "Any event is not actionable in *Cohorts*. This feature is available in the insights add-on."
}
[/block]
## Use Cases
