...
[block:callout]
{
  "type": "info",
  "title": "Testing Tip",
  "body": "You can test your product features or offerings with [Product Experiences](https://docs.clevertap.com/docs/product-experiences), then come back to check the power user curve. This gives you a more comprehensive understanding of your user reactions before you roll them out to your most coveted users."
}
[/block]
...
{
  "type": "info",
  "title": "Closed Beta Only and Consideration",
  "body": "This feature is only available in closed beta. In the meantime, you can check this feature in our demo account.\n\nAlso, creating a campaign or segment is not supported for this cohort."
}
[/block]
###Unbounded
...
{
  "type": "info",
  "body": "Advanced filters is a general feature available for all analytics features and most campaigns. Read more in [Segments](doc:segments).",
...
[block:callout]
{
  "type": "info",
  "title": "Closed Beta Only and Consideration",
  "body": "This feature is only available in closed beta. In the meantime, you can check this feature in our demo account.\n\nAlso, any event is not actionable in *Cohorts*."
}
[/block]