...
<Image title="1 Create a cohort.png" alt={518} className="border" border={true} src="https://files.readme.io/fe19aa1-1_Create_a_cohort.png" />
...
<Image title="2 Compare to another segment.png" alt={1045} className="border" width="100%" border={true} src="https://files.readme.io/613c811-2_Compare_to_another_segment.png" />
...
<Image title="Analytics_Cohorts_power_users_Create.png" alt={810} className="border" width="80%" border={true} src="https://files.readme.io/c26b706-Analytics_Cohorts_power_users_Create.png" />
...
<Image title="Analytics_Cohorts_power_users_result.png" alt={810} className="border" width="80%" border={true} src="https://files.readme.io/1d73647-Analytics_Cohorts_power_users_result.png" />
