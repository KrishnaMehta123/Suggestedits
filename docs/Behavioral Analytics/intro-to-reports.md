...
![1669](https://files.readme.io/053f126-230af12-Analytics_View_Today.png "230af12-Analytics_View_Today.png")
...
![1692](https://files.readme.io/6432ca7-aeaf6da-Analytics_View_Mobile.png "aeaf6da-Analytics_View_Mobile.png")
...
![1719](https://files.readme.io/f30578e-f469e26-Analytics_View_Uninstall.png "f469e26-Analytics_View_Uninstall.png")

## Revenue View

The [Revenue View](doc:revenue-view) tracks customer purchases.

![1698](https://files.readme.io/fbd8876-d2d91ec-Analytics_View_Revenue.png "d2d91ec-Analytics_View_Revenue.png")
...
<Image title="Analytics_Funnels_breakdown_by_event_property.png" alt={1179} className="border" border={true} src="https://files.readme.io/2ffa269-Analytics_Funnels_breakdown_by_event_property.png" />

For more information, see the [Funnels page](doc:funnels).
...
<Image title="Cohorts_retention_Hourly.png" alt={1178} className="border" border={true} src="https://files.readme.io/0207f19-Cohorts_retention_Hourly.png" />

For more information, please visit the [Cohorts page](doc:cohorts).
...
<Image title="Trends_Filter_By_Event_Property_Result1.png" alt={1151} className="border" border={true} src="https://files.readme.io/ba50e35-Trends_Filter_By_Event_Property_Result1.png" />

For more information, please visit the [Trends page](doc:trends).
...
<Image title="Pivots_Main.png" alt={1164} className="border" border={true} src="https://files.readme.io/7aa01be-Pivots_Main.png" />

For more information, please visit the [Pivots page](doc:pivots).
...
<Image title="Analytics_Flows_Main.png" alt={1175} className="border" border={true} src="https://files.readme.io/1c907c6-Analytics_Flows_Main.png" />

For more information, please visit the [Flows page](doc:flows).
