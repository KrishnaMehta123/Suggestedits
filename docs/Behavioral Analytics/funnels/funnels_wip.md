...
<Image title="1 Funnels - select event properties.png" alt={1403} align="center" className="border" border={true} src="https://files.readme.io/833a1d8-1_Funnels_-_select_event_properties.png" />
...
<Image title="Analytics_Funnels_Conversion_window.png" alt={888} align="center" className="border" border={true} src="https://files.readme.io/c1e68ec-Analytics_Funnels_Conversion_window.png" />
...
<Image title="2 Analytics_Funnels_Compare_Segments_Search.png" alt={1165} align="center" className="border" width="100%" border={true} src="https://files.readme.io/7f9ed1b-2_Analytics_Funnels_Compare_Segments_Search.png" />

The results are displayed.

<Image title="Analytics_Funnels_Compare_Segments_Search_Results.png" alt={1155} align="center" className="border" width="100%" border={true} src="https://files.readme.io/eb0e3a1-Analytics_Funnels_Compare_Segments_Search_Results.png" />
...
<Image title="image8.png" alt={1999} align="center" className="border" border={true} src="https://files.readme.io/ff2abce-image8.png" />
...
<Image title="Analytics_Funnels_breakdown_by_profile_property.png" alt={1208} align="center" className="border" width="100%" border={true} src="https://files.readme.io/3b40dbd-Analytics_Funnels_breakdown_by_profile_property.png" />

<Image title="Analytics_Funnels_breakdown_by_event_property.png" alt={1179} align="center" className="border" border={true} src="https://files.readme.io/56000b3-Analytics_Funnels_breakdown_by_event_property.png" />
...
<Image title="3-Analytics_Funnels_hold_property.png" alt={1174} align="center" className="border" border={true} src="https://files.readme.io/b7b281f-3-Analytics_Funnels_hold_property.png" />
...
> 🚧 Charged Event
>
> Hold property constant is not supported for the *Items array* for the **Charged** event when creating funnels.
...
<Image title="image5.png" alt={1999} align="center" className="border" border={true} src="https://files.readme.io/c7cf6b2-image5.png" />

The absolute trend graph shows you the spike in conversions within the first minute where 44% of users convert.

<Image title="image6.png" alt={1999} align="center" className="border" border={true} src="https://files.readme.io/296c6e0-image6.png" />
...
<Image title="image1.png" alt={1999} align="center" className="border" border={true} src="https://files.readme.io/80237b3-image1.png" />
...
<Image title="4 Enforce strict order.png" alt={207} align="center" className="border" border={true} src="https://files.readme.io/18a3234-4_Enforce_strict_order.png" />

# Table View

You can also view the funnel information in a table. 

<Image title="5-Analytics_Funnels_Table_view.png" alt={1186} align="center" className="border" width="100%" border={true} src="https://files.readme.io/4cc5ae9-5-Analytics_Funnels_Table_view.png" />
...
<Image title="Analytics_Funnels_Frequency.png" alt={1201} align="center" className="border" border={true} src="https://files.readme.io/4b27769-Analytics_Funnels_Frequency.png" />
...
<Image title="actionable-funnel-1.png" alt={1111} align="center" className="border" border={true} src="https://files.readme.io/6e87501-actionable-funnel-1.png" />

<Image title="actionable-funnel-2.png" alt={1110} align="center" className="border" border={true} src="https://files.readme.io/01d142e-actionable-funnel-2.png" />
...
<Image title="actionable-funnels-3.png" alt={1108} align="center" className="border" border={true} src="https://files.readme.io/3013112-actionable-funnels-3.png" />
