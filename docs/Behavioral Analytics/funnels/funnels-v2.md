...
1. Go to *Analytics* > *Funnels Beta*. 
...
<Image alt="Create a Funnel " align="center" width="50% " border={true} src="https://files.readme.io/83e833954c171c8e655df786784d081f722d5b0aca7590b1322027f72b9ba95c-image.png">
  Create a Funnel 
</Image>
...
<Image alt="Select Multiple Events" align="center" width="60% " border={true} src="https://files.readme.io/4bb245c3bd7e1c55d271354270052226658bf057accf2ee77e3a683657255db8-image.png">
...
3. Under the *Metric* section, select the Conversion window.
...
<Image alt="Set Conversion Window" align="center" width="70% " border={true} src="https://files.readme.io/d4b4a9c1425395ea28c7160e36f5036b4fbe26aa9060cf40d643bc2166e122df-image.png">
  Set Conversion Window
</Image>

## Compare by Segments

You can compare your conversions across different segments \[to analyze..}. For example, compare the funnel for *App Launched* > *Product Viewed* > *Charged* across the *All Users* and the *Engaged Users* segments. The differences in the conversion trends could reveal differences in your users' behavior in each segment and result in invaluable insight. 
...
<Image alt="Segment Comparison Results" align="center" border={true} src="https://files.readme.io/e9b8925214cf689ea3b18dce80dab48b64854c033f93eb6f3616c02eaa540eeb-image.png">
...
The default view shows cumulative conversions per step for the selected time range. It can be viewed as an absolute count of users completing each step or a percentage. \{any more insights on how to read funnel charts, I want to mark this chart with numbers and explain various info/observation points to the users.}

<Image alt="Funnel Charts" align="center" border={true} src="https://files.readme.io/004bcc51afc2a74579c288ffc3915fe73e0e85963c02da2f961c6939f8e346e0-image.png">
  Funnel Charts
</Image>

## Split by Property

You can split a funnel by profile properties for sessions, geographies, and technographics or by an event property associated with any event. This lets you compare your conversion across product categories, geographies, devices, and more. 
...
<Image alt="Split funnel by event property" align="center" src="https://files.readme.io/765e14575db123f3fbf0d28e7c1d8174c0ad9e4c4ccdbbecccbbfcea3c41dfc9-image.png">
  Split Funnel by Event Property
</Image>

<Image alt="Split Funnel by User Property" align="center" border={true} src="https://files.readme.io/43c847997049c7db2488cb2a08c2417a6fb9d37029765d8251a0f280e2022e1b-image.png">
...
<Image alt="Table view in funnels" align="center" border={true} src="https://files.readme.io/1168404ff665e17b95e472aa0d4c35eb1537a2129529fb9b7b92f6aac07f3f91-image.png">
...
Bookmarks are especially useful for tracking frequently accessed conversion journeys. For example, if you regularly monitor funnel steps such as *App Launched* > *Product Viewed* >  *Charged*, bookmarking it lets you instantly return to the same setup without recreating the funnel each time.
...
> 📘 **Note**
>
> Funnels are accessible only to the user who created them. You can access all your saved bookmarks from the bookmark list under the *Funnels* section.
