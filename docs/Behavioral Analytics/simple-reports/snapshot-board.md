...
Snapshot view is a combination of the Today, Mobile App, and Uninstall board. It provides a quick view of mobile app usage, active users, and engaged users across all platforms (Android, iOS, and Web). 
...
This view shows detailed metrics for *Active Users* and *New vs Returning Users* across platforms.
