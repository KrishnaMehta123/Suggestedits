...
<Image title="2020-06-08_16-02-09_Mobile View.png" alt={1692} className="border" border={true} src="https://files.readme.io/bc2c89e-2020-06-08_16-02-09_Mobile_View.png" />
...
* Daily Paying Users, Weekly Paying Users, and Monthly Paying Users represent users for whom you’ve raised the Charged event (or users qualifying as per the conversion event) at least once during the relevant time period.
...
* Daily Active Users/Monthly Active Users(DAU/MAU(%)) aka Sticky Quotient which represents the percentage of your monthly active users who visit your application daily i.e. how many of your active users are very active users.

# Video Tutorial

<HTMLBlock>{`
<div><iframe width="560" height="315" src="https://www.youtube.com/embed/y0YYMTCkvPU?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>
