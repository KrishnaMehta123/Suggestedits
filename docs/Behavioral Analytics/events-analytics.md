...
excerpt: Understand how to analyze events from CleverTap dashboard.
deprecated: false
hidden: false
metadata:
  title: ''
...
The _Quick View_ displays all the basic details such as the number of events, the number of profiles, demographics, and sample profiles.
