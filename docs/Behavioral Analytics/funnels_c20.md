...
{
  "type": "info",
  "body": "Advanced filters is a general feature available for all analytics features and most campaigns. For more information, refer to [Segments](doc:segments).",
