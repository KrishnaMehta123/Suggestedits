...
2. Select event properties for each event to constrain the analysis for the users who performed that event/property combination.camp

<Image title="1 Funnels - select event properties.png" alt={1403} className="border" border={true} src="https://files.readme.io/833a1d8-1_Funnels_-_select_event_properties.png" />
...
3. Select the *Compare to another segment* box. Select a segment from the list or create an ad-hoc segment. For more information, refer to [Segments](https://docs.clevertap.com/docs/segments_c20).
4. Click **View Funnel**.

<Image title="2 Analytics_Funnels_Compare_Segments_Search.png" alt={1165} className="border" width="100%" border={true} src="https://files.readme.io/7f9ed1b-2_Analytics_Funnels_Compare_Segments_Search.png" />
...
<Image title="Analytics_Funnels_breakdown_by_profile_property.png" alt={1208} className="border" width="100%" border={true} src="https://files.readme.io/3b40dbd-Analytics_Funnels_breakdown_by_profile_property.png" />

<Image title="Analytics_Funnels_breakdown_by_event_property.png" alt={1179} className="border" border={true} src="https://files.readme.io/56000b3-Analytics_Funnels_breakdown_by_event_property.png" />
...
<Image title="3-Analytics_Funnels_hold_property.png" alt={1174} className="border" border={true} src="https://files.readme.io/b7b281f-3-Analytics_Funnels_hold_property.png" />
...
Conversion time helps you understand how long it takes the majority of your users to progress between steps in your funnel. In turn, this can be used as a basis for sending engagement [campaigns](https://docs.clevertap.com/docs/intro-to-campaigns_c20) timed to reach users who *do not* convert within the time the majority of your users convert. 
...
<Image title="4 Enforce strict order.png" alt={207} className="border" border={true} src="https://files.readme.io/18a3234-4_Enforce_strict_order.png" />

# Table View

You can also view the funnel information in a table. 

<Image title="5-Analytics_Funnels_Table_view.png" alt={1186} className="border" width="100%" border={true} src="https://files.readme.io/4cc5ae9-5-Analytics_Funnels_Table_view.png" />
