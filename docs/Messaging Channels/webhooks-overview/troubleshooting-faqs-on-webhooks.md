...
* You may receive the payload at your endpoint but not send a "200 OK" response to the CleverTap server within the timeout frame of 3 seconds. CleverTap displays a *Webhook Dispatched Failed* error in this case.
