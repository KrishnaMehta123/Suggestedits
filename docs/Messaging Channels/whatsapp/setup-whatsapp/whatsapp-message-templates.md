...
5. Enter the _Template Name_, and configure headers and body as follows:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4cd7836-WhatsApp_Templates.png",
        "",
        "Carousel Template"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a1b4e98-Send_Test.png",
        "",
        "Select Send Test"
      ],
      "align": "center",
