...
5. Enter the *Template Name*, and configure headers and body as follows:
...
<Image alt="Carousel Template" align="center" border={true} src="https://files.readme.io/4cd7836-WhatsApp_Templates.png">
  Carousel Template
</Image>
...
<Image alt="Template Overview" align="center" width="45% " border={true} src="https://files.readme.io/dc49e19-overview.png">
  Template Overview
</Image>
...
<Image alt="Select Send Test" align="center" width="50% " border={true} src="https://files.readme.io/a1b4e98-Send_Test.png">
  Select Send Test
</Image>
...
A. Yes, emojis can be used in template messages to add a more expressive and engaging element to the content. You can copy the emojis from [emojipedia](https://emojipedia.org/most-popular).
