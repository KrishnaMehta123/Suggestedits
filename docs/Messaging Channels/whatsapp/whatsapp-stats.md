...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7a7a202-WhatsApp_callbacks.png",
        null,
        "Whatsapp Display Flow"
      ],
      "align": "center",
      "border": true,
      "caption": "Whatsapp Display Flow"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6edfe62-WhatsApp_Stats.png",
        null,
        "WhatsApp Stats"
      ],
      "align": "center",
      "border": true,
      "caption": "WhatsApp Stats"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8569d3b-Whatsapp_campaigg_filter.jpg",
        null,
        "Campaign Filter"
      ],
      "align": "center",
      "border": true,
      "caption": "Campaign Filters"
    }
  ]
}
[/block]
...
1. Search for a campaign from the _All Campaign_ page by _api request_ (search by ) or _server_api_messaging channel_ (search by identity).
2. Click **Apply**. 
...
WhatsApp Notifications are marked as **Sent** in CleverTap only if the notification/message API request is accepted by the customer's WhatsApp provider; else, the notifications are considered dispatch errors. The _Sent_ event count in campaign stats explains the number of notifications successfully sent to WhatsApp providers.  
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/19b2cab-small-whatsapp_message_trend.png",
        null,
        "WhatsApp Message Trend"
      ],
      "align": "center",
      "border": true,
      "caption": "WhatsApp Message Trend"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/26eecaa-small-whatsapp_graph_conversion_performance.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/12b9490-revenue_performance.png",
        null,
        "WhatsApp Revenue Performance"
      ],
      "align": "center",
      "border": true,
      "caption": "WhatsApp Revenue Performance"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/583e4e2-funnel_conversion_whatsapp_stats.png",
        null,
        "WhatsApp Users Conversion Funnel"
      ],
      "align": "center",
      "border": true,
      "caption": "WhatsApp Users Conversion Funnel"
    }
  ]
}
[/block]
...
You can view the details of users who clicked on your WhatsApp campaign using the _View details of users who clicked link_ present on the _Split of Clicks_ tab. You are redirected to the _Events_ page. Click the _People_ tab on this page to view the user details.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/46242e522acba64f3b3e09b5895ba283fd4b170d26a84a2bffba2f6a51b18990-image_2.png",
        null,
        "Error Types"
      ],
      "align": "center",
      "border": true,
      "caption": "Error in WhatsApp Campaign"
    }
  ]
}
[/block]
