...
{
  "type": "info",
  "body": "You can create Linked Content using Liquid Tags. Therefore, before we begin, familiarize yourself with writing [Liquid Tags](https://docs.clevertap.com/docs/liquid-tags).",
  "title": "Note"
}
[/block]
