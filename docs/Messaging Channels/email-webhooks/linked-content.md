...
> 📘 Note
>
> You can create Linked Content using Liquid Tags. Therefore, before we begin, familiarize yourself with writing [Liquid Tags](https://docs.clevertap.com/docs/liquid-tags).
...
<Image title="Dynamic_Content_API.png" alt={1192} width="smart" src="https://files.readme.io/8174ccf-Dynamic_Content_API.png" />
