...
These segments can be created on the basis of a user: 

1. Performing a specific action on one of your web pages. 
2. Visiting one of your specific web pages.
3. Visiting your website via an external ad referral, or even based on the count of web pages a user has visited so far. 
