...
<Image title="Web popup A:B test.png" alt={2326} className="border" border={true} src="https://files.readme.io/561e7ef-Web_popup_AB_test.png" />
...
<Image title="pop-up slit delivery.png" alt={2344} className="border" border={true} src="https://files.readme.io/b3026b1-pop-up_slit_delivery.png" />
...
![2320](https://files.readme.io/3d9b2da-hindi_sale.png "hindi sale.png")
...
<Image title="all templates.png" alt={1726} className="border" border={true} src="https://files.readme.io/bfdf7b0-all_templates.png" />
...
<Image title="custom html click tracking web popup.png" alt={1510} className="border" border={true} src="https://files.readme.io/76d8b12-custom_html_click_tracking_web_popup.png" />
...
<Image title="wp2.png" alt={1848} className="border" width="auto" border={true} src="https://files.readme.io/1d8fb30-wp2.png" />

3. Set the *Priority* as per your choice and click **Save**.

<Image title="WP2.png" alt={1780} className="border" width="80%" border={true} src="https://files.readme.io/02664d2-WP2.png" />
