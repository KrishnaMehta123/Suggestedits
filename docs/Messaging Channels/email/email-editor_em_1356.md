...
<Image title="email_editor_rows_edit_clone_delete.gif" alt={1164} className="border" border={true} src="https://files.readme.io/67215bf-email_editor_rows_edit_clone_delete.gif" />
...
<Image title="email_editor_rows_delete.png" alt={1306} className="border" border={true} src="https://files.readme.io/eeae8e5-email_editor_rows_delete.png" />
...
![1096](https://files.readme.io/bb4fe41-email_editor_mobile_view.gif "email_editor_mobile_view.gif")
...
<Image title="Select the template.png" alt={2866} className="border" border={true} src="https://files.readme.io/fc1d8a8-Select_the_template.png" />

2. Draft your message.

<Image title="Create message.png" alt={2880} className="border" border={true} src="https://files.readme.io/2e30dbe-Create_message.png" />
...
<Image title="Dark Mode Preview.gif" alt={1440} className="border" border={true} src="https://files.readme.io/c6ed33f-Dark_Mode_Preview.gif" />

You can also preview how the AMP email will look in dark mode with the same *Dark Mode* toggle.

![1420](https://files.readme.io/e72723d-AMP_Dark_Mode_Preview.png "AMP Dark Mode Preview.png")

> 📘 AMP Preview
>
> This is only available in case AMP is enabled for your account.

> 📘 Dark Mode Preview
>
> Dark Mode support varies across email clients and devices. Test the emails on an email client with dark mode enabled for best results. The Dark Mode preview generates a generic dark mode color scheme when enabled.
>
