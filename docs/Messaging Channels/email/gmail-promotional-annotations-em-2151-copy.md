...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/48a2d0f-image.png",
        null,
        "@Shreejith, the image will be updated with the one from Dashboard"
      ],
      "align": "center",
      "sizing": "-30px",
      "border": true,
...
[block:parameters]
{
  "data": {
    ...
    "2-1": "Provide the specific URL that opens when the user clicks on the promotional image.  \nTrack user engagement by using the **Notification Clicked** event, capturing the _Target Image URL_ value in the **wzrk_c2a** event property for performance evaluation.",
    "3-0": "_Headline_",
...
Ans. You should be able to track clicks on the images in the carousel through the **Notification Clicked** event and the value entered in the **Promo_URL”**should be tracked in the **wzrk_c2a** event property.
