...
1. **Open Campaign**: Click on the campaign to view its details. The _Stats_ tab will display key metrics, including Sent, Viewed, Clicks, CTR, and Converted Users.

2. **Navigate to Link Clicks**: Go to the _Link Clicks_ section. By default, the heat map will show the total number of clicks for each link in the email.
...
7. **View User Details**: Click on _View User Details_ to access the _Events_ page under _Analytics_.
