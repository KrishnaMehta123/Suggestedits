...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c9ee983-Email_Editor.png",
...
You can choose between pre-built or empty templates under _Basic Templates_. You can also save customized templates and view them under **Saved Templates**. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/60317ea-Search_Template.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bb8dfbc-Email_Editor_-_Liquid_Tags.gif",
        "",
        "Email Editor Display Condition"
      ],
      "align": "center",
      "border": true,
      "caption": "Email Editor Display Condition"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3c269b6-Search_Saved_Template.gif",
        null,
        "Search a Template"
      ],
      "align": "center",
...
| :------------------ | :--------------------------------------------------------------------------------------------------------------- |
| Type                | Select from the following options to filter templates by their type: _Select All_,  _HTML_,  and _Drag and Drop_ |
...
| Show only AMP Email | Toggle _Show only AMP Email_ option to display only AMP templates.                                               |
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/194af74-Filter_Saved_Templates_-_Amp_Email.gif",
        null,
