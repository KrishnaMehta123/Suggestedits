...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f551881-Navigate_to_All_Journeys_page.png",
        "Navigate to All Journeys page.png",
        2832
      ],
      "align": "center",
      "border": true,
...
2. Define the Entry Segment. In this case, it would be a past behavior segment that will users who received the email campaigns in the last 7 months but did not view them in the last 5 months. In the following figure, Campaign type _2_ refers to the Email campaign.  
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4f28294-Multiple_Email_Campaigns_Scheduled_at_Specific_Intervals.png",
        "Multiple Email Campaigns Scheduled at Specific Intervals.png",
        2540
      ],
      "align": "center",
      "border": true,
