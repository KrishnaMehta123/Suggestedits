...
After identifying the inactive user base, [create a Past Behavior Segment](doc:segments#create-segments) of these users.
...
<Image title="Navigate to All Journeys page.png" alt={2832} align="center" border={true} src="https://files.readme.io/f551881-Navigate_to_All_Journeys_page.png">
...
2. Define the Entry Segment. In this case, it would be a past behavior segment that will users who received the email campaigns in the last 7 months but did not view them in the last 5 months. In the following figure, Campaign type *2* refers to the Email campaign.  
...
<Image title="Multiple Email Campaigns Scheduled at Specific Intervals.png" alt={2540} align="center" border={true} src="https://files.readme.io/4f28294-Multiple_Email_Campaigns_Scheduled_at_Specific_Intervals.png">
...
2. Define the setup for your journey as shown in the following figure: @amrita Journey timeout duration need not be highlighted 
