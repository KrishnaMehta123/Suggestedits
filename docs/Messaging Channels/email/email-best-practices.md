...
* When introducing a new segment, gradually increase the sending volume according to [CleverTap's warm-up schedule](doc:ip-warmup). Where applicable, leverage the *Best Time* feature to send emails when users are most likely to engage.
