...
* Sent: Displays the total number of emails sent. This count excludes the count of emails sent to CC and BCC recipients.
* Viewed: Displays the open percentage for your message, which is calculated as (Viewed/Sent\*100). It also shows the total number of emails opened. The views of CC/BCC recipients will be attributed to the main recipient.
...
* Clicks: Displays the percentage of clicks from the total sent messages. It is calculated as [(Clicks/Sent)*100]. It also shows the number of clicks on the emails. The clicks of CC/BCC recipients will be attributed to the main recipient.
