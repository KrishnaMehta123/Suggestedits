...
1. Go to _Settings > Channels > Email > Advance Setup page_ to add a new Global Link Parameter.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/20c642d-Auto_append_setup.png",
        "",
        "Advance Setup"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/42965ba-Auto_append_2.png",
        "",
        "Add Link Parameters"
      ],
      "align": "center",
      "border": true,
      "caption": "Add Link Parameters"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9340454-Auto_append_add_link.png",
        "",
        "Pair Key Value"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/17a6663-2024-08-15_10-59-58_1.gif",
        "",
        "Enable Global Link Parameters"
      ],
      "align": "center",
      "border": true,
      "caption": "Enable Global Link Parameters"
    }
  ]
}
[/block]
...
1. Go to the _Campaigns_ page, click **+ Campaign**, and select _Email_ from the messaging channel list.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c039949-Auto_append_campaign.png",
        "",
        "Email Campaign"
      ],
      "align": "center",
      "border": true,
      "caption": "Email Campaign"
    }
  ]
}
[/block]
...
3. Go to _Sender Details_ under the _What_ section after drafting an email campaign.
4. Select _Global link parameters_ to append the parameters to the links included in the campaign. After you select this option, all the parameters set up in Step 1 are visible. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b5fa54d-2024-08-15_21-57-13_1.gif",
        "",
        "Global Link Parameters"
      ],
      "align": "center",
      "border": true,
      "caption": "Global Link Parameters"
    }
  ]
}
[/block]
...
5. Select _Custom link parameters_ if you want to add your custom parameters: 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/368c1e981d363709869c836732c7d58925260af27d4fc34b81ae28308d826c9f-Add_Custom_Link_Parameters.png",
        "",
        ""
      ],
      "align": "center",
...
6. Publish the Email campaign. The links used in the Email are appended with the selected global and/or custom link parameters for efficient tracking. The indicative order of parameters appended to the URL is displayed in the Link Parameters field under the _Sender Details_ tab on the left. The Parameters are appended in a top-to-bottom sequence, meaning the parameter at the top of the list is added to the URL first, followed by those listed below.

   [block:image]{"images":[{"image":["https://files.readme.io/ebb6ed41de44b15af8ac55f7fe5d8e4fe3acb4a45fa7300b83b3f611a1e9c2ab-Preview_Links_Appended_to_URL.png","","Preview Order of Parameters Appended to URLs"],"align":"center","border":true,"caption":"Preview Order of Parameters Appended to URLs"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9ac7f2c-auto_append_6.png",
        "",
        "Global Link Parameters Navigations"
      ],
      "align": "center",
      "border": true,
      "caption": "Manage Global Link Parameters"
    }
  ]
}
[/block]