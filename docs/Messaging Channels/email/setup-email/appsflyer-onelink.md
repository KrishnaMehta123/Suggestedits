...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5bd0865ba24a91d4298f625a073fb35f3791c867732fd591f9265d7a01f25808-Delete_OneLink_URL.gif",
        "",
        "Delete OneLink URLs from CleverTap Dashboard"
      ],
      "align": "center",
      "border": true,
      "caption": "Delete OneLink URLs from CleverTap Dashboard"
    }
  ]
}
[/block]
...
- **For iOS**: Configure the SDK to support an Apple App Site Association (AASA) file, enabling [Universal Linking](https://support.appsflyer.com/hc/en-us/articles/360000732237#universal-links) from the email message to your app. To do so:
  ...
  2. Toggle ON _Associated Domains_ and click + (plus), enter your click domain. For example,\<applinks:click.example.com>.
     ...
     [block:image]{"images":[{"image":["https://files.readme.io/78a28ba-image.png",null,"Configure SDK to Support an AASA file"],"align":"center","border":true,"caption":"Configure SDK to Support an AASA file"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c369366c65ef36c5bb45731970b9708de32258a73f3b8ddf5274d5aff566e4a0-image.png",
        null,
      ...
      "sizing": "25% ",
      "border": true,
      "caption": "Integrate ESP with AppsFlyer dashboard"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/aadba290bf5d1b3ec157261e5c806258bb316d2ffe20041fc744decb9d0302c4-image.png",
        null,
      ...
      "sizing": "65% ",
      "border": true,
      "caption": "Select your ESP for Setting Up Integration"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7a9b929e9bd48ffd35a01a3ca7c67d231e310460dd94f336df9c82cb0910351e-image.png",
        null,
      ...
      "sizing": "50% ",
      "border": true,
      "caption": "Select OneLink Template"
    }
  ]
}
[/block]
...
4. Click **Next**.
5. Enter the click tracking domain (for example, [click.example.com](click.yourdomain.com)) and CleverTap server endpoint. To know the server endpoint for your region, refer to the following table:

   | Region            | CleverTap Server Endpoint                                | CleverTap Dashboard URL                             |
   | :---------------- | :------------------------------------------------------- | :-------------------------------------------------- |
   | Europe            | [wizrocketmail.net](https://wizrocketmail.net)           | <https://eu1.dashboard.clevertap.com/login.html>    |
   | India             | [in1.wizrocketmail.net](https://in1.wizrocketmail.net)   | <https://in1.dashboard.clevertap.com/login.html>    |
   | Singapore         | [sg1.wizrocketmail.net](https://sg1.wizrocketmail.net)   | <https://sg1.dashboard.clevertap.com/login.html#/>  |
   | United States     | [us1.wizrocketmail.net](https://us1.wizrocketmail.net)   | <https://us1.dashboard.clevertap.com/login.html#/>  |
   | Middle East (UAE) | [mec1.wizrocketmail.net](http://mec1.wizrocketmail.net)  | <https://mec1.dashboard.clevertap.com/login.html#/> |
   | Indonesia         | [aps3.wizrocketmail.net](https://aps3.wizrocketmail.net) | <https://aps3.dashboard.clevertap.com/login.html#/> |
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/89cb63c61b53a0f825c45665d642074de3cbd7d9e9fac7674e99dd78f279ba9a-Enter_Click_Tracking_Domain_and_CleverTap_Endpoint.png",
        null,
      ...
      "sizing": "50% ",
      "border": true,
      "caption": "Enter Click Tracking Domain and CleverTap Endpoint"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/41ccdb2c2768706263d52dfe732e93f8fc030cf3797c4cb4f18ca163495eaf9c-Route_Link_Traffic_to_AppsFlyer.png",
        "",
      ...
      "sizing": "65% ",
      "border": true,
      "caption": "Link Redirection to AppsFlyer "
    }
  ]
}
[/block]
