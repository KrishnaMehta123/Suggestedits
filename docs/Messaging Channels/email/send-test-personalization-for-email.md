...
You can send test campaigns with personalized values by using the *Preview & Test* option on the campaign page.

<Image alt="Preview & Test Popup" align="center" width="90% " border={true} src="https://files.readme.io/2597389-Preview__Test.gif">
  Preview & Test Popup
</Image>

You can also personalize how your email appears to the recipients from the *Sender Details* tab. All the fields under this section can be personalized. You will be able to use [personalized values for the From and Reply-to Email Address fields](doc:create-message-email#sender-details), a feature released in Private Beta, for the following providers: SendGrid, Amazon SES, and Generic SMTP setup.
...
<Image alt="Add recipients in CC/BCC" align="center" width="75% " border={true} src="https://files.readme.io/635078b-image.png">
