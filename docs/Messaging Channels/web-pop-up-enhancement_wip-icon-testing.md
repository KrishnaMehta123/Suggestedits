...
{
  "type": "info",
  "title": "Pinning Dashboards",
  "body": "One can also pin all the reports to a custom dashboard using the Pin icon <img src=\"https://files.readme.io/91600a6-Screenshot_2021-09-14_at_3.11.38_PM.png” height=“30px” width=“30px”>  for monitoring the data at regular intervals."
}
[/block]
## Define the When
[block:image]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/91600a6-Screenshot_2021-09-14_at_3.11.38_PM.png",
        "Screenshot 2021-09-14 at 3.11.38 PM.png",
        62,
        56,
        "#f3f6fc"
      ]
