...
For Android 8.0 and above, you can create a group of notification channels that are available for selection during campaign creation. Every notification you send must be assigned to a channel. This allows end-users to turn on or off the subscription for specific notifications. It also helps control the settings for every channel.
