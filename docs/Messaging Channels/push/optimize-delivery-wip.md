...
excerpt: Understand how to optimize push messages with Pull Notification and App Inbox
deprecated: false
hidden: true
metadata:
  title: ''
...
<Image title="Enhanced push delivery.png" alt={2522} className="border" border={true} src="https://files.readme.io/41de8e0-Enhanced_push_delivery.png" />
...
<Image title="enhanced push deliver.png" alt={2672} className="border" border={true} src="https://files.readme.io/2e7757d-enhanced_push_deliver.png" />
