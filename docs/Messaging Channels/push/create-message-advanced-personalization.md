...
> 🚧 Delay > 24 Hours
>
> For all Live campaigns with a delay greater than 24 hours, CleverTap recommends using a Past Behavior campaign.
...
<Image title="Message and Media" alt="Screen shows single message editor with image URL selected" align="center" border={true} src="https://files.readme.io/74bbabd-Rich_Push_Notifications.png">
...
<Image title="Create Image Slides" alt={1294} align="center" width="80%" border={true} src="https://files.readme.io/0af7d403c78b8fe028cf49704fc9be2c8289dd48de9aa99af660b24be7776e7e-Adding_images_to_Push_Notifications.png">
...
* Active (default)
  * Behavior: Active notifications replicate the existing notification behavior. Upon delivery, they trigger audible sound and vibration and illuminate the screen.
...
<Image title="Add Buttons and Deeplinks" alt="Screen shows adding button actions into your notification" align="center" width="80%" border={true} src="https://files.readme.io/170e2a2d28a5ea7cd0d1827d57b4a1f284e841ea7fe1db02972827a895618968-Custom_Actions_for_Android_Notifications.png">
