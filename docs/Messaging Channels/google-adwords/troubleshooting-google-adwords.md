---
title: 'Google Ads: Troubleshooting and FAQs'
excerpt: >-
  Learn how to resolve the most commonly encountered errors related to Google
  Adwords messaging channel
deprecated: false
hidden: false
metadata:
  title: ''
...
### While uploading the Google Audience list from Clevertap, we received an error “Advertiser not Whitelisted.”
