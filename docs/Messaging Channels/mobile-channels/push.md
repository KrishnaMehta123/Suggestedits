...
<Image title="Screenshot 2020-06-09 at 4.47.07 PM.png" alt={2878} className="border" border={true} src="https://files.readme.io/2bc52cb-Screenshot_2020-06-09_at_4.47.07_PM.png" />

## Step2: Select the Engagement Channel

Click Mobile Push.

<Image title="Screenshot 2020-06-09 at 4.50.48 PM.png" alt={2436} className="border" border={true} src="https://files.readme.io/d8a40b6-Screenshot_2020-06-09_at_4.50.48_PM.png" />

## Step 3: Select a Campaign Type

<Image title="Screenshot 2020-06-10 at 9.49.52 AM.png" alt={1998} className="border" border={true} src="https://files.readme.io/1793634-Screenshot_2020-06-10_at_9.49.52_AM.png" />
...
<Image title="campaigns_push_Message_Who.png" alt={1438} className="border" width="100%" border={true} src="https://files.readme.io/51e6bfe-campaigns_push_Message_Who.png" />
...
You can add in a fixed (or with dynamic replacements) the URL for Android (Image only)  and iOS (Image and Video)  for push notifications.
...
![2366](https://files.readme.io/88810a4-Campaigns_Mobile_Push_Notification_Settings.png "Campaigns_Mobile_Push_Notification_Settings.png")
...
<Callout theme="warn" icon="🚧">
  1. The push event can be raised only for CleverTap SDK version 3.5.1 and above for Android and version 3.5.0 and above for iOS.
...
![2320](https://files.readme.io/350ef25-image_1.png "image (1).png")
