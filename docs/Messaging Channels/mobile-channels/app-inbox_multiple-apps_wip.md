---
title: App Inbox_multiple apps_WIP
excerpt: ''
deprecated: false
hidden: true
metadata:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1b130c7-Screenshot_2020-06-09_at_4.47.07_PM.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f1ea07a-Screenshot_2020-06-10_at_10.13.15_AM.png",
        "Screenshot 2020-06-10 at 10.13.15 AM.png",
        2434,
        1332,
        "#f7f8fa"
      ],
...
If you have integrated multiple apps, select the app from the list.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5a68c6b-Campaigns_Who_app_inbox.png",
