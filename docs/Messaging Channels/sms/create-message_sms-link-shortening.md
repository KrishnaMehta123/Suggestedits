---
title: Create Message_SMS Link Shortening_EM-958
...
For more information about each message type, refer to the [Message Types](doc:create-message_sms-link-shortening#message-types) section.
...
![](https://files.readme.io/7e4521d-Select_the_Link_to_Shorten.gif)

> 🚧 Shortening OneLink Custom Links
>
> Shortening Appsflyer OneLinks and Branch links is not recommended, as this may break the app-opening functionality. For more information, refer to the following articles: 
>
...
>
> Each shortened URL may consume between 15-22 characters.
...
> 📘 Time To Live for Shortened Links
>
> The shortened URLs from the SMS campaign expire after seven days from the date the campaign is sent. If the user opens these links after the expiration date, they are redirected to a 404 page.
