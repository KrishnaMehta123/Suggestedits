---
title: SMS_WIP_KaiOS Support Enhancement
excerpt: ''
deprecated: false
hidden: true
metadata:
...
If you use a generic SMS provider, perform the following steps:
1. Select a service provider.
2. Enter a template ID.
3. Enter any template variables.
4. Enter any key-value pairs depending on your payload structure. 

For more information, refer to [Generic SMS](https://docs.clevertap.com/docs/generic-sms).

______ DK TO PROVIDE NEW CLEAN SCREENSHOT BELOW ______
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/625c99b-3_SMS_The_What_.png",
        "3 SMS The What .png",
        2256,
        1642,
        "#f6f7f8"
