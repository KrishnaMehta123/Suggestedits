...
<Image title="Whatsapp_3_new (1).png" alt={1251} width="smart" src="https://files.readme.io/2f2d935-Whatsapp_3_new_1.png" />
...
CleverTap uses API endpoints from [Nexmo](https://www.nexmo.com/products/messages/whatsapp) or [Gupshup](https://enterprise.smsgupshup.com/whatsapp) to connect with WhatsApp. To get started, perform the following steps:
