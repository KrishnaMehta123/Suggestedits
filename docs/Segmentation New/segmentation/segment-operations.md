...
You can search segments by their _Name_ or _ID_ from the _Segments_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7edebc5-Search_Operation.png",
        "Search Segment.png",
        2396
      ],
      "align": "center",
      "border": true,
      "caption": "Search Segments"
    }
  ]
}
[/block]
...
To copy the segment name and ID, click the ![Copy](https://files.readme.io/0e1c106-Copy_icon.png) icon against the respective segment from the _Segments_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/907f602-Copy_Operation.png",
        "Copy Segment name and ID .png",
        2402
      ],
      "align": "center",
      "border": true,
      "caption": "Copy Segment Name and ID"
    }
  ]
}
[/block]
...
1. Click the ![Ellipses](https://files.readme.io/b15093f-ellipses_icon.png) icon displayed against the segment name under the _Segment details_ column and click **Engage**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/304a75e-Engage_Users.png",
...
[/block]
   ...
   The _Messaging Channels_ popup displays.
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Select an Engagement Channel"
    }
  ]
}
[/block]
...
You are navigated to the campaign creation page with your segment criteria pre-populated under the _Who_ section of the _New Campaign_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ab8d24d-Target_Segment_in_Campaigns.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7208305-Clone_Users.png",
        "Clone Segment.png",
        2394
      ],
      "align": "center",
...
[/block]
  ...
  The _Create New_ page opens with prepopulated qualification criteria.
...
2. Click the icon. The _Delete Segment?_ popup appears, listing the selected segments and their dependencies.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1812fa3cd4ecd35d0f9b61f5ade6d3d321369eff491f494e01d5a24fadf3575a-Delete_a_Segment.gif",
        "",
        ""
      ],
      "align": "center",
...
> 
> A segment that is part of an active engagement cannot be deleted. To know more about segment deletion handling, refer to [Delete Segments](doc:segment-deletion).

## Sort Segments

You can sort segments in ascending or descending order for the following columns under _Segments_ page:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/625e912-Sort_Segments.gif",
        "Sort Segments.gif",
        1188
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9a4aefa-Filter_Segments.gif",
        "Filter Segments.gif",
        1196
      ],
      "align": "center",
