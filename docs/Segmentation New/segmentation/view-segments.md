...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1759d4a-Segment_Insights.png",
        "",
...
1. Click the![Download](https://files.readme.io/758da8c-Export_User_Profiles.png) icon under the _Insights_  section. 
