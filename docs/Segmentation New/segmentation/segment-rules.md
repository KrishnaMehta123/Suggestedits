...
- **User bucket**: Segment users based on a system user property called [User Bucket](doc:random-user-bucket). For example, you can create a segment of users with bucket numbers 7, 100, and 999.
