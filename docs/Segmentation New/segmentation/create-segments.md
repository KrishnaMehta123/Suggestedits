...
6. Select the _Charged_ event where the count is one and click **Refresh Data**.
...
Your new segment, _ Charged Users _, now appears in the main section of the _Segments_ page.
...
Consider the example of creating an _Inaction in Time Frame_ segment where users qualify as soon as they add a product to the cart but do not purchase it within 10 minutes.
...
5. (Optional) Select _Filter on past behavior and common properties_ to apply filters to past actions, inactions, or common user property filters.
...
Your new segment, _Added to cart but no charge within 10 minutes_, now appears in the main section of the _Segments_ page.
...
1. Click the ellipsis ![Ellipses](https://files.readme.io/b15093f-ellipses_icon.png) icon from the segment you want to replace.
2. Click **Replace**.
...
> 📘 Tip
> 
> Click the ![download](https://files.readme.io/8967517-Download_Segment_Icon.png) download icon to download all the users in your segment.
