...
6. Select the *Charged* event where the count is one and click **Refresh Data**.
...
Your new segment, *Charged Users* , now appears in the main section of the *Segments* page.
...
Consider the example of creating an *Inaction in Time Frame* segment where users qualify as soon as they add a product to the cart but do not purchase it within 10 minutes.
...
5. (Optional) Select *Filter on past behavior and common properties* to apply filters to past actions, inactions, or common user property filters.
...
Your new segment, *Added to cart but no charge within 10 minutes*, now appears in the main section of the *Segments* page.
