...
<Image title="up1.png" alt={1408} className="border" border={true} src="https://files.readme.io/a11895e-up1.png" />
...
<Image title="find1.png" alt={1407} className="border" border={true} src="https://files.readme.io/2f1d58a-find1.png" />
...
<Image title="find2.png" alt={1076} className="border" border={true} src="https://files.readme.io/ef00a21-find2.png" />
