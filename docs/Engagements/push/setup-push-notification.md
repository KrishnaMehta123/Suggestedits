...
<Image align="center" className="border" width="5060px" border={true} src="https://files.readme.io/3ea1e3dd77383905a539a9257ccf9a110155faaf43c61058c109a809bc600351-image.png" />
...
<Image title="Setup Push Impressions for Android from the Schema" alt={1171} align="center" border={true} src="https://files.readme.io/1f68258-push_set_push_impression.png" />  Setup Push Impressions
...
<Image title="Select the Mutable Content Checkbox" alt={1251} align="center" width="80%" border={true} src="https://files.readme.io/2bd5135-campaign_iOS.png" />  Setup Push Impressions for iOS
