...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a9a4b113df292aabce35308f6b824efd970e51920d5a7b44ca8e622d2a4bc26b-Select_the_Push_Campaign.png",
...
Push Editor allows you to create and edit relevant and timely messages for your push campaign. From the _What_ section, click _Go To Editor_ to create your message. This section displays the editor to create your push message. 
...
You can see various options that will help you create a contextual and timely message. For the _Title_ and _Message_ fields, you can use the following options to create personalized and engaging campaigns:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cf64190-Create_Push_Message.png",
...
In the case of Android, alt text is supported only for the _Expanded notification image_ field. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2cd02d35c877e0b8fe32d05e0db432799b6471f9d0071b1943e346215880b2d3-Image_URL_with_Alt_text.png",
        null,
        "Image URL with alt text for Android"
      ],
      "align": "center",
      "border": true,
      "caption": "Image URL with alt text for Android"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0f246e47e6578b80caaacfce79e75e6b807788731bae8932b6ca2f88525ebec3-Image_URL_with_Alt_text_-_Carousel.png",
        null,
        "Image URL with alt text for iOS"
      ],
      "align": "center",
      "border": true,
      "caption": "Image URL with alt text for iOS"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fc36c4cc394b5d9d1cfb0370cfa9aec6e166f1db5fbc0feea0368f63367a4cb3-Custom_Actions_for_Android_Notifications.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/76f57ef7a6b353974c368a559889d85627cccda95ab32d149d562164a4c84a3a-2025-02-13_15-23-41.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/59a6c96bba6b0c6210713684bba962bd22f1f45e5899bcc075397dad65116a32-image.png",
        null,
