...
<Image title="Campaign Button Lists All Channels" alt={1360} align="center" width="80%" border={true} src="https://files.readme.io/a9a4b113df292aabce35308f6b824efd970e51920d5a7b44ca8e622d2a4bc26b-Select_the_Push_Campaign.png">
...
Push Editor allows you to create and edit relevant and timely messages for your push campaign. From the *What* section, click *Go To Editor* to create your message. This section displays the editor to create your push message. 
...
> | Android  | 65 characters            | 240 characters             |

You can see various options that will help you create a contextual and timely message. For the *Title* and *Message* fields, you can use the following options to create personalized and engaging campaigns:
...
* Use [Scribe](doc:scribe), the AI-powered writing assistant that can also analyze and adjust the emotional tone of your content. It helps generate attractive and emotionally relevant messages for your campaign.

<Image title="Edit,Personalize, Preview, and Test" alt={971} align="center" border={true} src="https://files.readme.io/cf64190-Create_Push_Message.png">
  Message Editor
</Image>
...
To enhance Rich Push Notifications on Android and iOS, you can configure a fixed image URL or use dynamic replacements. To ensure accessibility for users with visual impairments, add meaningful alternative text (alt text) for images.

In the case of Android, alt text is supported only for the *Expanded notification image* field. 

<Image alt="Image URL with alt text for Android" align="center" border={true} src="https://files.readme.io/2cd02d35c877e0b8fe32d05e0db432799b6471f9d0071b1943e346215880b2d3-Image_URL_with_Alt_text.png">
  Image URL with alt text for Android
</Image>

You can create iOS Push Notifications using a single image or an image carousel. However, alt text is supported only for carousel images. For each carousel slide, you can add a unique image URL, alt text for the image, caption, sub-caption, and call-to-action URL (fixed or with dynamic replacements).

<Image alt="Image URL with alt text for iOS" align="center" border={true} src="https://files.readme.io/0f246e47e6578b80caaacfce79e75e6b807788731bae8932b6ca2f88525ebec3-Image_URL_with_Alt_text_-_Carousel.png">
  Image URL with alt text for iOS
</Image>

> 🚧 Alt Text in Push Notifications
>
> * Alt text is optional unless you are aiming for compliance with accessibility standards, such as European Accessibility Act (EAA).
> * Maximum Alt text length: 150 characters.    
> * To enable support for alt text in Rich Push Notifications, update to the latest CleverTap SDKs:
>   * **For Android**: v7.4.1 or higher
>   * **For iOS**: v1.1.0 or higher
...
<Image title="Add Buttons and Deeplinks" alt="Screen shows adding button actions into your notification" align="center" width="80%" border={true} src="https://files.readme.io/fc36c4cc394b5d9d1cfb0370cfa9aec6e166f1db5fbc0feea0368f63367a4cb3-Custom_Actions_for_Android_Notifications.png">
...
<Image title="Push Notification with CTAs" alt={1080} align="center" border={true} src="https://files.readme.io/a91ddec-Push_notification_example.jpg">
...
<Image title="Control Variant Distribution" alt="Screen shows split Delivery Variant Distribution and message preview" align="center" border={true} src="https://files.readme.io/76f57ef7a6b353974c368a559889d85627cccda95ab32d149d562164a4c84a3a-2025-02-13_15-23-41.png">
...
* Variant A: 33% (approximately 660,000 users)
* Variant B: 33% (approximately 660,000 users)
* Variant C: 34% (approximately 680,000 users)
...
<Image alt="Message Variant by User Property" align="center" border={true} src="https://files.readme.io/59a6c96bba6b0c6210713684bba962bd22f1f45e5899bcc075397dad65116a32-image.png">
