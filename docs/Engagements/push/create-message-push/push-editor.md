...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/93a7bdf6e72fef4de198d03b9b26d60351824b0dc6d82175c4201ad8db29cff8-image.png",
        null,
        "Push Templates"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ed55e473b9eb0f92e91a4572766a83db96535aa90ec95492113b6d66ad782aec-image.png",
        null,
        "Standard Template"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/45e65c72a2e4c221854feefc82a0d58c8aaf6956c7a467c9c780c26613fad9ef-image.png",
        null,
        "Advanced Template"
      ],
      "align": "center",
      "sizing": "35% ",
      "caption": "Advanced Template"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b06f01f282ddb61ab6bca44b51c79e65c9735b224432fadaf0799eb6c1dd7a70-Screen_Recording_Jun_4_2025_from_Google_Drive.mp4_1.gif",
        null,
        "Auto Carousel Template"
      ],
      "align": "center",
      "sizing": "35% ",
      "caption": "Auto Carousel Template"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a0dd4a50b5b7783a1f970928b1d13d16d660728b9afb935e4947fbd3c942fb00-Timer_12_Light_Live.mp4_1.gif",
        null,
        "Timer Template"
      ],
      "align": "center",
      "sizing": "35% ",
      "caption": "Timer Template"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c7df51a2d91796e9e7433afa2c3c04646037dc71f5e0b017978a35715e0a2f6a-image.png",
        null,
        "Text over Image Push Template"
      ],
      "align": "center",
      "sizing": "35% ",
      "caption": "Text over Image Push Template"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/314a341e4efcff60b16c13c2d9d89c91866ff0a66eb39458de68670c9d1d7ab7-Screen_Recording_Jun_4_2025_from_Google_Drive_1.mp4_1.gif",
        null,
        "Manual Carousel Template"
      ],
      "align": "center",
      "sizing": "35% ",
      "border": true,
      "caption": "Manual Carousel Template"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-3": "Available for Template ",
    "0-0": "Title",
    "0-1": "The main headline of your notification should be concise and attention-grabbing, defining the exact purpose of your campaign.",
    "0-2": "Required ",
    "0-3": "All",
    "1-0": "Message",
    "1-1": "The body text of your notification. The message should clearly convey the purpose of your campaign.",
    "1-2": "Required",
    "1-3": "All",
    "2-0": "Background Color",
    "2-1": "Defines the background color of your push notification. You can use it to match your brand theme or draw visual attention to the notification. It accepts HEX codes or color pickers.",
    "2-2": "",
    "2-3": "Basic, Auto Carousel, Text over Image",
    "3-0": "Timer Duration",
    ...
    "3-2": "Required",
    "3-3": "Timer",
    "4-0": "Timer Text Color",
    "4-1": "Allows you to customize the color of the timer text using a HEX code. This ensures the timer stands out or aligns with your brand colors.",
    "4-2": "Optional",
    "4-3": "Timer",
    "5-0": "Expiry Title",
    "5-1": "The fallback title that appears when the timer has expired. This helps you communicate a follow-up message or next action.",
    "5-2": "Optional",
    "5-3": "Timer",
    "6-0": "Expiry Message",
    "6-1": "The message body displayed after the timer expires. You can use this to soften the missed opportunity or redirect the user elsewhere.",
    "6-2": "Optional",
    "6-3": "Timer",
    "7-0": "Expiry Img",
    "7-1": "An image that replaces the original notification image after the timer expires. Helps reinforce the expiry visually",
    "7-2": "Optional",
    "7-3": "Timer"
  },
  "cols": 4,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bc77b4776c512b19f495b2df17b6656687f3a6cf173da2555407256f63a23353-image.png",
        null,
        "Content Section"
      ],
      "align": "center",
...
| [Tray priority](doc:push-editor-v2#notification-tray-priority)     | Determines the prominence of the notification in the tray. Choose from the following options: _Default_, _High_, or _Maximum_. For more information, refer to [](<>).                                                                                                                                                              | Optional          | All                    |
| [Delivery priority](push-editor-v2#notification-delivery-priority) | Controls how quickly the push is delivered. Choose from the following options: _High_ or _Maximum_. Selecting _High_ ensures faster delivery but may affect the battery. For more information, refer to [](<>).                                                                                                                    | Optional          | All                    |
...
[block:parameters]
{
  "data": {
    ...
    "h-3": "Available for Template",
    "0-0": "Rich Media",
    "0-1": "Add a fixed or dynamically generated media URL to enrich push notifications. It supports images for Android and both images and videos for iOS. It is useful for visually engaging promotions or announcements.",
    "0-2": "Optional",
    "0-3": "All",
    "1-0": "Deep Link URL",
    "1-1": "A clickable URL that takes the user to a specific screen or section within your app. Supports deep linking for seamless In-App navigation.",
    "1-2": "Optional",
    "1-3": "All",
    "2-0": "Sound",
    "2-1": "Specifies the custom sound file to be played when the notification arrives. The sound file must be included in your iOS app bundle. Supported formats: `.aiff`, `.caf`, and `.wav`.",
    "2-2": "Optional",
    "2-3": "All",
    "3-0": "Badge Count",
    "3-1": "Updates the app icon badge number to the specified value. Setting it to `0` hides the badge. This must be manually managed at the application level, as it does not auto-increment.",
    "3-2": "Optional",
    "3-3": "All",
    "4-0": "[Interruption Level](doc:push-editor-v2#interruption-level) ",
    ...
    "4-3": "All",
    "5-0": "Relevance Score",
    "5-1": "Determines the importance of a notification when grouped in the iOS notification summary. Marketers can now set up the _Relevance Score_ for every notification when creating a Push campaign. This directly impacts the order of notifications when grouped. The score ranges from`0` (lowest) to `1` (highest). Notifications with higher scores take precedence. This feature was introduced in iOS 15 and later versions.",
    "5-2": "Optional",
    "5-3": "All",
    "6-0": "Category",
    "6-1": "Specifies a registered iOS category that groups notifications by type and defines custom actions (for example, buttons). Categories must be pre-registered in the app. Each category can support up to four actions.",
    "6-2": "Optional",
    "6-3": "All",
    "7-0": "Mutable Content",
    "7-1": "Sends the `mutable-content` flag with the payload, allowing your app’s service extension to modify the push content before it is displayed (for example, attach media, customize text). For more info, refer to Apple’s documentation on [Modifying Content in Newly Delivered Notifications](https://developer.apple.com/documentation/usernotifications/modifying_content_in_newly_delivered_notifications).",
    "7-2": "Optional",
    "7-3": "All"
  },
  "cols": 4,
...
[block:parameters]
{
  "data": {
    ...
    "h-3": "Available for Template",
    "0-0": "Webhook URL\t  \n\t  \n\t",
    "0-1": "A server endpoint you want to call when the push is clicked.",
    "0-2": "Required",
    "0-3": "All",
    "1-0": "Method",
    "1-1": "HTTP method to use (GET, POST, and so on)",
    "1-2": "Required",
    "1-3": "All",
    "2-0": "Payload",
    "2-1": "Optional data to include in the request (JSON format supported).",
    "2-2": "Required",
    "2-3": "All"
  },
  "cols": 4,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/89196f0e16cda364fdcb2d7bee03b9ae36f66045e18f9ccb7bc8c8d46313d420-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7c5da3ebe282535fd58efb085c44800e87799a61c3cd312ea38e5cf4cab6158e-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b0cfaab970524e37fad67aa1e645e6f7d810be916fdfea6b3ab2b3c42b13b2c6-image.png",
        null,
        "Notification Behavior"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c740918fae5e4fbf4e8e8dad8203a1b9004967ae92bac1c429c9d7080107dc10-image.png",
        null,
        "Dismiss Notificatiom"
      ],
      "align": "center",
      "sizing": "65% ",
      "border": true,
