...
You can set up the *When* section to schedule the campaign Date and Time, and the Delivery Preferences.

## Date and Time

Past behavior campaigns can be scheduled to run with the following options:
...
Use Set as Recurring when you want your campaign to be delivered repeatedly at fixed intervals. Once enabled, you can define the Start date, Recurrence frequency, and End date. 

<Image alt="Set as Recurring for Past Behaviour Campaigns" align="center" border={true} src="https://files.readme.io/943813bdfe861664dbf1ab8234ea74b6a4b759a22e7498699b7cc3ae8bf94914-recurring.png">
  Set as Recurring for Past Behaviour Campaigns
</Image>

#### Daily Recurrence

Choose **Day** to send the campaign every *X* number of days.

* Enter a value between 1–6 for how often the campaign should repeat.
* For values above 6, switch to the Weekly or Monthly options for better delivery control.

For Example: For repeat every 3 days, the campaign will trigger every third day from the selected start date.

#### Weekly Recurrence

Choose **Week** to send the campaign every *X* number of weeks.

* Select how many weeks apart the campaign should repeat.
* Choose one or more days of the week on which the campaign should be delivered.

For Example: For repeat every 1 week on Tuesday, the campaign will send push notifications every Tuesday in a week.

<Image alt="Repeat every X week" align="center" border={true} src="https://files.readme.io/b3a5d9667fdc3df5649d62a737518b2396dde8ce2bc6af52fdc684f6eedbd86f-image.png">
  Repeat every X week
</Image>

#### Monthly Recurrence

Choose **Month** to run the campaign every *X* number of months. You can schedule monthly recurrence in two ways:

* **Day of Month**: Send notifications on specific calendar dates each month. You can select one or more dates, or choose **Last day of month** if you want delivery to occur on the final day of the month, regardless of month length.

For Example: For repeat every 1 month on 10th and 20th, the campaign sends on those dates each month.

<Image alt="Repeat on Day of Month" align="center" border={true} src="https://files.readme.io/65ffec63c2685ac9a0efc979bfe8e04a18fc7daf2556889e0580a8541800a331-image.png">
  Repeat on Day of Month
</Image>

* **Day of Week**: Send on a particular weekday occurrence each month with multiple combinations.

For Example: Add custom combinations for six weeks as shown in the screenshot below: 

<Image alt="Repeat on Day of Week" align="center" border={true} src="https://files.readme.io/102921cd18acac3efb79045d8b83ce858454dbfd1c43b76cef8814017bbbb959-image.png">
...
* **Never end**: The campaign continues indefinitely.
* **On a date**: Stops on the specified date in the account timezone.
* **After X occurrences**: Stops after the recurrence has triggered the specified number of times.
...
<Image alt="Date and Time for Live Behaviour Campaigns" align="center" border={true} src="https://files.readme.io/72fdc102554f011f64df77cfda8ee17014e2ee841584e5ed938321dad93e7fd9-image.png">
  Date and Time for Live Behaviour Campaigns
</Image>
...
Check out our [Creative Push Notifications](clevertap.com/blog/creative-push-notifications/) guide for ideas that go beyond the basics and drive engagement.
