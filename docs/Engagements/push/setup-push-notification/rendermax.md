...
> 
> For more detail on the steps,  refer to the [RenderMax Push Integration](https://developer.clevertap.com/docs/android-push#integrate-rendermax-push-sdk-with-android).
