...
<Image title="google_ads_manager_id.png" alt={1600} className="border" border={true} src="https://files.readme.io/b74ffb0-google_ads_manager_id.png" />
...
<Image title="google_ads_allow_r.png" alt={400} className="border" border={true} src="https://files.readme.io/944d50f-google_ads_allow_r.png" />
