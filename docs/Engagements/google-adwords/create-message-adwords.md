...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9274b7e0980ecaf3b04114a69445e8468bc4ca5a2c1bae6f99c703af8a71c27e-google_adds.png",
...
Now, you can set up the _What_, that is, you can select the audience to which you want to export the user details.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a12d764-when.png",
        "",
        "Define the Campaign Schedule"
      ],
      "align": "center",
