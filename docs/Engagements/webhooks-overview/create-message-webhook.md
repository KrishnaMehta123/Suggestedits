...
<Image align="center" alt="Create a New Webhook Campaign " border={true} caption="Create a New Webhook Campaign" title="Create a New Webhook Campaign" src="https://files.readme.io/795882bc1b70d0b26a2d7a25c2ef25ea186d61414611584c6e1572c17791409f-google_adds.png" />
...
* **Qualification criteria**: Deliver the notification based on Past behavior/Custom list, Live behavior, or  [External trigger](doc:external-trigger-1).
