...
- **File URL**: Paste a publicly accessible HTTPS URL pointing to the file. Also, provide a friendly display name for the file, such as _Monthly Report.pdf_.  After uploading, you can rename the file by hovering over the uploaded attachment and clicking the ![](https://files.readme.io/42a29cd4fe23c9ab89b9e3f19c62f7896517787823c9b86827530e2ee9266a0b-Rename_icon.png) icon. The display name provided here (for example, _Monthly Report.pdf_) is visible to the end user in their inbox. Attachments are **not stored in CMS automatically** when uploaded via this option.
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/6b31ad1f1816495e90e8ef26a8b60e9809ebb8f3131a3ff57dfc1fb945ca2fe7-Attach_Files_via_Files_URL.gif","","Attach Files via Files URL"],"align":"center","border":true,"caption":"Attach Files via Files URL"}]}[/block]
- **Device Storage**: Click to open your file browser and select the file you want to upload. Attachments are **not stored in CMS automatically** when uploaded via this option.
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/3ab400251421ddd97f5b5e94098a63c8e95e33c91d535cc6a3fc7a4a2d6f3afc-Attach_Files_via_Device_Storage.gif","","Attach Files via Device Storage"],"align":"center","border":true,"caption":"Attach Files via Device Storage"}]}[/block]
- **Content Manager**: Click **Browse** to attach previously uploaded assets to the email campaign. 

  [block:image]{"images":[{"image":["https://files.readme.io/560767193ddfcc6087800fce5d63ba545c2b5544f9485f6756b729fa03d9c9a6-Attach_FIles_via_Content_Manager.gif","","Attach FIles via Content Manager"],"align":"center","border":true,"caption":"Attach Files via Content Manager"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6fb0e04c57b85a2861be36ee9cc5313fff2dbfc31d29c506d71a566ca296e227-Email_Attachment_Errors_Stats.png",
        null,
        "Email Attachment Errors"
      ],
      "align": "center",
      "border": true,
      "caption": "Email Attachment Errors"
    }
  ]
}
[/block]