...
After setting up the content of your campaign in the _What_ section, you can configure how your email appears to recipients. This helps ensure that the email adheres to best practices for deliverability and compliance. Except for the _From_ field, all the other fields under this section can be personalized (see the following image).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3950c9f-Sender_Details_-_Email_Campaign.png",
        null,
        "Sender Details"
      ],
      "align": "center",
...
CleverTap supports adding Custom headers and Custom extras to enhance email functionality in the campaign _What_ section. This feature enables users to include relevant data in the email payload (HTTP/SMTP), supporting personalization and improving engagement.

##### 

##### Use Case Examples

- **User Property Header and User ID Tracking:** Use a custom header with user properties and an embedded _User ID_ to adjust SMTP server behavior and facilitate recipient-side analysis.
- **Gmail Feedback ID:** Incorporate a _Gmail Feedback ID_ in the custom headers to utilize the Feedback Loop (FBL) for monitoring campaigns with high complaints from Gmail users, thus assisting in abuse detection.
- **Campaign ID Reporting:** Include a _campaign ID_ for internal reporting, allowing teams to optimize strategies based on campaign performance.
- **Category Tracking:** Add a  _CategoryID_ or _Category Name_ to track performance across different internal categories or business units, facilitating more granular analysis.
...
1. Navigate to _Sender Details_ and select the checkbox **Custom Headers**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/404328675cfdaab2c8b41188aee97e7f04bd0dc77b3db48475f0ece746e6f373-Custom_Key_Value_1.png",
        "",
        "Sender Details"
      ],
      "align": "center",
...
1. Navigate to _Sender Details_ and select the checkbox **Custom Extras**.
...
Global campaign limits are limits you can apply to determine how many messages each app user receives per day. If you want to override these settings for an important campaign, you can select the _Don’t apply global campaign limits to this campaign_ option.
