...
After setting up the content of your campaign in the *What* section, you can configure how your email appears to recipients. This helps ensure that the email adheres to best practices for deliverability and compliance. Except for the *From* field, all the other fields under this section can be personalized (see the following image).

> 📘 Private Beta
>
> The **From** and **Reply To** fields are available for Amazon SES, Sendgrid, and generic SMTP providers. To enable this feature, contact your Customer Success Manager.

<Image alt="Sender Details" align="center" width="65% " border={true} src="https://files.readme.io/3950c9f-Sender_Details_-_Email_Campaign.png">
  Sender Details
</Image>
...
* From Email Address: This is a mandatory field. This field specifies the email address from which the campaign is sent to the recipient. A default email address that has been added during the setup under  *From Address* field under the *Settings* > *Email* > *Providers* >  *Setup* page will be pre-populated in this field. 
* Reply-to Email Address: This is a mandatory field. This field determines the email address where replies will be directed, ensuring that responses from recipients are sent to the appropriate point of contact. A default email address that has been added during the setup under  *Reply-to-Address* field under the *Settings* > *Email* > *Providers* >  *Setup* page will be pre-populated in this field. 
...
#### Custom headers and Custom extras

> 📘 Private Beta
>
> This feature is released in Private Beta. You can now add Custom headers and Custom extras in emails for the following providers: Sendgrid, Amazon SES, Infobip, and Generic SMTP setup.

Headers provide essential information about the message, including details about the sender, recipient, authentication protocols, and routing information. Similarly, email message extras enable the transmission of additional data to email service providers, which is vital for tracking and custom analyses. This allows organizations to derive valuable insights and take informed actions.

CleverTap supports adding Custom headers and Custom extras to enhance email functionality in the campaign *What* section. This feature enables users to include relevant data in the email payload (HTTP/SMTP), supporting personalization and improving engagement.

#####

##### Use Case Examples

* **User Property Header and User ID Tracking:** Use a custom header with user properties and an embedded *User ID* to adjust SMTP server behavior and facilitate recipient-side analysis.
* **Gmail Feedback ID:** Incorporate a *Gmail Feedback ID* in the custom headers to utilize the Feedback Loop (FBL) for monitoring campaigns with high complaints from Gmail users, thus assisting in abuse detection.
* **Campaign ID Reporting:** Include a *campaign ID* for internal reporting, allowing teams to optimize strategies based on campaign performance.
* **Category Tracking:** Add a  *CategoryID* or *Category Name* to track performance across different internal categories or business units, facilitating more granular analysis.

> 📘 Limitations
>
> * A maximum of 10 parameters can be added in both Custom Headers and Custom Extras respectively.
> * The character limit for each field will be 100.
> * The combined size of Custom headers and Custom extras must not exceed 1KB.

##### Custom headers

**Custom headers** are user-defined fields that allow organizations to include specific information such as tracking IDs, campaign identifiers, or user properties. They can provide processing instructions and capture feedback data to monitor complaints or engagement metrics.

##### Adding Custom headers in Email Campaigns

1. Navigate to *Sender Details* and select the checkbox **Custom Headers**.

<Image alt="Sender Details" align="center" border={true} src="https://files.readme.io/404328675cfdaab2c8b41188aee97e7f04bd0dc77b3db48475f0ece746e6f373-Custom_Key_Value_1.png">
  Sender Details
</Image>

2. Add **Key** and **Value** in the respective fields.
3. Select **+ Header** to add more header parameters.
4. Personalization will be supported for user properties, event properties, and campaign ID.

##### Custom extras

**Custom extras** refer to additional data sent with the email payload, separate from the headers. This data aids in analyzing email performance and tracking user engagement metrics, facilitating custom reporting. Custom headers and message extras enhance email campaigns by providing valuable insights for improved tracking and analysis.

> 📘 Custom Extras
>
> Custom Extra Key-Value pairs are only supported for HTTP providers.

##### Adding Custom extras in Email Campaigns

1. Navigate to *Sender Details* and select the checkbox **Custom Extras**.
...
2. Add **Key** and **Value** in the respective fields.
3. Select  **+ Extra** to add more parameters to Custom extras.
4. Personalization will be supported for user properties, event properties, and campaign ID.
...
* Based on a date event property value of an event (for example,  a reminder for an upcoming travel booking).

### Delivery preferences

Global campaign limits are limits you can apply to determine how many messages each app user receives per day. If you want to override these settings for an important campaign, you can select the *Don’t apply global campaign limits to this campaign* option.
