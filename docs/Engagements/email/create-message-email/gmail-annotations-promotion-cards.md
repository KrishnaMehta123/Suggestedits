...
[block:parameters]
{
  "data": {
    ...
    "1-2": "This field is populated automatically using the _Subject_ part of the _Sender Details_.",
    "2-0": "Company logo",
    "2-1": "Upload an image or add a URL. Check that the URL is https (not http).",
    "2-2": "Ensure that you use an https (not http) URL. This logo selection only shows in the email preview. To render the logo, you must implement [Brand Indicators for Message Identification (BIMI)](doc:brand-indicators-for-message-identification-bimi) standards.",
    "3-0": "Discount offer",
    ...
    "5-2": "Using this feature allows an email to be previewed twice at the top in a bundle:<ul> <li>once when it is first sent.</li> <li>again within 3 days of the offer expiry.</li> </ul>When personalizing _Offer period_, specify the time and timezone. For example, _2018-12-30T23:59:59-0700_."
  },
  "cols": 3,
  "rows": 6,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4f32a4d939159fd3d44e0a3d4329515618705b4f0565f7464383812d17c14d1a-image.png",
        null,
        "Single Image Layout"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0dcfcde9bdbc05e3e8b476417628beb88bff3e3301683ef8fb8445148ac4da4d-Carousel_Image_Layout.png",
        null,
        "Carousel Image Layout"
      ],
      "align": "center",
      "border": true,
      "caption": "Carousel Image Layout"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ffda68725e844316f99a94057fc9e1dd4e190e94b8cbc90bf42b2aaa82d0c2fb-Annotate_Email_with_Promotion_Cards.png",
        null,
        "Annotate Email with Product Carousel Annotation"
      ],
      "align": "center",
      "border": true,
      "caption": "Annotate Email With Product Carousel Using Image URL Option "
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/577d56ec16b072b5ca0d4b53a877e5f3889f3dca5314ab93ad07f404c226a7f4-Upload_Image_for_Product_Carousel.png",
        "",
        "Annotate Email With Product Carousel Using Upload Image Option"
      ],
      "align": "center",
      "border": true,
      "caption": "Annotate Email With Product Carousel Using Upload Image Option"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "Mandatory",
    "0-0": "_Image URL_",
    "0-1": "Provide the unique image URL. Supported formats include PNG and JPEG. The image must meet the aspect ratio requirements based on whether you are creating a single promotional card or a carousel.<li> **For Single Image Layout**: Supported Aspect Ratio: 1.91:1 only.<li>**For Carousel Layout**:<ul><li>Supported Aspect Ratios: 4:5, 1:1, or 1.91:1.</li><li>All images in a carousel must use the same aspect ratio for compatibility. For additional guidelines, refer to the [Google Documentation](https://developers.google.com/gmail/promotab/overview#microdata_1).</li></ul></li>For more information, refer to [Image Specification for Promotion Cards](doc:gmail-annotations-promotion-cards#image-specification-for-promotion-cards).  \n**NOTE**: Google recommends not using personalized elements or user-specific UTM parameters in carousel image URLs. Only static images must be used across all campaign users for annotations to render in the email.",
    "0-2": "Yes, when the image is hosted on an external source",
    "1-0": "_Upload Image_",
    "1-1": "You can upload images in PNG or JPEG format. The image must meet the aspect ratio requirements based on whether you are creating a single promotional card or a carousel. You can resize images using the cropper tool; the aspect ratio will be maintained based on the selected option.<li> **For Single Image Layout**: Supported Aspect Ratio: 1.91:1 only.<li>**For Carousel Layout**:<ul><li>Supported Aspect Ratios: 4:5, 1:1, or 1.91:1.</li><li>All images in a carousel must use the same aspect ratio for compatibility. For additional guidelines, refer to the [Google Documentation](https://developers.google.com/gmail/promotab/overview#microdata_1).</li></ul></li>For more information, refer to [Image Specification for Promotion Cards](doc:gmail-annotations-promotion-cards#image-specification-for-promotion-cards).",
    "1-2": "Yes, when uploading an image from your local system",
    "2-0": "_Target URL_",
    "2-1": "Provide the specific URL that opens when the user clicks on the promotional image. The target URL can include personalized elements, such as UTM parameters for tracking or any other parameters.",
    "2-2": "Yes",
    "3-0": "_Headline_",
    "3-1": "Provide a concise 1 to 2-line description accompanying the promotional card. ",
    "3-2": "No",
    "4-0": "_Currency_",
    "4-1": "Select the currency of the displayed price from the dropdown list. The supported currencies include USD, INR, AED, EUR, and SGD. This field appears when you select the _Price Tag_ checkbox.",
    "4-2": "No",
    "5-0": "_Product Value_",
    "5-1": "Provide the numerical value representing the original price for the promotional product. This field appears when you select the _Price_ checkbox.",
    "5-2": "No",
    "6-0": "_Discount Value_",
    "6-1": "Provide the discount value, which represents the amount deducted from the original price. This field appears when you select the _Price_ checkbox.  \nFor example, if the discount value is 25 and the original price is 100, the final price displayed will be $75.",
    "6-2": "No"
  },
  "cols": 3,
  "rows": 7,
