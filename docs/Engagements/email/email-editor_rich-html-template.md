---
title: Email Editor_rich html template
excerpt: ''
deprecated: false
hidden: true
metadata:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/670c841-Email_editor_main.png",
...
You can choose from the following types of templates:
  ...
  * Email with rich media - Create a rich message with text and images using the built-in email editor. You can add your custom HTML to create custom email messages and also add personalization by using the **@** and **{{}} **icons. For more information on personalization, see [Personalize Message](doc:personalize-message-email).
...
[/block]
2. Enter your message details in the Body section. You can add the following elements in the Body section:
    * Text message: Type your message in the body section.  
    * Image: Add an image by clicking the ![Insert image](https://files.readme.io/f8faffb-Insert_image_icon.png) icon.
    * URL: Add external links by clicking the ![Link](https://files.readme.io/d520663-Link_icon.png) icon.
    *  HTML code: Add HTML code in the Body section by clicking the ![Source]() icon.

3. Click the **@** and **{{}}** icon to add personalization. For more information on personalization, see [Personalize Message](doc:personalize-message-email). 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b10e8da-Email_template_rich_media.png",
        "Email_template_rich_media.png",
        1219,
        697,
        "#978687"
      ]
...
[/block]
4. (Optional) Click **Save Template** and enter the *Name* for your template. You can choose to save a template for future use. 
5. Click **Save**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bb4fe41-email_editor_mobile_view.gif",
        "email_editor_mobile_view.gif",
        1096,
        634,
        "#e2d1ce"
      ]
...
{
  "type": "info",
  "body": "Dark Mode is only available in the *Email with drag and drop* editor.",
  "title": "Note"
}
[/block]
...
{
  "type": "info",
  "title": "Templates for Inbox Preview",
  "body": "Code Analysis with Inbox Preview is available for the [Custom HTML template](https://docs.clevertap.com/docs/email-editor-templates#custom-html-template) and [Rich Media Template](https://docs.clevertap.com/docs/email-editor-templates#rich-media-template)."
}
[/block]
