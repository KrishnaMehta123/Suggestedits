...
- **Custom headers**: These are additional key-value pairs that you can define and include in your email headers. CleverTap supports adding these under the _What_ section of the campaign. For more information, refer to [Custom Headers](doc:create-message-email#custom-headers).
- **Custom extras**: These are additional key-value pairs that you can define and include along with your email body. CleverTap supports adding these under the _What_ section of the campaign. For more information, refer to [Custom Extras](doc:create-message-email#custom-extras).
...
CleverTap offers the _Remove duplicate profiles_ option for Past Behavior campaigns to prevent sending the same email to multiple qualified user profiles that share the same email address. When enabled, CleverTap sends the email to only one profile per unique email address. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6e2ce2ff522bc61a2fd94c35654ed4c92bc860f6a608a508401bccc01b6db096-Remove_Duplicate_Profiles.png",
        "",
        "Remove Duplicate Profiles"
      ],
      "align": "center",
      "sizing": "75% ",
      "border": true,
      "caption": "Remove Duplicate Profiles"
    }
  ]
}
[/block]
...
If multiple profiles with the same email qualify for the campaign, only one will receive the email, while the others are reported as errors under _Duplicates excluded_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a36651dbe396a55a990251108ae5fe27a0fdbbe2c27622de65ecefeb049d7353-Duplicates_Excluded_Errors.png",
        "",
        "Duplicates Excluded Error"
      ],
      "align": "center",
      "border": true,
      "caption": "Duplicates Excluded Error"
    }
  ]
}
[/block]
