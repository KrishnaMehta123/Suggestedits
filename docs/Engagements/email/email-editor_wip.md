...
3. Select an image from the gallery or upload a custom image. 
[block:image]
{
  "images": [
    {
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7ce275a-Prevew_and_test_dark_mode.png",
        "Prevew and test_dark mode.png",
        2880,
        1378,
        "#bbbec4"
      ],
...
{
  "type": "info",
  "body": "Dark Mode support varies across email clients and devices. We recommend testing the mails on an email client with dark mode enabled for final results. The current Dark Mode preview generates a generic dark mode color scheme when enabled.\n\nFind below the references for dark mode email design tips :\n[5 Tips for Dark Mode Email Design](https://emaildesign.beefree.io/5-tips-for-dark-mode-email-design/)\n[The Ultimate Guide to Dark Mode for Email Marketers](https://www.litmus.com/blog/the-ultimate-guide-to-dark-mode-for-email-marketers/)",
