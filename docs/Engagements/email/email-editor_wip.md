...
<Image title="Prevew and test_dark mode.png" alt={2880} className="border" border={true} src="https://files.readme.io/7ce275a-Prevew_and_test_dark_mode.png" />

> 📘 Dark Mode Preview
>
> Dark Mode support varies across email clients and devices. We recommend testing the mails on an email client with dark mode enabled for final results. The current Dark Mode preview generates a generic dark mode color scheme when enabled.
>
