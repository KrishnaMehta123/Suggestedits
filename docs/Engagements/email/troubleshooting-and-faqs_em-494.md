...
<Image title="Providers.png" alt={1422} className="border" border={true} src="https://files.readme.io/213bdfe-Providers.png" />
...
<Image title="1 Settings.png" alt={182} className="border" border={true} src="https://files.readme.io/46f1e01-1_Settings.png" />

2. Click **Sender Authentication**.

<Image title="2 Sender Authentication.png" alt={180} className="border" border={true} src="https://files.readme.io/06c6adc-2_Sender_Authentication.png" />

3. Click **Authenticate Your Domain** under *Domain Authentication*.

<Image title="3 Authenticate Your Domain.png" alt={424} className="border" border={true} src="https://files.readme.io/242cfc9-3_Authenticate_Your_Domain.png" />

4. Select the name of your DNS host provider.

<Image title="4 name of your DNS host provider.png" alt={873} className="border" border={true} src="https://files.readme.io/2ce2a25-4_name_of_your_DNS_host_provider.png" />
...
<Image title="5 Next.png" alt={502} className="border" border={true} src="https://files.readme.io/b395e61-5_Next.png" />
...
<Image title="6 records.png" alt={1106} className="border" border={true} src="https://files.readme.io/3928608-6_records.png" />
