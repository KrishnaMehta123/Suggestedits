---
title: Email Campaign Stats Heatmap-Delivered
excerpt: >-
...
>
> Sent count is not decremented for delivery errors. This means that even if the ESP reports a delivery failure, such as a bounce or drop, the count of emails marked as Sent remains unchanged.
...
<Image alt="Variant Comparison" align="center" border={true} src="https://files.readme.io/57c3bfd35f0cee3bff90a0b3907aa7fcb54cba4eb16e407cbb112389c1b35f47-image_36.png">
  Variant Comparison
</Image>
...
Evaluate the performance of different links in a single email campaign using a *Click Map* for a visual overview and a *Breakdown* for detailed tabular insights. 
...
If your campaign includes multiple variants from the dropdown, select the email variant you want to analyze within the campaigns.
...
For AMP email campaigns, you can switch to the AMP variant by selecting it from the dropdown. By default, it is set to HTML, so ensure you change this setting to AMP to analyze metrics specific to the AMP version of your email.

<Image alt="AMP Template" align="center" border={true} src="https://files.readme.io/fa9bd9e39e3033607782559b9e94cece297575a11cc6d7d556cf1444c31371b9-image_47.png">
  AMP Template
</Image>
...
<Image alt="View Detailed Insights for Click Map" align="center" border={true} src="https://files.readme.io/bea903dcbdfc02d370b31b157d74ba4f1b2443f408e3adfe368d4a4a01568732-Breakdown_section.png">
...
* **Unique Clicks**: Displays the number of clicks by unique users, ensuring each user is counted only once.
...
<Image alt="View User Details" align="center" border={true} src="https://files.readme.io/dc59db63d66a35e10c17624583d8eb12fbb243dfb81aad7129ecb5da8bd72aa1-View_User_Details_Click_Map.png">
  View User Details
</Image>
...
>
> If you edit the email in a recurring or live campaign and publish the changes, the Click Map reflects data for the campaign's latest version. The statistics displayed are based on the updated version, and previous data will not be retained.
