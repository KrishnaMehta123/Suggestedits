...
3. Click the campaign to open it. The *Stats* tab displays the following campaign stats: 
   ...
   * [User Conversion Funnel](doc:email-campaign-stats-uniqueclicks#users-conversion-funnel)
...
<Image alt="Overall Campaign Performance" align="center" border={true} src="https://files.readme.io/07d9524a78cfa43f533c7055411a9a8e35d235934616db626ab405fc432fa251-image_52.png">
  Overall Campaign Performance
</Image>
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Displays the total number of emails sent, excluding emails sent to CC and BCC recipients. CC and BCC recipients are currently in Private Beta.
      </td>

      <td>
        Displays the total number of emails sent to unique recipients, excluding CC and BCC recipients. CC and BCC recipients are currently in Private Beta.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        . Note: It is currently in Private Beta for Infobip (in the case of Advanced Email add-on) and Sendgrid email providers. To gain access, contact your Customer Success Manager, and for more details, refer to 

        [Email Delivered Stats](doc:email-campaign-stats-delivered)
    ...
    <tr>
      ...
      <td>
        Denotes the Click Through Rate of the campaign, calculated as 
      ...
      <td>
        Displays the unique Click through Rate of the campaign, calculated as 
...
<Image alt="Message Trend" align="center" border={true} src="https://files.readme.io/dfbbdb769c12d042cfd8f82a8d39c78e6dcc69e763db08f04ad022682443b8d4-27a73a8-Email_Stats_Message_Trend_1.png">
  Message Trend
</Image>
