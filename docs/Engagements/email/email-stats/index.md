...
3. Click the campaign to open it. The *Stats* tab displays the following campaign stats: Sent, Viewed, Clicks, CTR, and Converted users (refer image below).

<Image alt="Overall Campaign Performance" align="center" border={true} src="https://files.readme.io/f7f4138f5d3338f644a451020649a04c8bba11679bfe3ee012f09dfc9fe80d2f-main_stats.png" />  Overall Campaign Performance
...
<Image title="View Message Trend Stats of Email Campaign" alt={2680} align="center" border={true} src="https://files.readme.io/27a73a8-Email_Stats_Message_Trend.png" />  Message Trend

## Conversion Performance

Click *Conversion Performance* to view conversion, revenue performance, and users' conversion funnel. 

<Image title="View Conversion Stas of Email Campaign" alt={2726} align="center" width="85% " border={true} src="https://files.readme.io/32d1f59-Email_stats_conversion_performance.png" />  Conversion Performance
...
<Image title="View Conversion Performance Stats of Email Campaign" alt={1310} align="center" width="85% " border={true} src="https://files.readme.io/7bf34ea-Email_Stats_Conversion_Conversion_hero.png" />  Conversion Performance Stats
...
| Attachment errors             | Occurs due to an issue with the attached file while sending the campaign, preventing the email from being delivered. A soft bounce is recorded and listed under the *Errors* tab on the campaign *Stats* page.                   | Users not unsubscribed | Notification Failed event raised with property *Error* = Attachment errors |
...
The user is unsubscribed from future email campaigns, and a Channel Unsubscribed event is raised with the event property *Type* as **bounced**. In addition, a Notification Failed event is raised with the event property *Error* as **Email hard bounced**. These errors are included in CleverTap campaign reports.
