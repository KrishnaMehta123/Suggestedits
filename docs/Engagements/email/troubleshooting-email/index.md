...
### What does the *Do not stack on mobile devices* mean?
...
<Image title="Email View with Stacking on Mobile" alt={1080} align="center" width="100%" border={true} src="https://files.readme.io/8ed477f-campaigns_email_Stack_images.png">
  Email with Stacking on Mobile
</Image>

**Without Stacking on Mobile**

<Image title="Email View without Stacking on Mobile" alt={1080} align="center" width="100%" border={true} src="https://files.readme.io/de9274d-campaigns_email_Not_Stack_images.png">
  Email without Stacking on Mobile
</Image>
...
<Image title="Click Browse to Upload a GIF" alt={1322} align="center" border={true} src="https://files.readme.io/76f72c9-New_final_GIF_file_Browse.png">
  Add a GIF
</Image>
...
<Image title="Click Insert to Add the GIF" alt={1318} align="center" border={true} src="https://files.readme.io/e6d322e-New_file_GIF_file_Upload.png">
  Insert a GIF
</Image>
...
<Image title="View CleverTap IPs for Sending Email" alt={1422} align="center" border={true} src="https://files.readme.io/213bdfe-Providers.png">
  CleverTap IPs
</Image>
...
<Image title="Error to Set the Email Credentials " alt={519} align="center" border={true} src="https://files.readme.io/e527565-Screen_Shot_2018-07-15_at_8.40.27_PM.png" />  Error Message
...
<Image title="SendGrid Settings" alt={182} align="center" border={true} src="https://files.readme.io/46f1e01-1_Settings.png" />  Settings
...
<Image title="Click Sender Authentication" alt={180} align="center" border={true} src="https://files.readme.io/06c6adc-2_Sender_Authentication.png" />  Sender Authentication
...
<Image title="Authenticate Your Domain" alt={424} align="center" border={true} src="https://files.readme.io/242cfc9-3_Authenticate_Your_Domain.png" />  Domain Authentication
...
<Image title="Set Your DNS Host Provider Name" alt={873} align="center" border={true} src="https://files.readme.io/2ce2a25-4_name_of_your_DNS_host_provider.png" />  Select DNS Host Provider
...
<Image title="Use Automated Security to Authenticate" alt={502} align="center" border={true} src="https://files.readme.io/b395e61-5_Next.png" />  Advanced Settings
...
<Image title="Verify DNS Records" alt={1106} align="center" border={true} src="https://files.readme.io/3928608-6_records.png" />  Install DNS Records
