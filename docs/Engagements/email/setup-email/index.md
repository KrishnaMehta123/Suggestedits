...
* Email Open Tracking: Tracks email opens by placing a pixel in the email body. By default, the pixel is added at the bottom of the email. Some inbox providers (for example, Gmail, which clips emails larger than 102 KB) may hide content at the bottom, which can impact open tracking. For longer emails, you can place the pixel at the top to help improve open-tracking accuracy.
