...
* Email Open Tracking: Tracks email opens by placing a pixel in the email body. By default, the pixel is added at the bottom of the email. Some inbox providers (for example, Gmail) clip emails larger than 102 KB, which may hide content at the bottom and impact open tracking. You can place the pixel at the top for longer emails to help improve open-tracking accuracy.  
