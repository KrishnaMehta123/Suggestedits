...
* Email Open Tracking: Tracks email opens by placing an invisible tracking pixel in the email body. By default, the pixel is added at the bottom of the email. Some inbox providers, such as Gmail, clip large emails (for example, emails larger than 102 KB) from the bottom, which can impact open tracking. In such cases, placing the pixel at the top helps ensure more reliable open-tracking accuracy.

  <Image align="center" border={true} caption="Select Pixel Location for Email Open Tracking" src="https://files.readme.io/c8d5c64f83eba41650a179d3a88351f1c6d9434a5a30d71d8edbfa845e27666f-Email_Open_Tracking.png" />
