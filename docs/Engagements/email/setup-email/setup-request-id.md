...
Use this option when you want CleverTap to automatically generate a unique identifier for every email sent using a specific provider configuration. You can enable *System Message ID* by selecting the *Add request ID* option while setting up the email provider. This unique system-generated identifier (`systemRequestId`) is assigned to every email sent using that provider configuration.
...
While setting up your email campaign, you can configure the *Custom Message ID* under the *Sender details* section. This identifier can be static or personalized using personalization variables and is attached to every email sent through that campaign.
...
<Image alt="Add Custom Message ID" align="center" width="85%" border={true} src="https://files.readme.io/52027341444d1efbbd5bc4c433a20ff3a14d56fb0580bebdeb6458641dab8b5b-Add_Custom_Message_ID.png" /> Add Custom Message ID
