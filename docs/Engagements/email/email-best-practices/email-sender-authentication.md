...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c6fd258-image.png",
        null,
        "Email Sender Authentication Records"
      ],
      "align": "center",
      "border": true,
      "caption": "Email Sender Authentication Records "
    }
  ]
}
[/block]
...
_In the postal mail analogy, you would contact the sender to verify if the postman can be trusted to deliver their letter._ Let's look at the following image to understand the flow of email authentication.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/aa36f08-DMARC_FINAL.png",
        "",
        "Sender Policy Framework (SPF) Authentication"
      ],
      "align": "center",
      "border": true,
      "caption": "Sender Policy Framework (SPF) Authentication"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/41ff156-DKIM_FINAL.png",
        "",
        "DKIM Authentication"
      ],
      "align": "center",
      "border": true,
      "caption": "DKIM Authentication"
    }
  ]
}
[/block]
...
DMARC is an additional layer above SPF and DKIM. It validates SPF and DKIM outcomes and verifies if the Header From domain aligns with those used in the SPF and DKIM checks. The _Header From_ address represents the sender's email address and is visible to recipients in their email clients.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f9ba461-SPF_FINAL.png",
        "",
        "DMARC Authentication"
      ],
      "align": "center",
      "border": true,
      "caption": "DMARC Authentication"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5de4461-image.png",
        null,
        "Email Authentication Process with DMARC "
      ],
      "align": "center",
      "border": true,
      "caption": "Email Authentication Process with DMARC "
    }
  ]
}
[/block]
