...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/06697f4-image.png",
        null,
        "Sample CSV of Most Engaged Users"
      ],
      "align": "center",
      "border": true,
      "caption": "Sample CSV of Most Engaged Users"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/968cf41f2ef7f6d23df68c2997035d163c71e40955858309cc6f52dae4872406-ok_11.png",
        null,
        "Clone Warmup Day 1 Email Campaign"
      ],
      "align": "center",
      "border": true,
      "caption": "Clone Warmup Day 1 Email Campaign"
    }
  ]
}
[/block]
...
Also, from Day 2 onwards, you must add an additional condition under the "Who have not done" section. Click **Add event** and select _Notification sent_ in the last 30 days (or more if your warmup takes longer). By doing this, you exclude all users who have received an email in the past 30 days (or the previous days of the warmup).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9e4089d2f19b638d0746d27844917399d123c43dce173000451da51c710cb9d3-IP_Warmup_Schedule.png",
        null,
      ...
      "sizing": "50% ",
      "border": true,
      "caption": "Sample Warmup Schedule"
    }
  ]
}
[/block]
...
Establishing and preserving your sender reputation involves numerous factors contributing to warming your IP and domain. For more information, refer to [Email Best Practices](<>). (**For reviewers**: Will add a cross-reference to the Email Best Practices document.)