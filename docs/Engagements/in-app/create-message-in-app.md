...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b43f6a2fa5d7834c20cd78d9dd90891d663d29d66d62469bdcdfe6512318b30d-Select_In-App_Campaign.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cdd8086-control_group.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c8de6f1-In-App_priority.png",
        "",
        "Set In-App Priority"
      ],
      "align": "center",
      "border": true,
      "caption": "Set In-App Priority"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9484a9e-Freq2.png",
        "",
        "Set Delivery Frequency "
      ],
      "align": "center",
      "border": true,
      "caption": "Set Delivery Frequency "
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/abb4944-Freq_2.png",
        "",
        "Exclude from Global Campaign Limits"
      ],
      "align": "center",
      "sizing": "500px",
      "border": true,
      "caption": "Exclude from Global Campaign Limits"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/105ad52-campaign_feq.png",
        "",
        "Campaign frequency limits for in-app"
      ],
      "align": "center",
      "border": true,
      "caption": "Campaign frequency limits"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/48cf7a1-display_rule.png",
        "",
        "Display Trigger."
      ],
      "align": "center",
...
The campaign is triggered after a specified delay once the user qualifies. You can set the number of seconds to wait before showing the popup. {@murtaza, what is the max delay possible here?}
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Triggers for Campaign Delivery {@murtaza, need a new screen}"
    }
  ]
}
[/block]
