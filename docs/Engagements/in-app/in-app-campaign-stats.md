...
You can use the [Campaign Filters](https://docs.clevertap.com/docs/intro-to-campaigns) to find your campaigns. Once the campaign is live, you can view its stats by selecting an *In-App* campaign from the *Campaigns* page on the CleverTap dashboard. Click to view its deliveries, clicks, and conversions. 

<Image title="Select In-App Stats" alt={1012} align="center" border={true} src="https://files.readme.io/41f0509930c6042557c64f170c1e40373a5cc024fdc33510cb59c09f8829635f-Filter_Campaigns.png">
  Filter by Channel
</Image>
...
<Image title="Daily, Weekly, and Monthly Trends" alt={1350} align="center" border={true} src="https://files.readme.io/fc4bb2c6907c94213c94ce5d3ee57df36c53bb309514c81f8b9a8c66c4b96d11-In-app_Message_trend.png">
  Daily Message Trend
</Image>
...
<Image alt="Conversion Performance and Revenue Numbers shown In the Table" align="center" width="75% " border={true} src="https://files.readme.io/e860139ed884795e65b014457dd986cd455d43d6badb2fcab1c3d7aa46a0c68c-In-app-_Conversion_and_Revenue.png">
...
<Image title="Conversion by OS" alt={1319} align="center" border={true} src="https://files.readme.io/01111e1-in-app_stats_users_conversion_funnel.png">
  Users Conversion Funnel
</Image>
