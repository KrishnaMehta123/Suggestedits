...
[Request App Rating](doc:request-app-rating) - Trigger a native app review prompt integrated with the App Store (iOS) and Google Play (Android). Use this function to encourage satisfied users to leave positive reviews, boosting your app's visibility and credibility.
...
5. Select one of the available functions: [Request App Rating](doc:register-for-push)  or [Request Push Permission](doc:request-app-rating) \`.   
