...
2. Click **+ Campaign**.
3. From the *Messaging Channels* list, select **Native Display**.
...
The *Start here* section helps you define key setup information.
...
* Further refine goals by filtering events using *Revenue Property*. For more details, see [Events](https://docs.clevertap.com/docs/events#event-properties).
...
The *What* section allows you to create your campaign content using different message types:
...
<Image alt="Define User Properties" align="center" width="60% " border={true} src="https://files.readme.io/1ed27bc59c6e6517233af4087fbe3b559a17d524533f3992a9ea8ce4a6694046-image.png">
...
1. Enter the **Title** and **Message** in the *Text* section.
2. You can include CTAs in the *Actions* section. *Native Display* enables various types of call to action (CTA) to cater to different use cases. Choose from one of the following actions (Optional):\
...
3. Upload or personalize media (images, GIFs, videos, or audio) in the *Media* section.\
...
The *Style* tab allows you to customize the look and feel of your message to ensure it aligns with your brand and captures users’ attention. You can adjust the following elements:
...
<Image alt="Set your Style Options" align="center" border={true} src="https://files.readme.io/97e7c4a61196ade266cc17d1dfdbc8af06b48aaa75de19714d8dfd42bf08dfbd-image.png">
...
Set the delivery schedule for live campaigns in the *When* section including:
...
<Image alt="Set Delivery Preferences" align="center" border={true} src="https://files.readme.io/eee9a39d24af56479de1e81faed430fc86ed1a882f1ed58a46c4871ad4792f28-image.png">
