...
excerpt: Understand how a Fintech business can solve its use cases with Signed Call™.
deprecated: false
hidden: false
metadata:
  title: ''
...
User security is of utmost importance in fintech businesses. The fintech businesses can improve the customer experience with the Signed Call™ while uplifting retention rates. The following are real-world examples of how Signed Call can solve business challenges.
...
**Solution** - With CleverTap Signed Call, a user can request an in-app callback. Once the call is initiated, the user does not need to explain the context of the call, thus ensuring speedy issue resolution. Also, phone numbers are not shared, which protects user privacy and security.
