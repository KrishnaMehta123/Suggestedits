...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8258b9c45b9ab558688a950d0f24d8ef781e5db8c314de50fb4296c02390ffe8-image_10.png",
        "",
        "Web Push Errors Stats"
      ],
      "align": "center",
      "border": true,
      "caption": "Web Push Errors Stats"
    }
  ]
}
[/block]
...
| apns_toomany_same_token | Too many requests for the same device token. |
...
| bad_auth             | The authorization header is invalid or missing, causing invalid credentials. |
...
| fcm_sending_rate_exceeded | The sending rate for FCM is exceeded. |
