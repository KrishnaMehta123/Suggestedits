...
- **Qualification criteria**: Deliver the notification based on the following:
  - _Past behavior/Custom list_: Target users based on an activity they performed or have been performing in the past.
  - _Live behavior_: Target users based on their real-time actions and behaviors within your app or website
...
Using the _With user properties_ filter in the _Who_ section, you can segment your campaign to reach users who meet specific criteria. For example, you can send the Inbox campaign to English-speaking female users who live in the United States.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2fd14a4-image.png",
        null,
...
[block:parameters]
{
  "data": {
    ...
    "5-0": "App Fields",
    "5-1": "App fields filters include _App Version_, _Device Make_, _Device Model_, _OS Version_, and CleverTap _SDK Version_. CleverTap's SDK sends this information for each device that has your app, which means a single user can have multiple devices associated with their user profile.",
    "5-2": "OS Version = 10"
  },
  "cols": 3,
  "rows": 6,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9dbb707-image.png",
        null,
        ""
      ],
      "align": "center",
...
- _Send the campaign each time the user qualifies_: This option ensures that every time a user meets the criteria set for the campaign (for example, performing a specific action such as adding an item to the cart), they receive the Inbox campaign.
- _Send multiple campaigns at a particular interval_: This option allows you to set a time interval between consecutive campaign messages to the same user. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5b5b1f7-image.png",
        null,
        null
      ],
      "align": "center",
      "border": true,
      "caption": "Define Limits for Inbox Campaign"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/745fba0-Define_Global_Campign_Limit_.png",
        null,
        "Define Delivery Preferences for Inbox Campaign"
      ],
      "align": "center",
      "border": true,
      "caption": "Define Global Campaign Limits for Inbox Campaign"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ff52028-image.png",
        null,
        ""
      ],
      "align": "center",
