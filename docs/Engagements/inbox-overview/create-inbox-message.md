...
* **Qualification criteria**: Deliver the notification based on the following:
  * *Past behavior/Custom list*: Target users based on an activity they performed or have been performing in the past.
  * *Live behavior*: Target users based on their real-time actions and behaviors within your app or website
...
If you want to create an ad-hoc segment, you can select a type of segment on which to base your campaign. You can create the target based on past user behavior and user properties or live (ongoing) user behavior.

Using the *With user properties* filter in the *Who* section, you can segment your campaign to reach users who meet specific criteria. For example, you can send the Inbox campaign to English-speaking female users who live in the United States.

<Image alt="Filter by User Properties" align="center" border={true} src="https://files.readme.io/2fd14a4-image.png">
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        App fields filters include *App Version*, *Device Make*, *Device Model*, *OS Version*, and CleverTap *SDK Version*. CleverTap's SDK sends this information for each device that has your app, which means a single user can have multiple devices associated with their user profile.
      </td>
...
For more information, refer to [Segments](doc:segmentation).
...
Live behavior campaigns can be set up on a specific event:

* In response to a user event.
* User event/inaction combination (for example, abandoned cart scenario).
* Based on a date event property value of an event (for example, a reminder for upcoming travel booking).

<Image align="center" className="border" border={true} src="https://files.readme.io/9dbb707-image.png" />
...
This option allows you to set limits on how often your campaign messages are sent to users.

* *Send the campaign each time the user qualifies*: This option ensures that every time a user meets the criteria set for the campaign (for example, performing a specific action such as adding an item to the cart), they receive the Inbox campaign.
* *Send multiple campaigns at a particular interval*: This option allows you to set a time interval between consecutive campaign messages to the same user. 

<Image alt="Define Limits for Inbox Campaign" align="center" border={true} src="https://files.readme.io/5b5b1f7-image.png">
  Define Limits for Inbox Campaign
</Image>

#### Global Campaign Limits

This option allows you to apply a limit on how many messages each app user receives per day. This option is enabled by default.

<Image alt="Define Delivery Preferences for Inbox Campaign" align="center" border={true} src="https://files.readme.io/745fba0-Define_Global_Campign_Limit_.png">
  Define Global Campaign Limits for Inbox Campaign
</Image>

You can define the Global campaign limits for Inbox campaigns by navigating to Settings > Setup > Campaign Limits. If you have not set up the limit before creating a campaign, you can do so by clicking the ![](https://files.readme.io/47cb684-Edit_icon.png) icon.

<Image align="center" className="border" border={true} src="https://files.readme.io/ff52028-image.png" />

To learn more about Global Frequency Caps, refer to [Messaging Frequency Caps](doc:messaging-frequency-caps).
