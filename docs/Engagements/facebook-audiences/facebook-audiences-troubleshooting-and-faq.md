...
- The _Campaign Overview_ page will continue to display as expected.
- The _Stats_ page will display data using the old structure for consistency and historical accuracy.
