...
<Image title="Whatsapp personalization.png" alt={2426} className="border" border={true} src="https://files.readme.io/f7d98fb-Whatsapp_personalization.png" />
...
<Image title="liquid personalization 2.png" alt={760} className="border" width="smart" border={true} src="https://files.readme.io/b8ffaab-liquid_personalization_2.png" />
...
<Image title="use case 1.png" alt={2154} className="border" border={true} src="https://files.readme.io/3ed6afa-use_case_1.png" />
...
<Image title="basic ecommerce template.png" alt={1046} width="80%" border={true} src="https://files.readme.io/b0400b3-basic_ecommerce_template.png">
...
<Image title="use case 2.png" alt={2030} width="auto" border={true} src="https://files.readme.io/8ed3468-use_case_2.png">
  Conditional logic using liquid tags
</Image>
