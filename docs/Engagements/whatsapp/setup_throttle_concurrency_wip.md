---
title: Setup_Throttle_Concurrency_WIP
...
<Image title="Templates.png" alt={2318} align="center" className="border" border={true} src="https://files.readme.io/fa88774-Templates.png" />
...
<Image title="image.png" alt={1894} align="center" className="border" border={true} src="https://files.readme.io/c423fd6-image.png" />

3. Navigate to the **Templates** tab.
4. Click **+ Template** .

<Image title="Screenshot 2021-09-21 at 8.37.29 PM.png" alt={2346} align="center" className="border" border={true} src="https://files.readme.io/af37717-Screenshot_2021-09-21_at_8.37.29_PM.png" />
...
<Image title="namespace.png" alt={2879} align="center" className="border" border={true} src="https://files.readme.io/f755093-namespace.png" />

Following is an example of *Namespace* format

<Image title="Screenshot 2021-09-23 at 1.01.12 PM.png" alt={1354} align="center" className="border" border={true} src="https://files.readme.io/d7f6250-Screenshot_2021-09-23_at_1.01.12_PM.png" />

6. Copy and save the approved message templates from your WABA dashboard.

<Image title="Whatsapp interactive.png" alt={1452} align="center" className="border" border={true} src="https://files.readme.io/5729acc-Whatsapp_interactive.png" />
