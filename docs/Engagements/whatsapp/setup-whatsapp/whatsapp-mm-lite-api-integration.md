...
5. A Meta onboarding dialog will appear: \{@krishna, this is not a step}
   ...
   * Review and **grant the required consents**.
     ...
     <Image alt="Meta Onboarding" align="center" width="65% " border={true} src="https://files.readme.io/77d750febd2d9267824f38f28646ac8840ace9d300998276f83943ef97c37dab-meta_onboarding.png">
       Meta Onboarding
     </Image>
