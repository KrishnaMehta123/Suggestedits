---
title: WhatsApp MM Lite API Integration
excerpt: >-
...
5. A Meta onboarding dialog will appear: {@krishna, this is not a step}

   - Select your **Facebook Business Manager**.
   - Review and **grant the required consents**.

     [block:image]{"images":[{"image":["https://files.readme.io/77d750febd2d9267824f38f28646ac8840ace9d300998276f83943ef97c37dab-meta_onboarding.png","","Meta Onboarding"],"align":"center","sizing":"65% ","border":true,"caption":"Meta Onboarding"}]}[/block]
