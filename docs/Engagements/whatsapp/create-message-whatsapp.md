...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6e7ec8fe82fca33ce48d386bc587ae0aff1eeedb404fcf917effee2da67f5ff9-giffe.png",
        "Create New Whatsapp Campaign",
        "Click the +Campaign button and Select WhatsApp to create a new WhatsApp campaign"
      ],
      "align": "center",
      "border": true,
      "caption": "Create a New WhatsApp Campaign"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "WhatsApp Campaign Configuration Page"
    }
  ]
}
[/block]
...
- **Qualification criteria**: Deliver the notification based on _Past behavior_, [Custom list](doc:custom-list-segments), or _Live behavior_ For more information about segmenting users, refer to [Segments](https://docs.clevertap.com/docs/segments).
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "WhatsApp Delivery Preferences"
    }
  ]
}
[/block]
