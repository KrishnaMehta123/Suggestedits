...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/34efc8b-WhatsApp_all_templates.jpg",
        "Email Editor Templates",
        1424
      ],
      "align": "center",
      "border": true,
      "caption": "Select WhatsApp Template"
    }
  ]
}
[/block]
...
From the WhatsApp editor, select the _Message Type_ and click **Go To Editor**.  Select the approved template. For more information on templates, refer to (@Sunil - This information is same as that included under previous doc. can we not simply cross-refer??)
...
You can add up to five custom quick reply buttons and a Marketing opt-out button. It is recommended to add a marketing opt-out button to raise your reputation with WhatsApp.  Use _Body_ to give clear instructions for Opt-outs, such as 'Tap Stop to Opt-out.' The Marketing opt-out button does not automatically unsubscribe users.  You must  configure one of the unsubscription flows <hyper linked> based on incoming keywords.
...
- To track clicks on CTAs within WhatsApp templates, you must create _ Dynamic URL type CTA _ templates with CleverTap tracking domains in the WhatsApp Account Manager.
