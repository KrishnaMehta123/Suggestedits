---
title: WhatsApp Editor (for templates)
...
<Image title="Email Editor Templates" alt={1424} align="center" border={true} src="https://files.readme.io/34efc8b-WhatsApp_all_templates.jpg" /> Select WhatsApp Template

# WhatsApp Templates

Select the template from the template window and start editing it. To create a template from the CleverTap dashboard, refer to [WhatsApp Template using CleverTap BSP](https://docs.clevertap.com/docs/clevertap-bsp#creating-whatsapp-message-templates). There are two types of templates available:
...
From the WhatsApp editor, select the *Message Type* and click **Go To Editor**.  Select the approved template. For more information on templates, refer to (@Sunil - This information is same as that included under previous doc. can we not simply cross-refer??)

<Image title="Whatsapp Editor" alt="Personalize the placeholders based on user/event properties and craft the template" align="center" border={true} src="https://files.readme.io/98aa909-Whatsapp_editor_create_message.png" /> Personalizing Message

### Header

Select text, image, video, document, location. Enter @ to personalize.
...
The footer can contain information such as a phone number for support, or guide the user for actions such as opting out of a marketing campaign. This information is already added.
...
<Image alt="Limited Time Offer Message Components" align="center" width="50%" border={true} src="https://files.readme.io/cd2ade8-LTO_sample.png" />  Limited Time Offer Message Components
### Header

Add an image URL or upload an image. Enter @ to personalize your URL text. 
...
The Copy Offer and Website redirection buttons are automatically added to the Limited Time Offer Template. You can add up to two website redirection buttons and one button each for copying the offer code and calling a phone.

# Quick Reply

You can add up to five custom quick reply buttons and a Marketing opt-out button. It is recommended to add a marketing opt-out button to raise your reputation with WhatsApp.  Use *Body* to give clear instructions for Opt-outs, such as 'Tap Stop to Opt-out.' The Marketing opt-out button does not automatically unsubscribe users.  You must  configure one of the unsubscription flows &lt;hyper linked&gt; based on incoming keywords.
...
<Image alt="Add a Custom Payload" align="center" border={true} src="https://files.readme.io/862aa69-small-quick_reply_button.png" />  Add a Custom Payload
...
<Image alt="WhatsApp Click Tracking Message " align="center" width="25%" border={true} src="https://files.readme.io/d82dc12-Whatsapp_click_track_end_user.jpg" /> WhatsApp Click Tracking Message
...
<Image alt="Click Track Text Header" align="center" border={true} src="https://files.readme.io/e14bea3-Whatsapp_editor_click_track_header_.jpg" />  Click Track Text Header
...
<Image alt="Click Track Message Body" align="center" border={true} src="https://files.readme.io/3234965-Whatsapp_editor_click_track_body.jpg" />  Click Track Message Body
...
<Image alt="Add or Replace Templates" align="center" width="60%" border={true} src="https://files.readme.io/d48c8e0-2023-09-25_17-21-03.jpg" /> Add or Replace Templates
