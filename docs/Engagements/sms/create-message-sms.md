...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8f48e3b4e1aac8482a265e15abe0b34cb640abc7ddf63b7399d18c6b6c14cbc2-Select_SMS_Campaign.png",
        "Click +Campaign and Select SMS",
        2796
      ],
      "align": "center",
      "border": true,
      "caption": "Create SMS Campaign"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "View Campaign Page Steps",
        1107
      ],
      "align": "center",
      "sizing": "80",
      "border": true,
      "caption": "View Campaign Page"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Set a Goal and Select Conversion Tracking Rules",
        919
      ],
      "align": "center",
      "border": true,
  ...
  "images": [
    {
      "image": [
        ...
        "Define the Target Segment and Click Done",
        961
      ],
      "align": "center",
      "border": true,
      "caption": "Define Target Segment"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Filter the Target Segment by User Properties",
        2376
      ],
      "align": "center",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/474530b-Control_Group_and_Target_Cap.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c867bf1-image.png",
        null,
        "Define-What"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9e5877265e518d82bfec0ea9b7bbb320b67ec9d81dcca6064462a45617043f1e-Create_Message_SMS.png",
        "",
        "Create Message"
      ],
      "align": "center",
...
Once you are all done setting up the content of your campaign in the _What_ section, you have the option to send a test SMS.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/df88567-image.png",
        null,
        "Select Message Type"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/087cf49-SMS_What_User_Property_variant.png",
        "Create Message and Its Content",
        3476
      ],
      "align": "center",
      "border": true,
      "caption": "Create Message Content"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Select Message Date and Time to Send",
        978
      ],
      "align": "center",
      "border": true,
  ...
  "images": [
    {
      "image": [
        ...
        "Set Up the Different SMS Delivery Preferences",
        838
      ],
      "align": "center",
      "border": true,
      "caption": "Set Up Delivery Preferences"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "CLick Publish Campaign to Publish it",
        1193
      ],
      "align": "center",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9bc74aeb0814633f881aa3b1ddaadca049e395bb61df7f9f55379bad0c76a63c-image.png",
        null,
        "System Domain Creation"
      ],
      "align": "center",
      "border": true,
      "caption": "System Domain Creation"
    }
  ]
}
[/block]
