...
Advanced Personalization in CleverTap lets you customize and personalize your website content dynamically based on user attributes, behaviors, and events. It includes powerful tools such as the Visual Editor, helping you deliver relevant, real-time experiences with minimal development effort.
...
1. Go to _Advanced Personalization_  and select **Visual Editor**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cf837f4296717228fbaddc0af9eedff07cfed6313eed05e7f15f25b361a76718-2025-03-23_16-00-49.png",
        "",
        "Visual Editor"
      ],
      "align": "center",
...
3. After the website loads in the editor, hover over the elements to highlight them. Click any element to open the inline editor menu to edit the specific element. The dropdown menu appears with the following options:
   1. [Edit Element](https://staging.docs.user.clevertap.net/docs/web-native-display-editor#edit-element)
   2. [Edit HTML](https://staging.docs.user.clevertap.net/docs/web-native-display-editor#edit-html)
   3. [Hide](https://staging.docs.user.clevertap.net/docs/web-native-display-editor#hide)
   4. [Insert Element](https://staging.docs.user.clevertap.net/docs/web-native-display-editor#insert-element)
   5. [Add JSON](https://staging.docs.user.clevertap.net/docs/web-native-display-editor#add-json)
   6. [Track Clicks](https://staging.docs.user.clevertap.net/docs/web-native-display-editor#track-clicks)
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c85e7610925b65d319ebf070ed33a4b47eb7c0b36ae450b31738ba8ee6c57257-2025-03-23_16-20-39.png",
        "",
        "Select Editor"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3231a766c38ad64153087bb63af20bb25b558e22093c2471a89a07be9fd2e1a6-2025-03-23_18-00-18_1.gif",
        "",
        "Edit Element"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7e5f40fde7c193e6a6b079495333c7bf5c334800d94a15ed0f427544055336b8-2025-03-23_18-09-19.png",
        "",
        "Personalisation in Visual Editor"
      ],
      "align": "center",
      "sizing": "100% ",
      "border": true,
      "caption": "Personalization in Visual Editor"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/09dc96c7fe21166f3b80ceee4d606c3db0692aee614fc9fb66dba731fb405a16-html.png",
        null,
        "Custom HTML"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a9e28e12650d4a6755b4539c5003b90d74146ada8b29e987cc21264cfc990f37-2025-03-23_17-52-26.png",
        "",
        "Hide on devices"
      ],
      "align": "center",
      "caption": "Hide on devices"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d89ea5257531e0beaa999ec0240337c4b123cb9da42b62e0288e09b2e45f694c-2025-03-23_17-54-16.png",
        "",
        "Insert Element"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fb3067387607ece0ce6ff232203fb840e00723a64555cae98c97127a22a53a2a-l.png",
        "",
        "Add JSON"
      ],
      "align": "center",
...
The Click Tracking feature allows element-wise tracking. Click **Track Clicks**, add a name, and click **Save** to start tracking. This name will be added as a value of the `wzrk_c2a` property in the Notification Clicked event. You can view the Click Tracking data under _Dashboard_ > _Analytics_ > _Events_. For more information, refer to [Events](https://docs.clevertap.com/docs/events).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0b2e587c69925bd3ef26c3528c53f5f6f84bfca007bebeb4c9f86e59fd1eac09-2025-03-23_17-49-02.png",
        "",
        "Track Clicks"
      ],
      "align": "center",
      "border": true,
      "caption": "Track Clicks"
    }
  ]
}
[/block]
...
4. You can preview and edit your website as it appears on desktop and mobile devices using the _Device Toggle_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b2dc3a6daaa8bd3d07eb59676c835fafee7d17bd118aece7592010fd7037ee48-2025-03-23_16-42-07_1.gif",
        "",
        "Mobile View"
      ],
      "align": "center",
...
5. You use the dropdown menu to adjust screen sizes and test responsiveness.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e83e2b0506a6544ae5a677cefd8600276b1284beaec04d0bd43161445c411a6b-2025-03-23_16-44-30.png",
        "",
        "Web Size"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/11942134a1cbf707b76db0af2cb7af5270b9dc263423a0f588cf575deb7ddd21-2025-03-23_16-46-17.png",
        "",
        "Mobile Size"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ae9ad6940d17b173d542a5fae23011f6de87ab02e3d3b0ac9c11242d9e1b2349-image.png",
        null,
        "Browse Mode"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ce3132c035dd478c70249e369cf07ba363c7291174433351d3df598be2ecc172-2025-03-23_16-49-38.png",
        "",
        "Changelog"
      ],
      "align": "center",
...
> 📘 Note
> 
> - CleverTap offers Custom Templates as a part of the _Advanced Web Personalization_ paid add-on. 
> - Custom Templates are currently under Private Beta. Contact your customer success manager to enable this feature for your account.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ff74e3ce480f8412fdc48492526b73dea436a23a87c0ee3d3380c2fdea4fcf6b-image.png",
        null,
        "Custom Templates in Advanced Personalization"
      ],
      "align": "center",
      "border": true,
      "caption": "Custom Templates in Advanced Personalization"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bac25bc341cdfb1063bdb9f711ec9482e17640f32bbb176bf59f3e1cf680217d-Custom_HTML_template.png",
        null,
        "Custom HTML Template"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/941447672dae7eb8100e84c6edf5afb30e871a7b81da8632ce12bdb852455d17-image.png",
        null,
        "Custom JSON Template"
      ],
      "align": "center",
