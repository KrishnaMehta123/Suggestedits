...
<Image alt="Web Native Display Editor." align="center" border={true} src="https://files.readme.io/b71dad4-visual_editor.jpg">
...
<Image title="Configure Custom Key-Value Pairs" alt={1596} align="center" border={true} src="https://files.readme.io/bd5c152-web_native_display_key_value.png">
...
<Image title="Configuring a Banner Template" alt={2558} align="center" border={true} src="https://files.readme.io/79e565b-banner_1.png">
  Banner Template
</Image>
...
<Image title="Setting up a Banner with Text Template" alt={2868} align="center" border={true} src="https://files.readme.io/fe8f080-banner_text.png">
  Banner With Text
</Image>

Under the *Style* tab in the editor, you also have the option to align the title and description of your banner as per your design guidelines. You can also define the font style, size,  and color of the title and description.

<Image title="Style your Banner" alt={2544} align="center" border={true} src="https://files.readme.io/12ecfc1-banner_font_2.png">
...
<Image title="Banner with Carousel" alt={1272} align="center" border={true} src="https://files.readme.io/ec98127-banner_carousel_gif_1.gif">
...
<Image title="Set the Slider Time for Auto Scroll" alt={1454} align="center" border={true} src="https://files.readme.io/37db7f7-Screenshot_2022-12-11_at_4.35.07_PM.png">
  Define Scroll Time
</Image>
...
<Image title="Set up Banner Carousel with Text Template" alt={1264} align="center" border={true} src="https://files.readme.io/3fa56dc-banner_carousel.gif">
  Banner Carousel with Text
</Image>

Under the *Style* tab in the editor, you also have the option to align the title and description of your banner as per your design guidelines. You can also define the font style, size,  and color of the title and description.

<Image title="Customize Web Inbox Appearance" alt={2554} align="center" className="border" border={true} src="https://files.readme.io/5ee93bf-font.png" />
...
<Image alt="Visual Editor" align="center" border={true} src="https://files.readme.io/47fecda-ve_1.jpg">
  Visual Editor
</Image>
...
<Image alt="Select Editor" align="center" border={true} src="https://files.readme.io/e5eb090-Editor_type.jpg">
  Select Editor
</Image>
...
4. Select the type of editor (Form, HTML, JSON) you require and click **Continue**.
   ...
   2. For example, if you select a text element, the *Form* editor allows you to modify the Font, Font size, Font Weight, Text Style, Text Color, Margin, Padding, and so on.

      <Image alt="Customize Text using Form Editor" align="center" border={true} src="https://files.readme.io/7010855-Form.gif">
        Customize Text using Form Editor
      </Image>
   3. If you select an image for customizing, the *Form* editor allows you to modify the image URL, on-click operations, and overall image dimensions across device types.

      <Image alt="Customize Image using Form Editor" align="center" border={true} src="https://files.readme.io/fc23665-image_form.jpg">
        Customize Image using Form Editor
      </Image>
