---
title: TikTok Remarketing Campaign Stats
...
After the campaign is live, you can view the campaign stats from the dashboard by navigating to the _Campaigns_ page and selecting the campaign of interest to view the following stats: Unique Sent, Audience Size (old), Audience Size (Current), Conversions. 
