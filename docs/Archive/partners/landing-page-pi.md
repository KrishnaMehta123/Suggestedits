...
<body>
    ...
    <a href="https://staging.docs.dev.clevertap.net/docs/adjust">      <!-- change the link here for re-directing -->
     ...
     <a href="https://staging.docs.user.clevertap.net/docs/amazon-eventbridge">
      ...
      <a href="https://staging.docs.user.clevertap.net/docs/data-export-to-aws-s3">
        <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/93783ddfa75cf49849085df73055ed5648715c6e5986cda3a2a1c5713ef79b5d-AWS_S3_Eventbridge.jpeg" alt="Amazon S3" class="logo">
            </div>
            <div class="content">
    ...
    <a href="https://staging.docs.user.clevertap.net/docs/bigquery-export">
      <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/d0d72890d0ba41924e06bf571d2cf1c981a032d5db9935bd9b00160ab9492ab9-BigQuery.webp" alt="BigQuery" class="logo">
            </div>
            <div class="content">
      ...
      <a href="https://staging.docs.dev.clevertap.net/docs/branch">
        <div class="integration-card">
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/41e2da3a829fecb0b3432cd1c685106eadb34c9cb37e45a46abfff09f66795db-Census.svg" alt="Census" class="logo">
            </div>
            <div class="content">
    ...
    <a href="https://staging.docs.user.clevertap.net/docs/crowdin"> 
      ...
      <a href="https://staging.docs.user.clevertap.net/docs/exotel-whatsapp"> 
       <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/33347aa0f1b003823019de7c681a0b9385efb15521daf7e415009ad5cd6100f6-Exotel.jpeg" alt="Exotel" class="logo">
            </div>
            <div class="content">
     ...
     <a href="https://staging.docs.user.clevertap.net/docs/facebook-audience-network-1"> 
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/ce9618bf8a67a2eb1cb026cb8603318b81b8218562fa805c333c531403a2a4c9-Facebook_Symbol_0.svg" alt="Facebook" class="logo">
            </div>
            <div class="content">
        ...
        <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/5d8f65d75d9cfaa7c388beb52805563d3ac83b071eee9ad0138afd672d275577-Google_Cloud_Platform.webp" alt="Google Cloud" class="logo">
            </div>
            <div class="content">
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/ba59994643f56bb5dd9ad8e5b95b14b6f3f5c5bc8a8390e79143e63e94d29155-Gupshup.svg" alt="Gupshup" class="logo">
            </div>
            <div class="content">
     ...
     <a href="https://staging.docs.user.clevertap.net/docs/haptik"> 
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/0848f45eaf97798b442ebb4f4367056f8db840c012c94977ff861aba1667628a-Hightouch-logo_black.svg" alt="HighTouch" class="logo">
            </div>
            <div class="content">
       ...
       <a href="https://staging.docs.user.clevertap.net/docs/mixpanel"> 
        <div class="integration-card">
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/ff59d84f553556fde9e6a96f5a7f75feb1471b58845f8a2fe811e9c584c2c774-mParticle.svg" alt="mParticle" class="logo">
            </div>
            <div class="content">
         ...
         <div class="integration-card">
           ...
           <a href="https://staging.docs.user.clevertap.net/docs/generic-sms_em-1033"> 
         <div class="integration-card">
            <div class="logo-container">
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/70be3c6be960d745b23307965cf83d2c6292a70ca2f1cd5cb243f0f47a81c558-OpenWeather.png" alt="OpenWeather" class="logo">
            </div>
            <div class="content">
         ...
         <div class="integration-card">
           ...
           <a href="https://staging.docs.user.clevertap.net/docs/plot-projects"> 
         <div class="integration-card">
            <div class="logo-container">
        ...
        <div class="integration-card">
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/d4562460f8d2226fde3e9259d8a7c0d70bdb211842adcc45b31c3eb64bd6c3e3-sendgrid-vector-logo-2022.svg" alt="SendGrid" class="logo">
            </div>
            <div class="content">
           ...
           <a href="https://staging.docs.dev.clevertap.net/docs/imports-via-sftp#receive-imports-notification"> 
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/a5fe31a101addc2380465a996f78b89c960fb4aedb53aac0172cd20fe1ff069d-SFTP.png" alt="SFTP" class="logo">
            </div>
            <div class="content">
        ...
        <div class="integration-card">
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/b2fbe403e42f3d463d980dbbd9b57da541b5dcbfc17e2b08ed6c28d8446e65aa-logo-horizontal.svg" alt="Stripo" class="logo">
            </div>
            <div class="content">
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/14ea9f0f2d1b3edd08dc3ee8df7592acce126e6db2121b7c29e8f72cc5a8b409-TikTok_Logo_Alternative_0.svg" alt="TikTok" class="logo">
            </div>
            <div class="content">
         ...
         <div class="integration-card">
            <div class="logo-container">
                <img src="https://files.readme.io/92d05c65e52c0780798740d35d0c4bdfd12b3758e2d42b6266a3343e251f2558-timesmobile.jpeg" alt="Times Mobile" class="logo">
            </div>
            <div class="content">
