...
4. Check the following from the _Deliverability Data_ and _Engagement Data_ in the SendGrid Dashboard: Dropped, Bounced, Unsubscribed From, and  Marked as Spam.
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Enable Event Notifications for Emails via SendGrid"
    }
  ]
}
[/block]
