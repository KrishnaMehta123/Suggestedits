...
>
> As journeys is an orchestration platform, precomputed segments are not applicable when creating journeys.
...
![1221](https://files.readme.io/4e1fcdb-Segments_all_operations.png "Segments_all_operations.png")

# Create Segments

To create new segments, navigate to *Segments* under the *Segmentation* tab on the dashboard.

<Image title="d99e397-Screenshot_2020-06-08_at_12.12.29_PM.png" alt={2278} className="border" border={true} src="https://files.readme.io/809321d-d99e397-Screenshot_2020-06-08_at_12.12.29_PM.png" />
...
<Image title="Types of Segment.gif" alt={1246} className="border" border={true} src="https://files.readme.io/a622721-Types_of_Segment.gif" />
...
<Image title="Segments_Created_Segment.png" alt={788} className="border" border={true} src="https://files.readme.io/ccf346b-Segments_Created_Segment.png" />
...
<Image title="Segment_Live_Segment_Report.gif" alt={1218} className="border" border={true} src="https://files.readme.io/2b9ceec-Segment_Live_Segment_Report.gif" />
...
<Image title="Segment Details page.png" alt={1233} className="border" border={true} src="https://files.readme.io/c8aa3e0-Segment_Details_page.png" />
