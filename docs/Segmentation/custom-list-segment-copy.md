---
title: Custom List Segment_TEC-309
excerpt: ''
deprecated: false
hidden: true
metadata:
...
<Image title="An Email is Sent After the File is Processed" alt={1109} align="center" border={true} src="https://files.readme.io/772be36-Segments_Custom_list_email_successful.png" />  View Segment Details - Email
...
<Image title="An Email is Sent if the Error Occurs" alt={1107} align="center" border={true} src="https://files.readme.io/a043cdf-File_Upload_error.png" />  File Upload Error - Email
...
| File re-upload failed | The segment could not be refreshed with the latest file. The segment will be available with the last successful update. Refer to the [View Segment Details](https://docs.clevertap.com/docs/custom-list-segments#section-segment-details) page for the last updated file. |
...
<Image title="Use the Custom List Segment from the Who Section of Campaign" alt={2744} align="center" border={true} src="https://files.readme.io/6e467c4-segments_custom_lists_WHO.png" />
  Custom List Segment