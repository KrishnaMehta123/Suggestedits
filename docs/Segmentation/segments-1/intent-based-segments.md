...
next:
  description: ''
---
@DOCS: EDIT THIS HACKATHON DOC TO ADHERE TO STYLE GUIDE LATER AND UNPUBLISH (OR DLETE) EXISTING PAGE https://docs.clevertap.com/docs/predictive-segments LATER
