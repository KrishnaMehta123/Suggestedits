...
next:
  description: ''
---
DOCS NOTE: BEFORE PUBLISHING THIS DOC, ENSURE THAT THE EXISTING PAGE IS UNPUBLISHED (OR DELETED): [https://docs.clevertap.com/docs/find-people](https://docs.clevertap.com/docs/find-people)
...
> 📘 Search By Identity
>
> You can also search users by identity such as email, user ID, and CleverTap ID.

> 📘 Bookmarked Segments
>
> You can bookmark queries that you run to find people with different parameters. This section only shows your bookmarks but not those from your colleagues.

![1200](https://files.readme.io/3a3f44b-Find_People1.png "Find People1.png")
...
![1435](https://files.readme.io/94a4712-Save_segment_or_bookmark.png "Save segment or bookmark.png")
