...
You can use the **Predominantly** option to select only users that have mostly purchased shoes out of their total purchases. In other words, the selected users may have purchased other items, but they have purchased shoes the most out of their total purchases.

<Image title="image4.png" alt={842} className="border" border={true} src="https://files.readme.io/dfd660a-image4.png" />
...
<Image title="image3.png" alt={846} className="border" border={true} src="https://files.readme.io/cfc3573-image3.png" />
...
<Image title="image2.png" alt={853} className="border" border={true} src="https://files.readme.io/559a9ca-image2.png" />
...
<Image title="image1.png" alt={845} className="border" border={true} src="https://files.readme.io/54a1b0c-image1.png" />
