...
<Image title="Segment List Page.png" alt={2400} className="border" border={true} src="https://files.readme.io/5e2b0e0-Segment_List_Page.png" />
...
<Image title="predictive_segment_example.png" alt={797} className="border" border={true} src="https://files.readme.io/4a21345-predictive_segment_example.png" />
