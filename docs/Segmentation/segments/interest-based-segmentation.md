...
{
  "type": "success",
  "title": "Predominately vs At Least",
  "body": "The **Predominately** option means the event property you select will only include users, where that event property is the most frequently occurring event property for the user. The **At Least** option lets you specify the specific percentage you need."
}
[/block]
# Interest by Time of Day
