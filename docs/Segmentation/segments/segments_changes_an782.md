---
title: Segments_Changes_AN782_WIP
excerpt: Understand segmentation and its various uses.
deprecated: false
hidden: true
metadata:
  title: ''
...
<Image title="Segment_list.png" alt={1208} border={true} src="https://files.readme.io/ec1520f-Segment_list.png">
  Segment list page
</Image>

# Create Segments

To create new segments, click *+Segment*.
...
Click **Save segment**, name the segment, and it then shows up in the *Segments* list.
