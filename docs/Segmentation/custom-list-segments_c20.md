---
title: Custom List Segments_C20
excerpt: ''
deprecated: false
hidden: true
metadata:
...
<Image title="segments_custom_lists_WHO.png" alt={2744} className="border" border={true} src="https://files.readme.io/6e467c4-segments_custom_lists_WHO.png" />