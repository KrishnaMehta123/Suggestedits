...
You will see the following trends with some presets. You can modify these presets by clicking the edit \<img src="[https://files.readme.io/d0f481d-icon\_edit.png"height=“8px”](https://files.readme.io/d0f481d-icon_edit.png"height=“8px”) width=“8px” > icon. 
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This is your current conversion rate. It shows the percentage of active users that converted.
      </td>
    </tr>
...
Shows the trend of users that transitioned from other stages into the selected stage. 

![1346](https://files.readme.io/f94b25d-LCO_Stats_into_a_stage.png "LCO_Stats_into_a_stage.png")

* From a stage

Shows the trend of users that transitioned to other stages from the selected stage. If the model is set up optimally, the users must transition from a lower stage to a higher stage. 
