...
<Image title="Get Started with Lifecycle Optimizer" alt="Screenshot of the Lifecycle Optimizer dashboard, displaying the steps to get started." width="100%" border={true} src="https://files.readme.io/c88a2f0-LCO_Retention_Main_Steps.png">
...
<Image title="Key metrics overview for all users" alt="Screenshot of the dashboard, displaying key metrics for all users across the customer lifecycle." border={true} src="https://files.readme.io/a3bd720-LCO_Current_Retention.png">
...
<Image title="Select a customer lifecycle framework." alt="Screenshot of the dashboard, displaying options to choose framework for the lifecycle." border={true} src="https://files.readme.io/6f1756a-LCO_Setup_Framework_Select.png">
...
<Image title="Choose AIC Events" alt="Screenshot of the dashboard, displaying options to choose AIC events that qualify users into each stage of the lifecycle." border={true} src="https://files.readme.io/360d773-LCO_select_events_AIC.png">
  Define Lifecycle Stages
</Image>

### AARRR Events

<Image title="Choose AARRR events" alt="Screenshot of the dashboard, displaying options to choose AARRR events that qualify users into each stage of the lifecycle." border={true} src="https://files.readme.io/9b58a11-LCO_select_events_AARRR.png">
  Define Lifecycle Stages
</Image>
...
<Image title="Choose preferred values" alt="Screenshot of the dashboard, displaying the options to select qualifying time frame, usage interval, and control group." border={true} src="https://files.readme.io/fee15f4-LCO_choose_preferred_values.png">
...
<Image title="Lifecycle optimizer dashboard" alt="Screenshot of dashboard, displaying Lifecycle Optimizer model." border={true} src="https://files.readme.io/780b17b-LCO_Dashboard_Main.png">
...
<Image title="Create engagement for each stage." alt="Screenshot of the dashboard, displaying Engagement Stats." border={true} src="https://files.readme.io/3003dba-LCO_Enagement_Create.png">
...
<Image title="Define engagement for users." alt="Screenshot of the dashboard, displaying how to define engagement for users." border={true} src="https://files.readme.io/db869fe-LCO_Engagment_Define.gif">
  Define Engagement
</Image>
...
<Image title="Create a journey" alt="Screenshot of the dashboard, displaying how to define engagement node using a journey." border={true} src="https://files.readme.io/57b756c-LCO_Journey.png">
  Create a Journey
</Image>
...
<Image title="Engagement statistics" alt="Screenshot of the dashboard, displaying distribution of the users across the lifestyle stages." border={true} src="https://files.readme.io/c7dfdb7-lifecycle_distribution_stages.png">
...
<Image title="User change over time" alt="Screenshot of the dashboard, displaying change in user count between yesterday and the selected date." border={true} src="https://files.readme.io/422bd93-LCO_Stats_Change_over_time.png">
...
<Image title="Interstage transition of users" alt="Screenshot of the dashboard, displaying how users transition across different stages." border={true} src="https://files.readme.io/59aa509-LCO_Stats_Inter_stage_Transitions.png">
...
<Image title="Daily user transition trends" alt="Screenshot of the dashboard, displaying daily user transition trends from other stages into the selected stage." border={true} src="https://files.readme.io/f94b25d-LCO_Stats_into_a_stage.png">
...
<Image title="Daily user transition trends" alt="Screenshot of the dashboard, displaying daily user transition trends from selected stage into other stages." border={true} src="https://files.readme.io/e10b9d6-LCO_Stats_from_a_stage.png">
