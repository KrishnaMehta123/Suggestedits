...
For example, if someone adds an item to your cart but doesn't transact within 15 minutes, you can send them a notification this workflow.
...
I should set up my abandoned cart trigger in CleverTap for Toys as a category with a delay of at least 10 mins. i.e. If someone adds toys to their cart and doesn't buy it within 10 mins, I should send them a notification since 80% of my users who did bought toys did it within 10 minutes.
