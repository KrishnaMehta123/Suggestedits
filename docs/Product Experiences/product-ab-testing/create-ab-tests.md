...
excerpt: Learn how you can create and manage your A/B Tests
deprecated: false
hidden: false
metadata:
  title: ''
...
To help you get started with A/B Testing on CleverTap, this page describes the fundamentals of creating and managing an A/B test.
