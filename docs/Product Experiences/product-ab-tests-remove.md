...
[block:callout]
{
  ...
  "body": "The old Product A/B Tests will be deprecated from 25th Nov 2020. However, our new Product A/B Tests will be available after it. The documentation for these new A/B tests will be available under the Product experiences section."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/612ad5f-Product_Exp_View.png",
...
{
  "type": "info",
  "body": "Hover, over the Experiment Stats to check the statistical significance of each of your variants. Statistical significance provides a measurable impact for your winning variant to eliminate any possibility of a chance winner. We use t-test to measure statistical significance. For more information on statistical significance, see our blog:\n\nhttps://clevertap.com/blog/how-to-identify-and-mitigate-risk-in-a-b-testing/",
