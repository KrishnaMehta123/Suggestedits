...
>
> A new and enhanced version of [Product A/B Tests](https://docs.clevertap.com/docs/product-ab-tests)  is now available. However, existing customers can continue using the legacy version of A/B Tests.
...
<Image title="AB_Test_Create.png" alt={801} align="center" border={true} src="Define A/B tests from CleverTap's A/B Tests page">
  Defining A/B Tests
</Image>
...
<Image title="AB_Variant_Create.png" alt={842} align="center" border={true} src="Create variations and define corresponding keys for A/B Tests">
