...
> 
> A new and enhanced version of [Remote Config](https://docs.clevertap.com/docs/remote-config)  is now available. However, existing customers can continue using the legacy version of Product Experiences.
