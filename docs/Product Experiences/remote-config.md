...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9eca507-small-Variable_types.png",
        null,
        "Sample Variables of Different Data Types of a Gaming App"
      ],
      "align": "center",
      "border": true,
      "caption": "Sample Variables of Different Data Types of a Gaming App"
    }
  ]
}
[/block]
...
If a user qualifies for two segments - _Paying Users_ and _All Users_, in this case, the user will see the variable value defined for the _Paying Users_ segment as shown below.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ff9a526-small-Segment_priority.png",
        null,
        ""
      ],
      "align": "center",
