...
1. Log in to your Fillout dashboard and click **Create Form** to start from scratch or use a _Template_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3be325758be7f3b3a46b1f3bdf046fac834132b335434b926b61aadf63ae2740-image.png",
        null,
      ...
      "sizing": "65% ",
      "border": true,
      "caption": "Create and Configure a Form in Fillout"
    }
  ]
}
[/block]
...
3. In the _Settings_ tab, open _URL Parameters_ and add dynamic parameters such as `name` and `email` to pass CleverTap profile data.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2ef1860eb23cad8c35222bd8c052b31759ca486315b16f01a53c2ddbcd9d9b5c-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4ca7dc750453d227acc71a1fc2aa2f33c23944f1f36177a8d8ae8a8e13050f68-image.png",
        null,
        "Publish Form"
      ],
      "align": "center",
...
5. Go to the _Share_ tab > _Embed Form_, select _Embed type_ as  _Standard_, click on **\</>Get the code**, to copy the embed code.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/438f6842f4c90db0bec692d88f70dae6d183952a0bec133784fd553c52d19879-image.png",
        null,
        "Copy Embed Code"
      ],
      "align": "center",
...
3. Replace the existing code with the HTML snippet copied from _Step 5_ of [Create a Form in Fillout](doc:fillout#create-a-form-in-fillout).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/95713037d15f7a806a3e66e16897b060d3685f5bd23b1137dfaccf49f0d150d9-image.png",
        null,
      ...
      "sizing": "65% ",
      "border": true,
      "caption": "Embed Fillout Form in CleverTap Campaign"
    }
  ]
}
[/block]
...
2. **Set up a Trigger**. To do so, perform the following steps:
   1. Select _Fillout Form_ in the App section. This starts the Zap when a trigger event occurs on the Fillout form.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5842f5f60cd2794d00752952febcfe700e11eebcd0dd9a4765b5bb44b6be430e-2025-11-09_17-41-57_1.gif",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d7a353ac9804ed2687967dee1abb4fba2796ca74c0859afb98e47592d4cbd7ea-image.png",
        null,
...
5. **Select the Action** that the zap must perform after the trigger event occurs. To do so, perform the following steps:
   ...
   3. Select _Account_ to connect the CleverTap account. The Zapier window opens. Enter all the required details to connect to the CleverTap account. Enter the same passcode you obtained during the [Create a Passcode on CleverTap Dashboard](doc:fillout#create-a-passcode-on-the-clevertap-dashboard) step.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/02b2ee93834c3070e98a67596b7ae15c25a8f33ca5869cb2eefdab8142c38bcd-2025-11-09_17-45-54_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/67c7784504dd0c845351a6098feff92380ee9cc3d818a6f441254b417224061e-image.png",
        null,
...
1. Follow _Step 1_ to _Step 4_ from [Create/Update User Profiles](doc:fillout#createupdate-user-profiles) to configure Fillout as the trigger.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3942272058be57f6d086d539bc57c34eba36276df4852526e92089cd52fae58c-image.png",
        null,
        "Select the Action for Zap"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/30b1c847706b02eca7b600f547a5627f6f24b5f8f0f2f699bbcb765c926481c5-7e389343-4e60-4ac5-920d-aae5919446c5.png",
        null,
        "In-App Message"
      ],
      "align": "center",
