...
- Funnel Optimization: Track _Add to Cart_ and _Purchase_ events to identify checkout drop-offs.
...
2. From the top-right navigation, select _Projects_ > _Your Project Name_.
...
A webhook allows CleverTap to automatically send event data, such as  _Purchase_, to Heap in real time.

To create a webhook:

1. Go to _Settings_ > _Channels_ > _Webhook_ in CleverTap dashboard
2. Click **+ Add Webhook**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5e58c0eb1ba1070b73e8c10a6f25c72297cb4ae0491cd50a4bb52c81021ed84f-2025-11-10_10-39-40_1.gif",
        "",
        "Create webhook"
      ],
      "align": "center",
...
| HTTP Method     | Set _HTTP Method_ to`POST`                                                  |
| Destination URL | Enter the following _Destination URL_:`https://heapanalytics.com/api/track` |
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/14b1d3edf33a1a031b925fbb56c095c464824fe70cb03b10bd79e5e5adcf7415-image.png",
        null,
        ""
      ],
      "align": "center",
...
1. Go to _Campaigns_ > **+ Campaign** > _Webhooks_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2413130f036cd48aaabfa67d13bb027f0fbf1daf666b37331fae2efce0b4d844-2025-11-10_11-20-25_1.gif",
        "",
...
3. Define your target audience, for example, users who received a _Cart Reminder_ push notification.
4. Under the _What_ section:

   - _Content Format_: `JSON`
   - _Custom Body_: Enter your event payload. [Example Heap payload](doc:heap#example-heap-payload)
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f37e71007be91601f2ede19ed4cf3863680137d2d54e79c8fb5f216a63bf02e8-image.png",
        null,
        "Example Payload"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7a552d584fb140008d544e141ccf28a50149de4fb81469eb5b2319315f208d67-image.png",
        null,
        "Preview and Test"
      ],
      "align": "center",
...
2. Go to your project workspace, and click _Data_ in the left-hand menu.
3. Search for the event name _Purchase_ to confirm that the event is being received by Heap.
4. Click the event name to review details such as:
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/eff422878dd54c35124825a8527e5f93a9d0bf9c5a98e59dddc9130c02389e8d-tuja.png",null,"Verify Event Data"],"align":"center","sizing":"75% ","border":true,"caption":"Verify Event Data"}]}[/block]
...
1. Go to your project workspace, and click _User_ in the left-hand menu.
2. Click the user’s profile to view event details and confirm that:
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/85712305b33f4a012b9fb482c9d54bd49c66a3dc2466bc3ed1a1d5435bb55952-aaja.png",null,"Verify User Data"],"align":"center","sizing":"75% ","border":true,"caption":"Verify User Data"}]}[/block]
...
Both the _Purchase_ event and corresponding user data appear in Heap’s timeline with the same metadata passed from CleverTap, confirming that your integration is functioning correctly.

### Analyzing Results in Heap

With _Purchase_ events now tracked in Heap, your marketing team can explore insights such as:

- Conversion Rates: Compare users who received a CleverTap campaign vs. those who didn’t.
- Behavioral Paths: Analyze how users move from _Add to Cart_ to _Purchase_.
