...
* Permission to access *Object Manager*, *App Manager*, and *Apex Classes* on Salesforce.
...
* [Username-Password OAuth Flow](https://help.salesforce.com/s/articleView?id=sf.remoteaccess_oauth_username_password_flow.htm) enabled under *Setup > OAuth and OpenID Connect Settings* on the Salesforce dashboard.
...
1. Select the *Setup* tab on the Salesforce dashboard.

2. Go to *Platform Tools* > *Apps* > *External Client Apps*. 
...
<Image alt="Connected App - Salesforce" align="center" border={true} src="https://files.readme.io/e9ea8f9db181888256880aff025dc70b30fa3d8afd91c1f7478ca4276bfffef7-Screenshot_2025-07-10_at_10.33.17_AM.png">
  Connected App - Salesforce
</Image>

3. Click **New Connected App** and fill in the form with the required fields:

   <Image alt="Fill Form for New Connected App" align="center" width="75% " border={true} src="https://files.readme.io/d7d8a73451c271a7add7c8bcb90027d43726da557080ebd363c5e1fbb7c73777-image.png">
     Fill Form for New Connected App
   </Image>

   <br />
4. Click **Save**. It may take 2–10 minutes for the changes to take effect. 

<Image alt="New Connected App - Salesforce" align="center" width="70% " border={true} src="https://files.readme.io/26be75838fbb07d4e04ee035773126587b583944f4a01bedafdc6a0bb6ede8a0-Screenshot_2025-07-08_at_5.15.20_PM.png">
...
3. Go to *App Manager* > *[Your Connected App]* > and select *Manage Consumer Details* from the list of actions. 
   1. <Image alt="App Manager - Salesforce" align="center" border={true} src="https://files.readme.io/bad6c472d33e7f831d129bbff5e98c5ef4a530193f3216fd611452dd7e06b506-2025-07-03_14-34-48_1.gif">
...
4. Copy and save the following credentials securely. These values will be required later when configuring the webhook in CleverTap for OAuth 2.0 authentication.
   ...
   * **Client Secret**: Authenticates the app during token generation. 
     1. * <Image alt="Client ID and Client Secret - Salesforce" align="center" border={true} src="https://files.readme.io/f8d88b7075bf5407457a0ccf993c28d607b54cf31c52cb65835c6d1a0d2182df-Client_ID__Secret.png">
            Copy Client ID and Client Secret
          </Image>
5. Go back to the Manage Connected Apps page, select *Edit* from the list of actions, and disable IP restrictions.
...
4. (Optional) Enable *Launch New Custom Tab Wizard after saving this custom object* and click **Save**.

5. Under *Fields & Relationships*, click **+ New Field** to add relevant data fields. For example:
...
1. Go tup*Setup* *Apex Classes* and click **New**.\
...
2. Click **Save** to compile and activate the Apex class. After the Apex class is saved, note the value defined in the `@RestResource(urlMapping='/...')` annotation. This value represents the URL mapping path used to construct the *Destination URL* in your CleverTap webhook configuration.\
...
* *Salesforce Password*: The integration user’s login password, **appended with a security token** if IP restrictions are enabled. You can retrieve or reset the [security token here](https://help.salesforce.com/s/articleView?id=sf.user_security_token.htm).
...
1. Go to *Settings* > *Channels* > *Webhook* on the CleverTap dashboard.
...
5. In the *Destination URL*, temporarily enter the Salesforce token endpoint:
...
1. Under *Authentication Type*, select **OAuth 2.0** from the dropdown.
2. Under *Grant Type*, select **Client Credentials**.
...
5. In the *Access Token URL*, enter:
...
7. Under *Additional Parameters*, click **+ Key Value Pairs** and add the following values:
...
8. Click **Generate Token**. CleverTap will connect with Salesforce and request a new access token using the above values. 
   ...
   <Image alt="Create Webhook - CleverTap" align="center" width="50% " border={true} src="https://files.readme.io/6b1c45c916e7fd46c81d24380ff6fbcb73ff696c7e8db779a3c97ba70792634b-Screenshot_2025-07-08_at_5.06.06_PM.png">
     Set Up OAuth 2.0 Webhook in CleverTap
   </Image>
...
<Image alt="Access Token Expiry - CleverTap" align="center" width="45% " border={true} src="https://files.readme.io/d65fb49a1866b6ff6f396182079e7bd3e9bdaae3593abebb912bc59ed69f65ca-Screenshot_2025-07-08_at_5.07.57_PM.png">
...
1. Go to *Campaigns* from the CleverTap and click **+ Campaign**.
...
<Image alt="Create Webhook Campaign" align="center" border={true} src="https://files.readme.io/5dd62382c5e5178a464af76cb0e39f63a140ef161add2aacab1fa5756d0586c3-Screenshot_2025-06-19_at_4.03.41_PM-20250619-103347.png">
...
9. Once validated, click **Publish**. 
   ...
   <Image alt="Published Webhook Campaign" align="center" border={true} src="https://files.readme.io/02ce2104d7a0e7368301aeca960c931d20c16df85904babb618bae1fcbdea1bf-Screenshot_2025-06-19_at_4.07.03_PM.png">
     Published Webhook Campaign
   </Image>
