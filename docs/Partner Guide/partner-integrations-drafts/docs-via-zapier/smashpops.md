...
[SmashPops](https://www.smashpops.com/) provides gamified pop-ups to attract new subscribers and grow your customer base through your website or app. With features like coupons, weighted rewards, and customizable game rules, SmashPops helps brands increase engagement while collecting valuable customer data.
...
* **Trigger Automated Engagement**: Forward events from SmashPops to CleverTap to power Flows and personalized campaigns.
...
<Image alt="SmashPops Dashboard" align="center" width="65% " border={true} src="https://files.readme.io/62c81ffa2e3d303de8115aba4db428370b1dd2d0bfadc1f9c70aca6ac7b1c1ed-image.png">
  SmashPops Dashboard
</Image>

2. Configure game rules such as display settings, coupon codes, and reward weights.

<Image alt="Configure Game" align="center" width="65% " border={true} src="https://files.readme.io/19547a71155fda053868eafc9a114304d7f79a5aa575b8f3ee56c256481025f1-image.png">
  Configure Game
</Image>
...
<Image alt="Accept Invite & Build a Zap" align="center" width="65% " border={true} src="https://files.readme.io/51e7bcbea8255782dbb2b6159a106886118e12d733c39a2431095a99485a9df3-Screen_Recording_2025-06-30_at_11.26.40_AM_1.gif">
  Accept Invite & Build a Zap
</Image>

Once Zapier is integrated into Smashpop, it can connect to Smashpop with CleverTap via Zapier.
...
* [Create/Update User Profiles](doc:smashpops#createupdate-user-profiles)
...
2. **Set up a Trigger**. To do so, perform the following steps:
   1. Select Smashpop from the App section. This starts the Zap when a trigger event occurs on Smashpop.
   2. Select *Trigger Event* from the dropdown list and then select *New Data* for this use case.
...
<Image alt="Set Up Trigger Event" align="center" width="75% " border={true} src="https://files.readme.io/ad8a55ab9674b9af05c53fb362477d8cf45278ec5f3db21f95c172c923f8fbfa-Screen_Recording_2025-06-30_at_10.57.02_AM_3.gif">
...
5. **Select the Action** that the zap must perform after the trigger event occurs. To do so, perform the following steps:
   ...
   3. Select *Account* to connect the CleverTap account. The Zapier window opens. Enter all the required details to connect to the CleverTap account. Enter the same passcode you obtained during the [Create a Passcode on CleverTap Dashboard](doc:smashpops#create-a-passcode-on-the-clevertap-dashboard) step.
   4. Click **Continue** after successfully connecting your account.

<Image alt="Select the Action for Zap" align="center" width="75% " border={true} src="https://files.readme.io/6134aee716977c0b32583899e754ac14e80ea3375ec98bed30ee418e64f6428f-4ea42b86-ce46-4fd0-9dde-09becd5626dd.png">
...
<Image alt="Test Zap" align="center" width="75% " border={true} src="https://files.readme.io/6354738a5f26e47ce1cf2ca78e532e2759399140945b80179171586117f28f54-6fa41f8d-5816-4b2e-a294-d708b88257d2.png">
  Test Zap
</Image>

8. Check the CleverTap dashboard to confirm the user profile has been created or updated.

<Image alt="Verify on the CleverTap dashboard" align="center" width="75% " border={true} src="https://files.readme.io/ef76ba31ab8daf8bb2c0918cb0e3b6a57e560712997a3f21b9cad1a129ee6125-image.png">
...
Consider an example where you want to track game interactions in CleverTap as events instead of updating user profiles. This ensures each play is logged for analytics, segmentation, and engagement campaigns. To do so, perform the following steps:

1. Follow *Step 1* to *Step 4* from [Create/Update User Profiles](doc:smashpops#createupdate-user-profiles) to configure SmashPops as the trigger.
...
## Add Integration Code to Your Website
...
1. In your SmashPops account, go to *Settings* > *My Account* > *Show Integration Code*.

<Image alt="Integration Code" align="center" width="75% " border={true} src="https://files.readme.io/e801dc33485473ddb448e22b0648267a6436412f11d3d1abe43d53582fda0943-image.png">
  Integration Code
</Image>
...
3. Once added, your game will display according to the rules you configured, and user actions will flow into the CleverTap dashboard.

<Image alt="Test" align="center" width="75% " border={true} src="https://files.readme.io/2f31702ceae16594ce4f72542b3446a15b78bc95c2567914481259dada02c93d-Screen_Recording_2025-06-30_at_11.20.27_AM_1.gif">
  Test
</Image>
