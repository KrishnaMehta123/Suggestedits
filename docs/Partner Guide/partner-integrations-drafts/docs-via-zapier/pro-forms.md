...
2. Once the form is ready, go to the _Publish_ tab and click on **Share as iframe**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b0ba445433f57f5f342dbe1e042d19c4b38a7638a3d44678de7dc3bd69830a2c-image.png",
        null,
        "Create a Form in Pro Forms"
      ],
      "align": "center",
      "sizing": "75% ",
      "border": true,
      "caption": "Create a Form in Pro Forms"
    }
  ]
}
[/block]
...
3. Replace the existing code inside the _Custom HTML_ section with the URL snippet copied from _Step 3_ of [Create a Form in Pro Forms](doc:pro-forms#create-a-form-in-pro-forms).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c5d8ce035166f5b7cbdbb3777479247c5c44707ab8bfe6883e537afda4da5a11-6f8a53b1-6b07-4a09-9742-9712c34badd5.png",
        null,
        "Preview and Test"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0c3b75f63f564279c7d38df93dc61d79018ff901788ae756784a667b52a2cc06-2025-09-18_17-04-06_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d66e9c17b9eeb04a45de4231281e17bd92f165a2ce3ac6aba6d8f682450c809a-2cf14213-b843-425f-9358-b2d0cda9b890.png",
        null,
        "Form Trigger"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c039f6489499f193a231985d97f03e7758d570d82ec308f6968b2a5fb370b289-d7776e4f-1912-449d-be5b-9587863f786a.png",
        null,
...
6. **Select the Action** that the zap must perform after the trigger event occurs. To do so, perform the following steps:
   ...
   3. Select _Account_ to connect the CleverTap account. The Zapier window opens. Enter all the required details to connect to the CleverTap account. Enter the same passcode you obtained during the [Create a Passcode on CleverTap Dashboard](doc:pro-forms#create-a-passcode-on-the-clevertap-dashboard) step.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c6fbe69e56e1972aba0455efb9f8768c374ef44047a2e361c0b25284e71d104c-2025-09-18_17-06-50_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2da1e39f60927e66be00a066f6c307ef3e71371904cf97c5136003b40dcf89be-89eecb01-a0cc-4ab3-863f-a9bb63cdde83.png",
        null,
        "In-app message"
      ],
      "align": "center",
...
1. Follow _Step 1_ to _Step 4_ from [Create/Update User Profiles](doc:pro-forms#createupdate-user-profiles) to configure Pro Forms as the trigger.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d5f8075b5818961947893bad492ef236aa53ca1f47a49cab450daf1019e0d334-2025-09-18_17-08-30_1.gif",
        "",
        "Select the Action for Zap"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/199d02e55f52aadadebfdc8c1d6721d73ad7a60ad94c41f13ee6bab98b56bbc7-7542bfb1-e958-47ca-b3ba-621fb586bd86.png",
        null,
