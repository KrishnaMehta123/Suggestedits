...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0eb6c8ec1307085f9f7e774b45e7f8260d70d52537b163339bc9c13c6b380605-f07bc68a-915e-4304-9efa-a10630bd008c.png",
        null,
        "Create survey"
      ],
      "align": "center",
...
3. Replace the existing code inside the _Custom HTML_ section and paste the HTML snippet copied from _Step 3_ of [Create Form in Yay! Forms](doc:yay-forms#create-form-in-yay-forms).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e99a5c6e7f02011691b5238b8bc1103d5d261de1e8d817a7c2f0b2bcc5921ee0-image.png",
        null,
        ""
      ],
      "align": "center",
...
2. **Set up a Trigger**. To do so, perform the following steps:
   ...
   2. Select _Trigger Event_ from the dropdown list and then select _New Response_ for this use case.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7ed73f7b9d1f2f8b4ffe81cc4d8cf11e4975f5f7868638f127687b4a6cc34edb-2025-09-07_02-49-50_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/970962d65cfbf45812e450bbe826cc944ba688b230502ab7576bc7eff51f3a91-14fd61e6-427e-4537-afa3-0bb0bc4a5811.png",
        null,
...
5. **Select the Action** that the zap must perform after the trigger event occurs. To do so, perform the following steps:
   ...
   3. Select _Account_ to connect the CleverTap account. The Zapier window opens. Enter all the required details to connect to the CleverTap account. Enter the same passcode you obtained during the [Create a Passcode on CleverTap Dashboard](doc:yay-forms#create-a-passcode-on-the-clevertap-dashboard) step.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dbaf9bcddeb7c69667c29b473dca07d5de3423053643231f54334958120ed03e-2025-09-07_02-59-41_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/79603fe7c956e3ee9802cd0adacc84ed7d048a717063199d7a9fd4c4812192ab-12756bd1-6c5b-4c53-bc18-7618dc8f1900.png",
        null,
        "In-app message"
      ],
      "align": "center",
...
1. Follow _Step 1_ to _Step 4_ from [Create/Update User Profiles](doc:surveynoodle#createupdate-user-profiles) to configure Yay! Forms as the trigger.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9f6f3a486286dfa35e969e2a3e9efe5a765eb415cfc94187dd6acccbf74c5193-2025-09-07_02-59-41_1.gif",
        "",
        "Select the Action for Zap"
      ],
      "align": "center",
