...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4ae8eb7b914179592ff92a6112c91371801077f74d8c1c3d78acc2d37a87d4ac-Screenshot_2025-08-13_at_2.07.53_PM-20250813-083756.png",
        null,
        "Create survey"
      ],
      "align": "center",
...
2. Go to _Embed Survey_. You will see an _HTML code_ snippet.
3. Copy _HTML code_ snippet to configure it in the CleverTap campaign.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fd61c2a37d8404efe6858f0df2ae9e77a5f1603afa87301c3fb260b5ec4be71b-Screen_Recording_2025-08-13_at_2.10.00_PM_1.gif",
        null,
        "Copy HTML Code"
      ],
      "align": "center",
...
3. Replace the existing code inside the _Custom HTML_ section and paste the HTML snippet copied from _Step 3_ of [Create SurveyNoodle Form](doc:surveynoodle#create-surveynoodle-form).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8edaf48711f41f6b38bc14971da6b7647adf8d2a989950374bc9f7e5b86541e4-86e1e5d3-74ad-4352-b124-83d5ec5e9ac0.png",
        null,
        "Preview and Test"
      ],
      "align": "center",
...
2. **Set up a Trigger**. To do so, perform the following steps:
   ...
   2. Select _Trigger Event_ from the dropdown list and then select _New Survey Answer_ for this use case.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/acccdd8091bf5c40bf49b936964ad911de13f18d2c80f38f760f3bfd9667092e-2025-09-06_12-49-55_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d1d4a215289e1d42445488f4390086ae1fd035433e003ee98fdcaeb7a34e62c5-751096c9-2655-4b4c-bab4-0d3ac64f3930_1.png",
        null,
...
5. **Select the Action** that the zap must perform after the trigger event occurs. To do so, perform the following steps:
   ...
   3. Select _Account_ to connect the CleverTap account. The Zapier window opens. Enter all the required details to connect to the CleverTap account. Enter the same passcode you obtained during the [Create a Passcode on CleverTap Dashboard](doc:surveynoodle#create-a-passcode-on-the-clevertap-dashboard) step.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b62f0bd05ba38200bba2111412d5cf0cc417e5e9165ad24eaeff67f3dce6e264-2025-09-06_12-54-46_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/81abacb22ee43cd05700cecd65d75260943b43fac52af16d3e5d220a4aa0dca7-9cd2108e-137c-4636-905b-6f711b27d9a1.png",
        null,
        "In-app message"
      ],
      "align": "center",
...
1. Follow _Step 1_ to _Step 4_ from [Create/Update User Profiles](doc:surveynoodle#createupdate-user-profiles) to configure SurveyNoodle as the trigger.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5e4a1918fb775baafbe76491e8b47b0aee9eb75c3c4cf048d7154836eb5031c5-2025-09-06_12-59-12_1.gif",
        "",
        "Select the Action for Zap"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d5ad478c5b2945c7ba3196b8d1cf94a76ae5aca344b90bee1591a6a5107df1f8-99db3877-182b-4da3-9e3d-c0b7aa031fd2.png",
        null,
