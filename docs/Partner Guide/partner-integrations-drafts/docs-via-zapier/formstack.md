...
<Image alt="Website Embed" align="center" width="65% " border={true} src="https://files.readme.io/02f27c66c84498aa010d2865549079bcf8805d2c96afbba3925f9f4a06704417-image.png">
  Website Embed
</Image>
...
3. Paste the Website Embed code copied in *Step 2* of [Configure Formstack Form](doc:formstack#configure-formstack-form) into the *Custom HTML* editor. Ensure the *Include JavaScript* option is enabled.

<Image alt="Preview and Test" align="center" width="65% " border={true} src="https://files.readme.io/e697931a25121c9f43ba2287eaa18c8bb0f29f6771c5e835877404b9ebf42f33-7603fda7-d6be-4e0d-a4fe-fe1494527df0.png">
  Preview and Test
</Image>
...
<Image alt="Details of Pulled Records" align="center" width="50% " border={true} src="https://files.readme.io/0cd8695f2eb3892763c04048540bd8902da133a2025be8161ac0229cef23890e-image.png">
...
<Image alt="Select the Action for Zap" align="center" width="75% " border={true} src="https://files.readme.io/2007e776ea6b55ae94e762b80b60bd9d22cbaf03c18490ee8546d4aa062244a6-2025-09-05_01-02-24_1.gif">
...
<Image alt="In-app message" align="center" width="25% " border={true} src="https://files.readme.io/c79ba193af64541cf8e158e4dd8c8ea6cdb53ce0553631c9176e73476c481ef5-image.png">
  In-App Message
</Image>
...
1. Follow *Step 1* to *Step 4* from [Create/Update User Profiles](doc:formstack#createupdate-user-profiles) to configure Formstack as the trigger.
