...
<Image alt="Create survey" align="center" width="65% " border={true} src="https://files.readme.io/cddb9c8213dda15e2bf368868c32dfd3d051e92a4f5a0f27687baf405c972996-5a743436-8291-4043-8ee6-427d72515fa8_1.png">
  Create Survey
</Image>

2. From the available distribution options, select *HTML Widget*.

<Image alt="Distribution Options" align="center" width="65% " border={true} src="https://files.readme.io/de013ffdb51add9e5492d72adfc0e49f5c586bb2fc62ae09f18e2bcc0b9c5449-ffffe.png">
  Distribution Options
</Image>

3. Set the *Height* and *Width* of the survey as required.

<Image alt="Set HTML Widget" align="center" width="65% " border={true} src="https://files.readme.io/9842b0174cea33e87ddad7ffacf46b02eaf1a4a563cc7eab413f897533c03dad-image.png">
  Set HTML Widget
</Image>

4. Click the **Create Collector** button, and you will be provided with an *HTML code* snipper.
5. Click **Copy Link** to copy the *HTML Widget*, which will be used to configure it into the CleverTap campaign.

<Image alt="Copy HTML Widget" align="center" width="75% " border={true} src="https://files.readme.io/35f9c8421764d2691ab3dc8bc64dba5ba6792d7969eb908f11f7170f30dbcd76-24484df8-dfba-49a5-92e3-df81ac2a74cb.png">
  Copy HTML Widget
</Image>
...
3. Replace the existing code inside the *Custom HTML* section and paste the HTML snippet copied from *Step 5* of [Create Drag’n Survey Form](doc:dragn-survey#create-dragn-survey-form).

<Image alt="Preview and Test" align="center" width="65% " border={true} src="https://files.readme.io/a75b60da1b5d304aa941ed69ba847ad73443e7d0b76af6f97bd235cdc01862d6-ff.png">
  Preview and Test
</Image>
...
2. **Set up a Trigger**. To do so, perform the following steps:
   ...
   2. Select *Trigger Event* from the dropdown list and then select *Respondent Answers* for this use case.
   3. Select Account and sign in using your Drag’n Survey account credentials.

<Image alt="Set Up Trigger Event" align="center" width="75% " border={true} src="https://files.readme.io/969d43e1da5e8eb667c1d6bb5dfdd95bd2b2d3d82b8941a85c8b7e2b3be0d424-2025-09-06_00-31-06_1.gif">
...
<Image alt="Details of Pulled Records" align="center" width="50% " border={true} src="https://files.readme.io/450b58edd50593f6d1851f5ed7d20abc0ccd9a407a0f4d8a3443706540da4e20-71d1b985-a5ee-4d5c-ba30-a1a609842bcd.png">
...
5. **Select the Action** that the zap must perform after the trigger event occurs. To do so, perform the following steps:
   ...
   3. Select *Account* to connect the CleverTap account. The Zapier window opens. Enter all the required details to connect to the CleverTap account. Enter the same passcode you obtained during the [Create a Passcode on CleverTap Dashboard](doc:dragn-survey#create-a-passcode-on-the-clevertap-dashboard) step.
   4. Click **Continue** after successfully connecting your account.

<Image alt="Select the Action for Zap" align="center" width="75% " border={true} src="https://files.readme.io/7e0701457b948af7de4d344701fd624dac25edbbb286e66d781f3ec1aace5eb5-2025-09-06_00-36-34_1.gif">
...
<Image alt="In-app message" align="center" width="25% " border={true} src="https://files.readme.io/1c76356e4acf261ad4bde75d73305be880e5b506f921aa56010ce24a85dfbd65-652bd61a-a9df-4c51-9658-ccbec2e9a776.png">
  In-App Message
</Image>
...
1. Follow *Step 1* to *Step 4* from [Create/Update User Profiles](doc:dragn-survey#createupdate-user-profiles) to configure Drag'n Survey as the trigger.
...
<Image alt="Select the Action for Zap" align="center" width="75% " border={true} src="https://files.readme.io/bd19b886cdda636b6c77860fb646d6f8c475b3558171e5da7b455eb95fa26383-2025-09-06_00-36-34_1.gif">
  Select the Action for Zap
</Image>
...
<Image alt="Verify on the CleverTap dashboard" align="center" width="75% " border={true} src="https://files.readme.io/6df0d273fbae48921af841cc8eb7a67667b76c4bcba536c24b61f8874efdaaa3-image.png">
