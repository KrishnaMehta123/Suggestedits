...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a7bd0ea5eb818ce831941ccec732f37c164a32c7bebae23cd6c8c1a6cb5af0a5-83271674-bf2c-44af-9798-14186aa55293.png",
        null,
        "Create survey"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/90a281e3e8bc4b68b03545cf5dd17b9b3c5441a19ae526f1cf1e3d3b0b5e7a91-d0c1e271-a4c2-48cc-b2c7-c991d979ad8d.png",
        null,
        "Share survey"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bc3a317cf140615dfab785df938e27984014e4dc42af2eac53842c512f373e24-e3353b38-b8d6-4808-8f8d-112277b55f67.png",
        null,
        "Copy Survey Link"
      ],
      "align": "center",
...
3. Paste the code snippet below under the _Custom HTML_ section. And, replace `<survey url>` with the survey URL copied in _Step 3_ of [Create and Configure Survey in SurveyMars](<>).
   ```html
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/40789fed231cf5356cd66039da25d92416656f3468e05d82b2576bc1ff4ca043-90053d92-848a-4f6f-97cb-ed03663d51c7.png",
        null,
        "Preview and Test"
      ],
      "align": "center",
...
2. **Set up a Trigger**. To do so, perform the following steps:
   ...
   2. Select _Trigger Event_ from the dropdown list and then select _Get Responses_ for this use case.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1a7a4bda3b2187022f9d74db43620107daf2bc7d8d0bf4a98a54ab1f8cfb7cc3-2025-09-05_21-46-52_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/09baef611e4f861daf5f6eb9865d9fc109bc3ff8cbdce20f339c6a3a8c83574d-2d296ef8-1c40-4b73-b523-0ef9bb8d06f6.png",
        null,
...
5. **Select the Action** that the zap must perform after the trigger event occurs. To do so, perform the following steps:
   ...
   3. Select _Account_ to connect the CleverTap account. The Zapier window opens. Enter all the required details to connect to the CleverTap account. Enter the same passcode you obtained during the [Create a Passcode on CleverTap Dashboard](doc:surveymars#create-a-passcode-on-the-clevertap-dashboard) step.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dba482ac8138d93d8a723ee4e1d3f861a213104d5443681f213620f54b09b611-2025-09-05_21-53-23_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e1b4c3a146a142513b93c125f3c3bc4f322cb0364bfd55c1bdbbf7d515efcf5e-7e7b2a39-131c-489b-97c8-256a3da42268.png",
        null,
        "In-app message"
      ],
      "align": "center",
...
1. Follow _Step 1_ to _Step 4_ from [Create/Update User Profiles](doc:surveymars#createupdate-user-profiles) to configure SurveyMars as the trigger.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a0c3fa9b383eddbb482fe7e7a43f5b2dec1ae81ac92b24c0497a564b41142dd6-2025-09-05_21-53-23_1.gif",
        "",
        "Select the Action for Zap"
      ],
      "align": "center",
