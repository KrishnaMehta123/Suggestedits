...
- _Send OTPs and Notifications_: Trigger real-time messages from mobile/web events.
- _Promote Offers and Campaigns_: Reach targeted users with SMS powered by event segmentation.
- _Enhance Chat App Messaging_: Expand your channel strategy with multi-mode engagement.
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Value",
    "0-0": "Nickname",
    "0-1": "Enter the nickname of the SMS provider to identify it uniquely. For example:`8x8_SMS`",
    "1-0": "Callback URL",
    "1-1": "Enter this URL in the 8x8 platform to receive delivery status updates for your SMS messages. Refer to [Set Up SMS Callbacks](doc:8x8-sms#set-up-sms-callbacks). This callback URL must be passed to 8x8 as part of the JSON payload in the Parameters section.",
    "2-0": "Request Type",
    "2-1": "Select `POST`",
    "3-0": "HTTP Endpoint",
    "3-1": "Paste the URL`<https://sms.8x8.com/api/v1/subaccounts/{subAccountId}/partners/clevertap/batch>`  \nReplace `{subAccountId}` with your actual Subaccount ID from 8x8.  \nEnsure that the URL is in HTTPS format, that is, your URL must begin with `https://.`",
    "4-0": "Authentication",
    "4-1": "Select `No Authentication`."
  },
  "cols": 2,
  "rows": 5,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4146d54984627248ea4affc5b1646c2ea54b45ea7119d1bbc306f6a2b0d114f2-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7bd25c76ca44da233cafb61c50e2ac2c5f6237af7bc16810918ceffa00d88e1f-8x8_3.png",
        "",
        ""
      ],
      "align": "center",
...
2. Enter the following details:
   ...
   - _Message_: Enter sample text, such as `This is a test message powered by 8x8`
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4141da97af121d16805772fb980f0888272958269467d79efd1a0a9f5f7c7dab-image.png",
        null,
        "Send a Test SMS"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/27be1e248b9101270026cf9be1bc09c56248d3f3b3c6cbbb4feef98e3bb6c85f-image.png",
        null,
        "Set Up SMS Callbacks"
      ],
      "align": "center",
