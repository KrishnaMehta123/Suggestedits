...
<Image title="Screenshot 2021-05-12 at 4.35.40 PM.png" alt="JSON Payload Structure for Outgoing Requests" align="center" border={true} src="https://files.readme.io/a8e7b8d-Screenshot_2021-05-12_at_4.35.40_PM.png" />  JSON Payload Structure for Outgoing Requests
...
| :-------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------- |
| event           | Denotes the event name.                                                                                                                                                                         | failed/failed\_dnd/replied/clicked                          |
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <li> Event property `url` in the `IncomingText` maps to Notification Clicked. </li> <li> Event property `shorturl` in the `IncomingText` maps to the event property `wzrk_c2a_short_url` of the Notification Clicked event.
      </td>
    </tr>
  </tbody>
</Table>
...
1. Navigate to *Settings> Channels> SMS* and select the **Provider**. Locate **Incoming Message Callback URL**.  The Incoming Message Callback URL on the CleverTap dashboard is displayed as a non-editable field after adding a new provider. Copy this URL and enter it in your SMS provider's callback URL field.  Forward the cincoming messages in the formats explained below to this callback URL.
...
<Image alt="SMS Campaign Stats" align="center" width="60% " border={true} src="https://files.readme.io/470db6b-SMS_Camapign_Stats_page.png">  SMS Campaign Stats
