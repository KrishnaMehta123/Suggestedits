...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <li> Event property `url` in the `IncomingText` maps to Notification Clicked. </li> <li> Event property `shorturl` in the `IncomingText` maps to the event property `wzrk_c2a_short_url` of the Notification Clicked event. </li>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        `incomingText` in the payload maps to the Notification Replied event.
      </td>
    </tr>
  </tbody>
</Table>
