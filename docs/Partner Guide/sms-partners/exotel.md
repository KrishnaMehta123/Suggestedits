...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>It is the ID from which the SMS is sent. </li>
          <li>The format of this field is as follows:<br /><code>&lt;VN&gt;/&lt;SenderID&gt;</code> where 
            <ul>
              <li><code>&lt;VN&gt;</code> is the Exotel Virtual </li>
              <li>Number/ExoPhone through which you send the SMS.</li>
            </ul>
          </li>
        </ul>
      </td>
