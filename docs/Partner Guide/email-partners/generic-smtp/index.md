...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        * Username*and*Password\* values must be your SMTP credentials needed to connect to the service.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        * From Address\* value is the sender’s email address. Most people will not open an email unless they recognize the sender.
      </td>
    </tr>
  </tbody>
</Table>
