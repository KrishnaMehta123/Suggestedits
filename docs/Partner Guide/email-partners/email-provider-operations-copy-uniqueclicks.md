...
[block:parameters]
{
  "data": {
    ...
    "0-2": "Unique stat does not apply here, as each email is counted individually, and there is no distinct user-based metric for emails sent. @shreejith should we stop at does not apply here.",
    "1-0": "Viewed",
    "1-1": "Total Viewed is the number of times the email was opened.",
    "1-2": "Unique Viewed is the number of users who opened the email.",
    "2-0": "Clicked",
    "2-1": "Total Clicked is the number of clicks on links in the email.",
    "2-2": "Unique Clicked is the number of users who clicked on at least one link in the email.",
    "3-0": "Open Rate",
    "3-1": "Total Open Rate is the percentage of emails opened in total. Calculated as `[(Total Viewed/Total Delivered)*100]`. In case, the Delivered count is 0, Total Open Rate will be calculated as `[(Total Viewed/Total Sent)* 100]`.",
    "3-2": "Unique Open Rate is the percentage of users who opened the email. Calculated as `[(Unique Viewed/Unique Delivered)* 100]`. In case, the Delivered count is 0, Unique Open Rate will be calculated as `[(Unique Viewed/Unique Sent) * 100]`.",
    "4-0": "Delivery Rate",
    "4-1": "Displays the percentage of emails successfully delivered to the recipient. It is calculated as `[(Total Delivered/Total Sent)* 100.]`",
    "4-2": "Unique stats does not apply here, as the delivery rate is based on the total number of emails sent, rather than a unique user count.  \n@shreejith is it okay to write it this way? I didn't want to leave it blank. Same with sent."
  },
  "cols": 3,
  "rows": 5,
  "align": [
