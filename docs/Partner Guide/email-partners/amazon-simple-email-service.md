...
8. Click **Send a test email** and fill in your details to test the configuration details you entered. If you encounter any issues, refer to [Troubleshooting](doc:amazon-simple-email-service#troubleshooting).
...
3. Repeat _Step 4_, _6_, and _7_ of [Integrate Amazon SES with CleverTap](doc:amazon-simple-email-service#integrate-amazon-ses-with-clevertap).
