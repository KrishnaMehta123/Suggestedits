...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Unique stat does not apply here, as each email is counted individually, and there is no distinct user-based metric for emails sent.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Total Delivered is the number of emails delivered to the end user.
      </td>

      <td>
        Unique Delivered is the number of users who were delivered this email.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Unique stat does not apply here, as the delivery rate is based on the total number of emails sent, rather than a unique user count.\
