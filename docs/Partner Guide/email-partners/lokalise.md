...
2. For users without a Content Manager subscription, the exported translated templates will appear under *Campaigns > + Campaigns > Emails > What Section > Saved Templates*.
