...
<body>
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/amplitude">
    <div class="integration-card">
     ...
     <a href="https://staging.docs.user.clevertap.net/docs/mixpanel">
    <div class="integration-card">
        <div class="logo-container">
  ...
  <a href="https://staging.docs.user.clevertap.net/docs/posthog">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.dev.clevertap.net/docs/adjust">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.dev.clevertap.net/docs/airbridge">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.dev.clevertap.net/docs/appsflyer">
    <div class="integration-card">
        <div class="logo-container">
 ...
 <a href="https://staging.docs.user.clevertap.net/docs/trackier-attribution">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.dev.clevertap.net/docs/branch">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.dev.clevertap.net/docs/singular-apsalar">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
  <a href="https://staging.docs.user.clevertap.net/docs/open-weather">
    <div class="integration-card">
        <div class="logo-container">
 ...
 <a href="https://staging.docs.user.clevertap.net/docs/radar">
    <div class="integration-card">
        <div class="logo-container">
  ...
  <a href="https://staging.docs.user.clevertap.net/docs/weather-api">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/apteligent">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
 <a href="https://staging.docs.user.clevertap.net/docs/formsuite">
    <div class="integration-card">
        <div class="logo-container">
 ...
 <a href="https://staging.docs.user.clevertap.net/docs/freshsales">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/hubspot-via-zapier">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/45ba67395af4a7d6bed73d2f35e5e99218b9d0500c965f63073886e7f64c431c-id_J1lk9xr_1740630488966_1.png" alt="HubSpot
" class="logo">
        </div>
        <div class="content">
            <div class="name">HubSpot
</div>
            <div class="category">Customer Relationship Management</div>
        </div>
    </div>
 </a>
  <a href="https://staging.docs.user.clevertap.net/docs/iterate">
    <div class="integration-card">
        <div class="logo-container">
    ...
    <a href="https://staging.docs.user.clevertap.net/docs/instapage-via-zapier">
    <div class="integration-card">
        <div class="logo-container">
  ...
  <a href="https://staging.docs.user.clevertap.net/docs/leadsquared">
    <div class="integration-card">
        <div class="logo-container">
    ...
    <a href="https://staging.docs.user.clevertap.net/docs/pipedrive-via-zapier">
    <div class="integration-card">
        <div class="logo-container">
    ...
    <a href="https://staging.docs.user.clevertap.net/docs/salesforce-via-zapier">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/223dd6a8d6e32f8d71ace553db45cdb814f2d1aac0981f9a64b6c3d04d78da05-Salesforce.com_logo.svg" alt="Salesforce CRM" class="logo">
        </div>
        <div class="content">
    ...
    <a href="https://staging.docs.user.clevertap.net/docs/swipe-pages">
    <div class="integration-card">
        <div class="logo-container">
     ...
     <a href="https://staging.docs.user.clevertap.net/docs/zoho-form-via-zapier">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
  <a href="https://staging.docs.user.clevertap.net/docs/boltic">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/census">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/hightouch">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/mparticle-2">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.dev.clevertap.net/docs/rudderstack">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/segment-export">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/treasuredata-cdp">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/amazon-eventbridge">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/data-export-to-aws-s3">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/bigquery-export">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/data-export-to-gcp">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/microsoft-azure-export">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/nexla">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    ...
    <a href="https://staging.docs.user.clevertap.net/docs/optilyz">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/blayer">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/blitzllama">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/contentful">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/delighted">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/jasper-ai">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/litmus">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/niftyimages">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/playable">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/quickads">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/rocketium">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/sendtric">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/squarespace">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/storyly">
    <div class="integration-card">
        <div class="logo-container">
    ...
    <a href="https://staging.docs.user.clevertap.net/docs/surveymonkey">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/surveysparrow">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/wove">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/shopify">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/amazon-simple-email-service">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/mandrill">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/postmark">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/sendgrid">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/clearout">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/kickbox">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
        <a href="https://staging.docs.user.clevertap.net/docs/alpaco">
    <div class="integration-card">
        <div class="logo-container">
     ...
     <a href="https://staging.docs.user.clevertap.net/docs/email-love">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/stripo">
    <div class="integration-card">
        <div class="logo-container">
      ...
      <a href="https://staging.docs.user.clevertap.net/docs/taxi-for-email">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/crowdin">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/lokalise">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/talonone">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/voucherify">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/yotpo">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/discord">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/sendbird-business-messaging">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/slack">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/line-messenger">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
  <a href="https://staging.docs.user.clevertap.net/docs/purchasely">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/qonversion">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/revenuecat">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/facebook-audience-network-1">
    <div class="integration-card">
        <div class="logo-container">
      ...
      <a href="https://staging.docs.user.clevertap.net/docs/facebook-lead-ads-via-zapier">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/ce9618bf8a67a2eb1cb026cb8603318b81b8218562fa805c333c531403a2a4c9-Facebook_Symbol_0.svg" alt=“Facebook Lead Ads (via Zapier)
” class="logo">
        </div>
        <div class="content">
            <div class="name">Facebook Lead Ads (via Zapier)
</div>
            <div class="category">Remarketing</div>
        </div>
    </div>
</a>
<a href="https://staging.docs.user.clevertap.net/docs/google-ads-remarketing">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/tiktok-remarketing">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
<a href="https://staging.docs.user.clevertap.net/docs/8x8-sms">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/bulksms">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/exotel">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/ics-mobile">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/sms-infobip">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/kaleyra-sms">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/msg91">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/netcore">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/nexmo-whatsapp">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/generic-sms">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/onextel-sms">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/route-mobile-sms">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/sinch-sms">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/3cac1aa682ee81cadb4f38660b5af36a8df8328e2ac03e08c8c6cdc4b1d14a13-sinch_logomark_black.svg" alt="Sinch" class="logo">
        </div>
        <div class="content">
...
<a href="https://staging.docs.user.clevertap.net/docs/times-mobile">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/twilio">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
   <a href="https://staging.docs.user.clevertap.net/docs/zendesk">
    <div class="integration-card">
        <div class="logo-container">
...
<body>
    <div class="grid">
      <!-- use this card below for replication and change the link to the desired one -->
<a href="https://staging.docs.user.clevertap.net/docs/8x8-whatsapp">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/dc09a5f5d7e04d537513a570343b5037be5c293b103dffb3ae3146c8851e3090-8x8-logo-01.png" alt="8x8" class="logo">
        </div>
...
<a href="https://staging.docs.user.clevertap.net/docs/aisensy">
    <div class="integration-card">
        <div class="logo-container">
 ...
 <a href="https://staging.docs.user.clevertap.net/docs/exotel-whatsapp">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/89a86c79cf4fe27f746a979545dffce12dc4292a2e42cfc3607aba2cf1315b02-Exotel.jpeg" alt="Exotel" class="logo">
        </div>
...
<a href="https://staging.docs.user.clevertap.net/docs/gupshup">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/haptik">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/infobip">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/8f8fb96c455eedc6728f420f2b1aba195a148bbfc07cc20f4721a4e3fbc1a802-Infobip_id8JKsF2ld_0.svg" alt="Infobip" class="logo">
        </div>
...
<a href="https://staging.docs.user.clevertap.net/docs/interakt">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/kaleyra">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/5c1d4b35de4b78d5cf5e97bd7bea915847e9507f8d24486c377c7ea590b5adaa-Kaleyra.jpeg" alt="Kaleyra" class="logo">
        </div>
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/msg91-whatsapp">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/4c7f4dfa7b7e264c616f1ebf7ddbd6da15238eb1585e12287eef47a70070bd94-MSG91.png" alt="MSG91" class="logo">
        </div>
...
<a href="https://staging.docs.user.clevertap.net/docs/nexmo-whatsapp">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/onextel-whatsapp">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/0c2d7328403509990400bdc186f722f9cf30bcaf481cb29576b6c88defb6f4ce-OneXtel_logo.jpg" alt="OneXtel" class="logo">
        </div>
  ...
  <a href="https://staging.docs.user.clevertap.net/docs/pingbix">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/29c7c2588d8d8e21783f77df2a3bb59476396c025f53b9cd3db9cd05de86f2e1-pinbix.jpeg" alt="Pingbix" class="logo">
        </div>
        <div class="content">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/quickreply">
    <div class="integration-card">
        <div class="logo-container">
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/route-mobile">
    <div class="integration-card">
        <div class="logo-container">
            <img src="https://files.readme.io/fa59938b06ba7bbb7c9c7cf07d9639da4bfe63b6c0b9b4f27808322a714851f9-images.jpeg" alt="Route Mobile" class="logo">
        </div>
   ...
   <a href="https://staging.docs.user.clevertap.net/docs/sinch">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/datachannel">
    <div class="integration-card">
        <div class="logo-container">
 ...
 <a href="https://staging.docs.user.clevertap.net/docs/n8n">
    <div class="integration-card">
        <div class="logo-container">
...
<a href="https://staging.docs.user.clevertap.net/docs/pipedream">
    <div class="integration-card">
        <div class="logo-container">
