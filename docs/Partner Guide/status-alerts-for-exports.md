...
* [Microsoft Azure](https://staging.docs.user.clevertap.net/docs/microsoft-azure-export)
...
2. [Enable Status Alerts for Exports on CleverTap Dashboard](https://staging.docs.user.clevertap.net/docs/status-alerts-for-exports#enable-status-alerts-for-exports)\
   OR
3. [Add or Modify the Webhook](https://staging.docs.user.clevertap.net/docs/status-alerts-for-exports#modify-the-webhook)

## Enable Status Alerts for Exports

To enable status alerts for exports:

1. On the CleverTap dashboard, go to *Settings* > *Partners* > *Exports*. 

<Image align="center" className="border" width="90% " border={true} src="https://files.readme.io/805c5d9-image.png" />
