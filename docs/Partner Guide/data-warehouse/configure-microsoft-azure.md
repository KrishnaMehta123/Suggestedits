...
excerpt: >-
  Learn how to configure Microsoft Azure to export data from CleverTap
  dashboard.
deprecated: false
hidden: true
metadata:
...
1. [Create a Microsoft Azure Storage Account](doc:configure-microsoft-azure#create-a-microsoft-azure-storage-account).
2. [Create a Blob Service Container](doc:configure-microsoft-azure#create-a-blob-service-container).
3. [Generate a SAS Token](doc:configure-microsoft-azure#generate-a-sas-token).
4. [Configure Microsoft Azure Blob Container details on the CleverTap Dashboard](doc:configure-microsoft-azure#configure-microsoft-azure-blob-container-on-clevertap-dashboard).
...
Now that both the dashboards are configured, you can configure export from the CleverTap dashboard. For more information, refer to the following:
