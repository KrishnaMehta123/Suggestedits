...
1. [Set Up CleverTap Export](doc:bigquery-export#set-up-clevertap-export)
2. [Store the Data in BigQuery](doc:bigquery-export#store-the-data-in-bigquery)
3. [Verify the Incoming Data](doc:bigquery-export#verify-the-incoming-data)
4. [Set Up a Recurring Data Transfer Service](doc:bigquery-export#set-up-a-recurring-data-transfer-service)
...
<Image alt="View Exported Data on the CleverTap Dashboard" align="center" border={true} src="https://files.readme.io/4471b4b-image.png">
...
* [Datasets](doc:bigquery-export#datasets)
* [Tables](doc:bigquery-export#tables)
...
1. Open the Google Cloud Console at [console.cloud.google.com](console.cloud.google.com).
