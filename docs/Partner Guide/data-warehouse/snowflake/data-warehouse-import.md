...
excerpt: >-
  Learn how to seamlessly import your data from Data warehouses into CleverTap
  to streamline workflows and boost user engagement through efficient data
  integration.
deprecated: false
hidden: false
metadata:
...
The Import feature enables seamless import and synchronization of data from your database into CleverTap. This integration ensures you maintain up-to-date customer insights for segmentation, analytics, and engagement.  
...
This section is intended for users who have previously set up an **Import** and need a quick refresher on technical steps for the Import before contacting support. The following are the key steps for running an Import:

1. [Set Up Import](doc:data-warehouse-import#set-up-snowflake-import)
2. [Map Data and Identity](doc:data-warehouse-import#map-data-and-identity)
3. [(Optional) Perform a Dry Run](doc:data-warehouse-import#optional-perform-a-dry-run)
4. [Schedule Import](doc:data-warehouse-import#schedule-import)
