...
- [**Repeat Intervals**](doc:frequency#repeat-intervals): Configure automated recurring imports at defined intervals (for example, every _N_ minutes, hours, or days) to ensure continuous and consistent data synchronization.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e227ddc30375daef057268a149e904edb03f38c35f76f7d54ce6a63889065452-Repeat_Intervals_-_schedules.png",
        "",
        "Repeat Intervals"
      ],
      "align": "center",
      "border": true,
      "caption": "Repeat Intervals"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0b673071d8857662830b0ca348b5455bf487b670c00a74a2f59ebbb10cf26572-day_of_week_-_schedule.png",
        "",
        "Custom Schedule - Day of Week"
      ],
      "align": "center",
      "border": true,
      "caption": "Custom Schedule - Day of Week"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6ed50c4bc3e009bba62864ac9f186698221e5736473f6236f8f81c08edd9706c-day_of_month_-_schedule.png",
        "",
        "Custom Schedule - Day of month"
      ],
      "align": "center",
      "border": true,
      "caption": "Custom Schedule - Day of Month"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f898832e9605420cbc58fad8b8a6c2df240c9cfac8eb94dde857b19b3603e807-run_immediately.png",
        "",
        "Manual Trigger - Run Immediately"
      ],
      "align": "center",
      "border": true,
      "caption": "Manual Trigger - Run Immediately"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/43d037884097d9b0db121f1118cf174234d765755b866bad170e831eb1b51274-run_on_a_specific_date.png",
        "",
        "Manual Trigger - Run on a specific date"
      ],
      "align": "center",
      "border": true,
      "caption": "Manual Trigger - Run on a specific date"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5c5f6b6f7eef9f360b140db824f4ad294bf609d0e5a7e4dba16fa7a08809864d-run_later_-_schedule_.png",
        "",
        "Manual Trigger - Run Later"
      ],
      "align": "center",
      "border": true,
      "caption": "Manual Trigger - Run Later"
    }
  ]
}
[/block]
