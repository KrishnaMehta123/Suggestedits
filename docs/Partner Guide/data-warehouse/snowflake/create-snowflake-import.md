...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Select the Snowflake database from the dropdown. Ensure the database has been integrated with CleverTap. For more information, refer to [Database Details](doc:snowflake-integration#database-details).
      </td>
    </tr>
