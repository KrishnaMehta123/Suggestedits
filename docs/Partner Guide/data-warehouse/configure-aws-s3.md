...
3. Click **Edit** under the *Bucket policy* section and enter the policy that you copied in Step *4* of [Copy IAM Policy from the CleverTap dashboard](doc:configure-aws-s3#copy-iam-policy-from-the-clevertap-dashboard):
...
5. Go back to the same window opened in *Step 4* of [Copy IAM Policy From CleverTap Dashboard](doc:configure-aws-s3#copy-iam-policy-from-the-clevertap-dashboard) and click **Save Credentials**.
