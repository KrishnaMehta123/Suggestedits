...
excerpt: >-
  Learn how to configure Google Cloud Platform (GCP) to export data from the
  CleverTap dashboard.
deprecated: false
hidden: true
metadata:
...
1. [Create a Service Account for your Project](doc:configure-google-cloud-platform#create-a-service-account-for-your-project).
2. [Create a Bucket](doc:configure-google-cloud-platform#create-a-bucket).
3. [Configure CleverTap Dashboard](doc:configure-google-cloud-platform#configure-clevertap-dashboard).
...
> 
> - [Data Exports](doc:event-and-profile-exports) for Legacy Profile and Event Export flow
...
Add the Service account credentials (created in [Step 1](doc:configure-google-cloud-platform#create-a-service-account-for-your-project) and bucket name to CleverTap. To configure the dashboard:
...
| :--------- | :--------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 403        | Credentials are incorrect, GCP account is forbidden. | Your Service Account Key has expired or is invalid. There could be various reasons why your key is incorrect. Recheck all the steps, and you can refer to [Integrate GCP with CleverTap](doc:configure-google-cloud-platform#integrate-gcp-with-clevertap). |
