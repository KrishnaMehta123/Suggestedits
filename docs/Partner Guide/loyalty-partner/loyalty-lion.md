...
title: LoyaltyLion
excerpt: >-
  Integrate LoyaltyLion with CleverTap to sync customer loyalty data and
  personalize campaigns with real-time rewards
deprecated: false
hidden: false
link:
  new_tab: false
...
1. [Create a Webhook in CleverTap](#create-a-webhook-in-clevertap)
2. [Configure Webhook Campaign in CleverTap](#configure-webhook-campaign-in-clevertap)
3. [Personalize Campaigns Using LoyaltyLion Rewards](#personalize-campaigns-using-loyaltylion-rewards)

## Create a Webhook in CleverTap

Create a webhook to push event and order data from CleverTap to LoyaltyLion. This webhook lets CleverTap transmit relevant customer activity data (for example, purchases, order totals, shipping) directly to LoyaltyLion in real time.
...
![LoyaltyLion Dashboard](https://files.readme.io/3512408261b3c8b03e266b85a6b08cdbdec380882e591b7740d4ed1e1d85e998-image.png)

3. Click **Save**

![Webhook Configuration](https://files.readme.io/3f0944c4df4ae061158621c5a44ea6f8cfb8c954988546d104c5af0baccb21a5-image.png)
...
2. Select the Webhook configured in [Create a Webhook in CleverTap](#create-a-webhook-in-clevertap)
...
> **Note:** Type `{`, `{{`, or `@` to view available personalization options.

5. Click **Preview and Test** the campaign to check if the data appears correctly in the LoyaltyLion dashboard

![Verify the data on LoyaltyLion](https://files.readme.io/4d155692e30ec741fa468077a5e940ab8cd970dfab9a9a2dd4001b9f143e3f19-image.png)
...
1. [Configure the Linked Content API in CleverTap](#configure-linked-content-api-in-clevertap)
2. [Create a Personalized Campaign Using Linked Content](#create-personalized-campaign-using-linked-content)
...
![Configure Linked Content in CleverTap](https://files.readme.io/1a179c1e39a615f60b441392068825a51c5c44db43b7ad72aacf9f3d2db7d799-2025-05-09_19-41-03_1.gif)

4. In the Headers, add this below key-value pair:
   * **Authorization:** Bearer `<Loyalty Lion API Key>`
5. Test the Linked Content to ensure it returns the expected output

![Test the Linked Content](https://files.readme.io/8d9e5da0f498e31fdfcb33a0fb65241075404e7ea61b6f64f3dd3fde475b8be9-image.png)
...
3. Configure all the campaign settings and then go to the **What** section:
   ...
   2. Select the **Linked Content** configured under [Configure Linked Content API in CleverTap](#configure-linked-content-api-in-clevertap) and click **Apply**

   ![Personalization](https://files.readme.io/e24f7ff1a37a0e936b6fd820948b17a598068c15a2fc8d88b4035de1f257bd94-image.png)
...
![Create Personalized Message Using Linked Content](https://files.readme.io/6e479e0d10c081b6a3edbbf5023899bf711640bce35f05cc68aeca3e0ffa7e7d-image.png)
...
```liquid
{% for reward in linked_content.rewards %}
  {{ reward.title }}
{% endfor %}
```
...
![Set the Title and Message](https://files.readme.io/6e360137cfde9c61d7ca3990aa7bd229bf0a6061a305dd1b76f06dcd2b494cf7-image.png)
...
![Push Notifications](https://files.readme.io/52e84680c8682ff563fd8c423d2e6c7413be99d860215c240a09b1b4e9e3ae59-image.png)
