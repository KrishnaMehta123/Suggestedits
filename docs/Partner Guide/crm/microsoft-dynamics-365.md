...
- [Configure an Export](doc:microsoft-dynamics-365#configure-an-export) 
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/46b042268a28ae49b3147a196e89bde849f7026615cafa493fb484caa770b71b-Microsoft_Dynamics_CleverTap.png","","Microsoft and CleverTap Integration"],"align":"center","border":true,"caption":"Microsoft and CleverTap Integration"}]}[/block]
...
1. In your Microsoft Dynamics 365 Customer Insights dashboard, navigate to _Admin > Connections_.
2. Click **Add connection**.
3. From the list of available connectors, choose **CleverTap**.
4. In the _Display name_ field, enter a meaningful name for the connection.
5. In the _Who can use this connection_ section, specify access control:
...
7. Review the [data privacy and compliance terms](https://learn.microsoft.com/en-us/dynamics365/customer-insights/data/connections#data-privacy-and-compliance), check _I agree_, and click **Connect** to establish the integration.
...
1. Navigate to _Data > Exports_.
2. Click **Add export** to create a new export configuration.
3. In the _Connection for export_ field, select the **CleverTap** connection you configured.
4. Under the _Data matching_ section, map the customer identity fields in CleverTap, which can include the following:
