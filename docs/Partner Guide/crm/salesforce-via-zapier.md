...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f6a83adf175766819e979676ed2e40166e63233b96d64c3d1735ed2237ef43b7-image.png",
        null,
...
2. **Set up a Trigger**. To do so, perform the following steps:
   ...
   2. Select _Trigger Event_ from the dropdown list and then select _New contacts _ for this use case.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/49910d8377cf69dde60e41917fcf0f4f8bc3094d822ee80b81a79b2ad564a051-2025-02-06_02-08-49_1.gif",
        "",
        "Set up a Trigger"
      ],
      "align": "center",
...
5. **Select the Action** that the zap must perform after the trigger occurs. To do so, perform the following steps:
   ...
   3. Select _Account_ to connect the CleverTap account. The Zapier window opens. Enter all the required details to connect to the CleverTap account. Enter the same passcode you obtained during the [Create a Passcode on CleverTap Dashboard](doc:salesforce-via-zapier#create-a-passcode-on-the-clevertap-dashboard) step.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3ab5447a6bfe7c10eea3c4c2b29b5e5380b2f868ffe471a50717c245346afaec-2025-02-06_02-20-52_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6dd75773f6f0c046b67da9909e18de805a3769e683136af8329b65a03cfe6a2e-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2d6934cb8569b57a5d5be4ab64ee390a6418e94ac98a7d4067be6c3b65194117-2025-02-06_02-29-51_1.gif",
        "",
        "Set up a Trigger"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4a721610d94c496a9da6bc85f50a26fb922907a5a0137ce1bf208bd0fecb121c-2025-02-06_02-37-47_1.gif",
        "",
        "Select Action for Zap"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/883a5b33191ab0d8ea765b4621f83e8339db36668ed11a1642462d9d18fecee7-image.png",
        null,
        "Configure the Action"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3a99d9007e84cf54336a785f0e1482249157b58c9d03b37f8e5ea33cd1d4fb5c-image.png",
        null,
