...
1. Navigate to _Settings_ > _Partners_ > _Partner List_ from the CleverTap dashboard.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/b5c963d-PartnersList.jpg",null,"Navigate to the Partners Page"],"align":"center","border":true,"caption":"Navigate to the Partners Page"}]}[/block]
2. Hover on the _Amplitude_ icon and click **Integrate**. The _Integrate analytics partner - Amplitude_ popup opens on the right side of the screen.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/98f7110-image.png",null,""],"align":"center","border":true}]}[/block]
...
After successful integration, the _Export_ tag displays against _Amplitude_ on the _Partner List_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cb1e912-image.png",
        null,
        "Succesful Amplitude Integration"
      ],
      "align": "center",
      "border": true,
      "caption": "Succesful Amplitude Integration"
    }
  ]
}
[/block]
