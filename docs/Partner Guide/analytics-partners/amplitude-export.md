...
1. Navigate to *Settings* > *Partners* > *Partner List* from the CleverTap dashboard.
   ...
   <Image alt="Navigate to the Partners Page" align="center" border={true} src="https://files.readme.io/b5c963d-PartnersList.jpg">
...
2. Hover on the *Amplitude* icon and click **Integrate**. The *Integrate analytics partner - Amplitude* popup opens on the right side of the screen.
   ...
   <Image align="center" className="border" border={true} src="https://files.readme.io/98f7110-image.png" />
...
After successful integration, the *Export* tag displays against *Amplitude* on the *Partner List* page.

<Image alt="Succesful Amplitude Integration" align="center" border={true} src="https://files.readme.io/cb1e912-image.png">
