...
excerpt: Understand how to import cohorts (segments) from Amplitude to CleverTap.
deprecated: false
hidden: false
metadata:
  title: ''
...
<Image alt="User Identity Mapping When Importing Cohorts (segments) to CleverTap" align="center" border={true} src="https://files.readme.io/9b1fe5d-Amplitude_User_Identity_Mapping.png">
