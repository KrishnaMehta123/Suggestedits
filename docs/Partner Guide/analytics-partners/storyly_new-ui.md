...
1. Log in to your CleverTap account and navigate to *Settings* > *Partners* page.

<Image title="Navigating to Partners page.png" alt={2876} className="border" border={true} src="https://files.readme.io/38570fa-Navigating_to_Partners_page.png" />

2. Hover on the *Amazon EventBridge* icon and click **Integrate**.

<Image title="Click Integrate.png" alt={2876} className="border" border={true} src="https://files.readme.io/601dea0-Click_Integrate.png" />

On clicking, *Integrate raw data partner - Amazon EventBridge* popup opens on the right side of the screen.

4. Enter the following Amazon service details and click **Integrate**:
...
<Image title="Integrate raw data partner - Amazon EventBridge.png" alt={2366} className="border" border={true} src="https://files.readme.io/a9c4294-Integrate_raw_data_partner_-_Amazon_EventBridge.png" />

After the integration is successful, the *Integrated* tag displays against *Amazon EventBridge* on the *Partners List* page.

<Image title="Integrated Tag.png" alt={2720} className="border" border={true} src="https://files.readme.io/231eda9-Integrated_Tag.png" />
...
<Image title="Create audience for CleverTap.png" alt={960} className="border" border={true} src="https://files.readme.io/01089f0-Create_audience_for_CleverTap.png" />
...
<Image title="Select Amazon EventBridge.png" alt={1852} className="border" border={true} src="https://files.readme.io/78c7437-Select_Amazon_EventBridge.png" />

2. Click **Go To Editor** under *What* section of campaign/journey.

<Image title="Message Editor - Campaigns.png" alt={2850} src="https://files.readme.io/c90a214-Message_Editor_-_Campaigns.png">
  For Campaigns
</Image>

<Image title="Message Editor - Journeys.png" alt={1047} border={true} src="https://files.readme.io/472d7ba-Message_Editor_-_Journeys.png">
  For Journeys
</Image>
...
<Image title="Add Key-Value Pairs.png" alt={2080} className="border" border={true} src="https://files.readme.io/35d7f52-Add_Key-Value_Pairs.png" />
