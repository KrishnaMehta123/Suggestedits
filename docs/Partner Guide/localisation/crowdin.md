...
<Image alt="Install CleverTap 1" align="center" border={true} src="https://files.readme.io/f4ce2003d2f4d30077ce8bd158c919bb4bf8ab64ac5ef1c5ec6eab45f6a16893-crowdin_14.png">
  Add Integration on Crowdin
</Image>

2. Search for CleverTap and click ![](https://files.readme.io/b3fa9fd999915adfd77d376f337fe30500c5144112634691cd726e8fc849e6c0-image_25.png)  icon to install it. 

<Image alt="Install CleverTap 2" align="center" src="https://files.readme.io/1fcb1de464bf433afbdfb7bd1f512c44d1782f545cc341074fdf1fd18abd5a09-Crowdin_13.png">
  Install CleverTap 
</Image>
...
<Image alt="Install CleverTap" align="center" width="60% " border={true} src="https://files.readme.io/dde1b0731275794809d44d8a88a686ff0484e317ac589179e62aad3a8130a22e-crwodin_14.png">
  Install CleverTap
</Image>
...
* **Region**: Navigate to *Settings > Project* from the CleverTap dashboard to select the appropriate API endpoint for your region. To identify your account’s region, refer to the table below:
...
<Image alt="Integrate CleverTap" align="center" border={true} src="https://files.readme.io/3e47a55df28b7406305274ab6614439a90e0be53554811675a25da32b86e6ac0-crowdin_9.png">
  Integrate CleverTap
</Image>
...
1. Click **Sync to Crowdin**  from the *Integrations* tab to export the templates from CleverTap to Crowdin. 

<Image alt="Sync Template" align="center" border={true} src="https://files.readme.io/081c5f3c20a75e2ddb31a4ce74dea56ca6b8174c66487e28a15697059d2f79ca-crowdin_2.png">
  Sync Template
</Image>

Once the templates are synced, they appear on the left side. 

<Image alt="Synced Template" align="center" border={true} src="https://files.readme.io/70358d21e9b8007f9df4b2aa0b41e2024bf0f1e80dd586245ca5763289b3c00a-crowdin_24.png">
  Synced Template
</Image>

2. Select the *Dashboard* tab, select the target language, and click **Go to Editor** and [translate the selected template](https://support.crowdin.com/ordering-professional-translations). 
3. Select the *Integrations* tab once the template is translated, select the template from the left side, and click  **Sync files to CleverTap**.

<Image alt="Sync Translated Template to CleverTap" align="center" border={true} src="https://files.readme.io/cced595be9d754c5623127ad9f57a91ad24979aad5465210cea5e43c1037382f-crowdin_8.png">
  Sync Translated Template to CleverTap
</Image>

For users with a Content Manager subscription to CleverTap, the exported translated templates from Crowdin will be found under *Content Manager > Templates > Email*. Each language will have its own separate template.

<Image alt="Translated Templated - CMS" align="center" border={true} src="https://files.readme.io/c6ce9e6831bfb8a390500e7865add71c3828482e929d91bbbb191ba6d2af7148-crowdin_23.png">
  Translated Templated - CMS
</Image>

For users without a Content Manager subscription, the exported translated templates will appear under *Campaigns > + Campaigns > Emails > What Section > Saved Templates*.

<Image alt="Translated Template - Saved Template in Campaign" align="center" border={true} src="https://files.readme.io/a077cb11ef98433bc9fda0a5d8bc0c88ddf8f0eb271d7202977854584f31fae2-crowdin_10.png">
