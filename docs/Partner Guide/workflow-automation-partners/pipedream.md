...
To integrate Pipedream with CleverTap, you must add CleverTap as an action in your Pipedream workflow to connect your source data with CleverTap's engagement tools. This enables seamless synchronization and ensures the user engagement strategies are powered by real-time, accurate data. 
...
3. Select from the following for *Pre-built Actions* to send pre-defined user properties to CleverTap.
   ...
   * [Select *Custom Actions* to send custom user properties to CleverTap](doc:pipedream#build-any-clevertap-api-request-custom-user-properties)

<Image alt="Set Actions" align="center" border={true} src="https://files.readme.io/4f8b540471f4694ed9730649868321fa833833e51d8a98e66ee916646066a8b3-set_action.gif">
...
<Image align="center" className="border" border={true} src="https://files.readme.io/4f748359cd0afd1db82d726670e794f8c829ec4a8e377d034a89578926045f72-image.png" />
...
| **Identity**     | A unique identifier (for example, user\_id).      |

<Image alt="Configuring User Data" align="center" width="85% " border={true} src="https://files.readme.io/84c85d8d7765edbbd68a1ff76e8c0b94e48a03313e8386be2fdc2215e31e35c8-image.png">
  Mapping Key Fields
</Image>
...
<Image alt="Test and Deploy" align="center" border={true} src="https://files.readme.io/a55e5641a8e162935163dfe3b61325fe1a85dc4ed378f93e9c9e569afd646091-image.png">
  Test and Deploy
</Image>
...
2. Connect a CleverTap Account, refer to *Step 2* of [Create or Update User Data](doc:pipedream#create-or-update-user-data).
...
<Image alt="Configuring Event Data" align="center" width="85% " border={true} src="https://files.readme.io/7f98d8c7b4792ccecaf22dcc8d01b48589b86e4b21f2f88769ec48c8b87394ec-image.png">
...
<Image alt="Test and Deploy" align="center" border={true} src="https://files.readme.io/a3fdbf8f373bb753bdcf4cd9a31bec591ef7a79e1239b27d437d6619a5f6c6b6-image.png">
  Test and Deploy
</Image>

To verify if the data is uploaded correctly, go to the *User Profiles* or *Event Analytics* page from the CleverTap dashboard.

<Image alt="Event in CleverTap" align="center" border={true} src="https://files.readme.io/f3214ca3d83df5a3c8e9f630f36d2cb340664af2a2aabaa430411f3018bad03b-image.png">
  Event in CleverTap
</Image>
...
2. Configure Headers to connect the CleverTap Account:
   ...
   2. *Base URL*: Enter the API endpoint basis the region of your CleverTap account. To identify the API endpoint for the region of your account, refer to [Region](https://staging.docs.dev.clevertap.net/docs/common-api-components#region).
...
<Image alt="Configure Headers" align="center" border={true} src="https://files.readme.io/74d89a821a36c70100113acb2766142faf6d22b3234783d48ae6aba10c2d4056-image.png">
  Configure Headers
</Image>
...
<Image alt="Configure the Request Body" align="center" border={true} src="https://files.readme.io/72d915c82c34566e01018400d206697f30925ea0b19848a12784740080cfcb55-image.png">
...
<Image alt="Edit Raw JSON" align="center" border={true} src="https://files.readme.io/84fb9099b93638e091abaf54cbb016066dcee30b19c801f3afb15663fb113ef4-image.png">
  Edit Raw JSON
</Image>
...
<Image alt="Test and deploy" align="center" border={true} src="https://files.readme.io/3fd718dae6ea2bf08e9cf59aeeb3e305f6e840c43b6ec7c2040a925d90629e40-image.png">
  Test and deploy
</Image>
...
<Image alt="Custom User Properties" align="center" border={true} src="https://files.readme.io/0e7986ffdd0f7f541132add52da10a3d51c4a409d21c9b10f39aee1f5e67e6c6-image.png">
