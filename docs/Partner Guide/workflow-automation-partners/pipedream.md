...
2. Configure Headers to connect the CleverTap Account:
   ...
   2. _Base URL_: Enter the API endpoint basis the region of your CleverTap account. To identify the API endpoint for the region of your account, refer to [Region](https://staging.docs.dev.clevertap.net/docs/common-api-components#region).
