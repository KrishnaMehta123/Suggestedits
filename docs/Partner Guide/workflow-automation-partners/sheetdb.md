...
> ⚠️ Support for Integration
> 
> This integration is managed and continuously improved by SheetDB. The CleverTap and SheetDB integration has undergone stringent testing to ensure seamless functionality. For any questions or issues, contact [SheetDB](mailto:support@sheetdb.io) for support and resolution.
...
2. Select your source:
   - _Existing spreadsheet_
   - _Create new spreadsheet_
   - _Create new spreadsheet JSON_
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0f042798072802b793ec8e2363660205ed93a7455b98e99c88b16ab24405dcd5-image.png",
        null,
        "Select Source"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/03c444a48910b34cb5c65708ebd9f7a8bf13f478dfb43872ac48bc6c4fa550d8-Screen_Recording_2025-02-05_at_2.43.41_PM_1.gif",
        "",
        ""
      ],
      "align": "center",
...
1. Go to _Settings_ > _Setup_ > _Linked Content_ in the CleverTap dashboard. Click **+ Linked Content**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c00a87fdc168e43428afcfd060fb01be047b7f3b09f02100c7f4ce10a6f8bdc6-image.png",
        null,
...
2. Select _Push Notification_ from the Messaging Channels list.
3. Configure all the campaign settings and then go to the _What_ section:
   1. Click **Personalization**
   2. Select the _Linked Content_ configured under [Configure the Linked Content API](doc:sheetdb#configure-the-linked-content-api) and click **Apply**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6d72365caee91c86624e70cc6a2c9263e5fda1c9879c16cc566c6f0b07b8bc4c-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/603907b0cec1fd9e727345df285791fea6588734f8449e407ece8501442ee94d-image.png",
        null,
        "Push Notifications"
      ],
      "align": "center",
