...
<Image alt="Setup Callbacks" align="center" width="80% " border={true} src="https://files.readme.io/21999d7-generic_Whatsapp_Provider_configuration.jpg">
  Setup Callbacks
</Image>
...
4. Select the type of template header (Text or Media). For Media headers, you can use *Image*, *Video*, *Document*, and *Location*.
5. Create a [Limited Time Offer Template](https://docs.clevertap.com/docs/whatsapp-message-templates#limited-time-offer-templates), if required. 
6. Enter the message content.
7. You can also add a Footer text and a Button (Quick Reply or a Call To Action).
