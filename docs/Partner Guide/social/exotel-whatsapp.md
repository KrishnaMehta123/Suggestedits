...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/21999d7-generic_Whatsapp_Provider_configuration.jpg",
        "",
        ""
      ],
      "align": "center",
...
4. Select the type of template header (Text or Media). For Media headers, you can use _Image_, _Video_, _Document_, and _Location_.
