...
To create different WhatsApp message templates on CleverTap, refer to this detailed document on [Creating WhatsApp Templates](https://staging.docs.user.clevertap.net/docs/whatsapp-message-templates#create-whatsapp-template).
