...
* **Private Key:** A private key is downloaded automatically after you create a new application on the Vonage dashboard. Store this key, as you may need it for future usage.
...
<Image title="Add a Message Template" alt={2164} align="center" border={true} src="https://files.readme.io/c63a032-Nexmo_approved_templates.jpg">
  Adding Message Template
</Image>
...
1. Right-click the ellipsis on the template.
2. Click *Send Test*.
