---
title: MSG91
excerpt: Learn how to integrate MSG91 with CleverTap for WhatsApp communication.
deprecated: false
hidden: false
metadata:
  title: ''
...
> 
> This integration is managed and continuously improved by MSG91. The CleverTap and MSG91 integration has undergone stringent testing to ensure seamless functionality. For any questions or issues, contact [MSG91](support@msg91.com) for support and resolution.
...
1. [Configure CleverTap Dashboard](docs:msg91-whatsapp#configure-clevertap-dashboard).
2. [Set Up CleverTap Callbacks in MSG91](docs:msg91-whatsapp#set-up-clevertap-callbacks-in-msg91).
...
| HTTP End Point | Enter HTTP Endpoint as the following:<https://api.msg91.com/api/v5/whatsapp//outbound/clevertap/> |
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/223edc0dd9395b8efbd83593933324956c2341e18a79097859d8ff3285b8efbf-image.png",
        null,
        "Callback URLs"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0983f272d9b7981e56f98dd7f2af74f3a3f09d10f46cd2e14f51169021033d33-image.png",
        null,
        "Configure Inbound Message Callback in MSG91"
      ],
      "align": "center",
      "border": true,
      "caption": "Configure Inbound Message Callback in MSG91"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8117a35d118ccfe4b13d8c780341fcc7d162eac2027a4345a32ab7f3c49cb8fb-image.png",
        null,
        "Configure Outbound Message Callback in MSG91"
      ],
      "align": "center",
      "border": true,
      "caption": "Configure Outbound Message Callback in MSG91"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e47df80c73ea34c89ba02cbd904cf9c685e08845c768ae77ae8b75ad0d96734e-image.png",
        null,
        "Configure Headers"
      ],
      "align": "center",
