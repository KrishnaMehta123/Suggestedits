...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/35548f0-Whatsapp_Infobip_clevertap_dashboard.png",
        "Add a WhatsApp Provider",
        "Add a WhatsApp Provider from the CleverTap dashboard"
      ],
      "align": "center",
      "sizing": "600rt",
      "border": true,
...
4. (Optional) Select _Set auto-reply for users not tracked on CleverTap_ to automatically reply to users who message on WhatsApp but are not tracked on the CleverTap dashboard.
5. (Optional) Select _Mark this as default_ to make this service provider the default provider to send a WhatsApp message.
...
You can find the Callback URLs on the CleverTap dashboard under the Provider _Setup_ page. Naviagte to _Settings_ > _Channels_ > _WhatsApp_ > _Infobip_. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/affba41-Whatsapp_provider_credentials.png",
        "Callback URLs and Mobile Number",
        "The Provider Setup Page on the CleverTap dashboard displays the callback URLs and also has the mobile number from Infobip"
      ],
      "align": "center",
      "border": true,
...
1. Navigate to _Settings_ > _Channels_ > _WhatsApp_ > _Provider Nickname_ from the CleverTap dashboard. 
  ...
  "images": [
    {
      "image": [
        ...
        "Create a Message",
        "Screen shows how to edit message on the CleverTap dashboard and also a preview of this message"
      ],
      "align": "center",
      "border": true,
