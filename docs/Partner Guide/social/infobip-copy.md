---
title: Infobip (COPY)_Concurrency
...
* You must enable a WhatsApp Connect add-on on the Clevertap account in addition to the basic price plan.
...
<Image title="Add a WhatsApp Provider" alt="Add a WhatsApp Provider from the CleverTap dashboard" align="center" width="600rt" border={true} src="https://files.readme.io/35548f0-Whatsapp_Infobip_clevertap_dashboard.png">
...
4. (Optional) Select *Set auto-reply for users not tracked on CleverTap* to automatically reply to users who message on WhatsApp but are not tracked on the CleverTap dashboard.
5. (Optional) Select *Mark this as default* to make this service provider the default provider to send a WhatsApp message.
...
You can find the Callback URLs on the CleverTap dashboard under the Provider *Setup* page. Naviagte to *Settings* > *Channels* > *WhatsApp* > *Infobip*. 
...
<Image title="Callback URLs and Mobile Number" alt="The Provider Setup Page on the CleverTap dashboard displays the callback URLs and also has the mobile number from Infobip" align="center" border={true} src="https://files.readme.io/affba41-Whatsapp_provider_credentials.png">
  Callback URLs
</Image>
...
<Image title="Pre-Approved Message Templates" alt="The screen shows multiple pre-approved message templates for WhatsApp" align="center" border={true} src="https://files.readme.io/024a8b8-exotel_templated.png">
...
<Image title="Create a Message" alt="Screen shows how to edit message on the CleverTap dashboard and also a preview of this message" align="center" border={true} src="https://files.readme.io/05f7706-whatsapp_template_addition.png">
  Create a Message
</Image>
