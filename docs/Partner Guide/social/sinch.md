...
For detailed instructions on creating a WhatsApp campaign using Sinch India as the provider, refer to [Create a WhatsApp Campaign](doc:whatsapp#section-creating-a-whatsapp-campaign).

## Creating a Journey

For detailed instructions on creating a WhatsApp journey using Sinch India as the provider, refer to [Create a WhatsApp Journey](https://docs.clevertap.com/docs/engagement-nodes-whatsapp).
