...
1. Log in to your CleverTap account and navigate to _Settings_ > _Partners_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/38570fa-Navigating_to_Partners_page.png",
        "Navigating to Partners page from the CleverTap dashboard",
        2876
      ],
      "align": "center",
      "border": true,
      "caption": "Navigating to Partner Page"
    }
  ]
}
[/block]

2. Hover on the _Amazon EventBridge_ icon and click **Integrate**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/601dea0-Click_Integrate.png",
        "Hover on the Amazon EventBridg icon and click Integrate",
        2876
      ],
      "align": "center",
      "border": true,
      "caption": "Integrate Amazon EventBridge"
    }
  ]
}
[/block]

The _Integrate raw data partner - Amazon EventBridge_ popup opens on the right side of the screen.
...
After the integration is successful, the _Integrated_ tag displays against _Amazon EventBridge_ on the _Partners List_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/231eda9-Integrated_Tag.png",
        "Integrated tag denotes that Amazon EventBridge Integration is Successful",
        2720
      ],
      "align": "center",
      "border": true,
      "caption": "Amazon EventBridge Integration Successful"
    }
  ]
}
[/block]
