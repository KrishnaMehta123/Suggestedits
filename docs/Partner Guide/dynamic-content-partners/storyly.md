...
<Image title="Navigating to Partners page from the CleverTap dashboard" alt={2876} align="center" border={true} src="https://files.readme.io/38570fa-Navigating_to_Partners_page.png">
  Navigating to Partner Page
</Image>

2. Hover on the *Amazon EventBridge* icon and click **Integrate**.

<Image title="Hover on the Amazon EventBridg icon and click Integrate" alt={2876} align="center" border={true} src="https://files.readme.io/601dea0-Click_Integrate.png">
  Integrate Amazon EventBridge
</Image>

The *Integrate raw data partner - Amazon EventBridge* popup opens on the right side of the screen.
...
<Image title="Integrated tag denotes that Amazon EventBridge Integration is Successful" alt={2720} align="center" border={true} src="https://files.readme.io/231eda9-Integrated_Tag.png">
  Amazon EventBridge Integration Successful
</Image>
