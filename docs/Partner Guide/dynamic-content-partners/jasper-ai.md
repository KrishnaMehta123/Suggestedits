...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7c6113e542fec6cf53782cc73b8e8e82f54dd413c9dabbc2e298b9d672c3e7a6-2025-04-07_12-35-07_1.gif",
        "",
        "Linked Content"
      ],
      "align": "center",
      "border": true,
      "caption": "Configure Linked Content"
    }
  ]
}
[/block]
...
| **Header**     | **Details**                                                                                                                                                                |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `X-API-Key`    | Jasper API token. [Generate a new Access Token](https://developers.jasper.ai/docs/authentication) from Jasper.ai dashboard. _(Only available on Enterprise/Business plan)_ |
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4fc890fbbd6040253e2ad52802ed4fafd5c07a37eec5e15f1bf7b3808c8727dc-Screen_Recording_2025-04-04_at_12.52.02_PM_1.gif",
        "",
        "Test Linked Content and AutoFill Objects with Response"
      ],
      "align": "center",
      "border": true,
      "caption": "Test Linked Content and AutoFill Objects with Response"
    }
  ]
}
[/block]
...
3. Configure all the campaign settings and then go to the _What_ section:
   ...
   2. Select the _Linked Content_ configured under [Configure Linked Content API in CleverTap](doc:jasper-ai#configure-linked-content-api-in-clevertap) and click **Apply**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a12a6ad188b0cc866215d99eee2ee0c0486d34fcf9708c1c6c95f7acc4f2497a-Screen_Recording_2025-04-07_at_2.35.38_PM_1.gif",
        "",
        "Personalization"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/18d726edcfb80eb0b07a802ab360013d008bb4d125868fd86d59146868b852a6-image.png",
        null,
        "Linked content"
      ],
      "align": "center",
  ...
  "data": [
    {
      ...
      "text": "\"Shreyans, Unlock Exclusive Christmas Discounts Now!\""
    }
  ]
}
```
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/51b63129d7df8331049b337bdb0860d33129b441fa45826466849f4603f28776-image.png",
        null,
        "Preview & Test"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/857a4d4ea8885dfeb3f51371846ef17c4f06ae8246ce965f42226082ba52681b-image.png",
        null,
        "Push Notifications"
      ],
      "align": "center",
