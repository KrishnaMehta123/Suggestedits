...
>
> This integration is managed and continuously improved by Typeform. The CleverTap and Typeform integration has undergone stringent testing to ensure seamless functionality. For any questions or issues, contact [Typeform](https://help.typeform.com/hc/en-us/requests/new?ticket_form_id=360000510012) for support and resolution.
...
<Image alt="Create a new survey" align="center" border={true} src="https://files.readme.io/8e9745bf2bace885248f018a0111efd834cc8a0492f32461953f2a5a3696be2d-2025-04-14_12-02-27_1.gif">
  Create a new survey
</Image>
...
<Image alt="Insert the HTML Code Snippet" align="center" width="75% " border={true} src="https://files.readme.io/1819eb876f94ad67d63576966fa6b2343927a1bae63bc0cd4882e1b988291807-email-_typeform_1.gif">
  Insert the HTML Code Snippet
</Image>

4. Preview and test your email campaign to ensure the survey is embedded correctly.

<Image alt="Preview and Test" align="center" width="75% " border={true} src="https://files.readme.io/20ffe2b7e15f6a305d7c77fd7936acf8605fec3c77a01a1078e9440ffa541858-image.png">
  Preview and Test
</Image>
...
<Image alt="Insert the HTML Code Snippet" align="center" width="75% " border={true} src="https://files.readme.io/69fd3819804a8b6d099cc8913af0d5fb8688c86a18132bdf19cc650e4cf332c6-2025-04-14_13-19-24_1.gif">
  Insert the HTML Code Snippet
</Image>

6. Click **Send Test** to preview and verify the In-App message.

<Image alt="Send Test" align="center" width="75% " border={true} src="https://files.readme.io/2a89acfabf5d8c5a68a7bb4eea179e92073f8aa130a0dcb04840ac9b7c30b7bf-image.png">
  Send Test
</Image>
