...
1. [Upload user profiles](https://staging.docs.user.clevertap.net/docs/csv-upload#upload-user-profiles).
2. [Map uploaded user profiles](https://staging.docs.user.clevertap.net/docs/csv-upload#map-uploaded-user-profiles).
...
<Image alt="CSV Uploads Page" align="center" width="95%" border={true} src="https://files.readme.io/1e03356-CSVUpload.jpg" />  CSV Uploads Page
...
<Image alt="Upload User Profiles" align="center" border={true} src="https://files.readme.io/a074165-image.png" />  Upload User Profiles
...
3. Under **Upload user profiles**, drag and drop or browse the CSV file. For more information on the CSV file format, refer to [CSV File Format](https://staging.docs.user.clevertap.net/docs/csv-upload#csv-file-format).\
...
4. Enter a unique file name for easy identification on the main screen and click **Save & Upload**.\
   The *Data Export uploaded* message appears.
5. (Optional) Click the **Preview** icon to view the uploaded user profiles.

<Image alt="Preview of the Uploaded User Profiles" align="center" border={true} src="https://files.readme.io/969865d-image.png" /> Preview of the Uploaded User Profiles
...
* [Manually Map the File](https://staging.docs.user.clevertap.net/docs/csv-upload#manually-map-the-file) 
* [Upload the Mapped File](https://staging.docs.user.clevertap.net/docs/csv-upload#upload-the-mapped-file) 
...
<Image alt="Manually Map User Profiles" align="center" border={true} src="https://files.readme.io/ebdbdc9-image.png" /> Manually Map User Profiles
2. From the table below, select the appropriate data type and user properties for each column in the file:
   * **Data Types**: Select a data type from the dropdown list for the user profile values. For instance, *id\_name* has the value *John Doe* and is of the *Alphanumeric* data type.
     ...
     * **Date Formats**: A date value for data such as the Date of Birth of the user. For more information about date formats supported by CleverTap, refer to the [Date Format](https://staging.docs.user.clevertap.net/docs/csv-upload#date-format) section. 
...
<Image alt="Upload Pre-Mapped User Profiles" align="center" border={true} src="https://files.readme.io/b8d03f8-image.png" />  Upload Pre-Mapped User Profiles
...
If you have not mapped the files, the status appears as *Start mapping*. Mapping is necessary to process the CSV upload. After the CSV file is processed, the status for that upload changes to *Completed*.  For more information about the statuses, refer to the [CSV Upload Details](https://staging.docs.user.clevertap.net/docs/csv-upload#csv-upload-details) section. 
...
<Image alt="Sample CSV File using `objectId`" align="center" border={true} src="https://files.readme.io/ecc0821ef3992355e7d917ed50bce5e1d4db81c12764f32b5277fd81172f12bf-Sample_CSV_File.png" />  Sample CSV File using `objectId`
...
A: If you input an incorrect or invalid identity, it results in an error, and the system flags the records in the file as error.  
