...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4851bca-Click_Import.png",
        "Click Import.png",
        1198,
        752,
        "#f3f5f6"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/453c793-Preview_CSV.png",
        "Preview CSV.png",
        816,
        617,
        "#f6f7f8"
...
{
  "type": "warning",
  "body": "* Ensure that the `identity` key is always in lower case.\n* You can upload a CSV with a file size of up to 50MB.",
  "title": "Note"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bcf5586-CSV_File_with_ObjectID.png",
        "CSV File with ObjectID.png",
        1587,
        88,
        "#dadbdb"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2e166c6-sample_upload_CSV.png",
        "sample_upload_CSV.png",
        1510,
        381,
        "#e5e5e5"
      ],
...
{
  "type": "success",
  "body": "A purchase date example: <dd/MM/yyyy HH:mm:ss>.",
