...
<Image title="Navigation.png" alt={2886} className="border" border={true} src="https://files.readme.io/ea1882a-Navigation.png" />

3. Click *CleverTap (Actions)*.
4. Click **Configure CleverTap (Actions)**.

<Image title="Click Configure CleverTap Actions.png" alt={5752} className="border" border={true} src="https://files.readme.io/7d7b183-Click_Configure_CleverTap_Actions.png" />
...
<Image title="CT_Project_Details.png" alt={1786} className="border" border={true} src="https://files.readme.io/e7276fc-CT_Project_Details.png" />
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul><li>This field is mandatory.</li><li>It is used to recognize a unique user. </li><li>It can be the user’s email, a phone number, or any other identifier that you are using to tag your users.</li></ul>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <ul><li>This field is mandatory.</li><li>It consists of user profile properties. </li><li>It is passed as key/value pairs.</li><li>properties[“Phone”] must be formatted as +\[phone number].</li></ul>
      </td>
    </tr>
  </tbody>
</Table>
