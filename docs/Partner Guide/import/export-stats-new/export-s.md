...
1. Navigate to *Settings > Partners* and select *Export Center*.
...
* Use the *Filter* option to refine exports based on Partner, Type, Format, Status, Frequency, and Exported On (Date).
...
<Image alt="One Time Export" align="center" border={true} src="https://files.readme.io/a49d7cd42b7a2f9b21f93e265c4f4b381ed24506be2db105da9c1dc140f435ef-image.png">
  One Time Export
</Image>
...
* Select *Recurring export* when creating the bucket to configure this option.
...
<Image alt="Recurring Export" align="center" border={true} src="https://files.readme.io/ad1af78e656f5fec82e58a65368207a1f0ca6656f462d0b2f7c38278957d193a-image.png">
  Recurring Export
</Image>
