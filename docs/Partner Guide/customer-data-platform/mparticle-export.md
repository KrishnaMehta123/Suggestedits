...
<Image title="Navigating to Partners page from the CleverTap dashboard" alt={2700} align="center" width="90% " border={true} src="https://files.readme.io/0fedd5f-PartnersList.jpg">
  Navigating to the Partners Page
</Image>

2. Hover on the *mParticle* icon and click **Integrate**.

<Image title="Hover on the mParticle icon and click Integrate" alt={2376} align="center" width="90% " border={true} src="https://files.readme.io/84c344e-IntegratemParticle.jpg">
  Integrate mParticle
</Image>
...
After successful integration, the *Export* tag displays against *mParticle* on the *Partner List* page.

<Image alt="Successful mParticle Integration" align="center" border={true} src="https://files.readme.io/ee2907d-image.png">
  Successful mParticle Integration
</Image>
...
<Image title="Enter export details and click Export" alt={2376} align="center" width="90% " border={true} src="https://files.readme.io/7fc995d-ExportTomParticle.jpg">
