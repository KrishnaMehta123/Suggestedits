...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0fedd5f-PartnersList.jpg",
...
2. Hover on the _mParticle_ icon and click **Integrate**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/84c344e-IntegratemParticle.jpg",
        "Hover on the mParticle icon and click Integrate",
        2376
      ],
      "align": "center",
      "sizing": "90% ",
      "border": true,
      "caption": "Integrate mParticle"
    }
  ]
}
[/block]
   ...
   On clicking, _Integrate raw data partner - mParticle_ popup opens on the right side of the screen.
...
After successful integration, the _Export_ tag displays against _mParticle_ on the _Partner List_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ee2907d-image.png",
        null,
        "Successful mParticle Integration"
      ],
      "align": "center",
      "border": true,
      "caption": "Successful mParticle Integration"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7fc995d-ExportTomParticle.jpg",
