...
1. **Add a Data Source**:
   1. Open the *Sources* section from the Census dashboard and click **+ New Source**. 
...
5. *Select a  Sync Behavior*. The sync behavior determines how changes are handled between the source and CleverTap. If you select **Send**, an event is raised on CleverTap every time new records are detected in the source system.
...
7. Under *Set Up CleverTap Field Mappings*, select whether you want to sync specific properties or all properties.\
