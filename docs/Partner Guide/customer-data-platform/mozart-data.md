...
1. Go to *Connectors*, select the data source type in the Mozart dashboard. Out of the available options in Mozart Data or upload a CSV file to Mozart Data.

<Image alt="Add Connector" align="center" width="75% " border={true} src="https://files.readme.io/0e27f60ab8136a730e58cded6a2cffaf9c898bb98d7bc2c46aff13b5a501b656-image.png">
  Add Connector
</Image>

2. Select the type of *Integration* you want to add. Search by typing in the search bar. Then click on the connector icon. For this use case, we will select *Snowflake*.

<Image alt="Type of Integration" align="center" width="75% " border={true} src="https://files.readme.io/443c5a7f546c2b8ae0d579cf928ffbc0922e2c9d9dd32162ab8e3796f03f822a-image.png">
  Type of Integration
</Image>
...
<Image alt="Snowflake destination connector" align="center" width="75% " border={true} src="https://files.readme.io/d6816ad7423fb25ac89fbb297c8a10809c4fde21676a371141e0b8c3233aa200-image.png">
...
<Image alt="Create Transform" align="center" width="75% " border={true} src="https://files.readme.io/36c99c172910f258c565e61b8af39b032f6c38cb7bc7d7c7cb2bba31712e44fe-image.png">
  Create Transform
</Image>
...
<Image alt="Filter the data from the source" align="center" width="75% " border={true} src="https://files.readme.io/1f63f4003ad36bcc9c2c88fcad2caf277d3a9dc3bf51a974ea36cbb7d4a875a2-image.png">
  Filter the data from the source
</Image>

4. Click **Save** and **Run**.
5. Go to the *Runs* tab to verify that the query executes properly.

<Image alt="Verify The Query" align="center" width="75% " border={true} src="https://files.readme.io/1f63f4003ad36bcc9c2c88fcad2caf277d3a9dc3bf51a974ea36cbb7d4a875a2-image.png">
  Verify The Query
</Image>
...
1. Go to *Settings* > *Partners* > *Connections* in your CleverTap dashboard.
2. Click **Snowflake**, fill in your credentials, and click **Save**.

<Image alt="Create a Snowflake Import in CleverTap" align="center" width="75% " border={true} src="https://files.readme.io/aa58040ff97292abfebc6f262f6fe1747000ab00a0246d366a45a5c17bec598f-image.png">
  Create a Snowflake Import in CleverTap
</Image>

3. Go to *Settings* > *Imports* and click **Create Import**.
...
<Image alt="Configure the import" align="center" width="75% " border={true} src="https://files.readme.io/187dbb2498af45ce2712c8a6d60cac88bf0c0e1f875edb0aa2de955a8d1e73a4-image.png">
  Configure Import
</Image>

6. Map the fields, select the data according to your requirements, and click **Test data**.

<Image alt="Map Fields" align="center" width="75% " border={true} src="https://files.readme.io/b8e6fb7b17684a03c83049209b001c189fcdb3bfa0e526b7cde723a8e56fc3b8-image.png">
  Map Fields
</Image>
...
8. Verify the imported data by navigating to the Segments page from the CleverTap dashboard.
   ...
   <Image alt="Verify Imported Data" align="center" width="75% " border={true} src="https://files.readme.io/9c67c4f82a5c59a2cb9a04f9953453e665e9a85a2a9bf2a2831573155e387974-image.png">
