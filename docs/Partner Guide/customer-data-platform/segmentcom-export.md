...
2. Hover on the *Segment* icon and click **Integrate**. The *Integrate raw data partner - Segment* popup displays on the right side of the screen.
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Used as an identifier to track anonymous users on Segment.
      </td>
    </tr>
  </tbody>
</Table>
...
<Image alt="Enter Export Details" align="center" border={true} src="https://files.readme.io/23bdeac-Enter_Export_Details.png">
