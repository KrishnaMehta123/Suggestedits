...
2. Hover on the _Segment_ icon and click **Integrate**. The _Integrate raw data partner - Segment_ popup displays on the right side of the screen.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/23bdeac-Enter_Export_Details.png",
        null,
...
3. Configure the following settings:
   ...
   - **Frequency**: Select from one of the following options:
     ...
     - _Recurring_: Set up a recurring frequency to export all the new events at regular intervals. You can export event data as frequently as every 4 hours and up to once every 24 hours.
...
The status for a newly-created export is displayed as _Pending_. The status changes to _Running_ after the processing starts and _Done_ when the export is complete.
...
- [All system events](doc:segmentcom-export#all-system-events)
