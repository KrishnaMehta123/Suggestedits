...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5a157b0ef34c4ab306de7ee2991dc9f10983a49cc2f8746ee8dd928d809e11f8-2025-07-16_11-54-42_1.gif",
        "",
        "Create Notify Campaign"
      ],
      "align": "center",
      "border": true,
      "caption": "Create Notify Campaign"
    }
  ]
}
[/block]
...
4. Click **Create Message** under _Content_ to create your campaign message as follows:
   ...
   2. Draft a message and enter the _Sender Details_. For more information, refer to [Email Editor](doc:create-message-email). You can personalize messages in two ways:
      ...
      - **Notify API Parameter Personalization**: Uses a key from the `notifyFields` object in the API payload, for example, `{{Notify.orderID | default:"Order number not available"}}`.  
        When the campaign is triggered via API, CleverTap pulls the value from the object in your payload and injects it into the message. This enables you to personalize email order details based on real-time values. For more information, refer to [Notify API](https://staging.docs.dev.clevertap.net/docs/notify-api).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d2a6a0502bef5fe08749d2cbf79e61a4d55a86e27adba01a8fe0ded77cf132b1-Personalized_Notify_Campaign.png",
        null,
        "Personalization Keys for Notify"
      ],
      "align": "center",
      "border": true,
      "caption": "Personalization Keys for Notify"
    }
  ]
}
[/block]
...
7. After creating an Email campaign, Click **Generate** to create the transaction ID or script required to trigger your Notify campaign. Once generated, copy the ID/script and use it in the [Notify API](https://staging.docs.dev.clevertap.net/docs/notify-api) request to launch the campaign.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/12a2419d5f1c686d3fae52451ee37403f7f28cec60b98fc42aea6ac37e206b35-image.png",
        null,
        "Generate "
      ],
      "align": "center",
...
- [Filter Notify Campaign](doc:https://staging.docs.user.clevertap.net/docs/notify#filter-notify-campaigns)
- [Edit Column Order](doc:notify#edit-columns)
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/97c92d38c9a611f9502dce7ca84ab18837a8f36ab46285e6a812dd49897cff8a-2025-07-16_16-08-34_1.gif",
        "",
        "View Notify"
      ],
      "align": "center",
      "border": true,
      "caption": "View Notify Campaign"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/807cb7803e5ef42e59d982ab4395a3048d73840087e4874590214fc484d967ef-image.png",
        null,
        "View Notify"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2e14f4c1e1fab9ba142e7b93d613efe266eb6fef8bf852f70853763d35d9ce53-image.png",
        null,
        "API Details"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8186102ccc8369ae2c64b214b60d6260bfe4ce65be9f26a41794030718c0a839-image.png",
        null,
        "Filter Notify Campaigns"
      ],
      "align": "center",
      "border": true,
      "caption": "Filter Notify Campaigns"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/29d2d3f46af3ec59f2803f74f7a5050167fed51fce3fe25c2b3ce66eaad3d0a4-2025-07-16_16-11-38_1.gif",
        "",
        "Edit Column Order"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b93a1b1365899978747cd2e7a67132b08a6e71e0e20509c4c17c1383d2601522-2025-07-16_16-34-29_1.gif",
        "",
        "Request-Level Stats"
      ],
      "align": "center",
      "border": true,
      "caption": "Request-Level Stats"
    }
  ]
}
[/block]
...
The _Channels _ section provides a detailed breakdown of channel-specific performance, helping you understand how recipients interact with transactional messages post-delivery. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ef00347e4433aa3e205007696649510a23b7fce0ab661c7a42db80f4456fb9fe-2025-07-16_16-29-33_1.gif",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/20c186d0646cffa76239b82865d44e3a6edaf7907e1c653bfe47bff63facc644-image.png",
        null,
        "Error Insights"
      ],
      "align": "center",
