...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/006da83-Inline_Personalization.png",
        "campaign_push_personalization.png",
        1095
      ],
      "align": "center",
      "border": true,
      "caption": "Personalize Messages using Dynamic Text"
    }
  ]
}
[/block]
...
In addition to the title and body, you can personalize many other things, such as media URLs, deep links, or button text. An _@ _ icon in a box indicates that it can be personalized. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/51be44068b21589f9266a8903e0b16c705c707e0a83018d193bc2377cc255255-Personaliza_Media_URL.png",
        "Personalization_@.png",
        748
      ],
      "align": "center",
      "border": true,
      "caption": "Add Media URLs, Deep Links or Button Text"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/699d610-Identity_Personalization_Example.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/04c801c-Identity_Personalization_Example_-_Email.png",
        "",
        "Identity Personalization Using Personalized URLs"
      ],
      "align": "center",
      "border": true,
      "caption": "Identity Personalization Using Personalized URL"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9d51aa9f401e16703257a12ac80d77d04fc1bd4ae195ae5c82ca212ec6a602f2-Identity_Personalization_Using_Personalization.png",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/201345db3e709ee65faf25b8c365870e9979e641dd12e21dc5fcd87fb04aea42-Identity_Personalization_Using_Liquid_Tags.png",
        "",
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Personalized Messages using Liquid Tags"
    }
  ]
}
[/block]
...
> 
> When customizing event or profile properties that involve dates, we transform them into different formats for liquid tags and @ personalization.
> 
> For instance:
> 
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Create Personalized Recommendations"
    }
  ]
}
[/block]
...
To invoke the personalization menu, type the _@_ or the _{{}}_ symbol in the title, message, and Deep link/Open URL fields when creating a message.
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Constant Event Property"
    }
  ]
}
[/block]
