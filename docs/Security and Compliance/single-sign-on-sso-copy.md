...
### How can I set up Single Sign-On (SSO) across different regions for my projects in CleverTap?

To set up SSO across regions for your projects in CleverTap, follow these steps:

1. Make sure you have an SSO connection for the parent project in any one region.
2. Contact CleverTap support to assist you in configuring this feature.
3. Provide the support manager with a list of all parent accounts for the additional regions where you intend to activate SSO.

Note that you can not configure SSO for multiple regions directly through the dashboard.  
To set this up, CleverTap will use your existing SSO connection to enable Single Sign-On for all the other accounts in different regions.