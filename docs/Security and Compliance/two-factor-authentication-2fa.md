...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/098da8a-2fa_QR.png",
        "",
...
After this setup, for the subsequent login, you should enter the 2FA verification code from the _Authenticator_ app, as shown in the following image:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e0d66e3-2fa_otp.png",
        "",
        "Two Step Verification Screen"
      ],
      "align": "center",
      "border": true,
      "caption": "Two-Step Verification Screen"
    }
  ]
}
[/block]
...
1. Navigate to _Settings_ > _Security_ > _Two-Factor Authentication_. This displays the list of all user email addresses with 2FA enabled.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7e16dfd-2023-09-22_14-26-21_1.gif",
        null,
        "Reset 2FA Key"
      ],
      "align": "center",
      "border": true,
      "caption": "Reset 2FA Key"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/83a0a40-scan_qr.png",
        "",
        "Set up Authenticaor"
      ],
      "align": "center",
