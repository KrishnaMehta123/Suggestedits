...
<Image title="SSO Nav.png" alt={2532} className="border" border={true} src="https://files.readme.io/14d6c04-SSO_Nav.png" />
...
![719](https://files.readme.io/740efa2-IDP1.png "IDP1.png")

<Image title="idp 2.png" alt={1058} className="border" border={true} src="https://files.readme.io/d86184e-idp_2.png" />
...
<Image title="SSO CTD.png" alt={2614} className="border" border={true} src="https://files.readme.io/61ffd10-SSO_CTD.png" />
...
5. You can explicitly edit the attributes or add roles that you want to assign to the users by selecting the specific user profiles. You can also find t
...
<Image title="ssos.png" alt={648} className="border" width="smart" border={true} src="https://files.readme.io/7da272e-ssos.png" />
...
<Image title="Screenshot 2020-03-24 at 12.55.03 PM.png" alt={2164} className="border" border={true} src="https://files.readme.io/12efc07-Screenshot_2020-03-24_at_12.55.03_PM.png" />
...
<Image title="sso1.png" alt={2704} className="border" border={true} src="https://files.readme.io/21cef6a-sso1.png" />

## Login

Once your SSO is set up, you can log in to CleverTap using the login with the SSO option.

<Image title="sso2.png" alt={2674} className="border" border={true} src="https://files.readme.io/f54a459-sso2.png" />
