...
excerpt: >-
  Understand the different ways in which you can optimize your Monthly Active
  User (MAU) count in your CleverTap for Startups Plan
deprecated: false
hidden: true
metadata:
  title: ''
