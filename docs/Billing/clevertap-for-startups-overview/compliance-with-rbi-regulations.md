---
title: Compliance with RBI Regulations
excerpt: >-
  Understand how CleverTap complies with recent RBI regulations around payments
  via India-issued cards
deprecated: false
hidden: true
metadata:
  title: ''
...
With the new regulations from RBI coming into effect, payment processing for India-issued cards will get affected. This section provides information about changes done to CleverTap for Startup payment workflows to comply with the new regulations.

# RBI eMandate Regulations for Recurring Payments
