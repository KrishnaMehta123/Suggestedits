---
title: Billing_Overages_calculation_change_WIP
excerpt: ''
deprecated: false
hidden: true
metadata:
...
For the CleverTap for Startups plan, CleverTap accepts all major credit cards (for example, Visa, Mastercard,  Discover,  and JCB). 
