...
This document provides information about billing terminologies and calculations for CleverTap for Startups users. The billing is based on the Monthly Billable Users, derived from Monthly Active Users and the Data Points that are explained in the sections to follow.
...
There are some system and debug events that are excluded from the MAU and Data Point calculations. For more information about these events, refer to [Events Excluded from Billing in CleverTap for Startups](https://docs.clevertap.com/docs/events-excluded-from-billing-in-clevertap-for-startups).

### **Monthly Billable User (MBU)**

MBU is a combination of MAUs and data points for the entire month. The total bill amount per month is based on whichever is highest from the following: 
...
>
> Only the account administrators have access to the *Organization* section.

### Data Upload Charges

If data is uploaded to amend a user profile or activity history, the number of data points uploaded counts toward the total number of data points allocated for the month. The number of data points allocated for each calendar month equals the MAU tier in your pricing agreement times 2,000.
...
To downgrade to a lower MAU tier, request a plan update from the My Plan section of your account. Our team will review your request, and we will notify you with a confirmation of the downgrade in a timely manner. 
...
To cancel your subscription, the project admin can request a cancelation by navigating to *Organization* > *Billing* > *My Plan* > *Cancel Plan*. You are prompted to select the reason and enter *DELETE* in the acknowledgment field. After doing so, all the projects under the organization are deleted permanently.\
Auto-cancelation of subscription for the entire organization occurs if the payment is overdue for more than ten days after the account suspension.

> 📘 Sign Up Again
>
> After canceling the subscription, you can always sign up again and start your new project.

# **Payments and Overages**

For the CleverTap for Startups plan, CleverTap accepts all major credit or debit cards (for example, Visa, Mastercard,  Discover,  and JCB). 
...
In case your payment has failed, we will notify you right away. You will be required to update your payment details within a grace period of 10 days. Incoming data, data exports, and dashboard access will not be affected during this period. If the payment details are not updated within the grace period, your account access will be locked.

If you do not clear all outstanding payments within ten days of the account lock, your account will be suspended. After account suspension, you will no longer be able to retrieve your account, and all data will be deleted.
...
**Example**\
Below is an example of overage charges for a subscription with an MAU tier limit of up to 20,000, including with add-ons:
...
2. To view the complete invoice, click on an invoice number.
...
CleverTap supports GST invoicing for customers in India. GST (Goods and Services Tax) is a mandatory levy for all Indian Rupee (INR) invoices following regulatory requirements in India. Businesses registered in India can input their GSTIN (GST Identification Number) during the signup process.
