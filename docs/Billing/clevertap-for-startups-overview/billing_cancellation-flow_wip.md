---
title: Billing_Cancellation Flow_WIP
excerpt: ''
deprecated: false
hidden: true
metadata:
...
To cancel your subscription, the project admin can request a cancelation by navigating to *Organization* > *Billing* > *My Plan* > *Cancel Plan*. You are prompted to select the reason and then enter *DELETE* in the acknowledgment field. After doing so, all the projects under the organization are deleted permanently.\
Auto-cancelation of subscription for the entire organization occurs if the payment is overdue for more than ten days after being in the soft-lock period.
