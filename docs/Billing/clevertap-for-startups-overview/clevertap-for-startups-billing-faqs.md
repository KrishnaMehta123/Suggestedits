...
If your card has been rejected, ensure your card information is up-to-date (e.g. expiration date and CVV code) and that you are entering your card number without dashes or spaces. If your card is still not processing, you may need to follow up with your bank to see if there are any issues on their end. If you are still having issues, create a support help request via the platform by providing the required details. 

##5.  Can I make a manual payment?
Since we process payments through a third-party processor, we are unable to manually enter your card. Cards are automatically processed through CleverTap.

##6. Can I make my payment with more than one card?
Our payment system is set up to upload only one card at a time; however, you can change your card information at any time.
