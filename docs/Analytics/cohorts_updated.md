...
This mode shows user actions on specific days. For example, a user reads the news on Day 2 but not on Day 1 or Day 3. If you view a cohort for 3 days, you will see the following:
