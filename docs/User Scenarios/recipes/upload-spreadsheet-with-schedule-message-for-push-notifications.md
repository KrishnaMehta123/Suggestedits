...
(For your previous users, you can upload account created event using this API and by sending the 'date set by user' property as an epoch this way: "$D\_epochValue")\
