...
2. CNAME the sendgrid domain to Branch. Refer to [Branch Universal Email Integration Guide](https://help.branch.io/using-branch/docs/universal-email-integration-guide).
