...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a8a4f2d-Sample_Best_Time_Config.png",
        null,
      ...
      "sizing": "75% ",
      "border": true,
      "caption": "Sample Best Time Config"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Define Best Time Config"
    }
  ]
}
[/block]
...
Currently, you can create journeys using the default Best Time config. So, it is mandatory to mark one of the Best Time configs as Default to refer to it later. You can do so by clicking the ![lEllipses](https://files.readme.io/3b92fb0-Ellipses.png) icon and selecting _Mark as Default_.
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Define Best Time Campaign Schedule"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Define Delivery Options"
    }
  ]
}
[/block]
