...
<Image title="Subscribe to Reports.gif" alt={1376} align="center" border={true} src="https://files.readme.io/b65efb968aa13ef918ee1a82100cd88e6ab1d8e3a37270ec1d2bd8e53f38a234-Subscribe_to_Reports.gif">
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Select the data from the following options that you want to include in the report:</p><ul><li>Campaign overview</li><li>Campaign stats</li><li>Campaign detailed stats</li><li>Campaign errors</li></ul>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <p>Select the option to split your data. The following are the available options:</p><ul><li>Day</li><li>OS</li><li>Variant type</li></ul><p><strong>Note:</strong> Split data by day is unavailable if the date range is more than 60 days on the campaigns page.</p>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <p>Select the export frequency for your report. The following are the available options:</p><ul><li>One-time</li><li>Recurring</li></ul>
      </td>
    </tr>
...
<Image title="Setup Campaign Reports" alt={1696} align="center" width="smart" border={true} src="https://files.readme.io/9e45c4e-Campaign_Reports.png">
  Setup Campaign Reports
</Image>
...
You can view your campaign reports by navigating to FileDir:`<accountID>/reports/` from your partner bucket. The report file name will be in the following format:  `reportName_Timestamp.csv`, where Timestamp indicates the time when the report is delivered. 
...
<Image title="Edit_subscriptions.gif" alt={570} align="center" border={true} src="https://files.readme.io/95f9da4-Edit_subscriptions.gif">
...
<Table align={["left","left","left","left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Total number of unique users who receive WhatsApp or SMS notifications.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Total number of WhatsApp or SMS notifications delivered to the end users.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Users who were sent a message and they converted. Referred to as influenced conversions on the dashboard.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The number of emails failed to be sent to CC users. This column is included only when you add CC/BCC recipients to the email campaign. The feature for adding CC/BCC recipients is currently available in Private Beta.
      </td>
    </tr>
...
>
> * User is considered converted if they complete a conversion evnt within the conversion timeline.
>
