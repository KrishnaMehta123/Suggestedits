...
[block:callout]
{
  "type": "warning",
  "title": "Charged Event",
  "body": "Hold property constant is not supported for the *Items array* for the **Charged** event when creating funnels."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/313b5e7-Select_Channel_Campaign.jpg",
  ...
  "images": [
    {
      "image": [
        ...
        "Who_constant_event_property.png",
        1204,
        596,
        "#f8f8fd"
      ],
