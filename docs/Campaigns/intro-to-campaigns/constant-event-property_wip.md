---
title: Constant Event Property_WIP
...
<Image title="Alias_Event_property.png" alt={447} className="border" border={true} src="https://files.readme.io/30998fe-Alias_Event_property.png" />
...
![2868](https://files.readme.io/313b5e7-Select_Channel_Campaign.jpg "Select_Channel_Campaign.jpg")

4. Under the *Start here* section, select the qualification criteria as *Live Behavior*. 
5. Click **Done**.

<Image title="StartHere_LiveBehavior.png" alt={659} className="border" border={true} src="https://files.readme.io/a82b66d-StartHere_LiveBehavior.png" />
...
<Image title="Who_constant_event_property.png" alt={1204} className="border" width="80%" border={true} src="https://files.readme.io/edfd708-Who_constant_event_property.png" />
