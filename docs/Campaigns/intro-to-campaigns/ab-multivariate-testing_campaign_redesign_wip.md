...
<Image title="1 Variant distribution.png" alt={1273} className="border" border={true} src="https://files.readme.io/a78e21f-1_Variant_distribution.png" />
...
@PM: NEED HELP CREATING A REPORT PAGE THAT MATCHES THE EXAMPLE

<Image title="2 Report.png" alt={1354} className="border" border={true} src="https://files.readme.io/3a62ff3-2_Report.png" />
...
<Image title="3 Split Delivery.png" alt={1338} className="border" border={true} src="https://files.readme.io/3c36f7a-3_Split_Delivery.png" />
...
<Image title="4 Limits.png" alt={1300} className="border" border={true} src="https://files.readme.io/d57e2ac-4_Limits.png" />
