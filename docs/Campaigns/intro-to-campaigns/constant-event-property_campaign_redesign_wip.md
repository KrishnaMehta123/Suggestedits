...
For example, the event *Purchased* has an event property that holds the product id of the item called *product_id*. However, the event *Added to cart *has an event property called *Product ID* that holds the same value. You can create an* Alias Event property* called *Product ID* that holds the event property *product_id* and *Product ID*. 
...
<<CHANGE SCREENSHOT TO ONE WITH BETTER NAMES>>
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9e0e992-1_Plus_Campaign.png",
        "1_Plus_Campaign.png",
        1578,
        622,
        "#f8f8fa"
...
<<CHANGE BELOW SCREENSHOT>>
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/db547ee-2_Past_Behavior_copy.png",
        "2 Past Behavior copy.png",
        1575,
        514,
        "#f9f7fa"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5c05e3a-3_Constant_Event_Property.png",
        "3 Constant Event Property.png",
        1574,
        765,
        "#f9f9fd"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/976b4ed-1_Plus_Campaign_copy.png",
        "1_Plus_Campaign copy.png",
        1578,
        622,
        "#f8f8fa"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/772970c-0_Plus_Campaign.png",
        "0 Plus_Campaign.png",
        1578,
        622,
        "#f8f8fa"
