...
Pick the size of the test audience to run and we will do the rest. We will determine the winner based on the number of views, and then deliver the winning message to the rest of your target audience.
...
After the 300,000 messages have been delivered, we will calculate the winning message over this test group based on the number of views. 
...
> 👍 Winner Evaluation
>
> We will determine the winner based on the number of views, and then deliver the winning message to the rest of your target audience. 
>
...
<Image title="Filtering Variants on Funnels page.png" alt={1778} className="border" border={true} src="https://files.readme.io/4a8bae7-Filtering_Variants_on_Funnels_page.png" />
