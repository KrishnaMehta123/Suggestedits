...
The campaigns list page allows you to view the campaigns. You can also email a report or export it to an Amazon S3 or Google Cloud Platform bucket.
...
You can view your campaign reports by navigating to FileDir:`<accountID>/reports/` from your partner bucket. The report file name will be in the following format:  `reportName_Timestamp.csv`, where the Timestamp indicates the time when the report is delivered. 
...
<Image title="Edit_subscriptions.gif" alt={570} align="center" width="75% " border={true} src="https://files.readme.io/95f9da4-Edit_subscriptions.gif">
