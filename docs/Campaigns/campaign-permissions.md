...
> 📘 Note
> 
> Roles define each user's default behavior and whether they have permission to override the Global Campaign or Throttle Limits at the campaign level. Users cannot change these permissions; an Admin defines them via _Settings > Roles_. 
> 
