...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/53ce081-Campaign_reports.gif",
        "Campaign_reports.gif",
        1422,
        715,
        "#e7e8ee"
      ],
...
[/block]
3. Click Email Report ![Email_report](https://files.readme.io/5e252c3-Email_Report_icon.jpg) or Subscribe to Reports. The Campaign Summary Emails pane appears.
3. Setup the campaign report from the *Setup* tab.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9cfd2b3-Campaign_summary_emails.png",
        "Campaign_summary_emails.png",
        401,
        678,
        "#f5f7fa"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5b2d697-Campaign_Reports.png",
        "Campaign_Reports.png",
        1425,
        860,
        "#ececf3"
      ],
