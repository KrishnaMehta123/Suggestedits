...
excerpt: Send Optimal time messages to users.
deprecated: false
hidden: true
metadata:
  title: ''
...
<Image title="Best_Time.png" alt={737} className="border" width="smart" border={true} src="https://files.readme.io/5a7e681-Best_Time.png" />
...
<Image title="2 Select attendance event.png" alt={746} className="border" width="auto" border={true} src="https://files.readme.io/6853c88-2_Select_attendance_event.png" />
...
<Image title="3a Select multiple dates.png" alt={1575} className="border" border={true} src="https://files.readme.io/89a9c9e-3a_Select_multiple_dates.png" />

Or it is available for recurring campaigns.

![776](https://files.readme.io/9860ca3-3b_Select_recurring_dates.png "3b Select recurring dates.png")
...
To set up a message to deliver at the best time, create a journey. For more information, refer to [Journeys](https://docs.clevertap.com/docs/journeys). 
...
<Image title="4 Click sleep time.png" alt={1547} className="border" border={true} src="https://files.readme.io/5660e8b-4_Click_sleep_time.png" />
