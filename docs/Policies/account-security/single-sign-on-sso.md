...
![1999](https://files.readme.io/5b022c4-image4.png "image4.png")
...
Go to Applications->Select your application-> General ->Configure SAML\
...
Go to Directory -> Profile Editor -> Hover on you app and select Profile .\
...
Go to Applications->"Select your application" -> Assignments\
...
Login to [https://admin.google.com/](https://admin.google.com/) and login as Admin for you app
...
2. For each account you have with CleverTap , create an equivalent entry here with the name of your account. FOR Example here our App has 2 Accounts and the account names are Account\_1 and Account\_2 
