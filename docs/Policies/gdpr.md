...
*Android* \_\_g(ADID stripped of hyphens)\
...
If GDPR doesn't apply to you, then life continues as usual - with regards to profile creation. You can simply allow CleverTap to track the ADID and location, as per the documentation here - [https://developer.clevertap.com/docs/sdk-changes-for-gdpr-compliance](https://developer.clevertap.com/docs/sdk-changes-for-gdpr-compliance)
