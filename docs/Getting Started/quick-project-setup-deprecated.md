...
hidden: true
metadata:
  title: This page was unpublished.
  description: >-
    @DOCS: THIS PAGE WAS UNPUBLISHED AND THE FOLLOWING NEW ONES WERE PUBLISHED
    TO REPLACE THIS OLD PAGE:

    https://docs.clevertap.com/docs/set-up-dashboard#section-set-up-your-website

    https://docs.clevertap.com/docs/project-setup


    WE MIGHT WANT TO DELETE THIS PAGE LATER.
  robots: noindex
next:
  description: ''
---
...
A project can be an individual app, a website, or a product. You can choose to combine multiple platforms in a single project or have separate projects for each platform, depending on your business goals.
