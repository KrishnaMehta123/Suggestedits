---
title: Sample Events by Business Vertical
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
Please see the links below for example events by vertical that you can track with CleverTap. You can use variations of these samples for your app.

* [Ecommerce Events](doc:ecommerce-events-2)
