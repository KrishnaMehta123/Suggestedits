...
<Image title="1 CleverTap Demo Account .png" alt={345} className="border" border={true} src="https://files.readme.io/04a0224-1_CleverTap_Demo_Account_.png" />
...
<Image title="Run a Report 1 - Funnels steps.png" alt={1418} className="border" border={true} src="https://files.readme.io/0c00065-Run_a_Report_1_-_Funnels_steps.png" />
...
<Image title="Create a Segment 1 - + Segment.png" alt={1354} className="border" border={true} src="https://files.readme.io/15eba62-Create_a_Segment_1_-__Segment.png" />

3. On the next page under *Live user segments*, select the *Inaction within time* box.

<Image title="Create a Segment 3 - Inaction within time box.png" alt={1180} className="border" border={true} src="https://files.readme.io/50a8969-Create_a_Segment_3_-_Inaction_within_time_box.png" />
...
<Image title="Create a Segment 2 - Live user segment - Inaction within time .png" alt={685} className="border" border={true} src="https://files.readme.io/85cd769-Create_a_Segment_2_-_Live_user_segment_-_Inaction_within_time_.png" />

6. Save the segment as *Added To Cart but did not Charge within 5 minutes*, then click **Save**.

<Image title="Create a Segment 4 - new segment name.png" alt={688} className="border" border={true} src="https://files.readme.io/7e20fae-Create_a_Segment_4_-_new_segment_name.png" />
...
<Image title="Build a Campaign 1 - Create campaign.png" alt={1394} className="border" border={true} src="https://files.readme.io/9712992-Build_a_Campaign_1_-_Create_campaign.png" />

2. Under *Email channels*, select *Email*.

![845](https://files.readme.io/68c4600-Build_a_Campaign_1b_-_Select_email_channel.png "Build a Campaign 1b - Select email channel.png")

3. Select a campaign type.

![418](https://files.readme.io/ef7d515-Build_a_Campaign_1c_-_Select_campaign_type.png "Build a Campaign 1c - Select campaign type.png")

3. Name the campaign *Abandoned Cart Email*.
...
![1615](https://files.readme.io/70ea522-Build_a_Campaign_1d_-_Name_campaign_and_When_selection.png "Build a Campaign 1d - Name campaign and When selection.png")
...
<Image title="Build a Campaign 1e - Day gap and Who selection NEW.png" alt={1626} className="border" border={true} src="https://files.readme.io/7f1329e-Build_a_Campaign_1e_-_Day_gap_and_Who_selection_NEW.png" />
...
![1611](https://files.readme.io/1e83527-Build_a_Campaign_1f_-_What_Message_selection.png "Build a Campaign 1f - What Message selection.png")
...
<Image title="Build a Campaign 1g - enter What content.png" alt={1612} className="border" border={true} src="https://files.readme.io/06d2ef1-Build_a_Campaign_1g_-_enter_What_content.png" />

9. Review the setup page, then click **Continue**.

![1629](https://files.readme.io/5ce015f-Build_a_Campaign_1h_-_Setup.png "Build a Campaign 1h - Setup.png")
...
<Image title="Build a Campaign 1i - Schedule notification.png" alt={1631} className="border" border={true} src="https://files.readme.io/69b59d4-Build_a_Campaign_1i_-_Schedule_notification.png" />
...
For further information, you can watch the following video introducing CleverTap.

<Embed url="https://www.youtube.com/watch?v=VuXoziQvBcU&list=PLTXk2GzdxAChuuVW4i_H3VwQ9obTRs1L8&index=1" title="Product Demo: Introduction to CleverTap" favicon="https://www.youtube.com/s/desktop/1f1401a5/img/favicon.ico" image="https://i.ytimg.com/vi/VuXoziQvBcU/hqdefault.jpg" provider="youtube.com" href="https://www.youtube.com/watch?v=VuXoziQvBcU&list=PLTXk2GzdxAChuuVW4i_H3VwQ9obTRs1L8&index=1" html="%3Ciframe%20class%3D%22embedly-embed%22%20src%3D%22%2F%2Fcdn.embedly.com%2Fwidgets%2Fmedia.html%3Fsrc%3Dhttps%253A%252F%252Fwww.youtube.com%252Fembed%252FVuXoziQvBcU%253Flist%253DPLTXk2GzdxAChuuVW4i_H3VwQ9obTRs1L8%26display_name%3DYouTube%26url%3Dhttps%253A%252F%252Fwww.youtube.com%252Fwatch%253Fv%253DVuXoziQvBcU%26image%3Dhttps%253A%252F%252Fi.ytimg.com%252Fvi%252FVuXoziQvBcU%252Fhqdefault.jpg%26key%3Df2aa6fc3595946d0afc3d76cbbd25dc3%26type%3Dtext%252Fhtml%26schema%3Dyoutube%22%20width%3D%22854%22%20height%3D%22480%22%20scrolling%3D%22no%22%20title%3D%22YouTube%20embed%22%20frameborder%3D%220%22%20allow%3D%22autoplay%3B%20fullscreen%22%20allowfullscreen%3D%22true%22%3E%3C%2Fiframe%3E" />
