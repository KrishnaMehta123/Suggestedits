...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ba7f979-SET_DRP.png",
        "Select the Storage Time and Click Save",
        388
      ],
      "align": "center",
      "sizing": "80",
      "border": true,
      "caption": "Set Data Retention Policy (DRP)"
    }
  ]
}
[/block]
...
You can mask the data for custom events to meet your security or audit requirements. CleverTap allows you to mask a single custom event or multiple custom events. This feature ensures that your PII data has additional security.  It takes about 15 minutes to start masking data. The encryption will apply only to new data.

### Mask a Single Event

To mask custom event data, follow these steps:
...
You can mask the data for custom user properties to meet your security or audit requirements. CleverTap allows you to mask a custom user property or multiple user properties. This feature ensures that your PII data has additional security.  It takes about 15 minutes to start masking data. The encryption will apply only to new data.
