...
{
  "type": "danger",
  "body": "You can only discard an active event. Exercise extreme caution when discarding an event. This action cannot be undone. This action has an impact on your schema because it purges all data for the discarded event. It also drops any future incoming event with the same name.",
  "title": "Note"
}
[/block]
...
To define an event, click the ellipsis menu on the event row and select *Define Event*. Click **Define & Save**. 
[block:image]
{
  "images": [
    {
...
You can handle all the undefined events simultaneously. To handle all undefined data, click the ellipsis menu on the *Events* page row, then select *Handle undefined data*.  The *Undefined data settings* page will be displayed. 
[block:image]
{
  "images": [
    {
...
[block:callout]
{
  "type": "danger",
  "title": "Note",
  "body": "Exercise this option with caution. This is a powerful option to keep your data clean, but you will lose any unexpected data. This action cannot be undone."
}
[/block]
...
[block:callout]
{
  "type": "info",
  "title": "Note",
  "body": "An error is reported for all actions. A drop will have a higher severity and allow will have a lower severity. For more information, see [Error Stream](https://docs.clevertap.com/docs/error-stream)."
}
[/block]
...
You can edit any column. However, you can edit names only for unpublished event properties. To edit a property, click the edit icon on the property row from the *Custom events* tab. 
[block:image]
{
  "images": [
    {
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3897ef2-Schema_download_system_events.png",
        "Schema_download_system_events.png",
        806,
        491,
        "#f6f6f8"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/43134ef-Schema_download_user_properties.png",
        "Schema_download_user_properties.png",
        805,
        487,
        "#f6f6f8"
      ]
