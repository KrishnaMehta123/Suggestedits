...
> 📘 Note
>
> The CleverTap script runs in `Go`. Check that you have installed `Go` on your system.  To download and install go, see [https://golang.org/dl/](https://golang.org/dl/).
