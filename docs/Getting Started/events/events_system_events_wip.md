---
title: Events_System_events_WIP
excerpt: ''
deprecated: false
hidden: true
metadata:
...
[block:parameters]
{
  "data": {
    ...
    "19-0": "App Upgraded",
    "20-0": "Push Impressions",
    "21-0": "Stayed",
    "17-0": "Notification Delivered",
    "18-0": "Reply Sent",
    "22-0": "Session Concluded",
    "23-0": "Wzrk Fetch",
    "24-0": "State Transitioned",
    "25-0": "Geocluster Entered",
    "26-0": "Geocluster Exited",
    "27-0": "Experiment Viewed",
    "28-0": "AB Experiment Rendered",
    "29-0": "AB Experiment Rolled Out",
    "30-0": "AB Experiment Stopped",
    "31-0": "AB Experiment Disqualified",
    "32-0": "Any Event",
    ...
    "22-1": "This event is recorded to mark the end of a session. Session tracking must be enabled for the event to be tracked.",
    "22-2": "This event is raised when there is 20 minutes of inactivity after an event is raised for a user.",
    "24-1": "This is an event raised only for  *Lifecycle Optimizer*.This event is recorded when a user transitions from one stage to another.",
    "24-2": "This event is raised whenever a user is assigned a state or there is a transition from one state to another. It is meant for internal usage at CleverTap and therefore, unavailable for querying.",
    "25-1": "The event is only be applicable if you have enabled the geofence feature. This event is recorded to mark when a device enters a geofence.",
    "25-2": "The event is tracked whenever a device enters a geofence.",
    "26-1": "The event is only be applicable if you have enabled the geofence feature. This event is recorded to mark when a device exits a geofence.",
    "26-2": "The event is tracked whenever a device exits a geofence.",
    "28-1": "This event indicates that the variant has reached the device.",
    "28-2": "Event is raised when you are using the *Product A/B Tests *feature.",
    "29-1": "This event is raised when the winner variant is sent to all devices.",
    "29-2": "Event is raised when you are using the *Product A/B Tests *feature.",
    "30-1": "This event is raised when experiment was stopped.",
    "30-2": "Event is raised when you are using the *Product A/B Tests *feature.",
    "31-1": "This event is raised when the device is disqualified.",
    "31-2": "Event is raised when you are using the *Product A/B Tests *feature.",
    "32-1": "This is not an actual event. It is a default composite event that comprises all other events.<<@praveen needs better explanation>>",
    "32-2": "<<@praveen when is this event raised ?>>",
    "27-1": "<<@praveen needs explanation>>",
    "27-2": "<<@praveen needs explanation>>"
  },
  "cols": 3,
  "rows": 33
}
