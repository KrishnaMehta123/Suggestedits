...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This is not an actual event. It is a default composite event that comprises all other events.\<\<@praveen needs better explanation>>
      </td>

      <td>
        \<\<@praveen when is this event raised ?>>
      </td>
    </tr>
  </tbody>
</Table>
