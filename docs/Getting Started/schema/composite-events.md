...
You can now use this composite property instead of two separate underlying properties. For example, you can view a trend of the _Booking Revenue_ property in the [Trends](doc:trends#view-a-trend) report. 
