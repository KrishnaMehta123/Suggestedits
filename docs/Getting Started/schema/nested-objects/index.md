...
No. Nested Objects are supported only through the REST API. For more information, refer to [Ingesting Nested Objects via CleverTap APIs](https://staging.docs.dev.clevertap.net/docs/ingesting-nested-objects-via-clevertap-apis).
