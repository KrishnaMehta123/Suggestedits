...
<Image alt="Exclude Users from Control Groups" align="center" border={true} src="https://files.readme.io/592b966226b6bc53ffcfb96a69570c8b9cd3b51efd3466b287fd474ebaaf8f04-image.png">
...
Using *Age*, you can create and target segments, such as all users between 25 and 30 years old.
...
You can encrypt your PII data to meet your security and audit requirements. Currently, you have the option to encrypt this data from the [schema](doc:schema#encrypt-user-data)  page. 

<Image alt="View Encrypted Profile Data" align="center" border={true} src="https://files.readme.io/6f55235803684c1f6dc6de7e964d7c46e6aa01b0052ded01adfe47de33d4c2f7-image.png">
  View Encrypted Profile Data
</Image>
...
**Profile not reachable**: This error is raised when the qualifying profile is unreachable on the selected communication channel. For example, a user blocks push notifications on iOS but qualifies for a campaign. This user does not receive the campaign and is marked as a profile that is not reachable.
