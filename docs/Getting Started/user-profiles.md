...
Using _Age_, you can create and target segments, such as all users between 25 and 30 years old.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6f55235803684c1f6dc6de7e964d7c46e6aa01b0052ded01adfe47de33d4c2f7-image.png",
        null,
        "View Encrypted Profile Data"
      ],
      "align": "center",
      "border": true,
      "caption": "View Encrypted Profile Data"
    }
  ]
}
[/block]
