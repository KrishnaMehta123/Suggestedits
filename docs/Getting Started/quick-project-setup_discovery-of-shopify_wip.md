---
title: Quick Project Setup_Discovery of Shopify_WIP
excerpt: ''
deprecated: false
hidden: true
metadata:
...
<Image title="Project page.png" alt={2040} className="border" border={true} src="https://files.readme.io/db5d3b4-Project_page.png" />

> 📘 Integrate Shopify
>
> For more information about integrating Shopify, [click here](https://docs.clevertap.com/docs/shopify).
