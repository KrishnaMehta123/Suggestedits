...
If the app is required to be GDPR compliant or if you do not want to use the Google AdID, you can use the __<Random Alphanumeric String> notation to generate the CleverTap ID. 
