  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Identify Logged-in Users"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Select Identity Method"
    }
  ]
}
[/block]
...
1. Go to _Settings_ > _User Identity_ .
...
1. From the dashboard, navigate to _Settings_ > _User Identity_.
2. Under the section _How do you want CleverTap to handle identified profiles?_, select  _Allow multiple identities to merge on the same device_.
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Use Device Identifiers"
    }
  ]
}
[/block]
