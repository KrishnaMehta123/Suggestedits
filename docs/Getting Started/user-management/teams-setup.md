  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        [Teams in Engagements](doc:teams-in-engagements)
    ...
    <tr>
      ...
      <td>
        ...
        [Teams in Segmentation](doc:teams-in-segmentation)
    ...
    <tr>
      ...
      <td>
        <ul><li>Users can view and manage only the product experiences (walkthroughs, tooltips, nudges, and so on.) created within their current team.</li><li>Events, segments, and targeting rules available in the builder reflect only the data accessible to that team.</li><li>Content, triggers, and targeting cannot reference entities created by another team.</li></ul>
      </td>

      <td>
        Product experiences created in other teams are hidden and cannot be edited or reused. To replicate an experience, you must recreate it using assets and events available in the new team context.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <ul><li>Users can view, edit, and trigger reminders created by their current team.</li><li>Events, triggers, and targeting configurations in reminders are restricted to the logged-in team context.</li><li>Reminders linked to events or segments from another team become inactive until replaced with team-accessible entities.</li></ul>
      </td>

      <td>
        Reminders created under another team are hidden. If a reminder references an event or segment no longer accessible in the new team, it must be updated or recreated using team-available data.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <ul><li>Users can view and build Boards, Funnels, Pivots, and Trends using only the events accessible to their current team.</li><li>Existing analytics assets (Boards, Funnels, etc.) created under a previous team remain visible but show limited or missing data if associated events are no longer accessible.</li><li>When event access changes, metrics or visualizations tied to restricted events are either hidden or marked as unavailable.</li></ul>
      </td>

      <td>
        Boards and reports automatically refresh to reflect the events accessible to your new team. Visualizations built on events from the previous team show empty or restricted data states.
      </td>
    </tr>
  </tbody>
</Table>
