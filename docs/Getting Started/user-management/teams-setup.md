...
> 
> - Switching Teams is seamless and helps users move between contexts, such as regions or products, without separate logins or dashboards. To switch Teams, click the Teams switcher dropdown under _Project Name_ on the left nav.
> 
> [block:image]{"images":[{"image":["https://files.readme.io/5d1f7437a2c7500087855d2606135288c52dc428be3bfd4f94e1387448b53f77-Switcher.png","","Teams Switcher Dropdown"],"align":"center","sizing":"60% ","border":true,"caption":"Teams Switcher Dropdown"}]}[/block]
> 
> - All open tabs auto-refresh on team switch to ensure consistency across sessions.
> 
> [block:image]{"images":[{"image":["https://files.readme.io/fbd6bdc2ebcee842c0cbaf1f269084add2773b626690aa166a1f465029801068-Modal__Switch_team.png","","Switching Teams"],"align":"center","sizing":"50% ","border":true,"caption":"Switching Teams"}]}[/block]
> 
...
- [Assign Teams to User During Invitation](doc:teams-setup#assign-teams-to-user-during-invitation)
...
To access the Teams listing page, go to _Project Settings_ and click **Teams**. To create a new Team, click **Create Team**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dab06247c127097061a32f062d51371279259cc1c64f23f4315bc7c154f74d65-Teams_Listing_Page.png",
        "",
        "Teams Listing Page"
      ],
      "align": "center",
      "border": true,
      "caption": "Teams Listing Page"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1a9f486c9d469944715581cfd3f01d867ca49f23d9cd3995791dcc2ef0e00375-teamss.png",
        "",
        "Create Team"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dd1020390721e277cd3886ecef044094fb77b99f16e797484e58d352de8e94fd-event_selection.png",
        "",
        "Event Selection for Including/Excluding Events"
      ],
      "align": "center",
      "border": true,
      "caption": "Event Selection for Including/Excluding Events"
    }
  ]
}
[/block]
...
1. Go to _Project Settings_ and click **Teams**. Click **Edit Team**. 
2. Edit the **Name** and **Description** fields. You can also view users and their roles on the team.
3. Click Custom event access to control which events the team can access. You can choose from _All events, Only selected events,_ and _All excluding selected events._
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/afffc53e2bdefd07f5880dc67cdae686f81ef2ed614f34a45d9c4bd19641e73f-Edit_teams_-_new.png",
        "",
        "Edit Team"
      ],
      "align": "center",
...
1. Go to _Settings_ and click **Users**. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/48f2f2948896e70dd5522d157e91a6801e57a71d0cf475575239ac63f00601d8-teams_users.png",
        "",
        "Manage Roles and Teams"
      ],
      "align": "center",
      "border": true,
      "caption": "Manage Roles and Teams"
    }
  ]
}
[/block]
...
When inviting a user from the dashboard, the admin can select one or more Teams to assign to the user during the invitation process. For users added via SSO (Single Sign-On), if the `accountList` attribute is configured, the user is initially placed in the Default Team. The admin can later update the user's team membership from the _Users_ page.

## Bulk Update Teams for Users

Admins can bulk **add** or **remove** Teams for users from the _Users page_. Validation ensures each user belongs to at least one team after bulk operations.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9bb13c4cea1973745f9c036dbff3861248d98215e0c769d115d2bbfbd7650361-Bulk_Updating.png",
        "",
        "Bulk Update"
      ],
      "align": "center",
...
You can export user details by selecting **Download as CSV** from  _Settings_ > _Users_. The CSV includes a Teams column, showing the teams each user belongs to, along with other key information such as _Name_, _Role_, _Email_, and _Status_. You can use this export to audit team membership across your organization, identify users who are not assigned to the right teams, and so on.
...
| Module              | Impact                                                                                                                                                                                                                                                                                                                                                                                                                                                           | What Happens When You Switch Teams                                                                                                                                                                           |
| :------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Analytics           | Users see and use only team-accessible events in queries.                                                                                                                                                                                                                                                                                                                                                                                                        | Event dropdown updates to reflect the event access for selected team. Users can only view and analyze queries built using events available to that team.                                                     |
| Best Time           | <ul><li> Shows only events accessible to the team.</li><li> A maximum of 10 configurations allowed across all your projects on the CleverTap dashboard.</li></ul>                                                                                                                                                                                                                                                                                                | The Event Configuration list updates to show only events allowed for the selected team. Users can view and use only configurations tied to those events.                                                     |
| Bulletins           | Business Event dropdown shows only events accessible to the selected team. Users can view and configure only those events assigned to their team.                                                                                                                                                                                                                                                                                                                | The event list updates automatically to reflect event access for your new team.                                                                                                                              |
| Content Manager     | <ul><li> Files, templates, blocks, and folders are only visible to the team that created them. </li> <li> Users cannot reuse or edit content created by other teams. </li> <li> All CMS asset names (templates, files, blocks, folders) must be **globally unique** across the account. </li> <li> To ensure consistency and avoid naming conflicts, asset names must be globally unique, even if users cannot see content created by other teams.</li></ul>     | CMS assets created in another team are not accessible or visible. Campaigns that reference such content must recreate it in the new team context.                                                            |
| Engagements         | <ul><li>Users can view and manage only those campaigns that belong to their team(s).</li> <li>The **Who** section in campaign setup displays only segments created within the same team context.</li> <li>Liquid Tags, Conversion Tracking, Personalization Setup, etc. show team-specific event data. </li></ul>                                                                                                                                                | Content reuse and targeting remain scoped to team-owned assets, ensuring controlled distribution and message governance. For more information, refer to [Teams in Engagements](doc:teams-in-engagements)   . |
| Promos              | <ul><li>When setting up a promo, the Event dropdown shows only events configured for the selected team.</li><li>Targeting rules are designed to work with team-specific event data, helping teams build precise, relevant campaigns.</li></ul>                                                                                                                                                                                                                   | <ul><li>Event dropdown in rule builder shows only events configured for the selected team.</li><li> Switching teams refreshes this list based on updated event access.</li></ul>                             |
| Segmentation        | Users can view, edit, and use only the segments created by their own teams. When building segments, only events visible to the team are available in the builder                                                                                                                                                                                                                                                                                                 | Users do not have access to segments from the previous team. Segment list and filters update based on new team context. For more information, refer to [Teams in Segmentation](doc:teams-in-segmentation)  . |
| Product Experiences | <ul><li>Users can view and manage only the product experiences (walkthroughs, tooltips, nudges, and so on.) created within their current team.</li><li>Events, segments, and targeting rules available in the builder reflect only the data accessible to that team.</li><li>Content, triggers, and targeting cannot reference entities created by another team.</li></ul>                                                                                       | Product experiences created in other teams are hidden and cannot be edited or reused. To replicate an experience, you must recreate it using assets and events available in the new team context.            |
| Reminders           | <ul><li>Users can view, edit, and trigger reminders created by their current team.</li><li>Events, triggers, and targeting configurations in reminders are restricted to the logged-in team context.</li><li>Reminders linked to events or segments from another team become inactive until replaced with team-accessible entities.</li></ul>                                                                                                                    | Reminders created under another team are hidden. If a reminder references an event or segment no longer accessible in the new team, it must be updated or recreated using team-available data.               |
| Analytics           | <ul><li>Users can view and build Boards, Funnels, Pivots, and Trends using only the events accessible to their current team.</li><li>Existing analytics assets (Boards, Funnels, etc.) created under a previous team remain visible but show limited or missing data if associated events are no longer accessible.</li><li>When event access changes, metrics or visualizations tied to restricted events are either hidden or marked as unavailable.</li></ul> | Boards and reports automatically refresh to reflect the events accessible to your new team. Visualizations built on events from the previous team show empty or restricted data states.                      |
...
- [Using Teams in Segmentation](https://staging.docs.user.clevertap.net/docs/teams-in-segmentation)
- [Customs List API](https://staging.docs.dev.clevertap.net/docs/custom-list-api-teams)
- [Using Teams in Engagements](https://staging.docs.user.clevertap.net/docs/teams-in-engagements)
- [Create Campaign API](https://staging.docs.dev.clevertap.net/docs/create-campaign-copy-1)