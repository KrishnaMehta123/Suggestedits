---
title: Manage Users
excerpt: Learn how to invite and manage users on the CleverTap dashboard.
deprecated: false
hidden: false
metadata:
  title: ''
...
To access the CleverTap dashboard, the user needs an invitation and an appropriate access level. The account admin can perform different operations, such as adding a new user, deleting an existing user, assigning a role to a user, editing the user's current role, and so on from the _Settings_ > _Users_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4ad9c66d5e3b370dda07c60a04d21f65404a0b1537a1734be355262577f07520-Users_Navigation.png",
...
1. Click **+ User** from the _Users_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a6364c54837b4a8886a9cd91ed670bbec7fdde0fdd81788150f3238bdca6a5f6-Invite_Users.png",
        "",
        "Invite Users"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a3d7e754fc9ea124cd7499303470731f3ee4b122d2c6923674690969d665cb4a-Bulk_User_Invite.png",
...
You can download the list of all users by clicking **Download as CSV** from the _Users_ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/316aa4d70b8dee9178b2750c5da9e112bfb220dad76aad65039264f2d7eabccb-Download_as_CSV.png",
        "Download User List",
...
Revoking user access implies that the user can no longer access the dashboard. To do so, click the ![Ellipses](https://files.readme.io/2717d2a-ellipses_icon.png) against the required user and select _Revoke User Access_ from the list.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ff67eeef82dc136192a51b15330abd0c3faca9a83408a8db520bc8c90908e6ae-Revoke_User_Access.png",
        "Revoke Access",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5963e7810ba35dd527a2ebc534de18bafe97c7098db5aaf0d544d4f6ddb2e611-Edit_Role.png",
        "Edit a Role",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/087f4f6460583409f2bb3c502af0f621050b6c9bb459f35b1eece01c0741e6dd-Bulk_Action_for_Managing_Multiple_Roles.png",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/416bca13c62d3aff8dd86308a4fc8ddb4d749f31039404aceeec81a129da0828-Multiple_Roles_Assignment.png",
        "",
        "Save Bulk Actions"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0de3e86a9df1cde55bbd98b4d9715fd63b9ac8e416de1a7bab9b1bdf4d3873b5-Delete_User.png",
        null,
        "Delete a User"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7ceab210ba5ce562e78dab2ce792ecfadf757b8f427b87af8acfd017f8492218-Reset_Passcode.png",
        "Reset Passcode",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5a749c9ba96244de87cf366e7dab3a8ffe64205f873b4e7c53b614424e040055-Grant_Passcode.png",
        "Grant Passcode",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f537e123c5519a313c110175d55e4e24211d2d5c5bf0ba9881943aa4e381bcc8-Grant_Passcode_Popup.png",
        "Grant Passcode",
