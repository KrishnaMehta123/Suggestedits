---
title: 'CMS-1067 Role-Based Access Control: Advance Governance'
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        • *System Boards* <br /> • *Custom Boards*
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        • *Manual Segmentation*: Segments, Find People <br /> • *Automated Segmentation*: Goals, IBS, RFM
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        • *Campaigns*: Channel Campaigns<br /> • *Journeys* <br /> • *Recommendations* <br /> • *Catalogs* <br /> • *Global Campaign Limit (GCL)*: Define the maximum number of campaigns that can run concurrently <br /> • *Global Throttle Limit (GTL)*: Control the number of messages sent per user per day <br /> • *Bulletins*
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        • *Billing*: Billing, app usage, plan, invoices <br /> • *Account Settings*: Add new app, change account, timezone, privacy settings <br /> • *User Settings*: Invite user, revoke access, passcode settings <br /> • *CSV Uploads*: Profile uploads, external user list <br /> • *My Profile and Password* <br /> • *Exports*: Event and profile exports to Amazon S3 <br /> • *Downloads*: Download profile <br /> • *Email Reports*: Campaign and Journey reports <br /> • *Campaign Integration and Settings*: Push, Email, SMS, Web Push, Facebook, Google AdWords <br /> • *Campaign Settings*: Campaign limits, best time settings <br /> • *SFTP Imports*: Event and profile imports via SFTP <br /> • *SSO Settings*: Enable/disable SAML SSO <br /> • *GCS Exports*: Event and profile exports to Google Cloud Storage <br /> • *Custom List Segment* <br /> • *Session Analytics*: Enable session tracking <br /> • *Geofences*: Create geofence clusters <br /> • *Attribution Partner Settings* <br /> • *MIXPANEL Exports*: Event exports to Mixpanel <br /> • *Amplitude Exports*: Event exports to Amplitude <br /> • *Mparticle Exports*: Event and profile exports to Mparticle <br /> • *Security*: IP Whitelisting, 2FA <br /> • *Segment Exports*: Event exports to Segment.io <br /> • *Azure Exports*: Event and profile exports to Azure Blob Storage <br /> • *Role Settings*: Role-based access control <br /> • *CDP Imports*: Event and profile imports from external datasource
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        • *User Profile Management*: Delete user, de-merge user, mark as test <br /> • *Error Stream*: Error stream
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        • *Event and Profile Properties Schema* <br /> • *Conversion Event* <br /> • *Qualifying Event*
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        • *Setup*: Legacy Setup <br /> • *Experiences & Experiments*: Legacy Experiences & Experiments
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        • *Files*: CMS Files <br /> • *Templates*: CMS Templates
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        • *Remote Config & A/B tests*: Remote Config, A/B tests
      </td>
    </tr>
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Read-only access to view analytics and reports. Access to Conversations.
      </td>

      <td>
        Replying to customer chats, ticket statuses, and managing chats with users. No access to campaign, billing, and so on. For more information, refer to [Conversations](https://docs.clevertap.com/docs/conversations) .
      </td>
    </tr>
  </tbody>
</Table>
...
* *Data Access*: Provide users access to different datasets and restrict access to the data you do not want them to view on the CleverTap dashboard. ow.
...
This tab is visible only to roles with *Write* access to engagement components, such as Campaigns and Journeys. You can define the Limits and Channel access from this tab.

> 📘 Private Beta
>
> The Channels feature is currently a Private Beta Release. If you want access to it, contact your Account Manager.
