...
excerpt: >-
  Learn how each team in your organization can create and use segments
  independently, maintaining clarity and governance.
deprecated: false
hidden: false
metadata:
  title: ''
...
For more information, refer to [Teams in Engagements](doc:teams-in-engagements).
