...
> 
> The Approver role can only be accessed when the [Campaign Approval Workflow](https://docs.clevertap.com/docs/campaign-approval-workflow) feature is enabled from _Settings_ > _Security_ > _Campaign Approval_.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/41f43fd72c8005dca3934d348e2cbbef3cbc3fde6321bf8cccbf48ef8553a2a2-Roles_Permissions.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/48280be8f79416863dd18df52ca1ff4de120eb52208392dcb92802a30897c77d-Data_Access.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bd9bed1198633873aef028c7555db50359ce1a408ad201ca8a53b3c3ff38da14-Overview.png",
        null,
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Deleting a Custom Role"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Permission Clash For Custom Roles"
    }
  ]
}
[/block]
