...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/484a9cfcb3aafd73f9c5cb8afc11e9f00afbf953a081a499aa2c5b033c2faaea-image.png",
        null,
...
This tab is visible only to users with _Write_ access to engagement components, such as Campaigns and Journeys.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ce5d102aeb44f1da36cfb3eb2eb71ec961573a6c01508272f971fc1428618b79-image.png",
        null,
        "Engagement Permissions"
      ],
      "align": "center",
...
For example, you can grant access to the role _US Campaign Manager_, which has write access to campaigns for only users in the United States. This role cannot create campaigns for users in other geographies.
