...
Schema is a framework for maintaining, organising, and structuring your data. It enforces rules to maintain data integrity so that you can avoid data quality issues later. Schema standardizes your data before you even begin using it. Since insufficient data leads to a high cost in effort and money, you can save a lot of manual effort on tracking your data in the long run.

The schema table stores event and user properties in a pre-defined order to preserve data sanity. It ensures better output by enforcing incoming data standardization and avoiding data duplication or corruption. Better input leads to a better outcome in your campaigns and journeys. It also provides more accurate insights into your data analytics.
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Turn Off Toggle to Disable Tracking UTM Visited"
    }
  ]
}
[/block]
...
The _Push Impression_ event has its properties, and the users can configure these non-required event properties to optimize the cost.
...
4. Turn ON the **Mobile Push** toggle and click **Save**. The _Push impressions tracking enables the_ message to be displayed on the screen.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/94f4dcb-Turn_Off_Push_Impression_Tracking.gif",
        null,
        "Disable Tracking Push Impressions Event"
      ],
      "align": "center",
      "border": true,
      "caption": "Disable Tracking Push Impressions Event"
    }
  ]
}
[/block]
...
The users can disable tracking of some of the _Push Impression_ event properties from the CleverTap dashboard. However, there are a few Push Impression event properties for which you do not have the option to disable the tracking. These are listed as follows:
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "Configurable",
    "0-0": "`wzrk_push_amp`",
    "0-1": "Indicates whether push amplification is enabled.",
    "0-2": "No",
    "1-0": "`wzrk_pn`",
    "1-1": "Indicates whether the push notification is sent from CleverTap.",
    "1-2": "No",
    "2-0": "`CT Source`",
    "2-1": "Specifies the source of the CleverTap campaign.",
    "2-2": "No",
    "3-0": "`wzrk_id`",
    "3-1": "Specifies the CleverTap campaign ID associated with the notification.",
    "3-2": "No",
    "4-0": "`wzrk_pid`",
    "4-1": "Specifies the unique ID for the push notification.",
    "4-2": "No",
    "5-0": "`wzrk_pivot`",
    "5-1": "Indicates the variant used in the A/B test campaign.",
    "5-2": "No",
    "6-0": "`wzrk_acct_id`",
    "6-1": "Specifies the CleverTap Account ID.",
    "6-2": "No",
    "7-0": "`CT App Version`",
    "7-1": "Indicates the version of the CleverTap App.",
    "7-2": "No",
    "8-0": "`wzrk_dt`",
    "8-1": "Specifies the delivery type for the notification.",
    "8-2": "No",
    "9-0": "`wzrk_acts`",
    "9-1": "Refers to the CTA button included in the notification.",
    "9-2": "No",
    "10-0": "`wzrk_pn_h`",
    "10-1": "Indicates the RenderMax health status of the push notification.",
    "10-2": "No",
    "11-0": "`wzrk_pn`",
    "11-1": "Indicates that the notification is sent from CleverTap, if present.",
    "11-2": "No",
    "12-0": "`wzrk_bp`",
    "12-1": "Displays an image in the notification if the URL is present.",
    "12-2": "Yes",
    "13-0": "`wzrk_sound`",
    "13-1": "Plays the default or custom Android notification sound if present.",
    "13-2": "Yes",
    "14-0": "`nt`",
    "14-1": "Displays the notification title; defaults to app name if absent or empty.",
    "14-2": "Yes",
    "15-0": "`nm`",
    "15-1": "Displays the notification body; ignores the notification if absent or empty.",
    "15-2": "Yes",
    "16-0": "`wzrk_dl`",
    "16-1": "Opens the specified deeplink when the notification is clicked, if present.",
    "16-2": "Yes",
    "17-0": "`wzrk_d`",
    "17-1": "Ignores the notification if this key is present.",
    "17-2": "No",
    "18-0": "`ico`",
    "18-1": "Displays the small notification icon from the specified URL if present and not empty.",
    "18-2": "Yes",
    "19-0": "`wzrk_pivot`",
    "19-1": "Identifies the variant type in A/B testing if present and not empty..",
    "19-2": "Yes",
    "20-0": "`wzrk_rnv`",
    "20-1": "Raises the Push Impressions event if present and not empty.",
    "20-2": "No",
    "21-0": "`wzrk_nms`",
    "21-1": "Displays summary text with the image if present and not empty.",
    "21-2": "Yes",
    "22-0": "`wzrk_st`",
    "22-1": "Displays subtitle text next to the app name if present and not empty.",
    "22-2": "Yes",
    "23-0": "`wzrk_clr`",
    "23-1": "Applies the hex color to the small icon and app name (on Android versions below Pie) if present and not empty.",
    "23-2": "Yes",
    "24-0": "`wzrk_bpds`",
    "24-1": "Indicates the image rendering status with the following values:  \n  \n<ul><li> NO_IMAGE- No image included</li>\n<li>SUCCESS- Image downloaded successfully</li>\n<li> NO_NETWORK- Image included but no network connectivity</li>\n  <li> DOWNLOAD_FAILED- Image download failed due to an external error</li></ul>",
    "24-2": "Yes",
    "25-0": "`wzrk_cid`",
    "25-1": "Refers to the channel ID used for the push notification.",
    "25-2": "Yes",
    "26-0": "`wzrk_mutable_content`",
    "26-1": "Enables rendering of rich push notification via extension class if set to true.",
    "26-2": "Yes",
    "27-0": "`wzrk_bi`",
    "27-1": "Specifies the badge icon to be displayed in the push notification.",
    "27-2": "Yes",
    "28-0": "`wzrk_bc`",
    "28-1": "Specifies the badge count to be shown on the app icon.",
    "28-2": "Yes",
    "29-0": "`Campaign Type`",
    "29-1": "Indicates the campaign’s channel type (for example, Push, Email, SMS).",
    "29-2": "No",
    "30-0": "`wzrk_ttl`",
    "30-1": "Specifies the time to live (TTL) for the notification.",
    "30-2": "Yes",
    "31-0": "`wzrk_ttl_s`",
    "31-1": "Specifies the time to live for the notification in seconds.",
    "31-2": "Yes",
    "32-0": "`wzrk_cts`",
    "32-1": "Records the timestamp when the notification is clicked.",
    "32-2": "No",
    "33-0": "`wzrk_ck`",
    "33-1": "Defines the collapse key (typically a timestamp) for the notification.",
    "33-2": "Yes",
    "34-0": "`wzrk_collapsible`",
    "34-1": "Specifies whether the notification is collapsible.",
    "34-2": "Yes",
    "35-0": "`wzrk_category`",
    "35-1": "Specifies the notification category for APNS (iOS only).",
    "35-2": "Yes",
    "36-0": "`wzrk_interruption_level`",
    "36-1": "Sets the interruption level on APNS (iOS only).",
    "36-2": "No",
    "37-0": "`wzrk_relevance_score`",
    "37-1": "Assigns the relevance score on APNS (iOS only).",
    "37-2": "No"
  },
  "cols": 3,
  "rows": 38,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1dd0fc5-View_Push_Impressions_Properties.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/479d1ac-Disable_a_Push_Impression_Property.gif",
        null,
        "Disable Property Tracking"
      ],
      "align": "center",
      "border": true,
      "caption": "Disable Property Tracking"
    }
  ]
}
[/block]
...
> 📘 Default Behavior
> 
> The UTM Visited tracking is ON for new customers by default. For existing customers, the tracking of _UTM Visited_ remains as is. However, they can enable or disable the same.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a13c357-Custom_Events.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6a62a19-Add_New_Event.png",
        "Click +Event. toAdd a Custom Event",
        "Add a Custom Event"
      ],
      "align": "center",
      "border": true,
      "caption": "Add a Custom Event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a57863ff74ecdc6b4f7712944b263471986135c4b829f70d073ef38fef10cd6e-image.png",
        null,
...
- DRP modifications (for example, reducing or increasing the retention period) are not immediate.
- Changes made to the DRP takes into effect after 24 hours.

As the purging happens after 16 days, users must plan DRP changes well in advance if using it to manage specific data lifecycle events (for example, deletion of incorrect uploads).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b6033f7-Custom_Events.png",
        "Click Remove from the Ellipsis Menu to Remove the Event",
        1153
      ],
      "align": "center",
      "border": true,
      "caption": "Remove an Event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6f94655-Discard_event.png",
        "Click Discard from the Ellipsis Menu to Discard the Event",
        1126
      ],
      "align": "center",
      "border": true,
      "caption": "Discard an Event"
    }
  ]
}
[/block]
...
> 📘 Discard Access
> 
> Only admin users can discard events, event properties, and user properties.
...
1. Go to the _Custom events _ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b64c088b7f531e770b0e9b81441008e59bb5b099c0a00a2f8b0be2826e0b9568-image.png",
        null,
        "Restore Custom Event"
      ],
      "align": "center",
      "border": true,
      "caption": "Restore Custom Event"
    }
  ]
}
[/block]
...
1. Go to the Events, or Event Properties, or User Properties table on the _Custom events _ page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f3def79a65dda3e144e4a8711f3e4e0407dc1b61b35dbcb12699fbde4ba41230-image.png",
        null,
        "Bulk Restore discarded items"
      ],
      "align": "center",
      "border": true,
      "caption": "Bulk Restore Discarded Items"
    }
  ]
}
[/block]
...
> 📘 Restore Access
> 
> Only admin users can restore the discarded events, events properties, and user properties.
...
> 
> Once data is encrypted, it cannot be marked as decrypted again. This action is irreversible.

### Encrypt a Single Event
...
Apply masking to event properties in CleverTap to protect sensitive information and meet your organization’s data security and compliance requirements. This feature ensures that Personally Identifiable Information (PII) is hidden by default and only visible to users with the appropriate [role-based access](doc:role-based-access-control).
...
- Restrict visibility of confidential data such as emails, phone numbers, or payment IDs.
- Ensure compliance with data privacy regulations like the General Data Protection Regulation (GDPR).
- Enforce internal policies using role-based access controls.

CleverTap provides two ways to mask event properties:

- [Mask Custom Event Property](doc:schema#mask-custom-event-property): Manually mask a specific custom event property.
- [Mask Bulk Custom Event Properties](doc:schema#mask-bulk-custom-event-properties): Mask multiple properties of a single custom event simultaneously for faster setup.

## Mask Custom Event Property

To mask a single property, such as a user name or email, you can apply the masking action directly from the event properties table.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/452a72da983136b4eeaf027e7748230b1e60f718240625380b63033d7af3eb8a-2025-05-08_02-06-07_1.gif",
        "",
        "Mask Single Property"
      ],
      "align": "center",
      "border": true,
      "caption": "Mask Single Property"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9aee73f5bf09518d23faedca071aa3f81d5a2f0b36452ac5c2d93c475bd28981-image.png",
        null,
        "Masked property queued for processing"
      ],
      "align": "center",
      "border": true,
      "caption": "Masked property queued for processing"
    }
  ]
}
[/block]
...
## Mask Bulk Custom Event Properties

To mask multiple properties in a custom event, you can mask them all in one go to streamline configuration.

To mask multiple properties:

1. Go to _Settings_ > _Schema_ >_ Events_ > _Custom events_.
2. Click the _Properties_ hyperlink for the relevant custom event.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9dcacf8fcbf672a377ed27003032bb9baafb53898792e39d3d1809d4f8673af7-2025-05-08_02-17-57_1.gif",
        "",
        "Mask Properties in Bulk"
      ],
      "align": "center",
      "border": true,
      "caption": "Mask Properties in Bulk"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ebad65c9d791a15ae65099da746df83b2e9071c7bb4caa370da64d75d9a71974-image.png",
        null,
        "Masked property queued for processing"
      ],
      "align": "center",
...
### Unmasking Custom Event Properties
...
The system now automatically generates clear and consistent descriptions whenever a user property, custom event, or custom event property is created or updated. You can choose to _Accept_ or _Dismiss_ the generated description. After accepting it, you can edit the description if needed.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b65740e2a6cc48dc01dc555988a05ede4f88f9730756aa8ace448119de4496c6-2025-12-04_17-08-08_1.gif",
        "",
        "AI-Generated Descriptions"
      ],
      "align": "center",
      "border": true,
      "caption": "AI-Generated Descriptions"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9a45a27-Add_property.png",
        "Click +Property to Add Event Property",
        1144
      ],
      "align": "center",
      "border": true,
      "caption": "Add Event Property"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/804cbdc-Edit_Event_Property.png",
        "Click the Edit Icon to Edit Event Property",
        1184
      ],
      "align": "center",
      "border": true,
      "caption": "Edit Event Property"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/40172c7-Discard_event_property.png",
        "Click Discard Button to Discard Event Property",
        531
      ],
      "align": "center",
      "sizing": "80",
      "border": true,
      "caption": "Discard Event Property"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Enter a Property Name and Choose a Data Type to Add a User Property",
        "Add User Property"
      ],
      "align": "center",
      "border": true,
      "caption": "Add User Property"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0afe960-Edit_User_Property.png",
        "Click the Edit Icon to Edit the Property Name and Data Type",
        1109
      ],
      "align": "center",
      "sizing": "80",
      "border": true,
      "caption": "Edit User Property"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d75580c-Discard_User_Property.png",
        "Click Discard Button to Discard User Property",
        525
      ],
      "align": "center",
      "sizing": "80",
      "border": true,
      "caption": "Discard User Property"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f3777e6-Create_Linked_Event_for_User_Property.gif",
        "",
        "Create Associated Event"
      ],
      "align": "center",
      "border": true,
      "caption": "Create Linked Event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6675b4f-Bulk_Link_Event.png",
        "",
        "Select User Properties in Bulk"
      ],
      "align": "center",
      "border": true,
      "caption": "Bulk Link Events"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7b5b7fd-Create_Linked_Events_in_Bulk.png",
        "",
        "Create Bulk Raise Events"
      ],
      "align": "center",
      "border": true,
      "caption": "Create Linked Events in Bulk"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5980787-Discard_Linked_Event.gif",
        "",
        "Discard a Linked Event"
      ],
      "align": "center",
      "border": true,
      "caption": "Discard a Linked Event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5ba54c0-set_conversion.png",
        "Set Conversion Event Details and Click Save",
        1155
      ],
      "align": "center",
      "border": true,
      "caption": "Set Up Conversion Event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5d67342-set_qualifying.png",
        "Set Qualifying Event and Click Save",
        1162
      ],
      "align": "center",
      "border": true,
