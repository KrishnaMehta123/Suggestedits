...
3. Now, enter the IP address you wish to whitelist in the *IP Address* field. You can add up to 20 IP addresses at once. If you are adding multiple IP addresses, use commas to separate them. After you enter all the IPs, click *Whitelist IP Address*.
