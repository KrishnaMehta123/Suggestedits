...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4f65ed07ee09b994dc8d709d8ab217f1fe6cf1772d3600b37e2b75a4435440ab-2025-06-16_14-25-07_1.gif",
        "",
        "Mask Single Custom Property"
      ],
      "align": "center",
      "border": true,
      "caption": "Mask Single Custom Property"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Mask Custom Properties in Bulk"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cb26bd32026184d2412c586f4b51370c3fbde712b88bab03db2e9d7b0d676656-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/558beee8be7de5adc325a9b16e54811a7280dfd1d3862505f02e287f9bcc1a91-2025-05-28_23-18-54_1.gif",
        "",
        "Unmask Single Custom Property"
      ],
      "align": "center",
      "border": true,
      "caption": "Unmask Single Custom Property"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/258b637bcc866a1fdfcbc779b7b9247a923632ee399f399b0088b9b44b870f9f-image.png",
        null,
        ""
      ],
      "align": "center",
...
Only Admin users can mask or unmask custom event or user properties. Non-admin users cannot apply masking.
...
No. Only Admin users have the permission to unmask properties. Non-admin users cannot reverse or access masked values.
