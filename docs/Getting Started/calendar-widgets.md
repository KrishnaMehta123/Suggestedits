...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d816116c888592d274af26bed8130d00edfe2ec1539a31f1a4d5ef5b159dd4f9-Calendar.png",
        "Select the Relative Date to View the Data",
        320
      ],
      "align": "center",
      "sizing": "60% ",
      "border": true,
      "caption": "Select Relative Date"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Select Calendar Date Range and Click Apply",
        573
      ],
      "align": "center",
      "border": true,
...
- **Does Not Exist:** Filter your data based on whether the date is absent for the event. For example, if you are a movie streaming app, you can find data for the _Subscribed_ event where the upload date you select does not exist.