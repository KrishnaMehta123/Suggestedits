...
{
  "type": "info",
  "body": "We recently added the Relative Date calendar widget to the CleverTap dashboard to provide more functionality and a better user experience.",
  "title": "New Calendar Widget"
}
[/block]
...
The Calendar Date widget provides the following options:
  ...
  * **Before:** When you select Before, you will get data for all dates before the date selected. The lower date bound will be the earlier option of these two possibilities: (A) the Data Retention Policy set for the event(s) needed, or (B) 10 years.
