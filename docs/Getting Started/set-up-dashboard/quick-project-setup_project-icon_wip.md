---
title: Quick Project Setup_Project Icon_WIP
excerpt: ''
deprecated: false
hidden: true
metadata:
...
A project can be an individual app, a website, or a product. You can choose to combine multiple platforms in a single project or have separate projects for each platform, depending on your business goals. For example, a luxury brand can create a super app linked to multiple apps for perfumes, jewelry, and so on for the same brand. The data from each app can be shared across all other apps under the super app.  

CleverTap automatically creates a *Test* project for testing after you create a project. You can perform all your tests on this project before you actually roll out the changes. 

Create a project quickly after you log on to CleverTap with the following steps:

<Image title="Online_Signup_project_create.png" alt={578} className="border" width="80%" border={true} src="https://files.readme.io/bfe1a41-Online_Signup_project_create.png" />

1. Enter the **Project name**.
2. Click the **Import Project icon** button.  The *Import project icon* window displays. Provide the project URL to import the project icon. After an icon is assigned to a project, it is visible across screens.  

<Image title="Self_serve_project_icon.png" alt={395} className="border" width="80%" border={true} src="https://files.readme.io/b62c0ab-Self_serve_project_icon.png" />

* Find app URL on Google Play.

1. Open [Google Play Store](https://play.google.com/store)  from your browser. 
2. Search for your app and open it in the browser.
3. Copy the URL from the address bar. Following is an example of a Google Play URL:\
   `https://play.google.com/store/apps/details?id=<package_name>`

* Find app URL on Apple App Store

1. Open [Apple App Store](https://www.apple.com/app-store/)  from your browser. 

2. Search for your app and open it in the browser.

3. Copy the URL from the address bar. Following is an example of an Apple App Store URL:\
...
6. Select from the following platforms:
...
* [Web](https://docs.clevertap.com/docs/quick-project-setup#section-setup-your-website)
* [API](https://docs.clevertap.com/docs/quick-project-setup#section-setup-api)

5. Select the platform for your iOS or Android app. Select "Native" for native Android and iOS apps. You can also select other hybrid platforms for iOS and Android such as:
...
<Image title="Online_Signup_Account_Integration.png" alt={1189} className="border" border={true} src="https://files.readme.io/08183f3-Online_Signup_Account_Integration.png" />
...
1. Enter the PlayStore URL for your app.  \<\<@saurav Why do we have this in two places. Will it be prefilled if the customer enters it at the beginning ?>
...
1. Enter the AppStore URL for your app. This step is optional. \<\<@saurav Why do we have this in two places. Will it be prefilled if the customer enters it at the beginning ?>
...
3. Set up push notifications\
   To integrate and enable web push notifications, navigate to \[web push channel setup] ([https://developer.clevertap.com/docs/web#section-web-push](https://developer.clevertap.com/docs/web#section-web-push)).
